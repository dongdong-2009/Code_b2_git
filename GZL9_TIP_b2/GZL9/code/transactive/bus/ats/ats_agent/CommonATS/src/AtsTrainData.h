/**
  ...
  * 
  * Source:    $File: //depot/4669_Review_Branch/4669/transactive/bus/ats/ats_agent/CommonATS/src/AtsTrainData.h $
...
#include "bus/ats/ats_agent/CommonATS/src/AtsTrainDataTimer.h"
...
namespace TA_IRS_Bus
{
    ...
    public:
		...
		AtsTrainData(std::string physicalTrainNumber, unsigned long entityKey,
		...
		void updateDirection(const TA_IRS_Bus::EDirection direction);
