/**
  ...
  * in any form.
  *
  * Source:   $File: \\depot\GZL6_TIP\3002\transactive\bus\signalling\SignallingProtocolLibrary\src\IMessagePollReceiver.h $
  * @author:  Lucky
  * @version: $Revision: #1 $
  *
  ...
  *
  * Receives a Message Poll telegram
  */

#ifndef _IMESSAGE_POLL_RECEIVER_H_
#define _IMESSAGE_POLL_RECEIVER_H_
#include "boost/shared_ptr.hpp"

class IMessagePollReceiver
{
public:
	virtual ~IMessagePollReceiver(){};
