...
/**
  ...
  * in any form.
  *
  * Source:   $File: \\depot\GZL6_TIP\3002\transactive\bus\signalling\SignallingProtocolLibrary\src\IPracticalStartReceiver.h $
  * @author:  Lucky Cuizon
  * @version: $Revision: #1 $
  *
  ...
  *
  * Receives a IPracticalStartReceiver telegram
  */

#ifndef _I_PRACTICAL_START_RECEIVER_H_
#define _I_PRACTICAL_START_RECEIVER_H_
...
public:
	virtual ~IPracticalStartReceiver(){};
