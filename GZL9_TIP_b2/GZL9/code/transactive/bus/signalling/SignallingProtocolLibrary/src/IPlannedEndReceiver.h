...
/**
  ...
  * in any form.
  *
  * Source:   $File: \\depot\GZL6_TIP\3002\transactive\bus\signalling\SignallingProtocolLibrary\src\IPlannedEndReceiver.h $
  * @author:  Lucky Cuizon
  * @version: $Revision: #1 $
  *
  ...
  *
  * Receives a PlannedTelegramEnd telegram
  */

#ifndef _I_PLANNED_END_RECEIVER_H_
#define _I_PLANNED_END_RECEIVER_H_
