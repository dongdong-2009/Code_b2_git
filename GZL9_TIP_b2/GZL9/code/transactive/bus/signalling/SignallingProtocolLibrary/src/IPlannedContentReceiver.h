...
/**
  ...
  * in any form.
  *
  * Source:   $File: \\depot\GZL6_TIP\3002\transactive\bus\signalling\SignallingProtocolLibrary\src\IPlannedContentReceiver.h $
  * @author:  Lucky Cuizon
  * @version: $Revision: #1 $
  *
  ...
  *
  * Receives a PlannedTelegramContent telegram
  */

#ifndef _I_PLANNED_CONTENT_RECEIVER_H_
#define _I_PLANNED_CONTENT_RECEIVER_H_
...
public:
	virtual ~IPlannedContentReceiver(){};
