/**
  ...
  * in any form.
  *
  * Source: $File: //depot/GZL6_TIP/3002/transactive/bus/pa/cachedmaps/src/PaAtsTriggeredBroadcastCachedMap.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Bus
{
            ...
            //throw(TA_Base_Core::DataException, TA_Base_Core::DatabaseException, TA_Base_Core::InvalidPasConfigurationException)
    {
        ...
        LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "PaAtsTriggeredBroadcastCachedMap refreshed and loaded %d items of location %d", m_keyToRecordMap.size(), locationKey );
        FUNCTION_EXIT;
    }
