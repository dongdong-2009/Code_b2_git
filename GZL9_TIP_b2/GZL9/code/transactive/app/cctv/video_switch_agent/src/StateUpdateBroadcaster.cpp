/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/StateUpdateBroadcaster.cpp $
...
namespace TA_IRS_App
{
    ...
    void StateUpdateBroadcaster::notifyAgentState()
    {
        ...
        /*TA_Base_Bus_GZL9::SwitchManagerCorbaDef::BVSStageSequence_var bvsSeq =
        ...
        const std::string& presetName )
    {
        ...
        CORBA::Any stateData;
        TA_Base_Bus_GZL9::MovementControlCorbaDef::CameraPreset preset;
   ...
   /* void StateUpdateBroadcaster::notifyBVSStateUpdate( unsigned long bvsKey, bool sendStateUpdateMessageOnly )
    ...
    void StateUpdateBroadcaster::notifyAlarmStackUpdate()
	{
		...
		{
			TA_Base_Bus_GZL9::SwitchManagerCorbaDef::AlarmStack alarmStack = alarmInterface->getAlarmStack();
