/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/FocusIrisControl.cpp $
...
namespace TA_IRS_App
{
        ...
        : m_camera( camera )
    {
        m_pdFocusIrisControl = std::auto_ptr< IPDFocusIrisControl >( 
            getPDInterfaceFactory().createFocusIrisControl( m_camera.getCameraData() ) );
    ...
    // updateState
    //
    void FocusIrisControl::updateState( const TA_Base_Bus_GZL9::CameraCorbaDef::CameraState& state )
    {
