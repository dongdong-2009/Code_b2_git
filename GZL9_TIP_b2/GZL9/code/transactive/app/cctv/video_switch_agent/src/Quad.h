...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/Quad.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    class Quad : public VideoInput,
                 public virtual POA_TA_Base_Bus_GZL9::QuadCorbaDef,
    ...
    public:
        ...
        /**
          ...
          */
        virtual void requestSwitchOfInput( TA_Base_Bus_GZL9::QuadCorbaDef::EQuadSegment segment, unsigned long videoInputEntityKey,
