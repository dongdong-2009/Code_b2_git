...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/MovementControl.h $
...
namespace TA_IRS_App
{
    class MovementControl : public virtual POA_TA_Base_Bus_GZL9::MovementControlCorbaDef,
    ...
    public:
        ...
        void panAndTilt( TA_Base_Bus_GZL9::MovementControlCorbaDef::EPanDirection panDirection,
        ...
        virtual TA_Base_Bus_GZL9::MovementControlCorbaDef::CameraPreset* getActivePreset();
        ...
        virtual TA_Base_Bus_GZL9::MovementControlCorbaDef::CameraPresetSequence* getAllPresets();
        ...
        /** 
          ...
          *
          * @param      const TA_Base_Bus_GZL9::MovementControlCorbaDef::CameraPreset& preset
          *             The preset details.
          * @param      const char* sessionId   
          *             Used to determine if the user has sufficient 
          *             privileges for this operation.
        ...
        virtual void storePreset( const TA_Base_Bus_GZL9::MovementControlCorbaDef::CameraPreset& preset, const char* sessionId );
