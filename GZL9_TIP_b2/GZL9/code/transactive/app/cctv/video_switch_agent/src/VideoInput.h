...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/VideoInput.h $
...
namespace TA_IRS_App
{
	class VideoInput : public VideoSwitchResource,
                       public virtual POA_TA_Base_Bus_GZL9::VideoInputCorbaDef,
	...
	public:
        ...
        void updateState( const TA_Base_Bus_GZL9::VideoInputCorbaDef::VideoInputState& state );
        ...
        /**
          ...
          *
          * @return     TA_Base_Bus_GZL9::VideoInputCorbaDef::SupportedVideoInputFeatures
        ...
        virtual TA_Base_Bus_GZL9::VideoInputCorbaDef::SupportedVideoInputFeatures getSupportedVideoInputFeatures();
		...
		virtual TA_Base_Bus_GZL9::VideoInputCorbaDef::VideoInputState* getVideoInputState();
		...
		/**
		  ...
		  *
		  * @return		TA_Base_Bus_GZL9::SuperimposedTextControlCorbaDef_ptr
        ...
        virtual TA_Base_Bus_GZL9::SuperimposedTextControlCorbaDef_ptr getSuperimposedTextControl();
