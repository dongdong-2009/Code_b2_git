...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/StateUpdateSubscriber.h $
...
namespace TA_IRS_App
{
    ...
    private:
        ...
        /**
          ...
          * @param      const TA_Base_Bus_GZL9::VideoOutputCorbaDef::QuadState& state
        ...
        /**
          ...
          * @param      const TA_Base_Bus_GZL9::BVSStageCorbaDef::BVSStageState& state 
	...
	//								const TA_Base_Bus_GZL9::BVSStageCorbaDef::BVSStageState& state );
		...
		void updateAlarmStack( TA_Base_Bus_GZL9::SwitchManagerCorbaDef::AlarmStack& stack);
