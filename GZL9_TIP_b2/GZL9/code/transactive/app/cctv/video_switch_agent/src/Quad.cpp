/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/Quad.cpp $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    , m_entityKey( entityData->getKey() )
    {
		...
		m_pdQuad = std::auto_ptr< IPDQuad >( getPDInterfaceFactory().createQuad( m_quadEntityData ) );
    ...
    TA_Base_Bus_GZL9::QuadCorbaDef::QuadState Quad::getQuadState()
	{
	...
	void Quad::requestSwitchOfInput( TA_Base_Bus_GZL9::QuadCorbaDef::EQuadSegment segment, unsigned long videoInputEntityKey,
    ...
    // updateState
    //
    void Quad::updateState( const TA_Base_Bus_GZL9::QuadCorbaDef::QuadState& state )
    {
