/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/VideoOutputGroup.cpp $
...
namespace TA_IRS_App
{
 ...
 //       TA_Base_Bus::GenericAgent::ensureControlMode();//limin
    ...
    // getVideoOutputList
    //
    TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef::VideoOutputSequence* VideoOutputGroup::getVideoOutputList()
    {
        TA_Base_Bus::GenericAgent::ensureControlMode();//limin
        ...
        TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef::VideoOutputSequence* videoOutputs = 
            new TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef::VideoOutputSequence();
        if ( 0 == videoOutputs )
        {
            throw TA_Base_Bus_GZL9::VideoSwitchAgentException( "Failed to create new VideoOutputSequence object." );
        }
    ...
    char* VideoOutputGroup::getVideoWallboardAgentName()
    {
        ...
        if ( ! this->isCapableOfLayouts () )
        {
            ...
            throw TA_Base_Bus_GZL9::VideoSwitchAgentException( "Requested Video Wallboard Agent Name, but the VideoOutputGroup is NOT capable of Video Wallboard Layout manipulation" );
        }
        else
        {
            try
