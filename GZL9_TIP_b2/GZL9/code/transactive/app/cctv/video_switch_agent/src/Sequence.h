 ...
 * in any form.
 *
 * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/Sequence.h $
 * @author:  Jade Welton
 * @version: $Revision: #1 $
 *
...
namespace TA_IRS_App
{
    ...
    class Sequence : public VideoInput,
                     public virtual POA_TA_Base_Bus_GZL9::SequenceCorbaDef,
    ...
    public:
        ...
        void updateState( const TA_Base_Bus_GZL9::SequenceCorbaDef::SequenceState& state );
        ...
        void updateSequenceConfig( const TA_Base_Bus_GZL9::SequenceCorbaDef::SequenceConfig& sequenceConfig );
        ...
        /**
          ...
          */
        virtual void setSequenceConfig( const TA_Base_Bus_GZL9::SequenceCorbaDef::SequenceConfig& newConfig, const char* sessionId,bool con );
        ...
        /**
          ...
          * Registers the Sequence so it can be resolved by the agent's clients.
          */
        ...
        /**
          ...
          * Deregisters the Sequence so it cannot be resolved by the agent's clients.
          */
