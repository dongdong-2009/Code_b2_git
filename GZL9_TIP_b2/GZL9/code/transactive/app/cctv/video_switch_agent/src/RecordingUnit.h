...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/RecordingUnit.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    class RecordingUnit : public VideoSwitchResource,
                          public virtual POA_TA_Base_Bus_GZL9::RecordingUnitCorbaDef,
    ...
    public:
        ...
        /**
          ...
          */
        void updateState( const TA_Base_Bus_GZL9::RecordingUnitCorbaDef::RecordingUnitState& state );
		...
		/**
		  ...
		  */
		TA_Base_Bus_GZL9::RecordingUnitCorbaDef::RecordingUnitState getRecordingUnitState();
		...
		/**
		  ...
		  *				Thrown if the agent is in Monitor mode.
		  */
		TA_Base_Bus_GZL9::RecordingUnitCorbaDef::recordingSpeedSequence* getRecordingSpeeds();
