...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/Camera.h $
...
namespace TA_IRS_App
{
    class Camera : public VideoInput,
                   public virtual POA_TA_Base_Bus_GZL9::CameraCorbaDef,
    ...
    public:
        ...
        void updateState( const TA_Base_Bus_GZL9::CameraCorbaDef::CameraState& state );
        ...
        /**
          ...
          *
          * @return     TA_Base_Bus_GZL9::CameraCorbaDef::SupportedCameraFeatures
        ...
        virtual TA_Base_Bus_GZL9::CameraCorbaDef::SupportedCameraFeatures getSupportedFeatures();
        ...
        /**
          ...
          *
          * @return     TA_Base_Bus_GZL9::CameraCorbaDef::CameraState
		...
		virtual TA_Base_Bus_GZL9::CameraCorbaDef::CameraState getState();
		...
		/**
		  ...
		  *
		  * @return		TA_Base_Bus_GZL9::MovementControlCorbaDef_ptr
		...
		virtual TA_Base_Bus_GZL9::MovementControlCorbaDef_ptr getMovementControl();
		...
		/**
		  ...
		  *
		  * @return		TA_Base_Bus_GZL9::FocusIrisControlCorbaDef_ptr
		...
		virtual TA_Base_Bus_GZL9::FocusIrisControlCorbaDef_ptr getFocusIrisControl();
		...
		/**
		  ...
		  *
		  * @return		TA_Base_Bus_GZL9::WashWipeControlCorbaDef_ptr
        ...
        virtual TA_Base_Bus_GZL9::WashWipeControlCorbaDef_ptr getWashWipeControl();
		...
		virtual void CameraPan(/*::CORBA::ULong camerakey, */::CORBA::UShort movement, ::CORBA::UShort speed);
		virtual void CameraTilt(/*::CORBA::ULong camerakey, */::CORBA::UShort movement, ::CORBA::UShort speed);
		virtual void CameraZoom(/*::CORBA::ULong camerakey, */::CORBA::UShort movement);
		virtual void CameraPanAndTilt(/*::CORBA::ULong camerakey,*/ ::CORBA::UShort pan, ::CORBA::UShort panspeed, ::CORBA::UShort tilt, ::CORBA::UShort tiltspeed);
