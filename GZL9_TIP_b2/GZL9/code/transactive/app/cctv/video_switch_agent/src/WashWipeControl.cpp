/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/WashWipeControl.cpp $
...
namespace TA_IRS_App
{
        ...
        : m_camera( camera )
    {
        m_pdWashWipeControl = std::auto_ptr< IPDWashWipeControl >( 
            getPDInterfaceFactory().createWashWipeControl( m_camera.getCameraData() ) );
