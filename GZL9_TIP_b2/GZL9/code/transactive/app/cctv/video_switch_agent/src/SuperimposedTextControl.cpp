/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/SuperimposedTextControl.cpp $
...
namespace TA_IRS_App
{
        ...
        : m_videoInput( videoInput )
    {
        m_pdSuperimposedTextControl = std::auto_ptr< IPDSuperimposedTextControl >( 
            getPDInterfaceFactory().createSuperimposedTextControl( m_videoInput.getVideoInputData() ) );
    ...
    // updateState
    //
    void SuperimposedTextControl::updateState( const TA_Base_Bus_GZL9::VideoInputCorbaDef::VideoInputState& state )    
    {
