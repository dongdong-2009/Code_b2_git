...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/VideoMonitor.h $
...
namespace TA_IRS_App
{
    class VideoMonitor : public VideoOutput,
                         public virtual POA_TA_Base_Bus_GZL9::VideoMonitorCorbaDef,
    ...
    public:
        ...
        /**
          ...
          *
          * @return     TA_Base_Bus_GZL9::VideoMonitorCorbaDef::EVideoMonitorSize
        ...
        virtual TA_Base_Bus_GZL9::VideoMonitorCorbaDef::EVideoMonitorSize getSize();
