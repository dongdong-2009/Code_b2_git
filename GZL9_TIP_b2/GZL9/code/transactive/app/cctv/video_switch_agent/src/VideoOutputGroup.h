...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/VideoOutputGroup.h $
...
namespace TA_IRS_App
{
    class VideoOutputGroup : public virtual POA_TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef,
    ...
    public:
        ...
        /**
          ...
          *
          * @return     TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef::VideoOutputSequence*
        ...
        virtual TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef::VideoOutputSequence* getVideoOutputList();
