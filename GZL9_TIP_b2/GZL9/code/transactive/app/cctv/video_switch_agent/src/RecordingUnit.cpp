/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/src/RecordingUnit.cpp $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    , m_entityKey( entityData->getKey() )
    {
		...
		m_pdRecordingUnit = std::auto_ptr< IPDRecordingUnit >( getPDInterfaceFactory().createRecordingUnit( m_recordingUnitEntityData ) );
    ...
    // updateState
    //
    void RecordingUnit::updateState( const TA_Base_Bus_GZL9::RecordingUnitCorbaDef::RecordingUnitState& state )
    {
	...
	//
    TA_Base_Bus_GZL9::RecordingUnitCorbaDef::SupportedRecordingUnitFeatures RecordingUnit::getSupportedFeatures()
    {
	...
	//
	TA_Base_Bus_GZL9::RecordingUnitCorbaDef::RecordingUnitState RecordingUnit::getRecordingUnitState()
    {
	...
	// getRecordingSpeeds
    //
	TA_Base_Bus_GZL9::RecordingUnitCorbaDef::recordingSpeedSequence* RecordingUnit::getRecordingSpeeds()
    {
