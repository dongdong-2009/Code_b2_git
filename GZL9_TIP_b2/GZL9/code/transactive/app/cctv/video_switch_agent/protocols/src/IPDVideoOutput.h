...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/src/IPDVideoOutput.h $
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        virtual void updateState( const TA_Base_Bus_GZL9::VideoOutputCorbaDef::VideoOutputState& state ) = 0;
        ...
        virtual TA_Base_Bus_GZL9::VideoOutputCorbaDef::VideoOutputState* getVideoOutputState() = 0;
		...
		virtual void activeVideoInput( unsigned long videoInputEntityKey,bool active, bool isDemand )=0;
		/**
		...
		virtual void stop() = 0;
          ...
          */
        virtual void connectSequence( const TA_Base_Bus_GZL9::VideoOutputCorbaDef::UserDefinedSequenceConfig& newConfig ) = 0;

		virtual void disconnectSequence() = 0;
		/*virtual bool OutputCameraPan(::CORBA::ULong cameraKey,char movement, char speed) = 0;
		virtual bool OutputCameraTilt(::CORBA::ULong cameraKey,char movement, char speed) = 0;
		virtual bool OutputCameraZoom(::CORBA::ULong cameraKey,char movement) = 0;
		virtual bool OutputCameraPTZ(::CORBA::ULong cameraKey, const ::TA_Base_Bus_GZL9::VideoOutputCorbaDef::CameraPTZ& cmd) = 0;*/
