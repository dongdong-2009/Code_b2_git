#if !defined(MODBUSVideoInput_B5DC94EC_53A1_432b_99C7_5F3286E2F499__INCLUDED_)
#define MODBUSVideoInput_B5DC94EC_53A1_432b_99C7_5F3286E2F499__INCLUDED_

/**
  * The source code in this file is the property of
  * Ripple Systems and is not for redistribution in any form.
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/MODBUS/src/MODBUSVideoInput.h $
  * @author:   Rob Young
  * @version:  $Revision: #1 $
  *
...
{
    class MODBUSVideoInput : public IPDVideoInput
	{
	public:
		/**
		  * MODBUSVideoInput
        ...
        MODBUSVideoInput( TA_Base_Core::VideoInputPtr videoInputData );
        ...
        virtual void updateState( const TA_Base_Bus_GZL9::VideoInputCorbaDef::VideoInputState& state );
		...
		/**
		  ...
		  *
		  * Identifies if this MODBUSVideoInput is allowed to be viewed publicly 
		  * (e.g. on the internet).
		  *
		  * @return		bool
		  *				True if the MODBUSVideoInput is allowed to be viewed publicly.
		  *				False if the MODBUSVideoInput is not allowed to be viewed publicly
		...
		/**
		  ...
		  *
		  * Sets if this MODBUSVideoInput is allowed to be viewed publicly 
		  * (e.g. on the internet).
		  *
		...
		/**
		  * isInService
		  *
		  * Identifies if this MODBUSVideoInput is in or out of service.
		  *
		  * @return		bool
		  *				True if the MODBUSVideoInput is in service.
		  *				False if the MODBUSVideoInput is not in service
		...
		/**
		  * setInService
		  *
		  * Sets this MODBUSVideoInput in or out of service.
		  *
		  * @param		bool isInService
		  *				True to set the MODBUSVideoInput in service.
		  *				False to set the MODBUSVideoInput out of service.
 		  */
    ...
    private:
        ...
        MODBUSVideoInput( const MODBUSVideoInput& theMODBUSVideoInput );
        MODBUSVideoInput& operator=( const MODBUSVideoInput& );
...
#endif // !defined(MODBUSVideoInput_B5DC94EC_53A1_432b_99C7_5F3286E2F499__INCLUDED_)