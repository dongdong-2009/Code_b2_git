#ifndef IMOS_HELPER_H
#define IMOS_HELPER_H
 ...
 * in any form.
 *
 * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/IMOS/src/IMOSHelper.h $
 * @author:  Rob Young
 * @version: $Revision: #2 $
 *
...
namespace TA_IRS_App
{
    ...
    class IMOSVideoOutput;
    class IMOSSequence;
    class IMOSQuad;
    class IMOSRecordingUnit;
}
...
namespace TA_IRS_App
{
	...
	namespace TA_IMOS
    {
		...
		///////////////////////////////////////////////
        ////  IMOS Packet Format Details Constants  ////
        ///////////////////////////////////////////////
        ...
        const unsigned int QUAD_STATUS_MIN_RESPONSE_PACKET_LENGTH = PACKET_HEADER_LENGTH + 9;
        const unsigned int QUAD_STATUS_MAX_RESPONSE_PACKET_LENGTH = PACKET_HEADER_LENGTH + 9;
        ...
        const unsigned int SEQUENCE_INFO_MAX_RESPONSE_PACKET_LENGTH = PACKET_HEADER_LENGTH + 130;
