...
* - 使用播放器XP软件包首先需要调用的函数。
*/
IMOS_EXPORT ULONG STDCALL XP_Init();
...
*/
IMOS_EXPORT ULONG STDCALL XP_Cleanup();
...
* - 使用播放器XP软件包首先需要调用的函数。
*/
IMOS_EXPORT ULONG STDCALL XP_InitXP(IN const CHAR *pcModuleBaseCode);
...
* @note 退出播放器XP软件包最后一个需要调用函数。
*/
IMOS_EXPORT ULONG STDCALL XP_CleanupXP();
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetXPDevID(IN const CHAR *pcXPDevID);
...
*/
IMOS_EXPORT ULONG STDCALL XP_SetWndIDInfo(IN IMOS_HANDLE hWnd,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetVoiceTalkbackResCode(IN const CHAR *pcTalkbackResCode);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetVoiceBroadcastResCode(IN const CHAR *pcBroadcastResCode);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetRunMsgCB(IN const XP_RUN_INFO_CALLBACK_PF pfnRunInfoFunc);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetOutputMediaDataCB(IN XP_PROCESS_MEDIA_DATA_CALLBACK_PF pfnDataProcFunc);
...
*/
IMOS_EXPORT ULONG STDCALL XP_SetRenderMode(IN XP_RENDER_MODE_E enRenderMode);
...
*/
IMOS_EXPORT ULONG STDCALL XP_SetCCServerInfo(IN const CHAR *pcServerDevID,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_RegXP();
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_UnregXP();
...
* -    必须在XP_RegXP接口调用之后调用
*/
IMOS_EXPORT ULONG STDCALL XP_StartXP();
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_OpenPlaySvc(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_SetWndLocalAddress(IN IMOS_HANDLE hXpWnd,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetWndServerAddress(IN IMOS_HANDLE hXpWnd,
                                                 IN const CHAR *pcServerIP,
                                                 IN USHORT usServerPort);
...
*/
IMOS_EXPORT ULONG STDCALL XP_InputMediaData(IN IMOS_HANDLE hXpWnd,
                                            IN const CHAR *pcBuf,
                                            IN ULONG ulLength);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetMediaDataFormat(IN IMOS_HANDLE hXpWnd,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_OpenRealtimeMonitor(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_SetFieldMode(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_EnableDeinterlace(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_EnableOutputMediaData(IN IMOS_HANDLE hXpWnd,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_PausePlay(IN IMOS_HANDLE hXpWnd);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_ResumePlay(IN IMOS_HANDLE hXpWnd);
...
*/
IMOS_EXPORT ULONG STDCALL XP_Quiet(IN IMOS_HANDLE hXpWnd,
                                   IN BOOL_T bEnabled);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_AdjustVolume(IN ULONG ulVolume);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_GetVolume(OUT ULONG *pulVolume);
...
*/
IMOS_EXPORT ULONG STDCALL XP_AdjustAllWaveAudio(IN ULONG ulCoefficient);
...
*/
IMOS_EXPORT ULONG STDCALL XP_SnatchOnce(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_StartSnatchSeries(IN IMOS_HANDLE hXpWnd,
                                               IN const CHAR *pcFileName,
                                               IN XP_PICTURE_FORMAT_E enPicFormat,
                                               IN ULONG ulSnatchInterval);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_StopSnatchSeries(IN IMOS_HANDLE hXpWnd);
...
*/
IMOS_EXPORT ULONG STDCALL XP_StartRecordVideo(IN IMOS_HANDLE hXpWnd,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_StopRecordVideo(IN IMOS_HANDLE hXpWnd);
...
*/
IMOS_EXPORT ULONG STDCALL XP_GetVideoEncodeType(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_GetLostPacketRate(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_ResetLostPacketRate(IN IMOS_HANDLE hXpWnd);
...
*/
IMOS_EXPORT ULONG STDCALL XP_GetLostFrameRate(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_ResetLostFrameRate(IN IMOS_HANDLE hXpWnd);
...
*/
IMOS_EXPORT ULONG STDCALL XP_GetFrameRate(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_GetBitRate(IN IMOS_HANDLE hXpWnd,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetTransportProtocol(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_SetDecoderTag(IN IMOS_HANDLE hXpWnd,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_OpenVodStream(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_StartPlay(IN IMOS_HANDLE hXpWnd);
...
*/
IMOS_EXPORT ULONG STDCALL XP_SetPlaySpeed(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_OneStepPlay(IN IMOS_HANDLE hXpWnd,
                                         IN BOOL_T bForward);
...
*/
IMOS_EXPORT ULONG STDCALL XP_DragPlay(IN IMOS_HANDLE hXpWnd,
...
*/
IMOS_EXPORT ULONG STDCALL XP_GetCurPlayPos(IN IMOS_HANDLE hXpWnd,
...
* -         2、用户同时启动下载的最大通道数为5。
*/
IMOS_EXPORT ULONG STDCALL XP_StartDownMediaStream(IN const CHAR *pcServerIP,
                                                  IN USHORT usServerPort,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_StopDownMediaStream(IN const CHAR *pcDownloadID);
...
*/
IMOS_EXPORT ULONG STDCALL XP_GetCurDownPos(IN const CHAR *pcDownloadID,
...
*/
IMOS_EXPORT ULONG STDCALL XP_StopPlay(IN IMOS_HANDLE hXpWnd);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_OpenLocalFile(IN IMOS_HANDLE hXpWnd,
                                           IN const CHAR *pcFileName,
                                           OUT ULONG * const pulTotalTime);
...
* @note 启动到指定语音终端的语音对讲。
*/
IMOS_EXPORT ULONG STDCALL XP_OpenVoiceTalkback(IN const CHAR *pszDstResCode);
...
* @note 停止与指定语音终端的语音对讲。
*/
IMOS_EXPORT ULONG STDCALL XP_CloseVoiceTalkback(IN const CHAR *pszDstResCode);
...
* @note 启动到指定语音终端的语音广播。
*/
IMOS_EXPORT ULONG STDCALL XP_OpenVoiceBroadcast(IN const CHAR *pszDstResCode);
...
* @note 停止到指定语音终端的语音广播。
*/
IMOS_EXPORT ULONG STDCALL XP_CloseVoiceBroadcast(IN const CHAR *pszDstResCode);
...
*/
IMOS_EXPORT ULONG STDCALL XP_VoiceSilence(IN BOOL_T bSilence);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL XP_VoiceQuiet(IN BOOL_T bEnabled);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_AdjustMicVolume(IN ULONG ulVolume);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_GetMicVolume(OUT ULONG *pulVolume);
...
*/
IMOS_EXPORT ULONG STDCALL XP_InitVoiceSvc(IN const CHAR *pszVoiceID,
...
* -         #ERR_XP_FAIL_TO_GET_PORT_RES             获得通道资源失败
*/
IMOS_EXPORT ULONG STDCALL XP_SetVoiceLocalAddr(IN const CHAR *pszVoiceID,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_SetVoiceRemoteAddr(IN const CHAR *pszVoiceID,
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_StartVoiceSvc(IN const CHAR *pszVoiceID);
...
* @note 无。
*/
IMOS_EXPORT ULONG STDCALL XP_StopVoiceSvc(IN const CHAR *pszVoiceID);
