 ...
 * in any form.
 *
 * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/src/IPDQuad.h $
 * @author:  Jade Welton
 * @version: $Revision: #1 $
 *
...
namespace TA_IRS_App
{
	...
	public:
		...
		virtual ~IPDQuad() {};
          ...
          */
        virtual TA_Base_Bus_GZL9::QuadCorbaDef::QuadState getQuadState() = 0;
        ...
        /**
          ...
          */
        virtual void requestSwitchOfInput( TA_Base_Bus_GZL9::QuadCorbaDef::EQuadSegment segment, unsigned long videoInputEntityKey, bool isDemand ) = 0;
        ...
        /**
          ...
          */
        virtual void updateState( const TA_Base_Bus_GZL9::QuadCorbaDef::QuadState& state ) = 0;
