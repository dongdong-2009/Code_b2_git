#ifndef MODBUSSEQUENCE_H
#define MODBUSSEQUENCE_H

/**
  * The source code in this file is the property of
  * Ripple Systems and is not for redistribution in any form.
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/MODBUS/src/MODBUSSequence.h $
...
{
    class MODBUSSequence : public IPDSequence//, public virtual IStateValidationItem
    {
    ...
    public:
        ...
        MODBUSSequence( TA_Base_Core::SequencePtr sequenceData );
    ...
    private:
        ...
        MODBUSSequence( const MODBUSSequence& theMODBUSSequence );
        MODBUSSequence& operator=( const MODBUSSequence& );
