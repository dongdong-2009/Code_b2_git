...
/*@brief 版本信息字符串长度 */
#define IMOS_VERSION_INFO_LEN                   32
...
/*@brief 视频输出虚拟通道最大数量 */
#define IMOS_VOUT_CHANNEL_MAXNUM            1
...
/*@brief IMOS支持的设备类型个数(EC/DC/MS/DM/VX500/摄像头/监视器/ECR/BM) */
#define IMOS_DEVICE_TYPE_NUM                9
