...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_StartConference
(
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetConferenceActiveInfo
(
    IN    USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
    IN    ULONG                         ulConfCheckAuthMode,
    IN    IMOS_ID                       idConfId,
    OUT   MC_CONF_ACTIVE_INFO_EX_S      *pstConferenceActiveInfo,
    INOUT ULONG                         *pulSiteCount,
    OUT   MC_CONF_SITE_LIST_EX_S        *pstSiteList,
    INOUT ULONG                         *pulMcuCount,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QuerySiteInConf
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLogIDInfo,
    IN  IMOS_ID                     idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_EndConference
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_ExtendConference
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  LONG                    lMinute
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_CallAllSites
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_LockConference
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  BOOL_T                  bLockConf
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetAllSilence
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetAllMute
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  BOOL_T                  bMuteAll
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetTurnBroadcast
(
    IN  USER_LOGIN_ID_INFO_S              *pstUserLogIDInfo,
    IN  IMOS_ID                           idConfId,
    IN  ULONG                             ulTurnMode,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SendAllVideo
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetCycleList
(
    IN    USER_LOGIN_ID_INFO_S               *pstUserLogIDInfo,
    IN    IMOS_ID                            idConfId,
    OUT   ULONG                              *pulCycleTime,
    INOUT ULONG                              *pulCycleTermCount,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetCycleList
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  ULONG                   ulCycleTime,
    IN  ULONG                   ulCycleTermCount,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetBanner
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetBanner
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetTitle
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetTitle
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetPicMode
(
    IN  USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
    IN  IMOS_ID                       idConfId,
...
*       它包括小画面位置、小画面显示类型（主席、发言人、其它会场、激励、轮巡等）。
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetPicMode
(
    IN  USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
    IN  IMOS_ID                       idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetConferenceFrame
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetConferenceFrame
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetConferenceColorGroup
(
    IN  USER_LOGIN_ID_INFO_S       *pstUserLogIDInfo,
    IN  IMOS_ID                    idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetShowSiteNameMode
(
    IN  USER_LOGIN_ID_INFO_S       *pstUserLogIDInfo,
    IN  IMOS_ID                    idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetShowSiteNameMode
(
    IN  USER_LOGIN_ID_INFO_S       *pstUserLogIDInfo,
    IN  IMOS_ID                    idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetConfCtrlInfo
(
    IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
    IN  IMOS_ID                  idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetConfCtrlInfo
(
    IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
    IN  IMOS_ID                  idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_AddSite
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_DelSite
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN]
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_CallSite
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_AcceptSpeakReq
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetSpeakReqList
(
    IN    USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN    IMOS_ID                 idConfId,
    INOUT ULONG                   *pulTermCount,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetSiteSilence
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetSiteMute
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetBroadcastSite
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN]
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_OpenSiteVideo
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetSiteChair
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetSiteFECCController
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetSecondVideoRes
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetSiteChannel
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetSiteInfo
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetTermStatus
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  CHAR                    szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_StartAlarmOfTerminal
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  IMOS_ID                         idConfId,
    IN  ULONG                           ulAlarmCount,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetSiteLayerSwitchMode
(
    IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
    IN  IMOS_ID                  idConfId,
    IN  CHAR                     szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetSiteLayerSwitchMode
(
    IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
    IN  IMOS_ID                  idConfId,
    IN  CHAR                     szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_ResumeMainLayer
(
    IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
    IN  IMOS_ID                  idConfId,
    IN  CHAR                     szSiteCode[IMOS_RES_CODE_LEN]
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetTermLinkInfo
(
    IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
    IN  IMOS_ID                  idConfId,
    IN  CHAR                     szSiteCode[IMOS_RES_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_ChairBrowseSite
(
    IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
    IN  IMOS_ID                  idConfId,
    IN  CHAR                     szSiteCode[IMOS_RES_CODE_LEN]
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetGK
(
    IN  USER_LOGIN_ID_INFO_S       *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetGK
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
    OUT ULONG                   *pulGKType,
    OUT CHAR                    szGKIP[IMOS_IPADDR_LEN],
    OUT ULONG                   *pulGKRegState
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetNAT
(
    IN  USER_LOGIN_ID_INFO_S       *pstUserLogIDInfo,
    IN  CHAR                       szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetNAT
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetMCUQos
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetMCUQos
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetMCURunMode
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetMCURunMode
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetMCUName
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetMCULanIP
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
    IN  ULONG                   ulNetID,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetMCULanIP
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_ModifyMCULanRoute
(
    IN  USER_LOGIN_ID_INFO_S           *pstUserLogIDInfo,
    IN  CHAR                           szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetMCULanRouteInfo
(
    IN  USER_LOGIN_ID_INFO_S                *pstUserLogIDInfo,
    IN  CHAR                                szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetMCUARPInfo
(
    IN  USER_LOGIN_ID_INFO_S                *pstUserLogIDInfo,
    IN  CHAR                                szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetAlarmConfig
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
    IN  CHAR                    szIpAddress[IMOS_IPADDR_LEN],
    IN  ULONG                   ulPower1AlarmID,
    IN  ULONG                   ulPower2AlarmID
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetAlarmConfig
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szDevCode[IMOS_DEVICE_CODE_LEN],
    OUT CHAR                    szIpAddress[IMOS_IPADDR_LEN],
    OUT ULONG                   *pulPower1AlarmID,
    OUT ULONG                   *pulPower2AlarmID
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetBackupLinkLayerIPCfg
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLogIDInfo,
    IN  CHAR                        szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetBackupLinkLayerIPCfg
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLogIDInfo,
    IN  CHAR                        szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetColorGroupValue
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  LONG                    lGroupID,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetColorGroupValue
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_AddContact
(
    IN    USER_LOGIN_ID_INFO_S       *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_ModifyContact
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLogIDInfo,
    IN  CONF_CONTACT_INFO_EX_S      *pstContactInfo
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_DelContact
(
    IN   USER_LOGIN_ID_INFO_S           *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryContactInfo
(
    IN   USER_LOGIN_ID_INFO_S           *pstUserLogIDInfo,
    IN   IMOS_ID                        idContactId,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryContactList
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  QUERY_BY_NAME_S                 *pstName,
    IN  QUERY_PAGE_INFO_S               *pstQueryPageInfo,
...
*/
IMOS_EXPORT ULONG STDCALL IMOS_AddTerminal
(
    IN    USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
...
* @note H3C设备仅需设置pstTerminalBaseInfo，其他设置可选。 第三方设备需要全部设置
*/
IMOS_EXPORT ULONG STDCALL IMOS_ModifyTerminal
(
    IN    USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
    IN    CHAR                          szTerminalCode[IMOS_DEVICE_CODE_LEN],
    IN    DEVICE_BASE_INFO_S            *pstTerminalBaseInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_DelTerminal
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szTerminalCode[IMOS_DEVICE_CODE_LEN]
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryTerminal
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szTerminalCode[IMOS_DEVICE_CODE_LEN],
    OUT ULONG                           *pulRegistered,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_Query3rdTerminal
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szTerminalCode[IMOS_DEVICE_CODE_LEN],
    OUT DEVICE_BASE_INFO_S              *pstTerminalBaseInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryTerminalList
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szOrgCode[IMOS_DOMAIN_CODE_LEN],
    IN  BOOL_T                          bContainSubOrg,
    IN  ULONG                           ulTermQueryType,
    IN  QUERY_BY_NAME_S                 *pstName,
    IN  QUERY_PAGE_INFO_S               *pstQueryPageInfo,
    OUT RSP_PAGE_INFO_S                 *pstRspPageInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_AddMcu
(
    IN    USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_ModifyMcu
(
    IN    USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
    IN    MCU_BASE_INFO_EX_S            *pstMcuBaseInfo
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryMcu
(
    IN    USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_DelMcu
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szMcuCode[IMOS_DEVICE_CODE_LEN]
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryMcuList
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szOrgCode[IMOS_DOMAIN_CODE_LEN],
    IN  BOOL_T                          bContainSubOrg,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryActiveConfList
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szOrgCode[IMOS_DOMAIN_CODE_LEN],
    IN  QUERY_BY_NAME_S                 *pstName,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryBookingConfList
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szOrgCode[IMOS_DOMAIN_CODE_LEN],
    IN  QUERY_BY_NAME_S                 *pstName,
...
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryHistoryConfList
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryConfTempList
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  QUERY_BY_NAME_S                 *pstName,
    IN  QUERY_PAGE_INFO_S               *pstQueryPageInfo,
...
* @note 只能删除未召开会议
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetConference
(
    IN    USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN    IMOS_ID                 idConfId,
    OUT   MC_CONF_INFO_EX_S       *pstConfInfo,
    INOUT ULONG                   *pulConfTermCount,
    OUT   CONF_SITE_CASTE_EX_S    *pstConfTermList,
    INOUT ULONG                   *pulMcuCount,
    OUT   CONF_MCU_CASTE_EX_S     *pstMcuList,
    INOUT ULONG                   *pulCycleTermCount,
    OUT   CONF_SITE_CIRCLE_EX_S   *pstCycleTermList,
    INOUT ULONG                   *pulContactCount,
    OUT   CONF_CONTACT_INFO_EX_S  *pstContactList
);
...
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetHistoryConference
(
    IN    USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN    IMOS_ID                 idConfId,
    OUT   MC_CONF_INFO_EX_S       *pstConfInfo,
...
* @note 会议混音终端列表 会议语音激励列表 会议接收字幕终端列表 为NULL, 现不实现
*/
IMOS_EXPORT ULONG STDCALL IMOS_ModifyConference
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfId,
    IN  MC_CONF_INFO_EX_S       *pstConfInfo,
...
* @note 只能删除预约会议
*/
IMOS_EXPORT ULONG STDCALL IMOS_DeleteConference
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  IMOS_ID                         idConfId
);
...
* @note   会议混音终端列表 会议语音激励列表 会议接收字幕终端列表 为NULL, 现不实现
*/
IMOS_EXPORT ULONG STDCALL IMOS_CreateConfTemp
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
...
* @note 会议混音终端列表 会议语音激励列表 会议接收字幕终端列表 为NULL, 现不实现
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryConfTemp
(
    IN    USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
...
* @note 会议混音终端列表 会议语音激励列表 会议接收字幕终端列表 为NULL, 现不实现
*/
IMOS_EXPORT ULONG STDCALL IMOS_ModifyConfTemp
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  IMOS_ID                 idConfTempId,
    IN  MC_CONF_INFO_EX_S       *pstConfTempInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_DeleteConfTemp
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  IMOS_ID                         idConfTempId
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetRecommendCascadeConf
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLogIDInfo,
    IN  MC_CONF_INFO_EX_S           *pstConfInfo,
    IN  ULONG                       ulConfTermCount,
    IN  CONF_SITE_CODE_EX_S         *pstConfTermList,
    INOUT  ULONG                    *pulConfTermCasteCount,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryTermInConfReport
(
    IN  USER_LOGIN_ID_INFO_S          *pstUserLogIDInfo,
    IN  CHAR                          szOrgCode[IMOS_DOMAIN_CODE_LEN],
    IN  BOOL_T                        bContainSubOrg,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_QueryConfInMcuReport
(
    IN    USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN    CHAR                    szMcuCode[IMOS_DEVICE_CODE_LEN],
    IN    LONG                    lStartTime,
    IN    LONG                    lEndTime,
    IN    ULONG                   ulSampleType,
    INOUT ULONG                   *pulConfStatInfoCount,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_ImportAddressBook
(
    IN    USER_LOGIN_ID_INFO_S             *pstUserLogIDInfo,
    IN    CHAR                             szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetDevicePerformanceInfo
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetDevicePortInfo
(
    IN  USER_LOGIN_ID_INFO_S            *pstUserLogIDInfo,
    IN  CHAR                            szDevCode[IMOS_DEVICE_CODE_LEN],
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetEmailSendingConfig
(
    IN  USER_LOGIN_ID_INFO_S         *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetEmailSendingConfig
(
    IN  USER_LOGIN_ID_INFO_S         *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetEmailSendingRules
(
    IN  USER_LOGIN_ID_INFO_S         *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetEmailSendingRules
(
    IN  USER_LOGIN_ID_INFO_S         *pstUserLogIDInfo,
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_TestToSendEmail
(
    IN  USER_LOGIN_ID_INFO_S         *pstUserLogIDInfo,
    IN  EMAIL_SENDING_CONFIG_S       *pstEmailSendingConfig
);
...
* @note
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetFTPInfo
(
    IN USER_LOGIN_ID_INFO_S *pstUserLogIDInfo,
...
* @note
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetUniqueFilePath
(
    IN USER_LOGIN_ID_INFO_S *pstUserLogIDInfo,
    IN ULONG ulFileType,
...
* @note
*/
IMOS_EXPORT ULONG STDCALL IMOS_SendFileToTerm
(
    IN USER_LOGIN_ID_INFO_S *pstUserLogIDInfo,
    IN CHAR szDevCode[IMOS_DEVICE_CODE_LEN],
...
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetFileFromTerm
(
    IN USER_LOGIN_ID_INFO_S *pstUserLogIDInfo,
    IN CHAR szDevCode[IMOS_DEVICE_CODE_LEN],
    IN ULONG ulFileType,
...
* @note
*/
IMOS_EXPORT ULONG STDCALL IMOS_ManualSyncDev
(
    IN USER_LOGIN_ID_INFO_S *pstUserLogIDInfo,
    IN CHAR szDevCode[IMOS_DEVICE_CODE_LEN]
);
...
* @note 无
*/
IMOS_EXPORT ULONG STDCALL IMOS_SiteBrowseSite
(
     IN  USER_LOGIN_ID_INFO_S     *pstUserLogIDInfo,
     IN  IMOS_ID                  idConfId,
