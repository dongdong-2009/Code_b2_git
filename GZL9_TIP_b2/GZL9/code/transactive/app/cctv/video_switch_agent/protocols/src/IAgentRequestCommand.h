 ...
 * in any form.
 *
 * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/src/IAgentRequestCommand.h $
...
namespace TA_IRS_App
{
    ...
    public:
		...
		virtual void setCompletionState(IAgentRequestCommand::ERequestCommandCompletionState state) = 0;
		virtual void setErrorDescription(std::string error) = 0;
