...
#define MW_PTZ_CMD_LEN 16  /**< 云台协议命令字最大长度 */
...
{
    ULONG ulCmdLen;  /**<  命令长度，每个命令一个长度，解决可变命令存在的问题 */
    ULONG ulCmdIntervalDelay;     /**<   由于某些协议需要一个命令间隔一段时间再次发送  单位是毫秒返回0的话不需要间隔*/
    ULONG ulCmdSendTimes;     /**<   由于某些协议需要重复多次发送，该项用来标识发送多少次，默认是1*/
...
typedef struct tagMwPtzOperation
{
    ...
    ULONG ulCmdParam1;           /**< 参数1 具体如何填写参考文档 */
    ULONG ulCmdParam2;           /**< 参数2 具体如何填写参考文档 */
    ULONG ulCmdParam3;           /**< 参数3 具体如何填写参考文档 */
}MW_PTZ_OPER_S;
