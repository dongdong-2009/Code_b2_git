#ifndef MODBUSRECORDINGUNIT_H
#define MODBUSRECORDINGUNIT_H

/**
  * The source code in this file is the property of
  * Ripple Systems and is not for redistribution in any form.
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/MODBUS/src/MODBUSRecordingUnit.h $
  * @author:   Rob Young
  * @version:  $Revision: #2 $
  *
...
{
    class MODBUSRecordingUnit : public IPDRecordingUnit//, public virtual IStateValidationItem
    {
    public:
        ...
        MODBUSRecordingUnit( TA_Base_Core::RecordingUnitPtr recordingUnitData );
    ...
    private:
        ...
        MODBUSRecordingUnit( const MODBUSRecordingUnit& theMODBUSRecordingUnit );
        MODBUSRecordingUnit& operator=( const MODBUSRecordingUnit& );
