...
typedef struct tagMC_ConfReserveInfoEx
{
    ...
    */
    ...
    ULONG                   ulCycleEndType;

    /** 重复会议的开始日期 创建会议时不填写，以会议召开时间为准 */
    LONG                    lCycleBeginTime;
...
typedef struct tagMC_ConfBaseAttrEx
{
    ...
    ULONG       ulChairBrowseMode;

    /** 广播模式 MC_BROADCAST_MODE_EX_E */
    ULONG       ulBroadcastMode;
...
{
    /** 适配协议格式数 */
    LONG                lVideoProtFmtNum;

    /** 适配协议格式 HD_VIDEO_PROT_FMT_EX_E */
    ULONG               aulVideoProtFmt[IMOS_EN_VID_PROT_FMT_COUNT];

    /** 支持帧率个数 */
    LONG                lVideoFramerateNum;

    /** 视频帧率 HD_FRAME_RATE_EX_E */
    ULONG               aulFramerate[IMOS_HD_MAX_VIDEO_FRAMERATE_NUM];

    /** 视频速率的个数 */
    LONG                lVideoRateNum;

    /** 视频比特率 HD_BITRATE_EX_E */
    ULONG               aulVideoRate[IMOS_HD_MAX_VIDEO_RATE_NUM];
...
typedef struct tagMC_RoleVideoCfgEx
{
    ...
    ULONG               aulVideoProt[IMOS_HD_MAX_VIDEO_PROTOCOL_NUM];

    /** 视频格式的个数 */
    LONG                lVideoFmtNum;

    /** 视频格式 HD_VIDEO_FORMAT_EX_E */
    ULONG               aulVideoFmt[IMOS_HD_MAX_VIDEO_FORMAT_NUM];
...
typedef struct tagMC_ConfMediaInfoEx
{
    ...
    ULONG                          ulCurrentAudioProt;

    /** 音频协议适配, 下面lAudioProtCount字段非0时，填BOOL_TRUE，否则BOOL_FALSE */
    BOOL_T                         bAudioAdapt;

    /** 支持音频协议数 */
    LONG                           lAudioProtCount;

    /** 音频标准 HD_AUDIO_PROT_EX_E */
    ULONG                          aulAudioProt[IMOS_HD_MAX_AUDIO_PROTOCOL_NUM];

    /** 主流视频 */
    /** 会议当前主流视频标准 HD_VIDEO_PROT_EX_E */
    ULONG                          ulCurrentMainVideoProt;

    /** 会议当前主流格式 HD_VIDEO_FORMAT_EX_E */
    ULONG                          ulCurrentMainVideoFmt;

    /** 会议当前主流速率 HD_BITRATE_EX_E, 默认填写为会议带宽 */
    ULONG                          ulCurrentMainVideoBitRate;

    /** 会议当前主流帧率 HD_FRAME_RATE_EX_E */
    ULONG                          ulCurMainFrameRate;
...
{
    /** 丢包率上限 */
    LONG lMaxLostPacketRate;

    /** 最大持续丢包时长，单位S */
    LONG lMaxLostPacketTime;
...
typedef struct tagMC_MultiCastInfoEx
{
    ...
    /** 音频组播端口 */
    ULONG       ulMultiPortAudio;

    /** 主流视频组播端口,音频组播端口加2 */
    ULONG       ulMultiPortVideo;

    /** 辅流视频组播端口,主流组播端口加2 */
    ULONG       ulMultiPortRoleVideo;
...
typedef struct tagMC_MCULanTableEx
{
    ...
    /** 每个网口的路由记录数 */
    LONG               alRouteCount[IMOS_MC_MAX_LAN_NET_NUM];
...
typedef struct tagMC_MCUARPTableEx
{
    ...
    /** 每个网口的ARP记录数 */
    LONG               alARPCount[IMOS_MC_MAX_LAN_NET_NUM];
...
typedef struct tagMC_TermVideoCfgEx
{
    ...
    ULONG               aulVideoProt[IMOS_EN_VID_PROT_COUNT];
...
typedef struct tagMC_TermRoleVideoCfgEx
{
    ...
    ULONG               ulPresentationVideoFmt;

    /** 胶片视频最高帧率 HD_FRAME_RATE_EX_E */
    ULONG               ulPresentationFrameRate;
...
typedef  struct  tagHD_SimpleChannelEx
{
    ...
    /** 通道状态信息 */
    /** 通道码率 */
    ULONG                   ulBiteRateCurrent;

    /** 该通道接收总数 */
    LONG                    lTotalPacketNum;

    /** 该通道丢包总数 */
    LONG                    lLostPacketNum;

    /** 实时丢包率, 用数值表示的是放大1000倍, 实际获取的百分比为lMaxLostPackRate */
    LONG                    lLostRateCurrent;
    ...
    /** 当前通道的NAA缓冲包数 */
    LONG                    lNAACachePackNumCurrent;

    /** 峰值通道的NAA缓冲包数 */
    LONG                    lNAACachePackNumPeak;

    /** 请求重发次数 */
    LONG                    lReSendNumRequested;

    /** 实际收到的重发包数 */
    LONG                    lResendNumReceved;
...
typedef struct tagMC_MCUConfNATEx
{
    ...
    /** 呼叫开始端口 */
    ULONG               ulBeginCallPort;

    /** 呼叫结束端口 */
    ULONG               ulEndCallPort;

    /** 媒体开始端口 */
    ULONG               ulBeginRTPPort;
...
typedef struct tagMC_MCUConfigAlarmEx
{
    ...
    /** 电源1掉电声光告警号 */
    ULONG ulPower1AlarmID;

    /** 电源2掉电声光告警号 */
    ULONG ulPower2AlarmID;
...
typedef struct tagMC_LinkInfoEx
{
    ...
    ULONG                              ulBandWidthMain;
    ULONG                              ulBandWidthBak;
...
typedef struct tagTerminalCapacityEx
{
    ...
    ULONG               aulAudioProt[IMOS_EN_AUD_PROT_COUNT];
...
typedef struct tagMC_SynchronizeWithWebEx
{
    ...
    ULONG   ulCurChairBrowseSiteType;
...
typedef struct tagHD_NATConfigEx
{
    ...
    /** 主流视频 */
    ULONG                   ulMainVideoPort;

    /** 辅流视频 */
    ULONG                   ulSecVideoPort;

    /** h225/h245使用  */
    ULONG                   ulOtherTcpPort1;

    /** h225/h245使用 */
    ULONG                   ulOtherTcpPort2;
...
typedef struct tagHD_VideoOutInfoEx
{
    ...
    ULONG                           ulVideoOutPort;

    /** 视频输出内容 HD_VIDEO_OUT_CONTENT_TYPE_EX_E */
    ULONG                           ulVideoOutContent;
...
typedef struct tagHD_VideoInOutEx
{
    ...
    ULONG                  aulVideoIn[IMOS_EN_VIDEO_TYPE_COUNT];
...
typedef  struct    tagHD_AudioInOutEx
{
    ...
    ULONG                          aulAudioInPortType[IMOS_EN_AUDIO_IN_PORT_COUNT];
} HD_AUDIO_INOUT_EX_S;
...
typedef struct tagHD_AudioAllConfigEx
{
    ...
    ULONG                   aulInVol[IMOS_EN_AUDIO_IN_PORT_COUNT];
...
typedef  struct  tagHD_InnerModuleDebugLevelEx
{
    ...
    ULONG               aulDebugLevel[IMOS_EN_HD_MODULE_TYPE_COUNT];
...
typedef struct tagHD_VideoPortDVIFmtEx
{
    ...
    ULONG     ulVideoPortDVIType;

    /** 视频分辨率大小 HD_VIDEO_FORMAT_EX_E */
    ULONG     ulVideoResolution;

    /** 视频刷新频率 HD_VIDEO_FREQUENCE_TYPE_EX_E */
    ULONG     ulVideoFrequence;
...
typedef struct tagHD_VideoInPortEventEx
{
    ...
    ULONG                      aulCheckFlag[IMOS_EN_VIDEO_IN_PORT_COUNT];
...
typedef struct tagHD_STKDropCallCfgEx
{
    ...
    LONG lRoundTripDelayTime;

    /** 发送往返延迟的间隔，单位秒 */
    LONG lRoundTripIntervalTime;

    /** 发送往返延迟的次数 */
    LONG lRoundTripCount;
...
typedef struct tagHD_ApPrearrange_CfgEx
{
    ...
    /** 解码延时包数 */
    ULONG ulDecodeTimeLapRtpNum;

    /** 编码延时包数 */
    ULONG ulEncodeTimeLapRtpNum;
...
typedef struct tagEmailSendingRules
{
    ...
    /** 会前提前通知时间， 单位为分钟 */
    ULONG   aulNotifyTime[IMOS_EMAIL_NOTIFICATION_NUMBER];
