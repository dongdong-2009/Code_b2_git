#if !defined(IMOSVideoInput_B5DC94EC_53A1_432b_99C7_5F3286E2F499__INCLUDED_)
#define IMOSVideoInput_B5DC94EC_53A1_432b_99C7_5F3286E2F499__INCLUDED_

/**
  * The source code in this file is the property of
  * Ripple Systems and is not for redistribution in any form.
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/IMOS/src/IMOSVideoInput.h $
  * @author:   Rob Young
  * @version:  $Revision: #1 $
  *
...
{
    class IMOSVideoInput : public IPDVideoInput
	{
	public:
		/**
		  * IMOSVideoInput
        ...
        IMOSVideoInput( TA_Base_Core::VideoInputPtr videoInputData );
		...
		/**
		  ...
		  *
		  * Identifies if this IMOSVideoInput is allowed to be viewed publicly 
		  * (e.g. on the internet).
		  *
		  * @return		bool
		  *				True if the IMOSVideoInput is allowed to be viewed publicly.
		  *				False if the IMOSVideoInput is not allowed to be viewed publicly
		...
		/**
		  ...
		  *
		  * Sets if this IMOSVideoInput is allowed to be viewed publicly 
		  * (e.g. on the internet).
		  *
		...
		/**
		  * isInService
		  *
		  * Identifies if this IMOSVideoInput is in or out of service.
		  *
		  * @return		bool
		  *				True if the IMOSVideoInput is in service.
		  *				False if the IMOSVideoInput is not in service
		...
		/**
		  * setInService
		  *
		  * Sets this IMOSVideoInput in or out of service.
		  *
		  * @param		bool isInService
		  *				True to set the IMOSVideoInput in service.
		  *				False to set the IMOSVideoInput out of service.
 		  */
    ...
    private:
        ...
        IMOSVideoInput( const IMOSVideoInput& theIMOSVideoInput );
        IMOSVideoInput& operator=( const IMOSVideoInput& );
...
#endif // !defined(IMOSVideoInput_B5DC94EC_53A1_432b_99C7_5F3286E2F499__INCLUDED_)