#if !defined(IMOSVideoOutput_6D856C3B_635C_4e91_8C91_072E38E337FD__INCLUDED_)
#define IMOSVideoOutput_6D856C3B_635C_4e91_8C91_072E38E337FD__INCLUDED_

/**
  * The source code in this file is the property of
  * Ripple Systems and is not for redistribution in any form.
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/IMOS/src/IMOSVideoOutput.h $
  * @author:   Rob Young
  * @version:  $Revision: #3 $
  *
...
{
    class IMOSVideoOutput : public IPDVideoOutput//, public virtual IStateValidationItem
    {
    public:
        /**
          * IMOSVideoOutput
        ...
        IMOSVideoOutput( TA_Base_Core::VideoOutputPtr videoOutputData );
        ...
        /**
		  *
		  */
		void notifyOutputShowingAlarmStack( TA_IMOS::AlarmStack alarmStack);
...
//		bool isBVSStageInAlarmStack(unsigned long bvsEntityKey);
    ...
    private:
        ...
        IMOSVideoOutput( const IMOSVideoOutput& theIMOSVideoOutput );
        IMOSVideoOutput& operator=( const IMOSVideoOutput& );
		TA_IMOS::AlarmStack alarmStateSequenceToAlarmStack(TA_Base_Bus_GZL9::VideoOutputCorbaDef::MonitorAlarmStack alarmStack);
		TA_Base_Bus_GZL9::VideoOutputCorbaDef::MonitorAlarmStack alarmStateSequenceFromAlarmStack(TA_IMOS::AlarmStack alarmStack);
		...
		TA_IMOS::AlarmStack	m_alarmStack;
		bool		m_isInAlarmMode;
		
		//std::map<TA_IMOS::AlarmState, unsigned long>	m_alarmStateToId;
		//std::map<unsigned long, TA_IMOS::AlarmState>	m_idToAlarmState;
...
#endif // !defined(IMOSVideoOutput_6D856C3B_635C_4e91_8C91_072E38E337FD__INCLUDED_)
