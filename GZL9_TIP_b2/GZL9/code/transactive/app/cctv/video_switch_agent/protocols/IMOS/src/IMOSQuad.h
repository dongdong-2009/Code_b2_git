...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/IMOS/src/IMOSQuad.h $
  * @author:   Rob Young
  * @version:  $Revision: #2 $
  *
...
{
    class IMOSQuad : public IPDQuad//, public virtual IStateValidationItem
    {
    public:
        ...
        IMOSQuad( TA_Base_Core::QuadPtr QuadData );
    ...
    private:
        ...
        IMOSQuad( const IMOSQuad& theIMOSQuad );
        IMOSQuad& operator=( const IMOSQuad& );
