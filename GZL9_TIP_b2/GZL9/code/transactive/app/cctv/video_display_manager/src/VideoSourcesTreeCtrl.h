/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_display_manager/src/VideoSourcesTreeCtrl.h $
  * @author:  Robert Young
  * @version: $Revision: #3 $
  *
...
namespace TA_IRS_App
{
    ...
    class VideoSourcesTreeCtrl : public CTreeCtrl
    {
        ...
        public:
            ...
            void setToSequenceEditorTree( BOOL set = TRUE )
            {
                m_isSequenceEditorTree = set;
            };

            void setToQuadControllerTree( BOOL set = TRUE )
            {
                m_isQuadControllerTree = set;
            };
            ...
            void setDetailsPointer( CEdit* pDetailsEdit )
            {
                m_pDetailsEdit = pDetailsEdit;
            }
            ...
            void setVideoDisplayManagerPresenter ( VideoDisplayManagerPresenter* presenter )
            {
