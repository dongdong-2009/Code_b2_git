...
namespace TA_IRS_App
{
    ...
    LoadStationTask::LoadStationTask(IDisplayItemLoader& callback,
                                     TA_Base_Core::SingleThreadBarrier& barrier)
        : m_callback(callback),
          m_barrier(barrier)
    {
    ...
    LoadStationTask::~LoadStationTask()
    {
        FUNCTION_ENTRY("~LoadSequenceTask");
        FUNCTION_EXIT;
    }
    ...
    void LoadStationTask::executeWorkItem()
    {
        FUNCTION_ENTRY("executeWorkItem");
        m_callback.loadStationsFromDatabase();
        m_barrier.post();
        FUNCTION_EXIT;
    }
