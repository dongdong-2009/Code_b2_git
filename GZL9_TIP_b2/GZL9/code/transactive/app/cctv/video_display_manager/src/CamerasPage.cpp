/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_display_manager/src/CamerasPage.cpp $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    void CamerasPage::OnSize(UINT nType, int cx, int cy)
    {
        ...
        if ( m_isOffsetInitialised )
        {
            ...
            m_cameraTreeCtrl.SetWindowPos(NULL, 0, 0, rect.Width(), ( rect.Height() - diff ),
