/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_display_manager/src/BvsStage.cpp $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    BvsStage::BvsStage( unsigned long entityKey,
      ...
      : VideoInput(entityKey, name, description, group, -1),
        m_stageId( stageId ),
    ...
    std::string BvsStage::getStageNumber()
    {
        ...
        unsigned int index;
        unsigned int tmpIndex = stageName.find('_', 0);
