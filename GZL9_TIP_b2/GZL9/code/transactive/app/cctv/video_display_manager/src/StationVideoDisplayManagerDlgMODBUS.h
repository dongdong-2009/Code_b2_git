...
class DlgVideoPlayModbus;

class StationVideoDisplayManagerDlgMODBUS : public TA_Base_Bus::TransActiveDialog,
...
public:
    ...
    StationVideoDisplayManagerDlgMODBUS(TA_Base_Bus::IGUIAccess& controlClass, VideoDisplayManagerPresenter& presenter);

    ~StationVideoDisplayManagerDlgMODBUS();
    ...
    enum { IDD = IDD_STATIONDISPLAY_DIALOG_MODBUS};
...
private:
    ...
    boost::array<CStatic*, 15> m_guiMonitors;
    boost::array<CLabel*, 15> m_guiMonitorsDesc;
