/**
  ...
  *
  */
#if !defined(APP_BAS_BASAgent_FireTriggerBasEquipmentManager_H)
#define APP_BAS_BASAgent_FireTriggerBasEquipmentManager_H
...
#endif //APP_BAS_BASAgent_FireTriggerBasEquipmentManager_H
