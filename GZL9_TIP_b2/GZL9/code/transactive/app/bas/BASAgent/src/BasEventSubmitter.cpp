/**
  ...
  * any form.
  *
  * Source:		$File: //depot/GZL9_TIP/GZL9/transactive/app/bas/BASAgent/src/BasEventSubmitter.cpp $
  * @author:	Huang Jian
  * @version:	$Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    void BasEventSubmitterImpl::submitBasTimetableDownloadEvent( const int& timetableType, const std::string& tableName, const bool bSucceed, const std::string& operatorSession, const unsigned long entityKey, const std::string& assetName )
    {
        ...
        TA_Base_Core::NameValuePair locationNamePair("LocationName", BasCachedConfig::getInstance().getLocDisplayName());
