#if !defined(APP_BAS_BASManager_CommonDef_H)
#define APP_BAS_BASManager_CommonDef_H
#pragma once
...
const std::string gControlIBPToString 		 = _T("IBP");
const std::string gControlFASToString 		 = _T("FAS");
const std::string gControlTimeTabToString 	 = _T("时间表");
const std::string gControlHMIToString 		 = _T("HMI");
const std::string gControlLinkageToString 	 = _T("联动");
const std::string gControlMaintainPCToString = _T("PC维修工作站");
...
#endif //APP_BAS_BASManager_CommonDef_H
