#if !defined (APP_BAS_BasModeManager_DeviceEquipment)
#define APP_BAS_BasModeManager_DeviceEquipment
#pragma once
...
namespace TA_IRS_App
{
	...
	protected:
		DeviceEquipment(DeviceEquipmentManager* equipmentManager, 
        				const std::string& strEquipmentStatus, 
						const std::string& strEquipmentAuto, 
...
#endif //APP_BAS_BasModeManager_DeviceEquipment
