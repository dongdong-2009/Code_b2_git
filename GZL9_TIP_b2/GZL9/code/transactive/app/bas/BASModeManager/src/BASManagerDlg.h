...
//
#if !defined (APP_BAS_BasManager_CBASManagerDlg_H)
#define APP_BAS_BasManager_CBASManagerDlg_H
#pragma once
#include "afxwin.h"
#include "afxcmn.h"
...
namespace TA_IRS_App
{
	...
	protected:
		...
		afx_msg LRESULT OnUpdateModeStatus(WPARAM wParam, LPARAM lParam);
...
#endif //APP_BAS_BasManager_CBASManagerDlg_H
