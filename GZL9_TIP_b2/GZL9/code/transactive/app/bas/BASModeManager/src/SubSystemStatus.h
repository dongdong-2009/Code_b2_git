...
namespace TA_IRS_App
{
	...
	{
	public:
		virtual void updateSubsystemMode(unsigned long locationKey, 
										unsigned long subsystemKey, 
										ModeSet::subsystemModeType modeType) = 0;
	};
	...
	public:
		...
		~SubSystemStatus(void);
	public:
		void updateSubsystemModeExecuteForClean(unsigned long locationKey, 
												unsigned long subsystemKey, 
												ModeSet::subsystemModeType modeType);
		
		void updateSubsystemMode(unsigned long locationKey, 
								unsigned long subsystemKey, 
								unsigned long value, 
								ModeSet::subsystemModeType modeType);

		unsigned long getSubsystemMode(unsigned long locationKey, 
										unsigned long subsystemKey, 
										ModeSet::subsystemModeType modeType);
