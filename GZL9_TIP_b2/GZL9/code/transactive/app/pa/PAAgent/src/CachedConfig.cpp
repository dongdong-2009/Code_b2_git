...
m_pasDvaRecordingMaxDurationInSecond(30)
{
}
...
void CachedConfig::setFasEntityName(const std::string& param)
{
	m_fasEntityName = param;
}
...
std::string CachedConfig::getFasEntityName()
{
	return m_fasEntityName;
}
