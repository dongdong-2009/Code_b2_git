...
/**
  ...
  * in any form.
  *
  * Source : $File: //depot/GZL6_TIP/3002/transactive/app/pa/PAAgent/src/TrainDVABroadcast.cpp $
  * @author  A. Parker
  * @version $Revision: #1 $
...
namespace TA_IRS_App
{
    ...
    void TrainDVABroadcast::validateBroadcastConfig() //throw(TA_Base_Core::BadParameterException)
    {
        ...
        try
        {
            TA_IRS_Bus::TrainDvaMessageRecord record; // No train dva message now = TA_IRS_Bus::CachedMaps::getInstance()->getTrainDvaMessageRecordFromKey(m_theSpecifics.messageKey);
        }
