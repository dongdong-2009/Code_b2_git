...
namespace TA_IRS_App
{
    ...
    // raises (BadParameterException, TA_Base_Core::AccessDeniedException, BroadcastLimitReached)
    {
		...
		std::vector<unsigned long> vecMsgs;
        ThreadGuard guard( m_lock );
        ...
        try
        {
			...
			newBroadcast.updateDVAMsgIdByDVAMsgKeys(vecMsgs);
			newBroadcast.updateDwellTime(dwellInSecs);
    ...
    // exception checked
    char* BroadcastManager::broadcastStationScheduleDva( 
			const ::TA_Base_Bus::IPAAgentCorbaDef::MessageKeySeq& messages, 
        	const ::TA_Base_Bus::IPAAgentCorbaDef::ZoneCoverage& zones, 
			::CORBA::UShort dwellInSecs, 
        	::CORBA::Boolean hasChime, 
			::CORBA::Boolean isSynchronisedWithTis, 
			const char* groupName, 
        	const ::TA_Base_Bus::IPAAgentCorbaDef::StationCyclicParams& stCyclicParams, 
			const char* sessionId )
        // raises (BadParameterException, TA_Base_Core::AccessDeniedException, BroadcastLimitReached)
    {
...
//         PasHelpers::getInstance()->sendPAAgentNewBroadcastUpdate(*newBroadcastConfigP);
	...
	void BroadcastManager::broadcastStationMusic(TA_Base_Bus::IPAAgentCorbaDef::EMusicType musicType, const TA_Base_Bus::IPAAgentCorbaDef::ZoneCoverage& zones, const char* sessionId)
	{
		...
		try
		{
			...
			newBackgroundMusic->updatePriorityId(7);
    ...
    ::CORBA::Boolean BroadcastManager::setAdhocType( 
			::CORBA::ULong messageKey, 
    ...
    ::CORBA::Boolean BroadcastManager::setAdhocLabel( 
				::CORBA::ULong messageKey, 
				const char* label, 
				const char* sessionId )
