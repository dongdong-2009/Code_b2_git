...
*/
int IEC104_API::syncTime(int iRtuAddr)
{
	CCommand cmd;
	cmd.create_Time_Syn();
	IEC104_API::putCommand( cmd);
...
int IEC104_API::select_Double_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui8 bDcs,b_bool tmflag,b_ui8 bQu)
{
	if(bDcs>3)
		return -3;
	if(bQu>31)
		return -5;
	CCommand cmd;
	cmd.create_DoubleCommand(iRtuAddr,iInfoAddr,bDcs,CCommand::SELECT,tmflag,bQu);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::exec_Double_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui8 bDcs,b_bool tmflag,b_ui8 bQu)
{
	if(bDcs>3)
		return -3;
	if(bQu>31)
		return -5;
	CCommand cmd;
	cmd.create_DoubleCommand(iRtuAddr,iInfoAddr,bDcs,CCommand::EXECUTE,tmflag,bQu);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::undo_Double_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui8 bDcs,b_bool tmflag,b_ui8 bQu)
{
	if(bDcs>3)
		return -3;
	if(bQu>31)
		return -5;
	CCommand cmd;
	cmd.create_DoubleCommand(iRtuAddr,iInfoAddr,bDcs,CCommand::CANCEL,tmflag,bQu);
	IEC104_API::putCommand( cmd);
	return 0;
}

//regulating step command
int IEC104_API::select_RegulatingStep_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui8 bRcs,b_bool tmflag,b_ui8 bQu)
{
	if(bRcs>3)
		return -3;
	if(bQu>31)
		return -5;
	CCommand cmd;
	cmd.create_StepCommand(iRtuAddr,iInfoAddr,bRcs,CCommand::SELECT,tmflag,bQu);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::exec_RegulatingStep_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui8 bRcs,b_bool tmflag,b_ui8 bQu)
{
	if(bRcs>3)
		return -3;
	if(bQu>31)
		return -5;
	CCommand cmd;
	cmd.create_StepCommand(iRtuAddr,iInfoAddr,bRcs,CCommand::EXECUTE,tmflag,bQu);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::undo_RegulatingStep_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui8 bRcs,b_bool tmflag,b_ui8 bQu)
{
	if(bRcs>3)
		return -3;
	if(bQu>31)
		return -5;
	CCommand cmd;
	cmd.create_StepCommand(iRtuAddr,iInfoAddr,bRcs,CCommand::CANCEL,tmflag,bQu);
	IEC104_API::putCommand( cmd);
	return 0;
}

//set point command, normalized value
int IEC104_API::select_SetPointNVA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui16 Nva,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointNva(iRtuAddr, iInfoAddr,Nva, CCommand::SELECT, tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::exec_SetPointNVA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui16 Nva,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointNva(iRtuAddr, iInfoAddr,Nva, CCommand::EXECUTE, tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::undo_SetPointNVA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui16 Nva,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointNva(iRtuAddr, iInfoAddr,Nva, CCommand::CANCEL, tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}

//set point command, scaled value
int IEC104_API::select_SetPointSVA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_i16 Sva,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	//cmd.create_SV(iRtuAddr, iInfoAddr,(b_ui8*)&Value,1,CCommand::SELECT,tmflag);
	cmd.create_SetPointSVA(iRtuAddr,iInfoAddr,Sva,CCommand::SELECT, tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::exec_SetPointSVA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_i16 Sva,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointSVA(iRtuAddr,iInfoAddr,Sva,CCommand::EXECUTE, tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::undo_SetPointSVA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_i16 Sva,b_bool tmflag,b_ui8 bQl)
{	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointSVA(iRtuAddr,iInfoAddr,Sva,CCommand::CANCEL, tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}

//set point command, short floating point number
int IEC104_API::select_SetPointSFA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,float Sfa,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointSFA(iRtuAddr, iInfoAddr, Sfa,CCommand::SELECT,  tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::exec_SetPointSFA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,float Sfa,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointSFA(iRtuAddr, iInfoAddr, Sfa,CCommand::EXECUTE,  tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::undo_SetPointSFA_DO(b_ui16 iRtuAddr,b_ui32 iInfoAddr,float Sfa,b_bool tmflag,b_ui8 bQl)
{
	if( bQl>127)
		return -5;
	CCommand cmd;
	cmd.create_SetPointSFA(iRtuAddr, iInfoAddr, Sfa,CCommand::CANCEL,  tmflag, bQl);
	IEC104_API::putCommand( cmd);
	return 0;
}
//============================================================
...
int IEC104_API::read_command(b_ui16 iRtuAddr,b_ui32 iInfoAddr)
{
	CCommand cmd;
...
int IEC104_API::reset_process(b_ui16 iRtuAddr,b_ui8 bQrp)
{
	if(bQrp==0)
		return -2;
	CCommand cmd;
...
int IEC104_API::test_with_time(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui16 bTcs)
{
	CCommand cmd;
	cmd.create_test_with_time(iRtuAddr,iInfoAddr,bTcs);
	IEC104_API::putCommand( cmd);
	return 0;
}
int IEC104_API::parameter_measured_value_NVA(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_ui16 nva,b_ui8 bQpm)
{
	CCommand cmd;
...
int IEC104_API::parameter_measured_value_SVA(b_ui16 iRtuAddr,b_ui32 iInfoAddr,b_i16 sva,b_ui8 bQpm)
{
	CCommand cmd;
...
int IEC104_API::parameter_measured_value_SFA(b_ui16 iRtuAddr,b_ui32 iInfoAddr,float sfa,b_ui8 bQpm)
{
	CCommand cmd;
...
int IEC104_API::parameter_activation(b_ui16  rtuAddr,b_ui8 bCot,b_ui8 bQpa)
{
	if(!((bCot==6)||(bCot==8) ))
		return -2;
	CCommand cmd;
	cmd.create_parameter_activation(rtuAddr,bCot,bQpa);
	IEC104_API::putCommand(cmd);
	return 1;
}
//--------------------------end---------------------------
