...
IMPLEMENT_DYNAMIC(CPlanStepEditorPropertySheet, CMultiFontPropertySheet)

CPlanStepEditorPropertySheet::CPlanStepEditorPropertySheet() :
	CMultiFontPropertySheet("Plan Manager PS", NULL, 0, true)
{
...
BEGIN_MESSAGE_MAP(CPlanStepEditorPropertySheet, CMultiFontPropertySheet)
...
BOOL CPlanStepEditorPropertySheet::OnInitDialog()
{
    ...
    BOOL bRet = CMultiFontPropertySheet::OnInitDialog();
...
BOOL CPlanStepEditorPropertySheet::PreTranslateMessage(MSG* pMsg)
{
    ...
    FUNCTION_EXIT;
    return CMultiFontPropertySheet::PreTranslateMessage(pMsg);
}
...
void CPlanStepEditorPropertySheet::Activate(CWnd* pParentWnd)
{
	...
	Create(pParentWnd, WS_CHILD | WS_VISIBLE, 0);
