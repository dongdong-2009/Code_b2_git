/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL9_TIP/TA_BASE/transactive/app/response_plans/plan_manager/src/BackgroundLaunchGuiAppStep.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2016/11/04 17:32:02 $
                                               ...
                                               PlanStepParameterList &stepParameters)
{
    ...
    TA_Base_Core::IProfile *profile = ProfileConfigAccess::instance()->getProfileByKey(parameterSet.bgLaunchGuiApp().profile);
    if (NULL == profile)
    {
        bValidProfile = false;
        LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugFatal, "Invalid profile key = %lu", parameterSet.bgLaunchGuiApp().profile);
    }
