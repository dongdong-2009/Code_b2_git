/**
  ...
  * any form.
  *
  * Source:		$File: //depot/3002_TIP/3002/transactive/app/scada/EMSAgent/src/EMSAgent.h $
  * @author:	HoaVu
  * @version:	$Revision: #5 $
  *
...
namespace TA_IRS_App
{
	...
	class EMSAgent : public virtual TA_Base_Bus::IGenericAgentUser,
	...
	public:
		...
		*/
		...
		//
		// opearations specific to EMSAgent
		//

		/**
		  * startEMSAgent
		  *
		  * Start this EMSAgent process
		  *
		  */
		void startEMSAgent();
	...
	private:
		...
		/**
		  ...
		  *
		  * Load the EMSAgent entity's parameter from the database
		  *
		  */
		...
		/**
		  * startProcessors
		  *
		  * Start up all processors associated with the EMSAgent entity
		  *
		  */
		...
		/**
		  * stopProcessors
		  *
		  * Stop all processors associated with the EMSAgent entity
		  *
		  */
		void stopProcessors();
		...
		void updateEMSAgentConfiguration ( const TA_Base_Core::ConfigUpdateDetails & updateEvent);
		 ...
		 *
		 */
        void createEMSWorkers();
            // attributes
		std::vector<unsigned long> parseAddresses( std::string );

	private:

		unsigned long m_EMSAgentPrimaryKey;
		...
		//various for EMSAgent other businesses
