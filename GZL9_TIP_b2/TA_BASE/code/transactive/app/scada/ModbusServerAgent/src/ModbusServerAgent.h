/**
  ...
  * any form.
  *
  * Source:		$File: //depot/GZL6_TIP/TA_BASE/transactive/app/scada/ModbusServerAgent/src/ModbusServerAgent.h $
...
{
	class ModbusServerAgent : public TA_Base_Bus::IGenericAgentUser
	{

	public:

		ModbusServerAgent ( int argc, char* argv[] );
		virtual ~ModbusServerAgent();
