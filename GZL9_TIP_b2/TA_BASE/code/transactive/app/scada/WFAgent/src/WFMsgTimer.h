/**
  ...
  *
  * Source:   $File: //depot/3002_Review_Branch/3002/transactive/app/scada/WFAgent/src/WFMsgTimer.h $
  * @author:  Liu Yong
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
	...
	class WfMsgTimer : public TA_Base_Core::Thread
    {
    ...
    private:
        ...
        std::map<unsigned long, WfTimerInfo*> m_timedMessages;   // Rule Id and expiry time

        static unsigned int WF_PROTOCOL_MESSAGE_TIMEOUT;
		static unsigned int WF_PROTOCOL_OPERATE_TIMEOUT;
