 ...
 * in any form.
 *
 * Source:   $File: //depot/GZL6_TIP/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/EventLoader.h $
 * @author:  Nick Jardine
 *
...
private:
	...
	//bool m_actionLoad;
	unsigned long m_taskID;  // we should use this taskID instead of boolean(m_actionLoad)
