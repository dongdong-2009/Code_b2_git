...
namespace DAO.Trending.Helper
{
    ...
    public class DAOHelper
    {
        ...
        public const string AUDIT_PROC_PARAMETER_NAME3 = "@p_audit_data_dml";
#else
        public const string ORACLE_AUDIT_PROCEDURE_NAME = "audit_data_queue_pkg.enqueue_audit_data";
       ...
       /* public static void ExecuteNonQuery(string sql)
        ...
        public static List<SqlParameter> CreateEnqueneParameters(List<string> parameterValues)
        {
            ...
            SqlParameter parameter1 = new SqlParameter(DAOHelper.AUDIT_PROC_PARAMETER_NAME1, System.Data.ParameterDirection.Input, DAO.Trending.Common.DBConnectionStrings.GetInstance().GetDatabaseName(DAO.Trending.Common.DBConnectionStrings.GetInstance().GetConnectionString()));
