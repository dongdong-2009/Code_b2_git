...
namespace TA_Base_App
{
    ...
    const CString ProfileDetailView::CHANGE_ACCESS_CONTROL_GROUP_DIALOG_TITLE = "Change Access Control Group";
    const CString ProfileDetailView::CHANGE_RADIO_LOGIN_GROUP_DIALOG_TITLE = "Change Radio Login Group";
    const CString ProfileDetailView::CHANGE_PA_PRIORITY_GROUP_DIALOG_TITLE = "选择广播权限组";
...
END_MESSAGE_MAP()
    ...
    void ProfileDetailView::showItemDetails(bool isShown)
    {
        ...
        GetDlgItem(IDC_STATIC_PA_PRIORITY_GROUP)->ShowWindow(isShown);
        ...
        GetDlgItem(IDC_CHANGE_PA_PRIORITY_GROUP)->ShowWindow(isShown);
    }
