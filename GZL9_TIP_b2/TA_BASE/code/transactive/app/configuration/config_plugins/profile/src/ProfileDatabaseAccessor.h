/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/TA_BASE/transactive/app/configuration/config_plugins/profile/src/ProfileDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
         ...
         * @return map<unsigned long, string> - This returns all the radio login group keys and names.
         */
         std::map<unsigned long, std::string> getAllPaPriorityGroups();
