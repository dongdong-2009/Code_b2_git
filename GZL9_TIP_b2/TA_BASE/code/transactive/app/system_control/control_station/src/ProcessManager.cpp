                                       ...
                                       const bool isVisible /*= true*/)
{
    ...
    LOG( SourceInfo, DebugUtil::GenericLog, DebugUtil::DebugInfo,
        "Launching the application %lu with the command line: %s, posFlag=%d, alignFlag=%d, objectDim=%s, boundaryDim=%s, isVisible=%d",
        appType, additionalCommands.c_str(), posFlag, alignFlag, Utilities::toString(objectDim).c_str(), Utilities::toString(boundaryDim).c_str(), isVisible);
