...
namespace TA_Base_App
{
		  ...
		  m_errorOccurred(false)
    {
        ...
        m_refreshIntervals.push_back(6);
        m_refreshIntervals.push_back(7);
        m_refreshIntervals.push_back(8);
        m_refreshIntervals.push_back(9);
        ...
        m_refreshIntervals.push_back(35);
        m_refreshIntervals.push_back(40);
        m_refreshIntervals.push_back(45);
        m_refreshIntervals.push_back(50);
        m_refreshIntervals.push_back(55);
