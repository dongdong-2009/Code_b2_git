...
namespace TA_Base_Bus
{
	...
	void CreateEntityWorkItem::executeWorkItem()
	{
        ...
        {
            LOG_EXCEPTION_CATCH( SourceInfo, "Unknown Exception", "Caught unknown exception in CreateEntityWorkItem::executeWorkItem");
        }
	...
	void InitDataPointWorkItem::executeWorkItem()
	{
        ...
        {
            LOG_EXCEPTION_CATCH( SourceInfo, "Unknown Exception", "Caught unknown exception in InitDataPointWorkItem::executeWorkItem");
        }
		unsigned long nLapsed1 = timeStart1.elapsed();
		m_sync->itemEnd();
		unsigned long nLapsed2 = timeStart2.elapsed();
	...
	void ChangeDataNodeOpertionModeWorkItem::executeWorkItem()
	{
        ...
        {
            LOG_EXCEPTION_CATCH( SourceInfo, "Unknown Exception", "Caught unknown exception in ChangeDataNodeOpertionModeWorkItem::executeWorkItem");
        }
		unsigned long nLapsed1 = timeStart1.elapsed();
		m_sync->itemEnd();
		unsigned long nLapsed2 = timeStart2.elapsed();
	...
	void ChangeDataPointOpertionModeWorkItem::executeWorkItem()
	{
        ...
        {
            LOG_EXCEPTION_CATCH( SourceInfo, "Unknown Exception", "Caught unknown exception in ChangeDataPointOpertionModeWorkItem::executeWorkItem");
        }
		unsigned long nLapsed1 = timeStart1.elapsed();
		m_sync->itemEnd();
		unsigned long nLapsed2 = timeStart2.elapsed();
	...
	*/
	...
	void DataNodeActivateWorkItem::executeWorkItem()
	{
		...
		for (it = m_datanodes.begin(); it != m_datanodes.end(); ++it)
		{
            ...
            {
                LOG_EXCEPTION_CATCH( SourceInfo, "Unknown Exception", "Caught unknown exception in DataNodeActivateWorkItem::executeWorkItem");
            }
		}
		unsigned long nLapsed1 = timeStart1.elapsed();
		m_sync->itemEnd();
