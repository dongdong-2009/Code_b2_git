...
int CIec104::AppRxAsdu_45(const b_ui8 *asdu, b_ui8 size)
{
	...
	if (2 == p104->AppPara.CotLen)
	{
		//Get originatoraddress 
		b_ui8 bOriAddr = asdu[3];
		GetHandler()->handleSingleCommand(iRtuAddr,infoAddr, bCot, asdu[infoAddrLen+infoIndex],bOriAddr);
	}
	else
	{
...
int CIec104::AppRxAsdu_58(const b_ui8 *asdu, b_ui8 size)
{
	...
	if (2 == p104->AppPara.CotLen)
	{
		//Get originatoraddress 
		b_ui8 bOriAddr = asdu[3];
		GetHandler()->handleSingleCommandWithTimeTag(iRtuAddr,infoAddr, bCot, asdu[infoAddrLen+infoIndex],bOriAddr,timeTag);
	}
	else
	{
