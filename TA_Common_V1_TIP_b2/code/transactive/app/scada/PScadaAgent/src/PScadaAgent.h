/**
  ...
  * any form.
  *
  * Source:		$File: //depot/3002_TIP/3002/transactive/app/scada/PScadaAgent/src/PScadaAgent.h $
  * @author:	HoaVu
  * @version:	$Revision: #1 $
  *
...
#ifndef PSCADAAGENT_H
#define PSCADAAGENT_H
...
namespace TA_IRS_App
{
	...
	class PScadaAgent : public virtual TA_Base_Bus::ScadaAgentUser
	{
	...
	public:
		...
		/**
		  * startPScadaAgent
		  *
		  * Start this PScadaAgent process
		  *
		  */
		void startPScadaAgent(int argc, char* argv[]);
	...
	private:
		...
		/**
		  ...
		  *
		  * Load the PScadaAgent entity's parameter from the database
		  *
		  */
		...
		/**
		  * startProcessors
		  *
		  * Start up all processors associated with the PScadaAgent entity
		  *
		  */
		...
		/**
		  * stopProcessors
		  *
		  * Stop all processors associated with the PScadaAgents entity
		  *
		  */
		void stopProcessors();
		...
		void updatePScadaAgentConfiguration ( const TA_Base_Core::ConfigUpdateDetails & updateEvent);
		 ...
		 * createPScadaWorkers
		 *
		 * create PScada internal worker utilities
		 *
		 */
	...
	private:
		...
		// attributes
		unsigned long m_pscadaAgentPrimaryKey;
