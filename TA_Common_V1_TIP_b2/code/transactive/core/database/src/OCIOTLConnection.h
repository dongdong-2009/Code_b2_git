...
* in any form.
*
* Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/database/src/OCIOTLConnection.h $
* @author:  Ripple
* @version: $Revision: #5 $
*
...
#ifndef OCI_OTL_CONNECTION_H
#define OCI_OTL_CONNECTION_H
...
namespace TA_Base_Core
{
	...
	class OCIOTLConnection : public IDbConnection
	{
	public:
		...
		*/
		OCIOTLConnection( const std::string& connectionStr, 
