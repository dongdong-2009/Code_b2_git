/**
  ...
  * @author Nick Jardine
  * @version $Revision: #12 $
  * Last modification: $DateTime: 2017/11/28 17:43:21 $
...
namespace TA_Base_Core
{
    ...
    void EntityAccessFactory::setUpMap()
    {
        ...
        // TisTrainAlarmAgent        
        m_entityTypes.insert(EntityTypeMap::value_type( TisTrainAlarmAgentEntityData::getStaticType(), TisTrainAlarmAgentEntityData::clone ) );
