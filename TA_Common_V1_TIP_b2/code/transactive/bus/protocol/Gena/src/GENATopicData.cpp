...
namespace TA_Base_Bus
{
	...
	std::string toUpperString(const std::string& inputStr)
	{
		std::string strTmp;
		strTmp = inputStr;
	...
	GENATopicData::GENATopicData(const std::string& objID, const std::string& topicName)
	{
		...
		m_msgDetail->topicName = topicName;
	...
	GENATopicData::GENATopicData(const GENATopicData& rhs)
	{
		...
		m_msgDetail->topicName =  rhs.m_msgDetail->topicName;
...
// 			}
	...
	boost::shared_ptr<Attribute> GENATopicData::_find_create(T_AttribValueMap& attributeMap, const std::string& attributeName)
	{
		...
		T_AttribValueMap::iterator itFind = attributeMap.find(attributeName);
		...
		else
		{
			...
			// Add it to the map
			attributeMap.insert(T_AttribValueMap::value_type(attributeName, pRetVal));
		}
