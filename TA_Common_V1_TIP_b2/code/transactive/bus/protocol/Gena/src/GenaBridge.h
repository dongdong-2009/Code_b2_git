...
namespace TA_Base_Bus
{
	...
	private: // Variables
		...
		//The current GENABridge does not support filtering; 
		//It is no possible for forwarding data based on filtering result of received data.
		//Has to get url from subscriber and forwarding the url to genaclient;
		std::string m_topicURL;
	};
