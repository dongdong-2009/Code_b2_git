/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/generic_agent/src/GenericAgent.cpp $
  * @author:  Ripple
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2018/02/09 10:56:59 $
...
namespace TA_Base_Bus
{
	...
	// dummySignalHandler
	//
	void GenericAgent::dummySignalHandler(int sigNum)
	{
		// just log something;
		LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "Received signal and sigNum: %d, Need do nothing, ignore it...", sigNum);
	}
};
