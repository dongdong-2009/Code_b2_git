/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/mfc_extensions/src/coloured_controls/ColorButton.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
class AFX_CLASS_IMPORT CColorButton : public CButton
#else
