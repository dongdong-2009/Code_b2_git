/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/mfc_extensions/src/bitmap_and_text_push_button/FooButton.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
class __declspec(dllimport) FooButton : public CButton
#else
class AFX_EXT_CLASS FooButton : public CButton
#endif
{
/////////////////////////////////////////////////////////////////////////////
// Construction
...
public:
  ...
  //! Sets the button as read-only
  //! @param    readOnly Flag: button is readOnly.
