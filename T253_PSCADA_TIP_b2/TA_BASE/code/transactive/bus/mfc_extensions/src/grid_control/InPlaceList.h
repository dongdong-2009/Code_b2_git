/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/mfc_extensions/src/grid_control/InPlaceList.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
class __declspec(dllimport) CInPlaceList : public CComboBox
#else
