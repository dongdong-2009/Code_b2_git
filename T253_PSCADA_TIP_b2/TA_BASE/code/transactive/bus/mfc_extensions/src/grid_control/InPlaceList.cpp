/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/mfc_extensions/src/grid_control/InPlaceList.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
						   ...
						   UINT nFirstChar)
{
	...
	for (int i = 0; i < Items.GetSize(); i++) 
		nMaxLength = max(nMaxLength, (int)dc.GetTextExtent(Items[i]).cx);
