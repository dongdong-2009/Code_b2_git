 ...
 * in any form
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/mfc_extensions/src/tab_dialog_control/tabdialogctrl.h $
 * @author:  Andy Parker
 * @version: $Revision: #1 $
 *
 * Last mofification: $DateTime: 2017/10/31 16:21:54 $
