 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedInspector.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
#ifndef ACTION_RELATED_INSPECTOR_H_FRI_20_02_04
#define ACTION_RELATED_INSPECTOR_H_FRI_20_02_04
...
{
    class ActionRelatedInspector : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionRelatedInspector(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionRelatedInspector();
    ...
    private:
        ...
        ActionRelatedInspector& operator=(const ActionRelatedInspector&);

        unsigned long getInspectorPanelKey();

        bool m_isAvailableInContextMenu;

        static const std::string INSPECTOR_PANEL_ENTITY_TYPE_NAME;

        unsigned long m_inspectorPanelKey;
    };

}
#endif // ACTION_RELATED_INSPECTOR_H_FRI_20_02_04
