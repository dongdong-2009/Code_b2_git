 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/columns/ColumnSubsystem.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
#if !defined(AFX_ColumnSubsystem_H__26C75118_4AC8_4594_BBE3_266FC53666A0__INCLUDED_)
#define AFX_ColumnSubsystem_H__26C75118_4AC8_4594_BBE3_266FC53666A0__INCLUDED_
...
namespace TA_Base_Bus
{
    ...
    class ColumnSubsystem: public AbstractAlarmColumn
	{
	public:
         ...
         */
        ColumnSubsystem(int width,
                         bool isEnabled,
                         SORT_COLUMN sortCol,
                         IAlarmAction* doubleClickAction);


        virtual ~ColumnSubsystem()
        {
        };
    ...
    private:
         ...
         */
        ColumnSubsystem& operator=(const ColumnSubsystem& rhs);

        /**
         * Copy constructor - Hidden as not used
         */
        ColumnSubsystem(const ColumnSubsystem&);
...
#endif // !defined(AFX_ColumnSubsystem_H__26C75118_4AC8_4594_BBE3_266FC53666A0__INCLUDED_)
