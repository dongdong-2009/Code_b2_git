 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedDSS.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
#ifndef ACTION_RELATED_DSS_H_FRI_20_02_04
#define ACTION_RELATED_DSS_H_FRI_20_02_04
...
{
    class ActionRelatedDSS : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionRelatedDSS(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionRelatedDSS();
    ...
    private:
        ...
        ActionRelatedDSS& operator=(const ActionRelatedDSS&);
...
#endif // ACTION_RELATED_DSS_H_FRI_20_02_04
