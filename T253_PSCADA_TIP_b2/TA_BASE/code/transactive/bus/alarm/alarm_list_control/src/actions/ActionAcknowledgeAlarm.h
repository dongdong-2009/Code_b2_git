 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionAcknowledgeAlarm.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
#ifndef ACTION_ACKNOWLEDGE_ALARM_H_THU_19_02_04
#define ACTION_ACKNOWLEDGE_ALARM_H_THU_19_02_04
...
{
    class ActionAcknowledgeAlarm : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionAcknowledgeAlarm(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionAcknowledgeAlarm();
    ...
    private:
        ...
        ActionAcknowledgeAlarm& operator=(const ActionAcknowledgeAlarm&);
