 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionJobRequest.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
#ifndef ACTION_JOB_REQUEST_H_FRI_20_02_04
#define ACTION_JOB_REQUEST_H_FRI_20_02_04
...
{
    class ActionJobRequest : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionJobRequest(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionJobRequest();
    ...
    private:
        ...
        ActionJobRequest& operator=(const ActionJobRequest&);
...
#endif // ACTION_JOB_REQUEST_H_FRI_20_02_04
