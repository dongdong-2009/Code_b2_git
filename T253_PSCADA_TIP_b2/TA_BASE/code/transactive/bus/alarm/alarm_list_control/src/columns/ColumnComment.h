 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/columns/ColumnComment.h $
 * @author:  Karen Graham
 * @version: $Revision: #1 $
 *
...
#if !defined(AFX_ColumnComment_H__26C75118_4AC8_4594_BBE3_266FC53666A0__INCLUDED_)
#define AFX_ColumnComment_H__26C75118_4AC8_4594_BBE3_266FC53666A0__INCLUDED_
...
namespace TA_Base_Bus
{
    ...
    class ColumnComment : public AbstractAlarmColumn
	{
	public:
         ...
         */
        ColumnComment(int width,
                         bool isEnabled,
                         SORT_COLUMN sortCol,
                         IAlarmAction* doubleClickAction);


        virtual ~ColumnComment()
        {
        };
    ...
    private:
         ...
         */
        ColumnComment& operator=(const ColumnComment& rhs);

        /**
         * Copy constructor - Hidden as not used
         */
        ColumnComment(const ColumnComment&);
	};
} //End of TA_Base_Bus


#endif // !defined(AFX_ColumnComment_H__26C75118_4AC8_4594_BBE3_266FC53666A0__INCLUDED_)
