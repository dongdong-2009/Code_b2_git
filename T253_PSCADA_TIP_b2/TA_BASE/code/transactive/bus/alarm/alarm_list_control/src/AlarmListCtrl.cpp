...
* in any form.
*
* Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/AlarmListCtrl.cpp $
* @author:  Karen Graham
* @version: $Revision: #2 $
*
...
// 		m_selectedAlarms.clear();
    ...
    void AlarmListCtrl::PreSubclassWindow()
    {
		...
		//We need to change the Font Size of List Control
		// from http://support.microsoft.com/kb/85518
		LOGFONT lf;                        // Used to create the CFont.

		memset(&lf, 0, sizeof(LOGFONT));   // Clear out structure.
		lf.lfHeight = 18;                  // Request a 16-pixel-high font
		lf.lfWeight = FW_BOLD;			   // Make the font bold
