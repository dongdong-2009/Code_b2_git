 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/columns/ColumnAlarmType.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
namespace TA_Base_Bus
{
    ...
    class ColumnAlarmType : public AbstractAlarmColumn
	{
	public:
         ...
         */
        ColumnAlarmType(int width,
                         bool isEnabled,
                         SORT_COLUMN sortCol,
                         IAlarmAction* doubleClickAction);


        virtual ~ColumnAlarmType()
        {
        };
    ...
    private:
         ...
         */
        ColumnAlarmType& operator=(const ColumnAlarmType& rhs);

        /**
         * Copy constructor - Hidden as not used
         */
        ColumnAlarmType(const ColumnAlarmType&);
 
	};
} //End of TA_Base_Bus


#endif // !defined(AFX_ColumnAlarmType_H__26C75118_4AC8_4594_BBE3_266FC53666A0__INCLUDED_)
