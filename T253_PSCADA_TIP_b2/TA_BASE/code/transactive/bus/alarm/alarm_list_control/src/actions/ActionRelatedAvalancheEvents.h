 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedAvalancheEvents.h $
 * @author:  Ben Robbins
 * @version: $Revision: #2 $
 *
...
#ifndef ACTION_RELATED_AVALANCHE_EVENTS_H
#define ACTION_RELATED_AVALANCHE_EVENTS_H
...
{
    class ActionRelatedAvalancheEvents : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionRelatedAvalancheEvents(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionRelatedAvalancheEvents() {};
        ...
        {
            return "Related A&valanche Events...";
        };
        ...
        {
            return RELATED_AVALANCHE_EVENTS;
        };
		 ...
		 * Returns true iff one alarm is selected, it is the head of an avalanche, and
		 * the user has rights to launch the event viewer.
         */
    ...
    private:
        ...
        ActionRelatedAvalancheEvents(ActionRelatedAvalancheEvents&);
        ActionRelatedAvalancheEvents& operator=(const ActionRelatedAvalancheEvents&);

        unsigned long getEventViewerKey();

        bool m_isAvailableInContextMenu;

        unsigned long m_eventViewerKey;
    };

}
#endif // ACTION_RELATED_AVALANCHE_EVENTS_H
