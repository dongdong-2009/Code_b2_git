 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedEvents.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
#ifndef ACTION_RELATED_EVENTS_H_FRI_20_02_04
#define ACTION_RELATED_EVENTS_H_FRI_20_02_04
...
{
    class ActionRelatedEvents : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionRelatedEvents(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionRelatedEvents();
    ...
    private:
        ...
        ActionRelatedEvents& operator=(const ActionRelatedEvents&);

        bool m_isAvailableInContextMenu;
    };

}
#endif // ACTION_RELATED_EVENTS_H_FRI_20_02_04
