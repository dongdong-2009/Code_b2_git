 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedPlanInstance.h $
...
#ifndef ACTION_RELATED_PLAN_INSTANCE_H_FRI_20_01_06
#define ACTION_RELATED_PLAN_INSTANCE_H_FRI_20_01_06
...
{
    class ActionRelatedPlanInstance : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionRelatedPlanInstance(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionRelatedPlanInstance();
    ...
    private:
        ...
        ActionRelatedPlanInstance& operator=(const ActionRelatedPlanInstance&);

        unsigned long getPlanManagerKey();
...
#endif // ACTION_RELATED_PLAN_INSTANCE_H_FRI_20_01_06
