 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionAcknowledgeAllAlarms.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
namespace TA_Base_Bus
{
    ...
    public:
         ...
         */
        ActionAcknowledgeAllAlarms(HWND parentWindowHandle, bool isAvailableInContextMenu = true);
