 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionPostponeDSS.h $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
#ifndef ACTION_POSTPONE_DSS_H_FRI_20_02_04
#define ACTION_POSTPONE_DSS_H_FRI_20_02_04
...
{
    class ActionPostponeDSS : public virtual IAlarmAction
    {
    public:
         ...
         */
        ActionPostponeDSS(bool isAvailableInContextMenu = true);


        /**
         * Destructor
         */
        virtual ~ActionPostponeDSS();
    ...
    private:
        ...
        ActionPostponeDSS& operator=(const ActionPostponeDSS&);
...
#endif // ACTION_POSTPONE_DSS_H_FRI_20_02_04
