...
namespace TA_Base_Bus
{
	...
	{
	public:
		AuthenPeerTask(AuthenticationAgentNamedObjPtr pAuthAgent, AuthenticationLibrary * m_pAuthLib, unsigned long locationId );
	...
	private:
		AuthenticationAgentNamedObjPtr m_pAuthAgent;
