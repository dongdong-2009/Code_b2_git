/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/security/authentication_library/src/AuthenticationLibrary.h $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_Bus
{
    ...
    typedef TA_Base_Core::NamedObject<TA_Base_Bus::IAuthenticationAgentCorbaDef> AuthenticationAgentNamedObj;
    typedef boost::shared_ptr<AuthenticationAgentNamedObj> AuthenticationAgentNamedObjPtr;
    ...
    public:
        ...
        void getActiveSessionsForOneLocation(const std::string & noUseSessionId, AuthenticationAgentNamedObjPtr authAgent,  std::vector<SessionInfo> & vtSessionInfo);
