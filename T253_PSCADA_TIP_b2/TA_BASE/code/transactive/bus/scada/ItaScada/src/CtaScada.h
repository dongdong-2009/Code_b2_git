/**
  ...
  * in any form.
  *
  * Source : $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/scada/ItaScada/src/CtaScada.h $
  * @author  Sean Liew
  * @version $Revision: #1 $
...
namespace TA_Base_Bus
{
	...
	*/
    ...
    public:
		...
		*
		*/        
        virtual void addAllDatapoints(std::map < unsigned long, TA_Base_Bus::DataPoint *>& dataPointList);
