...
namespace TA_Base_Bus
{
    ...
    public:
        ...
        **/
        ...
        virtual void resetRTUManagerStatus() {};
        ...
        bool setOverlapModbusRequest(bool overlapModbusRequest) { m_overlapModbusRequest = overlapModbusRequest; return true; };
        bool setStandardModbusLengthLimit(bool standardModbusLengthLimit) { m_standardModbusLengthLimit = standardModbusLengthLimit; return true; };
        int  setMaxModbusLength(unsigned int maxModbusLength) { m_maxModbusLength = m_maxModbusLength; return 0; };
        int  setIntervalBetweenModbusTransaction(unsigned int interval) { m_interval = interval; return 0; };
