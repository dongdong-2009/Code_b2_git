/**
  ...
  * any form.
  *
  * Source:		$File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/scada/rtu_library/src/RTU.cpp $
  * @author:	Liu Yong
  * @version:	$Revision: #1 $
  *
...
namespace TA_Base_Bus
{
	...
	void RTU::setToControlMode()
	{
        ...
        m_rtuInternalDpProcessor->setToControl();
	...
	void RTU::setToMonitorMode()
	{
        // set the flag
		m_isInControlMode = false;
        m_rtuInternalDpProcessor->setToMonitor();

		stopProcessing();
        m_rtuStatus->resetStatusWorker();
	}
