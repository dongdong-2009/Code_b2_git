/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/scada/common_library/src/CommonDefs.h $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2018/03/22 11:17:09 $
...
namespace TA_Base_Bus
{
	...
	enum EControlOperation
	{
		...
		CONTROL_BLINK 			// Control Blink Operation
	};
    ...
    const char * const DPT_CONTROL_WRITTEN				= 	"Sent";
    const char * const DPT_CONTROL_PENDING				= 	"Pending";
    const char * const DPT_CONTROL_CONDITIONALSUCCESS	= 	"";
    const char * const DPT_CONTROL_SUCCESS				= 	"";
    const char * const DPT_CONTROL_FAILED				= 	"Fail";
    const char * const DPT_CONTROL_LCC_FAILED			= 	"LCC fail";
    const char * const DPT_CONTROL_RCC_FAILED			= 	"RCC fail";
    const char * const DPT_CONTROL_COMMS_FAILED			= 	"Comms fail";

	//Using for IEC104 Protocol control
	const char * const DPT_CONTROL_SELECT_SENT			= 	"Pending";
	const char * const DPT_CONTROL_SELECT_CONFIRM		= 	"Pending";
	const char * const DPT_CONTROL_SELECT_TIMEOUT		= 	"";
	const char * const DPT_CONTROL_OPERATOR_TIMEOUT		= 	"";
	const char * const DPT_CONTROL_EXECUTE_SENT			= 	"Pending";
	const char * const DPT_CONTROL_EXECUTE_CONFIRM		= 	"Pending";
	...
	const char * const DPT_CONTROL_CANCEL_SENT			= 	"Pending";
