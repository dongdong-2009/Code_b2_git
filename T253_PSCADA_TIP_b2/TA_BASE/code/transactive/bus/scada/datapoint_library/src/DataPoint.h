/**
  ...
  * in any form.
  *
  * Source : $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/scada/datapoint_library/src/DataPoint.h $
  * @author  J. Welton
  * @version $Revision: #2 $
...
namespace TA_Base_Bus
{
	...
	public:
		...
		*/
	    ...
	    /**setControlState
	      ...
	      * 
	      */
		virtual void setControlState ( TA_Base_Bus::EDataPointControlState controlStatus, std::string& strInfo, bool isRequestedBySystem ) ;
    ...
    class DataPointWorkItem : public TA_Base_Core::IThreadPoolExecuteItem
    {
    public:
        DataPointWorkItem(DataPoint* dp);
        virtual ~DataPointWorkItem() {};

        // impletet IThreadPoolExecuteItem interface
        virtual void executeWorkItem();
