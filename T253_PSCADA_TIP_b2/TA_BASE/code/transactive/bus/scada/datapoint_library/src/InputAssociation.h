/**
  ...
  * any form.
  *
  * Source : $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/scada/datapoint_library/src/InputAssociation.h $
  * @author  HoaVu
  * @version $Revision: #2 $
...
namespace TA_Base_Bus
{
    ...
    // This class for InputAssociation using in threadpool
    class InputAssociationWorkItem : public TA_Base_Core::IThreadPoolExecuteItem
    {
    public:
        InputAssociationWorkItem(InputAssociation* association);
    ...
    private:
        InputAssociation* m_association;
    };
}
