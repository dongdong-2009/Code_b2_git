/**
  ...
  * any form.
  *
  * Source : $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/scada/datapoint_library/src/InputAssociation.cpp $
  * @author  HoaVu
  * @version $Revision: #2 $
...
namespace TA_Base_Bus
{
	...
	void InputAssociation::resolveCurrentDataPointState()
	{
		...
		if ( true == schedulingNeeded )
		{
            ...
            InputAssociationWorkItem* item = new InputAssociationWorkItem(this);
    ...
    InputAssociationWorkItem::InputAssociationWorkItem(InputAssociation* association)
		:
