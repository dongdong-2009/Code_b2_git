/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/sound/sound_player/src/dxutil.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
		...
		FLOAT __stdcall DXUtil_Timer( TIMER_COMMAND command )
		{
			...
			if( m_bUsingQPF )
			{
				...
				{
					double fBusTime = (double) ( qwTime.QuadPart - m_llBaseTime ) / (double) m_llQPFTicksPerSec;
					return (FLOAT) fBusTime;
				}
