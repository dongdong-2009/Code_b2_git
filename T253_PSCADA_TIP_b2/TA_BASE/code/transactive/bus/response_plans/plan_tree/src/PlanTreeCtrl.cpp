/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/response_plans/plan_tree/src/PlanTreeCtrl.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
LRESULT CPlanTreeCtrl::OnInitialise(WPARAM wParam, LPARAM lParam)
{
    ...
    rootSummary.name = PlanInternetional::PlanTreeRootItem.c_str();
    rootSummary.node = 1;
