...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/response_plans/active_plans_display/src/PlanActiveInstanceListCtrl.h $
...
namespace TA_Base_Bus
{
    ...
    public:
		...
		/** 
		  ...
		  *
		  */
        virtual void Populate(const TA_Base_Core::ActivePlanStepsDetails &activePlanDetails);
        ...
        virtual void PopulateInstance(const TA_Base_Core::ActivePlanId& plan,  const TA_Base_Core::ActiveStepDetail &activeStepDetail);
    ...
    protected:
        ...
        virtual void ProcessInstance(const TA_Base_Core::ActivePlanId& plan,  const TA_Base_Core::ActiveStepDetail &activeStepDetail);
		...
		/** 
		  ...
		  *
		  */
		virtual void ClearInstances(const unsigned long ulLocationKey);
    ...
    protected:
        ...
        //
        // Message handler for WM_ACTIVE_STEP_DETAIL_UPDATE.
        // Note: client code must send message to this class using valid 
        // pointer to ActivePlanDetail as WPARAM.
        //s
        afx_msg LRESULT OnActiveStepDetailUpdate(WPARAM wParam, LPARAM lParam);

        //
        // Message handler for WM_ACTIVE_PLAN_RESET.
        // Note: client code must send message to this class using valid 
        // pointer to ActivePlanDetail as WPARAM.
        //
        afx_msg LRESULT OnActivePlanReset(WPARAM wParam, LPARAM lParam);
