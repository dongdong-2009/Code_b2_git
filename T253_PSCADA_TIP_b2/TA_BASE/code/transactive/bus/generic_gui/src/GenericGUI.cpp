/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/bus/generic_gui/src/GenericGUI.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
/*//TD18095, jianghp, to fix the performance of showing manager application
            ...
            activateServantWithName( "GenericGUI" );
...
/////////////////////////////////////////////////////
    ...
    void GenericGUI::shutdown()
    {
		...
		TA_Base_Core::RealTimeEventSenderInstance::close();

		//Clean up EventProcessLibray (for insert event into DB)
		TA_Base_Core::EventProcessingLibrary::close();
