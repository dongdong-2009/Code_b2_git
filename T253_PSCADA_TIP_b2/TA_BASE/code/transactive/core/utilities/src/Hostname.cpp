/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/utilities/src/Hostname.cpp $
  * @author:  Ripple
  * @version: $Revision: #4 $
  *
...
namespace TA_Base_Core
{
    ...
    {
        if (true == TA_Base_Core::RunParams::getInstance().isSet("Hostname"))
        {
            return TA_Base_Core::RunParams::getInstance().get("Hostname");
        }
