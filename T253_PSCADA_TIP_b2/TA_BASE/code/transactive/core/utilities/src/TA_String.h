/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/utilities/src/TA_String.h $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2017/11/13 16:36:41 $
...
namespace TA_Base_Core
{
    ...
    std::ostream& operator<<(std::ostream& stm, const AsPtr_t<T>& obj)
    {
	    ...
	    //#if !defined(SOLARIS)     (different only in WIN32)
		#if defined(WIN32)
            stm << "0x";
        #endif
    ...
    std::ostream& operator<<(std::ostream& stm, const AsDeletedPtr_t<T>& obj)
    {
        ...
        // overload above.
	    //#if defined(SOLARIS)  (Only WIN32 should skip this line)
		#if ( !defined(WIN32) )
