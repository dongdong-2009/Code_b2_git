...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/utilities/src/DebugUtil.h $
  * @author:  Ripple
  * @version: $Revision: #4 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        * setInstance
		*
        * Set the one and only DebugUtil object.
        * DLLs need to use the main application's DebugUtil instance.
        *
        * @param    DebugUtil   The object to point this instance to.
        */

        static void setInstance(DebugUtil& debugUtil);
