/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/utilities/src/DebugUtil.cpp $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_Core
{
	...
	void DebugUtil::setInstance( DebugUtil& debugUtil )
	{
		if (m_instance != NULL )
		{
			return;
		}
		m_instance = &debugUtil;
	}
