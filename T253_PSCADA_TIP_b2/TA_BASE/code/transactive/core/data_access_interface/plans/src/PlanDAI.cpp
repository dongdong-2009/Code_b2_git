  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/data_access_interface/plans/src/PlanDAI.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
//			std::string strSql  = databaseConnection->prepareSQLStatement(NODE_TREE_SELECT_33501, 
		    SQLStatement strSql;
		    databaseConnection->prepareSQLStatement(strSql, PLAN_NODE_TREE_SELECT_33501,
    ...
    void PlanDAI::refreshPath()
    {
        ...
        while ( ulCurNode != ROOT_NODE_ID )
        {
            ...
            SQLStatement strSql;
            databaseConnection->prepareSQLStatement(strSql, PLAN_NODE_TREE_SELECT_33556,  ulCurNode);
...
//		std::string strSql  = database->prepareSQLStatement(NODE_TREE_SELECT_33502, m_nodeId);
		SQLStatement strSql;
		database->prepareSQLStatement(strSql, PLAN_NODE_TREE_SELECT_33502, m_nodeId);
