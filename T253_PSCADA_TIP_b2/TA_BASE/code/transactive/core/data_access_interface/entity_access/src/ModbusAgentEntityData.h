/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3002_TIP/TA_BASE/transactive/core/data_access_interface/entity_access/src/ModbusAgentEntityData.h $
  * @author Dhanshri
  * @version $Revision: #1 $
...
#ifndef ModbusAgent_ENTITY_DATA_H
#define ModbusAgent_ENTITY_DATA_H

#include "core/data_access_interface/entity_access/src/EntityData.h"
#include "core/data_access_interface/entity_access/src/IModbusAgentEntityData.h"

namespace TA_Base_Core
{
    class ModbusAgentEntityData : public virtual IModbusAgentEntityData, public virtual EntityData
    {
	public:

		ModbusAgentEntityData();
        ModbusAgentEntityData( unsigned long key );

        virtual ~ModbusAgentEntityData();
		...
		//
		// operations required by the IModbusAgentEntityData
		//
         ...
         * getPollTimeout
         *
         * Returns the PollTimeout in msecs for ModbusAgent entity
         *
         * @return The integer value presenting the time in msecs
         */
    ...
    private:
        ...
        ModbusAgentEntityData( const ModbusAgentEntityData & obj );
		ModbusAgentEntityData & operator= ( const ModbusAgentEntityData &);
    ...
    public:
        static const std::string ModbusAgent_ENTITY_TYPE;
    ...
    typedef boost::shared_ptr<ModbusAgentEntityData> ModbusAgentEntityDataPtr;
