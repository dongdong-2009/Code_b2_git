/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/data_access_interface/entity_access/src/Console.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
		...
		virtual unsigned long getCCTVClientPort();
    ...
    private:
		...
		static const std::string CCTV_CLIENT_PORT;
