/**
  ...
  *
  *  
  * Source: $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/data_access_interface/entity_access/src/EntityAccessFactory.cpp $
  * @author Nick Jardine
  * @version $Revision: #4 $
  * Last modification: $DateTime: 2018/02/09 13:08:32 $
...
namespace TA_Base_Core
{
    ...
    void EntityAccessFactory::setUpMap()
    {
        ...
        // ModbusAgent entity
        m_entityTypes.insert(EntityTypeMap::value_type( ModbusAgentEntityData::getStaticType(), ModbusAgentEntityData::clone ) );
