/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/types/src/ta_types.h $
  * @author:  San Teo
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2018/01/25 16:47:14 $
...
//==========================================================
	...
	typedef signed char          ta_int8;    // 8 bits ta_int32 signed integer
	typedef signed short         ta_int16;   // 16 bits ta_int32 signed integer
	typedef size_t               ta_pointer; // pointer type

	typedef unsigned char        ta_uint8;   // 8 bits ta_int32 unsigned integer, "byte"
	typedef unsigned short       ta_uint16;  // 16 bits ta_int32 unsigned integer, "word"
    typedef signed long          ta_long;    // should avoid to use this type, in some platform it's 32 bit and 64bit at others
	typedef unsigned long        ta_ulong;   // should avoid to use this type, in some platform it's 32 bit and 64bit at others
	...
	// integer then output the compiler error
		...
		typedef unsigned long        ta_uint32;  // 32 bits long signed integer
	#endif
	
	typedef float                ta_float32;  // single, 4 bytes ta_int32 float
	typedef double               ta_float64;  // double, 8 bytes ta_int32 float
////	typedef long double          ta_float80; // extended - 12 bytes on Solaris
//	typedef ta_int32 double          ta_float80; // extended - 12 bytes on Solaris


// Definition of data types supported by Windows
//==========================================================
#elif defined( WIN32 ) || defined( __WIN32__ )
	typedef __int8               ta_int8;   // 8 bits ta_int32 signed integer
	typedef __int16              ta_int16;  // 16 bits ta_int32 signed integer
	typedef long              	 ta_int32;  // 32 bits long signed integer
	typedef size_t               ta_pointer;

	typedef unsigned __int8      ta_uint8;   // 8 bits ta_int32 unsigned integer, "byte"
	typedef unsigned __int16     ta_uint16;  // 16 bits ta_int32 unsigned integer, "word"
	...
	// integer then output the compiler error
		...
		typedef __int64              ta_int64;  // 64 bits ta_int32 signed integer
		typedef unsigned __int64     ta_uint64;  // 64 bits ta_int32 unsigned integer
		static const ta_int64 TA_MAX_INT64     =  0x7fffffffffffffff;
		static const ta_int64 TA_MIN_INT64     =  -0x7fffffffffffffff-1;
...
//	typedef ta_int32 double      ta_float80; // extended - 10 bytes on Solaris
...
//	typedef ta_int32 double      ta_float80; // extended - 16 bytes on Solaris
