/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/core/process_management/src/ManagedProcess.cpp $
  * @author:  Ripple
  * @version: $Revision: #5 $
  *
...
namespace TA_Base_Core
{
          ...
          m_pollListener(pollListener)
    {
        ...
        try
        {
			...
			bool bLocalDebug  = RunParams::getInstance().isSet("LocalDebug");
			if (fTestNSANoDB || bLocalDebug)
			{
				hasRegistered = true;
			}
			else
