...
namespace TA_Base_App
{
	...
	public:
		...
		void  ATSComWrapper::setStartEndTimeToATSFilter ( IATSFilterCriteria * atsfilter, 
			FilterCriteria & filterCriteria);

/*		void adjustATSFilterTime(ATSBridgeUtilLib::IATSFilterCriteria *  atsfilter);*/

		void setATSFilterStartTimeByCTime(IATSFilterCriteria *  atsfilter, CTime time);
		void setATSFilterEndTimeByCTime(IATSFilterCriteria *  atsfilter, CTime time);

		void setTMTypeToATSFilter(IATSFilterCriteria * atsfilter, FilterCriteria & filterCriteria);
		...
		ICombinedEventData * createCombinedEvent (CComPtr<IATSEvent> pATSEvent, unsigned long key);
