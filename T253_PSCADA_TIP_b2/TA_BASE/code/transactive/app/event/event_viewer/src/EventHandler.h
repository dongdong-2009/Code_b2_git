...
namespace TA_Base_App{
	...
	public:
		...
		virtual void mergeEventFromATS( std::vector<TA_Base_Core::ICombinedEventData*> & eventlist);
		 ...
		 * clearEventStoreList
		 *
		 * For clearing  m_eventStoreList, m_eventIdSet and m_ATSeventIdSet
		 */
    ...
    {    
		...
		std::set<std::string> m_ATSeventIdSet; //used to store ATS  EventId
	...
	private:
		...
		virtual void statusBarUpdate(TA_Base_Core::EventCategory eventCategory,std::string status );
