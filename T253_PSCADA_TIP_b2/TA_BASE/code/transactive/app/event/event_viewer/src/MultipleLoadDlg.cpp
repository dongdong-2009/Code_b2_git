/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/event/event_viewer/src/MultipleLoadDlg.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace // unnamed
{
	...
	const std::string LIST_ITEM_NOFILTER_STRING("No Filter");
} // unnamed namespace
...
BOOL MultipleLoadDlg::OnInitDialog() 
{
	...
	if(m_includeAllItem)
	{
		m_multiList.InsertString(LIST_ITEM_ALL_INDEX,LIST_ITEM_NOFILTER_STRING.c_str());
