 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/event/event_viewer/src/DatabaseAccess.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
std::vector<ISCSSubsystemItem> DatabaseAccess::getSubsystems()  
{
    ...
    for ( ssIt=m_subsystems.begin(); ssIt!=m_subsystems.end(); ssIt++ )
    {
        ...
        ISCSSubsystemItem subsystem(ssIt->second->getKey(),  ssIt->second->getName(),ssIt->second->getSystemKey());
