 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/event/event_viewer/src/EventViewerDlg.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
//     }
    ...
    if( value == RPARAM_DBONLINE || value == RPARAM_DBOFFLINE)
    {
        ...
        {
            // There is now a new database connection but continue with the same task
