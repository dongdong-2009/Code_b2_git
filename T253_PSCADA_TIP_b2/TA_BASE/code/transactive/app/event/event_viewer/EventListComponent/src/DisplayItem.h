 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/DisplayItem.h $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
public:
	...
	//virtual void setColumnData (std::string columnName, std::string value)=0;

	virtual bool compareTo(DisplayItem* rhs, std::string& sortColumn, bool sortAscending)=0;
	 ...
	 */
	virtual void setEventCategory( TA_Base_Core::EventCategory ec )=0;
	 ...
	 *
	 */ 
	virtual TA_Base_Core::EventCategory getEventCategory()=0;
