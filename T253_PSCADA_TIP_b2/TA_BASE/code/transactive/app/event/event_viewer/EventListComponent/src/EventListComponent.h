 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/EventListComponent.h $
 * @author:  Nick Jardine
 * @version: $Revision: #2 $
 *
...
class ATSEventLoader;  // forward declaration
...
private:
     ...
     * convertText
     *
     * Used by exportEvents() to escape commas in text fields before writing them to the file. As the file format is "comma-delimited"
