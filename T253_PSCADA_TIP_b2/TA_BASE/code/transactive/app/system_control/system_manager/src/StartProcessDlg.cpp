/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/system_manager/src/StartProcessDlg.cpp $
    ...
    void StartProcessDlg::OnOK()
    {
            ...
            iter != m_processes.end(); iter++)
        {
            ...
            catch(TA_Base_Core::SystemControllerException&)
            {
                ...
                userMsg << process;
                UINT selectedButton = userMsg.showMsgBox(IDS_UE_020020);
            }
        }
