/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/system_manager/src/TransActiveLoginDlg.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    private:
         ...
         */
        void verifyDetailsWithDatabase(const ISessionChecker::SessionDetails& details);
         ...
         */
        void performDatabaseVerification(const ISessionChecker::SessionDetails& details);
