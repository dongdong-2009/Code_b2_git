/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/system_manager/src/ProcessListCtrl.h $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /**
          ...
          */
        virtual void populate(std::vector<TA_Base_Core::ProcessData> processData);
        ...
        /**
          ...
          * @param processData  The vector of ProcessData structures
          */
        void update(std::vector<TA_Base_Core::ProcessData>);
