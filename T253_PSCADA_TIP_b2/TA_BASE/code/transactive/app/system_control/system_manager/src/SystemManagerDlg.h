/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/system_manager/src/SystemManagerDlg.h $
...
public:
		...
		static const std::string STANDBY;

		static const std::string RUNNING_STANDBY;
		static const std::string GOING_TO_STANDBY;
