/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/LogoutDlg.cpp $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
void LogoutDlg::confirmAction(unsigned long resourceId)
{
    CString actionName;
