/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/BtnST.h $
  * @author:  Davide Calabro
  * @version: $Revision: #1 $
  *
  * Last modification: $DateTime: 2018/01/23 17:58:03 $
  * 
  * This class is an extension of CButton and is used in the launch pad.
  */
...
public:
    ...
    void SetAssociatedData(const unsigned long data)
    {
        m_ulAssociatedData = data;
    }

    unsigned long GetAssociatedData() const
    {
        return m_ulAssociatedData;
    }
	...
	void AddToMenu(unsigned int type, unsigned int callbackId, const char* message);
	void AddMenu(CMenu* pMenu, HWND hParentWnd);
#endif
...
private:
    ...
    unsigned long m_ulAssociatedData; // Data associated with the button.
