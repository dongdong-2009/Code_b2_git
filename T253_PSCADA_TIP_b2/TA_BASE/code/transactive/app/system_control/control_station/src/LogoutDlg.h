/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/LogoutDlg.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
public:
	...
	//IDS_UW_010003: Are you sure you want to {0}?
	void confirmAction(unsigned long resourceId);
