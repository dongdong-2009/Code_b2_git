/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/DutyManager.cpp $
  * @author:  San Teo
  * @version: $Revision: #2 $
  *
    ...
    for (unsigned int i = 0; i < source.length(); i++)
    {
        ...
        if (!sessionId.empty())
        {
            ...
            {        
				...
				std::auto_ptr<TA_Base_Core::ILocation> loc(LocationAccessFactory::getInstance().getLocationByKey(sessionInfo.LocationId,false));
