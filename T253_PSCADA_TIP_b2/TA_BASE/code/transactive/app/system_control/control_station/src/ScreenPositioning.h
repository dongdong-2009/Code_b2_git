/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/ScreenPositioning.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
private:
    ...
    void calculateMonitor( unsigned long& monitorNumber, unsigned long& monitorWidth );
