/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/EnumProcess.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
  ...
  *
  * This code was found at http://www.codeproject.com/threads/enumprocess.asp. 
  *
  * A simple class encapsulating tlhelp32 and PSAPI
  *
  * It is used by the Control Station to find out if any other Control Station processes
  * are running.
  * 
  */
...
//#define USE_VDMDBG // Comment this if you don´t want to use vdmdbg at all
