/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/ProcessManager.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
class ProcessManager : public virtual POA_TA_Base_Core::IProcessManagerCorbaDef,
...
private:
	...
	*/
    ...
    std::vector<std::string> m_dbConnectionFileList;
};
