/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/system_control/control_station/src/QuickToolComboEx.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
void CQuickToolComboEx::loadEntities()
{
    ...
    {				
		...
		tmpComboItem.pszText = strdup(name.c_str());
