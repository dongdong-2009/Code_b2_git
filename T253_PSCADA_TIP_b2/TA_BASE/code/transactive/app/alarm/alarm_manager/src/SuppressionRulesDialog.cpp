/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/alarm/alarm_manager/src/SuppressionRulesDialog.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    const int CSuppressionRulesDialog::REMOVABLE_COLUMN_WIDTH = 30;
	...
	void CSuppressionRulesDialog::populateLocationCombo()
	{
		...
		for (unsigned int i = 0;i < allLocationData.size(); ++i)
        {
			...
			{
				m_locationCombo.InsertString( count, allLocationData[i]->getName().c_str() );
