/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/alarm/alarm_manager/src/AlarmFilterDlg.h $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_App
{
	...
	public:
		...
		static const std::string FILTER_SUBSYSTEMTYPE;
		static const std::string FILTER_SYSTEM;
		static const std::string FILTER_LOCATION;
		static const std::string FILTER_OPERATOR;
		static const std::string FILTER_EQUIPMENT_ID;
		...
		static const std::string FILTER_OMTYPE;
		static const std::string FILTER_OMTYPE_OPERATION;
		static const std::string FILTER_OMTYPE_MAINTENANCE;
		static const std::string FILTER_OMTYPE_BOTH;
		static const std::string FILTER_OMTYPE_ALL;
	...
	afx_msg void OnSubsystemTypeButton();
	...
	afx_msg void OnOMTypeButton(UINT nId);
...
//	afx_msg void OnTimer(UINT nIDEvent); //TD17081
	...
	private:
		...
		MultipleSelectionDlg* m_subsystemTypeDlg;
		MultipleSelectionDlg* m_SystemDlg;
	  ...
	  /**
		...
		*/
		...
		void setOMTypeButton(int resourceID);
	  ...
	  /**
		...
		*/
		...
		CTime  m_bakfromDateTime;
		CTime  m_bakToDateTime;
