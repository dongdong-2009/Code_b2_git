/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/alarm/alarm_manager/src/MultipleSelectionDlg.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace // unnamed
{
	...
	const std::string LIST_ITEM_ALL_STRING("No Filter");
} // unnamed namespace
