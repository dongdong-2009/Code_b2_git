...
{
	class DataStoreUpdaterMMSJobCommand  :public DataStoreUpdater<std::string , AlarmMmsJobCommand,AlarmMMSJobCommandManager>
	{
	public:

		virtual ~DataStoreUpdaterMMSJobCommand();
		void Initialize(std::vector< boost::shared_ptr<AlarmMmsJobCommand> >& batch);
