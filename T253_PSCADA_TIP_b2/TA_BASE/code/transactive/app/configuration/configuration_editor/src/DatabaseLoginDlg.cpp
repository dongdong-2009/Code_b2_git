/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/DatabaseLoginDlg.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
END_MESSAGE_MAP()
    ...
    void DatabaseLoginDlg::onOK() 
    {
        ...
        catch( const TA_Base_Core::DatabaseException& )
        {
            ...
            userMsg << databaseString;
            UINT selectedButton = userMsg.showMsgBox(IDS_UE_010017);
