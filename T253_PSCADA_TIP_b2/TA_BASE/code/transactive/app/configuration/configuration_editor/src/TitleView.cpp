/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/TitleView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    const int TitleView::TITLE_FONT_SIZE = 160;

    // The font typeface to use for the title
    const CString TitleView::TITLE_FONT_TYPEFACE = "Arial Bold";
