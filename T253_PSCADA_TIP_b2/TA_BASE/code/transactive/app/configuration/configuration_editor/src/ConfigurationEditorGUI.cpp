/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/ConfigurationEditorGUI.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    void ConfigurationEditorGUI::checkEntity(TA_Base_Core::IEntityData* guiEntity)
    {
        ...
        if (configEditor->isConfigurationEditorAlreadyRunning(workstationName))
        {
            ...
            userMsg << applicationName << workstationName;
            UINT selectedButton = userMsg.showMsgBox(IDS_UE_030061);
