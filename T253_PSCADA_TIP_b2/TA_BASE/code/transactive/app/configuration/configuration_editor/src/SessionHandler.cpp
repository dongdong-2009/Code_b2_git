/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/SessionHandler.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    void SessionHandler::connectToSystemController()
    {
        ...
        try
        {
            m_rights = new TA_Base_Bus::RightsLibrary;
