/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/ConfigurationEditorMenu.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    void ConfigurationEditorMenu::onMenuItemSelected(UINT nID, Component* selectedComponent)
    {
        ...
        if (menu == NULL)
        {
            TA_Base_Bus::TransActiveMessage userMsg;
            userMsg << menuItemStr;
            UINT selectedButton = userMsg.showMsgBox(IDS_UE_030058);
            FUNCTION_EXIT;
            return;
        }
