/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/ConfigurationEditor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2018/01/26 10:21:27 $
...
END_MESSAGE_MAP()
    ...
    : m_genericGUI(NULL),
      ...
      m_applicationName("Configuration Editor"),
      TransActiveWinApp(&m_gui, "Configuration Editor"),
