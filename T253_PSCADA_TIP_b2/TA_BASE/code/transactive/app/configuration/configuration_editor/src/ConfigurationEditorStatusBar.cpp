/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/ConfigurationEditorStatusBar.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
END_MESSAGE_MAP()
    ...
    LRESULT ConfigurationEditorStatusBar::OnSetText(WPARAM wParam, LPARAM lParam)
    {
        if (lParam && 0 == strcmp((LPCTSTR)lParam, "" ))
        {
            ...
            return CStatusBar::OnSetText((m_text.c_str()) );
        }
