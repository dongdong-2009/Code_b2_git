/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/ConfigurationEditorToolbar.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    void ConfigurationEditorToolBar::populateToolBar()
    {
		...
		for(int i = 0, j = m_toolBar.GetToolBarCtrl().GetButtonCount(); i < j; ++i)
		{
