/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/location/src/LocationDetailView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    protected:
		...
		afx_msg void onKillfocusEditDisplayName();
		afx_msg void OnDisplayOnlyClicked();
	    //}}AFX_MSG
	    DECLARE_MESSAGE_MAP()
    ...
    private:
		...
		static const int DISPLAY_NAME_FIELD_LENGTH;
