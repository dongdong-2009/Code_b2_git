/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/generic_entity/src/EntityFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_ENTITYFRAMEWORKVIEW_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_ENTITYFRAMEWORKVIEW_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class EntityFrameworkView : public AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
	    ...
	    DECLARE_DYNCREATE(EntityFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(EntityFrameworkView)
	    //}}AFX_VIRTUAL

    // Implementation
    protected:
	    virtual ~EntityFrameworkView();
    #ifdef _DEBUG
...
#endif // !defined(AFX_ENTITYFRAMEWORKVIEW_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
