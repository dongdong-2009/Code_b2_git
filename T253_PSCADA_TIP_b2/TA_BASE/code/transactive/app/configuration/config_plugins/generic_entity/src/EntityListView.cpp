/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/generic_entity/src/EntityListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    {
        m_componentIcon = LoadIcon(GetModuleHandle(GenericEntityComponent::DLL_NAME), MAKEINTRESOURCE(IDI_CONFIG_ENTITY) );
    }
