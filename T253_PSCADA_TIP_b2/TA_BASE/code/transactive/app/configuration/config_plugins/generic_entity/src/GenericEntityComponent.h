/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/generic_entity/src/GenericEntityComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(GenericEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define GenericEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class GenericEntityComponent : public AbstractComponent
    {
    ...
    public:
         ...
         *                          represent
         */
        GenericEntityComponent(const std::string& componentName,
         ...
         * Destructor
         */
	    virtual ~GenericEntityComponent();
    ...
    private:
         ...
         */
        GenericEntityComponent( const GenericEntityComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        GenericEntityComponent& operator=(const GenericEntityComponent&);
...
#endif // !defined(GenericEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
