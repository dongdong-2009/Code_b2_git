/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/system_controller_groups/src/SCGroupDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(SCGroupDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
#define SCGroupDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_
...
{
    class SCGroupDatabaseAccessor : public IDatabaseAccessor
    {
    ...
    public:
         ...
         * Constructor
         */
        SCGroupDatabaseAccessor();


        /**
         * Destructor
         */
        virtual ~SCGroupDatabaseAccessor();


        /**
         * loadItems
         *
         * This will retrieve all the SC groups from the database and store them in m_groups.
         *
         * @exception DataException - This will be thrown if there is an error with the SC group data and it
         ...
         * getItemNames
         *
         * This returns all SC group names and keys to the caller. 
         ...
         *
         * @return map<CString, unsigned long> - This returns a map of all the SC group names. The map also
         *                                       contains the identifier of the SC group as the caller will probably
         *                                       need this later to specify a specific SC group.
         *
         * @exception DataException - This will be thrown if there is an error with the SC group's data and it
         *                            cannot be retrieved for some reason.
         * @exception DatabaseException - This will be thrown if there is an error communicating with the
         *                                database.
         */
    ...
    private:
         ...
         */
        SCGroupDatabaseAccessor( const SCGroupDatabaseAccessor& theSCGroupDatabaseAccessor){ };
         ...
         * Hidden as a private method so it is not used.
         */
        SCGroupDatabaseAccessor& operator=(const SCGroupDatabaseAccessor& pm);


        // This is a map of IConfigSCGroup* objects stored by their SC group key (unsigned long)
        typedef std::map<unsigned long, TA_Base_Core::IConfigGroupMonitor*> LoadedSCGroups;

        LoadedSCGroups m_groups;   // This is all the SC groups loaded from the database

        bool m_isLoaded;          // This indicates if we have loaded the SC groups before or not. If we
                                  // have never loaded the SC groups then when we are told to refresh we
                                  // shouldn't load them.

    };
}

#endif // !defined(SCGroupDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
