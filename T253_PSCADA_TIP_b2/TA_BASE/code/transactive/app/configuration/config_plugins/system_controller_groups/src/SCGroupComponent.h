/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/system_controller_groups/src/SCGroupComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(SCGroupComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define SCGroupComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class SCGroupComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        SCGroupComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~SCGroupComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_SYSTEM_CONTROLLER_GROUPS;
        }
    ...
    private:
         ...
         */
        SCGroupComponent( const SCGroupComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        SCGroupComponent& operator=(const SCGroupComponent&);
...
#endif // !defined(SCGroupComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
