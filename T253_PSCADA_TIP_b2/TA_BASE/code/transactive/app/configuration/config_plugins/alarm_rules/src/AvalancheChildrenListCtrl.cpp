/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_rules/src/AvalancheChildrenListCtrl.cpp $
...
namespace TA_Base_App
{
    ...
    const CString AvalancheChildrenListCtrl::ENTITY_COLUMN_NAME   = "Entity";
    const int     AvalancheChildrenListCtrl::ENTITY_COLUMN        = 0;
    const CString AvalancheChildrenListCtrl::ALARM_TYPE_COLUMN_NAME  = "Alarm Type";
...
END_MESSAGE_MAP()
    ...
    void AvalancheChildrenListCtrl::setupList()
    {
        ...
        InsertColumn(ALARM_TYPE_COLUMN, ALARM_TYPE_COLUMN_NAME, LVCFMT_LEFT, width);
        ...
        AlarmRulesDatabaseAccessor* accessor)
    {
        ...
        for (unsigned int i = 0; i < children.size(); i ++)
        {
            ...
            std::string alarmTypeName =
                AlarmRuleData::getAlarmTypeName(alarmTypeKey);
    ...
    std::vector<std::string> AvalancheChildrenListCtrl::getAllAlarmTypeNames()
    {
