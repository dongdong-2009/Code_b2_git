/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_rules/src/SelectDataNodeDialog.h $
...
namespace TA_Base_App
{
    ...
    private:
        ...
        std::map<unsigned long, std::string> m_alarmTypeKeyNameMap;
