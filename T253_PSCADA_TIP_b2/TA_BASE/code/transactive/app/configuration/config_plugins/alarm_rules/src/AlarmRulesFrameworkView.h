/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_rules/src/AlarmRulesFrameworkView.h $
...
#if !defined(AFX_AlarmRulesFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_AlarmRulesFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class AlarmRulesFrameworkView : public AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AlarmRulesFrameworkView();

	    DECLARE_DYNCREATE(AlarmRulesFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(AlarmRulesFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~AlarmRulesFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(AlarmRulesFrameworkView)
...
#endif // !defined(AFX_AlarmRulesFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
