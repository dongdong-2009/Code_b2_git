/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_rules/src/AlarmRulesListView.cpp $
...
namespace TA_Base_App
{
    ...
    const CString AlarmRulesListView::TYPE_COLUMN_NAME       = "Rule Type";
    const CString AlarmRulesListView::APPLIED_COLUMN_NAME    = "Status";
    const CString AlarmRulesListView::ALARMTYPE_COLUMN_NAME  = "Alarm Type";
    const CString AlarmRulesListView::ENTITYTYPE_COLUMN_NAME = "Entity Type";
    const CString AlarmRulesListView::ENTITY_COLUMN_NAME     = "Entity";
    const CString AlarmRulesListView::TRIGGER_COLUMN_NAME    = "Trigger";
	const CString AlarmRulesListView::DESCRIPTION_COLUMN_NAME = "Alarm Description";
    ...
    const CString AlarmRulesListView::NEW      = "New";
    const CString AlarmRulesListView::MODIFIED = "Modified";
    const CString AlarmRulesListView::UPTODATE = "";

    const CString AlarmRulesListView::NEW_ALARM_RULE_DIALOG_TITLE = "Alarm Rule Type";
...
//        using AlarmRulesDatabaseAccessor::AlarmRule;
             ...
             iter != m_currentDisplayedItems.end(); ++iter)
        {
            ...
            GetListCtrl().SetItemText(position, ALARMTYPE_COLUMN,  iter->second.alarmType);
    ...
    void AlarmRulesListView::itemDetailsChanged(unsigned long id, const CString& name)
    {
        ...
        if (foundItemIndex != -1)
        {
            ...
            GetListCtrl().SetItemText(foundItemIndex, ALARMTYPE_COLUMN,  details.alarmType);
        ...
        else
        {
            ...
            GetListCtrl().SetItemText(position, ALARMTYPE_COLUMN,  details.alarmType);
    ...
    void AlarmRulesListView::newItem()
    {
        ...
        namesAndKeys[0] = "Automatic Acknowledgement Rule";
        namesAndKeys[1] = "Avalanche Suppression Rule";
        namesAndKeys[2] = "Plan Execution Rule";
        namesAndKeys[3] = "Suppression By Type Rule";
        namesAndKeys[4] = "Suppression By Description Rule";
		//TD16491++
        namesAndKeys[5] = MMSRuleData::RULE_TYPE + " Rule";
		//++TD16491
        namesAndKeys[6] = "CCTV Rule";
    ...
    int CALLBACK AlarmRulesListView::compareItems(LPARAM index1, LPARAM index2, LPARAM listCtrl)
    {
        ...
        switch(list->m_sortColumn)
        {
            ...
            case(ALARMTYPE_COLUMN):
                    string1 = item1->second.alarmType;
                    string2 = item2->second.alarmType;
                    break;
