/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_rules/src/AlarmRulesListView.h $
...
namespace TA_Base_App
{
    ...
    private:
        ...
        static const CString TRIGGER_COLUMN_NAME;
        ...
        // The title of the dialog that appears when the user clicks the new
        // button
        static const CString NEW_ALARM_RULE_DIALOG_TITLE;
