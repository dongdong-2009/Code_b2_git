/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_rules/src/AlarmRulesComponent.h $
...
#if !defined(AlarmRulesComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AlarmRulesComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AlarmRulesComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        AlarmRulesComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~AlarmRulesComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ALARM_RULES;
        }
    ...
    private:
         ...
         */
        AlarmRulesComponent( const AlarmRulesComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AlarmRulesComponent& operator=(const AlarmRulesComponent&);
...
#endif // !defined(AlarmRulesComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
