/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/scada_displays/src/ScadaDisplayComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(ScadaDisplayComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define ScadaDisplayComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class ScadaDisplayComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        ScadaDisplayComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~ScadaDisplayComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_SCADA_DISPLAYS;
        }
    ...
    private:
         ...
         */
        ScadaDisplayComponent( const ScadaDisplayComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        ScadaDisplayComponent& operator=(const ScadaDisplayComponent&);
...
#endif // !defined(ScadaDisplayComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
