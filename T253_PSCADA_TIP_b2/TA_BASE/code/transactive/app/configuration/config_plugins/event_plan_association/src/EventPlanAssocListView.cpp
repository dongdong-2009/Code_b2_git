/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/event_plan_association/src/EventPlanAssocListView.cpp $
  * @author:  Brad Cleaver
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    const CString EventPlanAssocListView::APPLIED_COLUMN_NAME = "Status";
    const CString EventPlanAssocListView::ENABLED_COLUMN_NAME = "Enabled";
    const CString EventPlanAssocListView::EVENTTYPE_COLUMN_NAME = "Event Type";
    const CString EventPlanAssocListView::ENTITYTYPE_COLUMN_NAME = "Entity Type";
    const CString EventPlanAssocListView::ENTITY_COLUMN_NAME = "Entity";
    const CString EventPlanAssocListView::PLAN_COLUMN_NAME = "Plan";
