/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/event_plan_association/src/EventPlanAssocDetailView.cpp $
  * @author:  Brad Cleaver
  * @version: $Revision: #1 $
  *
...
END_MESSAGE_MAP()
    ...
    void EventPlanAssocDetailView::onKillfocusEditEvent() 
    {
        ...
        try
        {
            ...
            if ( eventTypeString == m_currentAssociation->getEventTypeName().c_str() )
            {
                m_eventType.setTextType( TA_Base_Bus::TextColourEdit::VALID );
            }
            else
