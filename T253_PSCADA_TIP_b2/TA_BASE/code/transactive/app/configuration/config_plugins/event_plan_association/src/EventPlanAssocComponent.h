/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/event_plan_association/src/EventPlanAssocComponent.h $
  * @author:  Brad Cleaver
  * @version: $Revision: #1 $
  *
...
#if !defined(_EVENT_PLAN_ASSOC_COMPONENT_H_)
#define _EVENT_PLAN_ASSOC_COMPONENT_H_
...
{
    class EventPlanAssocComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        EventPlanAssocComponent( const std::string& componentName );


        /**
         * Destructor
         */
	    virtual ~EventPlanAssocComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_EVENT_PLAN_ASSOCIATIONS;
        }
    ...
    private:
         ...
         */
        EventPlanAssocComponent( const EventPlanAssocComponent& );
         ...
         * Hidden as a private method so it is not used.
         */
        EventPlanAssocComponent& operator=( const EventPlanAssocComponent& );
...
#endif // !defined(_EVENT_PLAN_ASSOC_COMPONENT_H_)
