/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/profile/src/ProfileComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(ProfileComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define ProfileComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class ProfileComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        ProfileComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~ProfileComponent();
    ...
    private:
         ...
         */
        ProfileComponent( const ProfileComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        ProfileComponent& operator=(const ProfileComponent&);
...
#endif // !defined(ProfileComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
