/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/profile/src/ProfileFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_ProfileFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_ProfileFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class ProfileFrameworkView : public AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    ProfileFrameworkView();

	    DECLARE_DYNCREATE(ProfileFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(ProfileFrameworkView)
	    //}}AFX_VIRTUAL

    // Implementation
    protected:
	    virtual ~ProfileFrameworkView();
    #ifdef _DEBUG
...
#endif // !defined(AFX_ProfileFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
