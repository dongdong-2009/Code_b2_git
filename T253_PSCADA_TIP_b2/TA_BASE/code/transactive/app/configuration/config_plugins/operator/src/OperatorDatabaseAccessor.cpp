/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/operator/src/OperatorDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    std::map<CString,unsigned long> OperatorDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
