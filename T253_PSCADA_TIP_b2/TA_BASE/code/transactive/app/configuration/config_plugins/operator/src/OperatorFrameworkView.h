/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/operator/src/OperatorFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_OperatorFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_OperatorFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class OperatorFrameworkView : public AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    OperatorFrameworkView();

	    DECLARE_DYNCREATE(OperatorFrameworkView)


    // Overrides
	    // ClassWizard generated virtual function overrides
	    //{{AFX_VIRTUAL(OperatorFrameworkView)
	    //}}AFX_VIRTUAL

    // Implementation
    protected:
	    virtual ~OperatorFrameworkView();
    #ifdef _DEBUG
...
#endif // !defined(AFX_OperatorFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
