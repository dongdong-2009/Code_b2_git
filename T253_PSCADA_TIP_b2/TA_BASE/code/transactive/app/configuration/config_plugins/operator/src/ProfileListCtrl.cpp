/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/operator/src/ProfileListCtrl.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    const CString ProfileListCtrl::PROFILE_NAME_COLUMN_NAME   = "Profile";
    const int     ProfileListCtrl::PROFILE_NAME_COLUMN_WIDTH  = 200;
    const int     ProfileListCtrl::PROFILE_NAME_COLUMN        = 0;
    const CString ProfileListCtrl::PROFILE_CHECK_COLUMN_NAME  = "Available";
