/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/operator/src/OperatorDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(OperatorDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
#define OperatorDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_
...
{
    class OperatorDatabaseAccessor : public IDatabaseAccessor
    {
    ...
    public:
         ...
         * Constructor
         */
        OperatorDatabaseAccessor();


        /**
         * Destructor
         */
        virtual ~OperatorDatabaseAccessor();


        /**
         * loadItems
         *
         * This will retrieve all the items from the database and store them in m_operators.
         *
         * @exception DataException - This will be thrown if there is an error with the Operator data and it
         ...
         * getItemNames
         *
         * This returns all Operator names and keys to the caller. 
         ...
         *
         * @return map<CString, unsigned long> - This returns a map of all the Operator names. The map also
         *                                       contains the identifier of the Operator as the caller will probably
         *                                       need this later to specify a specific Operator.
         *
         * @exception DataException - This will be thrown if there is an error with the Operator's data and it
         *                            cannot be retrieved for some reason.
         * @exception DatabaseException - This will be thrown if there is an error communicating with the
         *                                database.
         */
         ...
         *                been applied.
         */
         bool areCurrentChangesPending(std::vector<std::string>& OperatorsNotApplied);
    ...
    private:
         ...
         */
        OperatorDatabaseAccessor( const OperatorDatabaseAccessor& theOperatorDatabaseAccessor){ };
         ...
         * Hidden as a private method so it is not used.
         */
        OperatorDatabaseAccessor& operator=(const OperatorDatabaseAccessor& pm);


        // This is a map of IConfigOperator* objects stored by their Operator key (unsigned long)
        typedef std::map<unsigned long, TA_Base_Core::IConfigOperator*> LoadedOperators;

        LoadedOperators m_operators;   // This is all the operators loaded from the database

        bool m_isLoaded;          // This indicates if we have loaded the operators before or not. If we
                                  // have never loaded the operators then when we are told to refresh we
                                  // shouldn't load them.

    };
}

#endif // !defined(OperatorDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
