/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/operator/src/OperatorListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
END_MESSAGE_MAP()
    ...
    void OperatorListView::deleteItem()
    {
		...
		if (numberOfItemsActive != 0)
        {
			...
			CString errorMsg = "an active session is still using this operator";
