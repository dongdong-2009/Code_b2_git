/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/sound_file/src/SoundFileDatabaseAccessor.cpp $
  * @author:  Brad Cleaver
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    std::map<CString,unsigned long> SoundFileDatabaseAccessor::getItemNames( CProgressCtrl& progress )
    {
