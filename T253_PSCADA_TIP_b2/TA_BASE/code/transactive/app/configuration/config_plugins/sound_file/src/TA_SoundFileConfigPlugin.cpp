/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/sound_file/src/TA_SoundFileConfigPlugin.cpp $
  * @author:  Brad Cleaver
  * @version: $Revision: #1 $
  *
...
{
    static AFX_EXTENSION_MODULE TA_SoundFileConfigPluginDLL = { NULL, NULL };
    ...
    DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
    {
	    ...
	    {
		    TRACE0("TA_SOUNDFILECONFIGPLUGIN.DLL Initializing!\n");
		    
		    // Extension DLL one-time initialization
		    if (!AfxInitExtensionModule(TA_SoundFileConfigPluginDLL, hInstance))
			    return 0;
		    ...
		    new CDynLinkLibrary(TA_SoundFileConfigPluginDLL);
	    }
	    else if (dwReason == DLL_PROCESS_DETACH)
	    {
		    TRACE0("TA_SOUNDFILECONFIGPLUGIN.DLL Terminating!\n");
		    // Terminate the library before destructors are called
		    AfxTermExtensionModule(TA_SoundFileConfigPluginDLL);
	    }
	    return 1;   // ok
    }
    ...
    /**
      ...
      *
      * @return IConfigurableComponent*		A new SoundFileComponent object which implements
    ...
    {
	    return new SoundFileComponent(componentName);
    }
