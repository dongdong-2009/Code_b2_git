/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/subsystem/src/SubsystemComponent.h $
...
#if !defined(SubsystemComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define SubsystemComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class SubsystemComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        SubsystemComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~SubsystemComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_SUBSYSTEMS;
        }
    ...
    private:
         ...
         */
        SubsystemComponent( const SubsystemComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        SubsystemComponent& operator=(const SubsystemComponent&);
...
#endif // !defined(SubsystemComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
