/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/subsystem/src/SubsystemDatabaseAccessor.cpp $
...
namespace TA_Base_App
{
    ...
    std::map<CString,unsigned long> SubsystemDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
