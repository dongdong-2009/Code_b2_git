/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/scada/src/ScadaDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    std::map<CString,unsigned long> ScadaDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
        // Doesn't do anything as our tree holds the items
        std::map<CString,unsigned long> empty;
        return empty;
    }
