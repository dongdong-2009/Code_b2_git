/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/scada/src/ScadaComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(ScadaComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define ScadaComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class ScadaComponent : public AbstractComponent
    {
    ...
    public:
         ...
         * @param vector<string>& - These are all entity types that this component should represent
         */
        ScadaComponent(const std::string& componentName,
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_SCADA;
        }
    ...
    private:
         ...
         */
        ScadaComponent( const ScadaComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        ScadaComponent& operator=(const ScadaComponent&);
...
#endif // !defined(ScadaComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
