/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/scada/src/HelpConfiguration.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_HELPCONFIGURATION_H__04BB63BA_4539_40EF_B674_158AEC8480B5__INCLUDED_)
#define AFX_HELPCONFIGURATION_H__04BB63BA_4539_40EF_B674_158AEC8480B5__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class HelpConfiguration : public CPropertyPage, virtual public IConfigurationPage
    {
	    DECLARE_DYNCREATE(HelpConfiguration)
    ...
    // Dialog Data
	    //{{AFX_DATA(HelpConfiguration)
	enum { IDD = IDD_HELP_CONFIG };
	    CTransparentImage	m_bitmapHelpUrl;
	    CTransparentImage	m_bitmapEngNote;
	    CEdit	m_helpURLControl;
	    CEdit	m_engNoteControl;
	    BOOL	m_engNoteCheck;
	    BOOL	m_helpUrlCheck;
	    CString	m_engNote;
	    CString	m_helpURL;
    ...
    protected:
	    ...
	    //{{AFX_MSG(HelpConfiguration)
	    virtual BOOL OnInitDialog();
	    afx_msg void onCheckEngNote();
	    afx_msg void onCheckHelpMessage();
	    afx_msg void onKillfocusEditEngNote();
	    afx_msg void onKillfocusEditHelpUrl();
	    //}}AFX_MSG
	    DECLARE_MESSAGE_MAP()
    ...
    private:
        ...
        static const std::string HELP_MESSAGE_ENABLED;
        static const std::string HELP_URL;
        static const std::string ENG_NOTE_ENABLED;
        static const std::string ENG_NOTE;

        static const int HELP_URL_FIELD_LENGTH;
        static const int ENG_NOTE_FIELD_LENGTH;
...
#endif // !defined(AFX_HELPCONFIGURATION_H__04BB63BA_4539_40EF_B674_158AEC8480B5__INCLUDED_)
