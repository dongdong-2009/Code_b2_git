/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/system_controller/src/SystemControllerComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(SystemControllerComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define SystemControllerComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class SystemControllerComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        SystemControllerComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~SystemControllerComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_SYSTEM_CONTROLLERS;
        }
    ...
    private:
         ...
         */
        SystemControllerComponent( const SystemControllerComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        SystemControllerComponent& operator=(const SystemControllerComponent&);
...
#endif // !defined(SystemControllerComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
