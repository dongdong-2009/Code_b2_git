/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/agent/src/AgentComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AgentComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AgentComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AgentComponent : public AbstractComponent
    {
    ...
    public:
         ...
         *                          represent
         */
        AgentComponent(const std::string& componentName,
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_AGENTS;
        }
    ...
    private:
         ...
         */
        AgentComponent( const AgentComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AgentComponent& operator=(const AgentComponent&);
...
#endif // !defined(AgentComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
