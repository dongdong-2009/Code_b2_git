/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_type/src/AlarmTypeComponent.h $
...
#if !defined(AlarmTypeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AlarmTypeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AlarmTypeComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        AlarmTypeComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~AlarmTypeComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ALARM_TYPES;
        }
    ...
    private:
         ...
         */
        AlarmTypeComponent( const AlarmTypeComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AlarmTypeComponent& operator=(const AlarmTypeComponent&);
...
#endif // !defined(AlarmTypeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
