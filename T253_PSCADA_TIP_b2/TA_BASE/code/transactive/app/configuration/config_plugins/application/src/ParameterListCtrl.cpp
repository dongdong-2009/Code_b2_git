/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/application/src/ParameterListCtrl.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This class manages the list display used to show the entity parameters in the ApplicationDetailView class
  */
...
namespace TA_Base_App
{
    ...
    const int     ParameterListCtrl::ATTRIBUTE_VALUE_COLUMN_WIDTH = 200;
    const int     ParameterListCtrl::ATTRIBUTE_VALUE_COLUMN       = 1;
    const CString ParameterListCtrl::ATTRIBUTE_UPDATE_COLUMN_NAME = "Restart";
    const int     ParameterListCtrl::ATTRIBUTE_UPDATE_COLUMN_WIDTH= 60;
