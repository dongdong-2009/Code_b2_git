/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/application/src/ApplicationComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(ApplicationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define ApplicationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class ApplicationComponent : public AbstractComponent
    {
    ...
    public:
         ...
         *                          represent
         */
        ApplicationComponent(const std::string& componentName,
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_APPLICATIONS;
        }
    ...
    private:
         ...
         */
        ApplicationComponent( const ApplicationComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        ApplicationComponent& operator=(const ApplicationComponent&);
...
#endif // !defined(ApplicationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
