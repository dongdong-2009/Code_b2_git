/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/config_plugin_helper/src/AbstractComponent.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_App
{
    ...
    const CString AbstractComponent::EDIT_MENU_NAME = "&Edit";

    const CString AbstractComponent::MENU_NEW_ITEM    = "&New";
    const CString AbstractComponent::MENU_COPY_ITEM   = "&Copy";
    const CString AbstractComponent::MENU_DELETE_ITEM = "&Delete";

    const CString AbstractComponent::TOOLBAR_NEW_ITEM    = "New";
    const CString AbstractComponent::TOOLBAR_COPY_ITEM   = "Copy";
    const CString AbstractComponent::TOOLBAR_DELETE_ITEM = "Delete";

    const CString AbstractComponent::NEW_ITEM_CAPTION    = "Create a new item";
    const CString AbstractComponent::COPY_ITEM_CAPTION   = "Copy the selected item(s)";
    const CString AbstractComponent::DELETE_ITEM_CAPTION = "Delete the selected item(s) permanently";
