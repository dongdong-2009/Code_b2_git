/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/config_plugin_helper/src/MultipleChangeDialog.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
          ...
          m_compareData(0)
    {
	    ...
	    //{{AFX_DATA_INIT(MultipleChangeDialog)
