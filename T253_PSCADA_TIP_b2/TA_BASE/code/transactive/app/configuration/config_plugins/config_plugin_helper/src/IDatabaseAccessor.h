/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/config_plugin_helper/src/IDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
         ...
         *                                database.
         */
        virtual std::map<CString,unsigned long> getItemNames(CProgressCtrl& progress) =0;
