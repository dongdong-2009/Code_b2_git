/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_severity/src/AlarmSeverityDatabaseAccessor.h $
...
#if !defined(AlarmSeverityDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
#define AlarmSeverityDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_
...
{
    class AlarmSeverityDatabaseAccessor : public IDatabaseAccessor
    {
    ...
    public:
         ...
         * Constructor
         */
        AlarmSeverityDatabaseAccessor();


        /**
         * Destructor
         */
        virtual ~AlarmSeverityDatabaseAccessor();
         ...
         *
         * @exception DataException - This will be thrown if there is an error with the AlarmSeverity data and it
         ...
         * getItemNames
         *
         * This returns all AlarmSeverity names and keys to the caller. 
         ...
         *
         * @return map<CString, unsigned long> - This returns a map of all the AlarmSeverity names. The map also
         *                                       contains the identifier of the AlarmSeverity as the caller will probably
         *                                       need this later to specify a specific AlarmSeverity.
         *
         * @exception DataException - This will be thrown if there is an error with the AlarmSeverity's data and it
         *                            cannot be retrieved for some reason.
         * @exception DatabaseException - This will be thrown if there is an error communicating with the
         *                                database.
         */
    ...
    private:
         ...
         */
        AlarmSeverityDatabaseAccessor( const AlarmSeverityDatabaseAccessor& theAlarmSeverityDatabaseAccessor){ };
         ...
         * Hidden as a private method so it is not used.
         */
        AlarmSeverityDatabaseAccessor& operator=(const AlarmSeverityDatabaseAccessor& pm);


        // This is a map of IConfigAlarmSeverityData* objects stored by their AlarmSeverity key (unsigned long)
        typedef std::map<unsigned long, TA_Base_Core::IConfigAlarmSeverityData*> LoadedAlarmSeverities;

        LoadedAlarmSeverities m_alarmSeverities;   // This is all the alarm severities loaded from the database
...
#endif // !defined(AlarmSeverityDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
