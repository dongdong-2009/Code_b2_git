/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/profile_groups/src/ProfileGroupsComponent.h $
  * @author:  Derrick Liew
  * @version: $Revision: #1 $
  *
...
#if !defined(ProfileGroupsComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define ProfileGroupsComponentt_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class ProfileGroupsComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        ProfileGroupsComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~ProfileGroupsComponent();
    ...
    private:
         ...
         */
        ProfileGroupsComponent( const ProfileGroupsComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        ProfileGroupsComponent& operator=(const ProfileGroupsComponent&);
...
#endif // !defined(ProfileGroupsComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
