/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/profile_groups/src/ProfileGroupsDatabaseAccessor.cpp $
  * @author:  Derrick Liew
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    std::map<CString,unsigned long> ProfileGroupsDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
