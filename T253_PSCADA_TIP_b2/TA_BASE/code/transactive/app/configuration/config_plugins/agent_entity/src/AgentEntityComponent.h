/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/agent_entity/src/AgentEntityComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AgentEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AgentEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class AgentEntityComponent : public AbstractComponent
    {
    ...
    public:
         ...
         *                          represent
         */
        AgentEntityComponent(const std::string& componentName,
    ...
    private:
         ...
         */
        AgentEntityComponent( const AgentEntityComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AgentEntityComponent& operator=(const AgentEntityComponent&);
...
#endif // !defined(AgentEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
