/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/action_groups/src/DutyComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(DutyComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define DutyComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class DutyComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        DutyComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~DutyComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ACTION_GROUPS;
        }
    ...
    private:
         ...
         */
        DutyComponent( const DutyComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        DutyComponent& operator=(const DutyComponent&);
...
#endif // !defined(DutyComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
