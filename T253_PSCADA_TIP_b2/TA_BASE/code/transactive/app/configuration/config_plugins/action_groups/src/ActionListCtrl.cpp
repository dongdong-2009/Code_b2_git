/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/action_groups/src/ActionListCtrl.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    const CString ActionListCtrl::ACTION_NAME_COLUMN_NAME = "Action";
    const int     ActionListCtrl::ACTION_NAME_COLUMN_WIDTH = 300;
    const int     ActionListCtrl::ACTION_NAME_COLUMN = 1;

    const CString ActionListCtrl::ACTION_DESCRIPTION_COLUMN_NAME = "Description";
