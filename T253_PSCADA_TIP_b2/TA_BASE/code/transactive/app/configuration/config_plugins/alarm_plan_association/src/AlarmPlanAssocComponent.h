/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_plan_association/src/AlarmPlanAssocComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AlarmPlanAssocComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AlarmPlanAssocComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AlarmPlanAssocComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        AlarmPlanAssocComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~AlarmPlanAssocComponent();
    ...
    private:
         ...
         */
        AlarmPlanAssocComponent( const AlarmPlanAssocComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AlarmPlanAssocComponent& operator=(const AlarmPlanAssocComponent&);
...
#endif // !defined(AlarmPlanAssocComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
