/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_plan_association/src/AlarmPlanAssocDetailView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    const CString AlarmPlanAssocDetailView::CHANGE_ENTITYTYPE_DIALOG_TITLE    = "Change Entity Type";
    const CString AlarmPlanAssocDetailView::CHANGE_ALARMTYPE_DIALOG_TITLE  = "Change Alarm Type";
...
END_MESSAGE_MAP()
    ...
    void AlarmPlanAssocDetailView::populateItemDetails(TA_Base_Core::IConfigItem* currentItem)
    {
        ...
        try
        {
            ...
            m_alarmType.SetWindowText( m_currentAssociation->getAlarmTypeName().c_str() );
    ...
    void AlarmPlanAssocDetailView::onButtonAlarmtype() 
    {
        ...
        ChangeDialog::ItemsForSelection items = m_databaseAccessor->getAllAlarmTypes();
    ...
    void AlarmPlanAssocDetailView::onKillfocusEditAlarm() 
    {
        ...
        try
        {
            ...
            if (alarmTypeString == m_currentAssociation->getAlarmTypeName().c_str())
            {
                m_alarmType.setTextType( TA_Base_Bus::TextColourEdit::VALID );
            }
            else
            {
                m_currentAssociation->setAlarmType( std::string(alarmTypeString) );
