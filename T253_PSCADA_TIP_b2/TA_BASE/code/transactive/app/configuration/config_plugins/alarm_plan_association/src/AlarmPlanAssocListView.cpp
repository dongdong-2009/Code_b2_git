/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/alarm_plan_association/src/AlarmPlanAssocListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    const CString AlarmPlanAssocListView::APPLIED_COLUMN_NAME = "Status";
    const CString AlarmPlanAssocListView::ALARMTYPE_COLUMN_NAME = "Alarm Type";
    const CString AlarmPlanAssocListView::ENTITYTYPE_COLUMN_NAME = "Entity Type";
    const CString AlarmPlanAssocListView::ENTITY_COLUMN_NAME = "Entity";
    const CString AlarmPlanAssocListView::PLAN_COLUMN_NAME = "Plan";
    ...
    const CString AlarmPlanAssocListView::NEW = "New";
    const CString AlarmPlanAssocListView::MODIFIED = "Modified";
    const CString AlarmPlanAssocListView::UPTODATE = "";
