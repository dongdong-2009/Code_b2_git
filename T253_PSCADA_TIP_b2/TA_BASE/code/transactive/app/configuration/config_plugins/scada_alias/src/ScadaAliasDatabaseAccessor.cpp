/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/scada_alias/src/ScadaAliasDatabaseAccessor.cpp $
  * @author:  Wu Mintao
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    std::map<CString,unsigned long> ScadaAliasDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
