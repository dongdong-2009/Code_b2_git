/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/message_type/src/MessageTypeDatabaseAccessor.cpp $
...
namespace TA_Base_App
{
    ...
    std::map<CString,unsigned long> MessageTypeDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
