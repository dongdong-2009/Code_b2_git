/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/message_type/src/TA_MessageTypeConfigPlugin.cpp $
...
{
    static AFX_EXTENSION_MODULE TA_MessageTypeConfigPluginDLL = { NULL, NULL };
    ...
    DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
    {
	    ...
	    {
		    TRACE0("TA_MESSAGETYPECONFIGPLUGIN.DLL Initializing!\n");
		    
		    // Extension DLL one-time initialization
		    if (!AfxInitExtensionModule(TA_MessageTypeConfigPluginDLL, hInstance))
			    return 0;
		    ...
		    new CDynLinkLibrary(TA_MessageTypeConfigPluginDLL);
	    }
	    else if (dwReason == DLL_PROCESS_DETACH)
	    {
		    TRACE0("TA_MESSAGETYPECONFIGPLUGIN.DLL Terminating!\n");
		    // Terminate the library before destructors are called
		    AfxTermExtensionModule(TA_MessageTypeConfigPluginDLL);
	    }
	    return 1;   // ok
    }
    ...
    /**
      ...
      *
      * @return IConfigurableComponent*		A new MessageTypeComponent object which implements
    ...
    {
	    return new MessageTypeComponent(componentName);
    }
