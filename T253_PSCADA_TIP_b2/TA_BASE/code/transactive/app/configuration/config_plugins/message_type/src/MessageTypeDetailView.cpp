/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/configuration/config_plugins/message_type/src/MessageTypeDetailView.cpp $
...
END_MESSAGE_MAP()
    ...
    void MessageTypeDetailView::populateItemDetails(TA_Base_Core::IConfigItem* currentItem)
    {
        ...
        try
        {
            ...
            m_name.SetWindowText( m_currentMessageType->getName().c_str() );
