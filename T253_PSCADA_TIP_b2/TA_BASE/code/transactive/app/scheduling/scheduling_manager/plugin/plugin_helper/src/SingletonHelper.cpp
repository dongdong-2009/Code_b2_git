/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/scheduling/scheduling_manager/plugin/plugin_helper/src/SingletonHelper.cpp $
...
{
    void SingletonHelper::initialiseUtilities( const TA_Base_Core::IDllHandler& handler, const std::string& dllName )
    {
