/**
  ...
  *
  * Source:    $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/scheduling/scheduling_agent/src/PlanRunnerJob.cpp $
  * @author:   Dirk McCormick
  * @version:  $Revision: #4 $
  *
  * Last modification: $DateTime: 2015/04/09 11:50:57 $
