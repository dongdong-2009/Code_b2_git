/**
  ...
  *
  * Source:    $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/scheduling/scheduling_agent/src/SchedulingAlarmSender.cpp $
  * @author:   Dirk McCormick
  * @version:  $Revision: #4 $
  *
  * Last modification: $DateTime: 2015/04/09 14:37:53 $
...
void SchedulingAlarmSender::jobExecutionFailed( const std::string& jobID, unsigned long minuteStarted, const std::string& jobDescription, const std::string& errorMessage)
{
    ...
    TA_Base_Core::NameValuePair errorMessagePair("ErrorMessage", errorMessage);
