/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/DataNodeListItem.h $
  * @author:  Alan Brims
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        /** 
          ...
          */
        DataNodeListItem(unsigned long entitykey, TA_Base_Bus::ScadaProxyFactory& proxyFactory, 
			HWND hwndToNotify);
        ...
        /** 
          ...
          *                         updates are posted up to the UI thread.
          */
        DataNodeListItem(boost::shared_ptr<TA_Base_Core::DataNodeEntityData> entityData , TA_Base_Bus::ScadaProxyFactory& proxyFactory, 
			HWND hwndToNotify);
