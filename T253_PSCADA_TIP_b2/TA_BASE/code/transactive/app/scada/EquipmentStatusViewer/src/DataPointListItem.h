/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/DataPointListItem.h $
  * @author:  Alan Brims
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        /** 
          ...
          */
        DataPointListItem(unsigned long entitykey, TA_Base_Bus::ScadaProxyFactory& proxyFactory,
			HWND hwndToNotify);

		DataPointListItem(boost::shared_ptr<TA_Base_Core::DataPointEntityData> dpEntityData, 
    ...
    protected:
		...
		virtual bool    UpdateTextIfChanged( EslColumns column, CString const& newText);
		virtual void	initStaticColumn();
    private:
		/** 
		 ...
		 */
        boost::shared_ptr<TA_Base_Core::DataNodeEntityData>              m_dataNodeEntity;	
        ...
        /** 
          ...
          */
	    void loadParentDataNode(unsigned long parentKey);
