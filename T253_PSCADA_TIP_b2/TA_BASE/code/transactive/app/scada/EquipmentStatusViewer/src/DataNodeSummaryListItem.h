/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/DataNodeSummaryListItem.h $
  * @author:  Alan Brims
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        /** 
          ...
          */
        DataNodeSummaryListItem(unsigned long entitykey, TA_Base_Bus::ScadaProxyFactory& proxyFactory, HWND hwndToNotify);
        ...
        /** 
          ...
          *                         updates are posted up to the UI thread.
          */
        DataNodeSummaryListItem(boost::shared_ptr<TA_Base_Core::DataNodeEntityData> entityData , 
