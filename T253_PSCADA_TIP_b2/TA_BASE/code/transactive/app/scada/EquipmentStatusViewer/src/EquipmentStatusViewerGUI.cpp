 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/EquipmentStatusViewerGUI.cpp $
 * @author:  Rod Rolirad
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_App
{
    ...
    void EquipmentStatusViewerGUI::checkEntity(TA_Base_Core::IEntityData* guiEntity)
    {
        ...
        {
            TA_THROW(GenericGUIException("Entity configuration is not of type Equipment Datapoint Status Viewer", 
