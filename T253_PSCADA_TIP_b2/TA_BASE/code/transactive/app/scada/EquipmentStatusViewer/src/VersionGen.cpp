/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/VersionGen.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
{
    char componentName[] = "Equipment Datapoint Status Viewer";
