 ...
 * in any form.
 *
 * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/EquipmentStatusViewer.cpp $
 * @author:  Rod Rolirad
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_App
{
	...
	CEquipmentStatusViewerApp::CEquipmentStatusViewerApp() : 
		TA_Base_Bus::TransActiveWinApp(new EquipmentStatusViewerGUI(), "Equipment Datapoint Status Viewer")
	{
	}

	BOOL CEquipmentStatusViewerApp::InitInstance()
	{
		HWND hWnd = ::FindWindow(NULL,"Equipment Datapoint Status Viewer"); 
		if (hWnd) 		
			return FALSE; 
		else
