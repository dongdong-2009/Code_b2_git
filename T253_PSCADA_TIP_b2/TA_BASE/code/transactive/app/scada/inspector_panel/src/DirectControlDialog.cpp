...
namespace TA_Base_App
{
    ...
    void CDirectControlDialog::OnConfirm() 
    {
        ...
        {           
            ...
            CString cstring;
            AfxFormatString1(cstring, IDS_NO_PERMISSION_MSG, dataPoint->getDescription().c_str());
            message << cstring;
		...
		try
		{
			if ( dataPoint->isControlInhibited() )
			{
                ...
                CString cstring;
                AfxFormatString1(cstring, IDS_CONTROL_INHIBITED_MSG, dataPoint->getDescription().c_str());
                message << cstring;
            ...
            CString cstring;
            AfxFormatString2(cstring, IDS_SET_NEW_VALUE_MSG, dataPoint->getDescription().c_str(), m_newValue.c_str());
            message2 << cstring;
		...
		catch (TA_Base_Core::ScadaProxyException &e)
		{
			...
			std::stringstream message;
            CString cstring;
            AfxFormatString2(cstring, IDS_SET_FAILED_PROXY_MSG, dataPoint->getDescription().c_str(), m_newValue.c_str());
            message << cstring;
		...
		catch (...)
		{
			...
			std::stringstream message;
            CString cstring;
            AfxFormatString2(cstring, IDS_SET_FAILED_UNKNOWN_MSG, dataPoint->getDescription().c_str(), m_newValue.c_str());
            message << cstring;
