/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/TA_BASE/transactive/app/scada/inspector_panel/src/OverrideDialog.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	void COverrideDialog::displayDataPoints()
	{
...
//		unsigned int nItem = m_equipment->getNotWriteableIndex().size();
