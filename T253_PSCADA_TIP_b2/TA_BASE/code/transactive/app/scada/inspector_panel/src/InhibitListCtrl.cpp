...
//		MMS_INHIBIT_COLUMN			= 6,
  ...
  // 		this->InsertColumn(CONTROL_INHIBIT_COLUMN,		"Ctrl");
		...
		this->InsertColumn(CONTROL_INHIBIT_COLUMN, StringTableHelper(IDS_CONTROL_COLUMN), LVCFMT_CENTER);
		this->InsertColumn(SCAN_INHIBIT_COLUMN, StringTableHelper(IDS_SCAN_COLUMN), LVCFMT_CENTER);
		this->InsertColumn(ALARM_INHIBIT_COLUMN, StringTableHelper(IDS_ALARM_COLUMN), LVCFMT_CENTER);
		//this->InsertColumn(MMS_INHIBIT_COLUMN,			"MMS");
		this->InsertColumn(CURRENT_VALUE_COLUMN, StringTableHelper(IDS_CURRENT_VALUE_COLUMN));
				...
				{	
					...
					if ((strValue == "Yes") != prevInhibitState)
					{
						...
						if (inhibitOverrideConfirm(IDS_SCAN_INHIBIT, dataPoint, (strValue == "Yes")))
						{
                            ...
                            statusLine << StringTableHelper(IDS_SCAN_INHIBIT_MSG) << ((strValue == "Yes") ? StringTableHelper(IDS_ON_MSG) : StringTableHelper(IDS_OFF_MSG));
				...
				case ALARM_INHIBIT_COLUMN:
				{
					...
					if ((strValue == "Yes") != prevInhibitState) 
					{
						...
						if (inhibitOverrideConfirm(IDS_ALARM_INHIBIT, dataPoint, (strValue == "Yes")))
						{
                            ...
                            statusLine << StringTableHelper(IDS_ALARM_INHIBIT_MSG) << ((strValue == "Yes") ? StringTableHelper(IDS_ON_MSG) : StringTableHelper(IDS_OFF_MSG));
				...
				case CONTROL_INHIBIT_COLUMN:
				{
					...
					if ((strValue == "Yes") != dataPoint->isControlInhibited())
					{
						...
						if (inhibitOverrideConfirm(IDS_CONTROL_INHIBIT, dataPoint, (strValue == "Yes")))
						{
                            ...
                            statusLine << StringTableHelper(IDS_CONTROL_INHIBIT_MSG) << ((strValue == "Yes") ? StringTableHelper(IDS_ON_MSG) : StringTableHelper(IDS_OFF_MSG));
