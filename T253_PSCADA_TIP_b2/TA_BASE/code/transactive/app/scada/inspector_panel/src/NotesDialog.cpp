		...
		if (m_equipment != NULL)
		{
			...
			if (selectedButton == IDYES)
			{
				...
				catch (TA_Base_Core::ScadaProxyException &e)
				{
					...
					statusLine << StringTableHelper(IDS_NOTE_REMOVE_FAILED) << e.what();
					//  [3/14/2010 benxun]
				...
				catch (...)
				{
					...
					statusLine << StringTableHelper(IDS_NOTE_REMOVE_FAILED_UNKNOWN);
					//  [3/14/2010 benxun]
					std::string* statusLineStr = new std::string(statusLine.str());
					AfxGetApp()->m_pMainWnd->PostMessage(UPDATE_STATUS_WINDOW_MESSAGE, reinterpret_cast<UINT>(statusLineStr), 0);
				...
				statusLine << StringTableHelper(IDS_NOTE_REMOVE_SUCCESS);
				//  [3/14/2010 benxun]
				std::string* statusLineStr = new std::string(statusLine.str());
				AfxGetApp()->m_pMainWnd->PostMessage(UPDATE_STATUS_WINDOW_MESSAGE, reinterpret_cast<UINT>(statusLineStr), 0);
				//TDCL-20167 tianxiang++
	...
	bool CNotesDialog::updateNotes()
	{
		...
		if (m_equipment != NULL)
		{
			...
			catch (TA_Base_Core::ScadaProxyException &e)
			{
				...
				statusLine << StringTableHelper(IDS_NOTE_ADD_FAILED) <<e.what();
				//  [3/14/2010 benxun]
				std::string* statusLineStr = new std::string(statusLine.str());
				AfxGetApp()->m_pMainWnd->PostMessage(UPDATE_STATUS_WINDOW_MESSAGE, reinterpret_cast<UINT>(statusLineStr), 0);
				//TDCL-20167 tianxiang++
			...
			catch(...)
			{
				...
				statusLine << StringTableHelper(IDS_NOTE_ADD_FAILED_UNKNOWN);
				//  [3/14/2010 benxun]
				std::string* statusLineStr = new std::string(statusLine.str());
				AfxGetApp()->m_pMainWnd->PostMessage(UPDATE_STATUS_WINDOW_MESSAGE, reinterpret_cast<UINT>(statusLineStr), 0);
			...
			statusLine << StringTableHelper(IDS_NOTE_ADD_SUCCESS);
			//  [3/14/2010 benxun]
			std::string* statusLineStr = new std::string(statusLine.str());
			AfxGetApp()->m_pMainWnd->PostMessage(UPDATE_STATUS_WINDOW_MESSAGE, reinterpret_cast<UINT>(statusLineStr), 0);
			//TDCL-20167 tianxiang++
