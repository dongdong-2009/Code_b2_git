...
namespace TA_Base_App
{
	...
	{
        SetWindowText((LPCTSTR)_T(StringTableHelper(IDS_CONFIRM_CANCLE)));
		GetDlgItem(IDC_STATIC1)->SetWindowText((LPCTSTR)_T(StringTableHelper(IDS_EQUIPMENT)));
		GetDlgItem(IDC_STATIC2)->SetWindowText((LPCTSTR)_T(StringTableHelper(IDS_CONTROL_POINT)));
		GetDlgItem(IDC_STATIC3)->SetWindowText((LPCTSTR)_T(StringTableHelper(IDS_CONTROL_ACTION)));
		GetDlgItem(IDC_STATIC4)->SetWindowText((LPCTSTR)_T(StringTableHelper(IDS_CONTROL_INFO)));

		GetDlgItem(IDOK)->SetWindowText((LPCTSTR)_T(StringTableHelper(IDS_CONFIRM)));
		GetDlgItem(IDCANCEL)->SetWindowText((LPCTSTR)_T(StringTableHelper(IDS_CANCEL)));
	}
}
