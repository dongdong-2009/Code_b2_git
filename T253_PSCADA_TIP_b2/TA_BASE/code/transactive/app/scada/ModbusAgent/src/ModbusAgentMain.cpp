/**
  ...
  * any form.
  *
  * Source:		$File: //depot/3002_TIP/3002/transactive/app/scada/ModbusAgent/src/ModbusAgentMain.cpp $
  * @author:	Dhanshri
  * @version:	$Revision: #1 $
  *
  ...
  * Description:
  *
  *	Main program for ModbusAgent process
  *
  */
...
int main( int argc, char * argv[] )
{
	try
	{
		...
		TA_IRS_App::ModbusAgent ModbusAgent( argc, argv );
		ModbusAgent.startModbusAgent();
	}
