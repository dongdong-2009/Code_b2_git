/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/security/DutyManager/src/DutyManagerGUI.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
void DutyManagerGUI::createApplicationObject()
{
    ...
    TA_THROW(TA_Base_Core::GenericGUIException("Rights Manager initialisation failed.", 
