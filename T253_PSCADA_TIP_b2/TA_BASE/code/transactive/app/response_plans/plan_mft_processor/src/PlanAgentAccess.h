...
#if !defined(AFX_MFTPLANAGENTACCESS_H__A514BE67_87EF_46C0_A8BB_869EF214256A__INCLUDED_)
#define AFX_MFTPLANAGENTACCESS_H__A514BE67_87EF_46C0_A8BB_869EF214256A__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class PlanAgentAccess : public IMftPlanAgentAccess
    {
    public:
        ...
        virtual std::string getNodePath( const unsigned long ulLocationKey, const unsigned long nodeId );
        virtual unsigned long getStepPosition( const unsigned long ulLocationKey, const unsigned long ulPlanNodeId, const unsigned long ulStepId );
        virtual void processStepResponse( const TA_Base_Core::ActivePlanId& planId, TA_Base_Core::InteractiveStepData& stepDetail );
