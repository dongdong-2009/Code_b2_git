...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/common/src/StringConstants.h $
// @author:  Mahaveer Pareek
// @version: $Revision: #7 $
//
// Last modification: $DateTime: 2015/06/11 10:27:14 $
...
const char* const RemarkPlanPausedByFailure = "Plan paused due to step(s) failure";
...
const char* const RemarkStepExecutionPaused = "Step paused by operator";
...
const char* const RemarkPlanExecuting = "Plan executing";
const char* const RemarkPlanResumed = "Plan resumed";
const char* const RemarkPlanExpired = "Plan expired";
const char* const RemarkPlanPending = "Customization in progress";
...
const char* const RemarkSyncFailedByPausedSteps = "Step synchronization failed due to paused step(s)";
const char* const RemarkPlanNotCompleted = "Sub-plan could not be completed";
