...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanAgentUser.h $
...
namespace TA_Base_App
{
	...
	public:
		...
		time_t getActivePlanExpiryTime() { return m_activePlanExpiryTime; }
