/**
  ...
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/response_plans/plan_agent/src/DatapointTriggerObserver.cpp $
  * @author:  Huang Qi
  * @version: $Revision: #2 $
  *
...
void DatapointTriggerObserver::processEntityUpdateEvent( unsigned long entityKey, TA_Base_Bus::ScadaEntityUpdateType updateType )
{
    ...
    try
    {
        ...
        const unsigned long ulCurTimestamp = time( 0 );
