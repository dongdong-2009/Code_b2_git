...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanDataWriter.h $
...
namespace TA_Base_App
{
	...
	//Plan Edit methods
        ...
        void getEditPlanLock( const std::string& session, TA_Base_Core::NodeId plan, bool noDBAccess = false );
		...
		void insertPlan(const std::string& session, const TA_Base_Core::NodeId parent, TA_Base_Core::ENode nodeType);
