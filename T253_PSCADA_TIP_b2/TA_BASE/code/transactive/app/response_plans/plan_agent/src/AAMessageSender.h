...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_agent/src/AAMessageSender.h $
...
namespace TA_Base_App
{
    ...
    class AAMessageSenderImpl: public IMessageSender
	{
	// Public methods
	public:
        ...
        virtual void sendAuditMessage(const std::string& session, const TA_Base_Core::MessageType& auditMessageType, const std::vector<TA_Base_Core::NameValuePair*>& description);
