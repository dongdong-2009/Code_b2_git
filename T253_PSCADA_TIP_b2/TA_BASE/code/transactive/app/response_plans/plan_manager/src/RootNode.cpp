...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/RootNode.cpp $
// @author:  Bart Golab
// @version: $Revision: #4 $
//
...
bool RootNode::isEnable(const int nAction)
{
...
void RootNode::newPlan(TA_Base_Core::ENode nodeType)
{
    FUNCTION_ENTRY( "newPlan" );

    // Create new plan associated with this node
    PlanAgentAccess::getInstance().addPlanToRoot(nodeType);
