...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanManagerGUI.cpp $
// @author:  Bart Golab
// @version: $Revision: #7 $
//
...
void PlanManagerGUI::createApplicationObject()
{
    ...
    TA_Base_Bus::PlanInternetional::initLocaleEnglish();
