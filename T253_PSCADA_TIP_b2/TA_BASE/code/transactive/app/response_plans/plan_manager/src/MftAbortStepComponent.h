#ifndef __MFT_ABORT_STEP_COMPONENT_H_
#define __MFT_ABORT_STEP_COMPONENT_H_
...
{
    class  MftAbortStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftAbortStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftAbortStepComponentImpl();
        ~MftAbortStepComponentImpl();
        MftAbortStepComponentImpl( const MftAbortStepComponentImpl& );
        MftAbortStepComponentImpl& operator=( const MftAbortStepComponentImpl& );

    };

    typedef ACE_Singleton<MftAbortStepComponentImpl, ACE_Recursive_Thread_Mutex> MftAbortStepComponent;
}
