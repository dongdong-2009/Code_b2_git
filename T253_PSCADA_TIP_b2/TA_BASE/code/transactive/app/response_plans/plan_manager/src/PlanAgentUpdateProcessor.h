/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanAgentUpdateProcessor.h $
  * @author:  Bart Golab
  * @version: $Revision: #8 $
  *
  * Last modification: $DateTime: 2015/05/12 16:47:40 $
...
namespace TA_Base_App
{
    ...
    protected:
        ...
        void processActivePlanReset( const unsigned long ulLocationKey );
        ...
        void processActiveStepDetailUpdate(const TA_Base_Core::PlanExecuteStepUpdate& activePlanDetail);
