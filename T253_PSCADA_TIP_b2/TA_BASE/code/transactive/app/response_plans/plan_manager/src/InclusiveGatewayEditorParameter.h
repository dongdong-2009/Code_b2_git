...
class IPlanNode;
class InclusiveGatewayExpressionPairsGridEditor : public IGridEditor, public IStringEditor, public IListPicker
{
public:
	InclusiveGatewayExpressionPairsGridEditor(std::vector<ExpressionPair>& stepExpressionPairs, IPlanNode& refPlanNode);
	~InclusiveGatewayExpressionPairsGridEditor();
	// IGridEditor
	...
	std::vector<ExpressionPair> getInclusiveGatewayExpressionPairs();
...
class InclusiveGatewayEditorParameter : public InteractiveParameter
{
public:
    InclusiveGatewayEditorParameter(ConditionalGatewayParameter& refParameter, IPlanNode& refPlanNode);
...
private:
	InclusiveGatewayExpressionPairsGridEditor m_expressionPairsGridEditor;
