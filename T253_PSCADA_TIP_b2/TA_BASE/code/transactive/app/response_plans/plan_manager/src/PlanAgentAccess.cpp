...
TA_Base_Core::SequenceFlows * TA_Base_App::PlanAgentAccess::getSequenceFlows( TA_Base_Core::NodeId planNodeId )
{
    ...
    PAA_BEGIN_TRY
    {
        TA_Base_Core::SequenceFlows_var sequenceFlowsVar;

        // TD15049++
        m_planAgentMap.getDefaultPlanAgent().setPlanAgentTimeout( PLAN_AGENT_PLAN_MEDIUM_TIMEOUT );
        // ++TD15049
        m_planAgentMap.getDefaultPlanAgent().getSequenceFlows( planNodeId, sequenceFlowsVar.out() );

        FUNCTION_EXIT;
        return sequenceFlowsVar._retn();
    }
    PAA_END_TRY( getSequenceFlows );
...
TA_Base_Core::ParameterNames *PlanAgentAccess::getParameterNames(const int stepType)
{
...
std::vector<std::string> PlanAgentAccess::getStepParameters(TA_Base_Core::StepId stepId)
{
    ...
    PAA_BEGIN_TRY
    {
        ...
        m_planAgentMap.getDefaultPlanAgent().setPlanAgentTimeout(PLAN_AGENT_PLAN_MEDIUM_TIMEOUT);
        // ++TD15049
		m_planAgentMap.getDefaultPlanAgent().getParametersByStepId(stepId, stepParametersVar.out());

        for ( size_t szLoop = 0u; szLoop < stepParametersVar->length(); ++szLoop )
        {
            vecParameters.push_back( stepParametersVar[szLoop].in() );
        }
    }
...
TA_Base_Core::StepParameters *PlanAgentAccess::getStepParameters(TA_Base_Core::NodeId planNodeId, TA_Base_Core::StepNumber stepNumber)
{
    ...
    PAA_BEGIN_TRY
    {
        ...
        m_planAgentMap.getDefaultPlanAgent().setPlanAgentTimeout(PLAN_AGENT_PLAN_MEDIUM_TIMEOUT);
        // ++TD15049
		m_planAgentMap.getDefaultPlanAgent().getParametersByStepNumber(planNodeId, stepNumber, stepParametersVar.out());
...
TA_Base_Core::NodeIds *PlanAgentAccess::getNodeIdsInNodePath(const unsigned long nodeId)
{
...
TA_Base_Core::StepNumber PlanAgentAccess::getStepPosition(TA_Base_Core::NodeId planId, TA_Base_Core::StepId stepId)
{
    ...
    PAA_BEGIN_TRY
    {
        ...
        m_planAgentMap.getDefaultPlanAgent().setPlanAgentTimeout(PLAN_AGENT_PLAN_MEDIUM_TIMEOUT);
        // ++TD15049
        m_planAgentMap.getDefaultPlanAgent().getStepPosition(planId, stepId, stepNumber);

        FUNCTION_EXIT;
        return stepNumber;
    }
    PAA_END_TRY(getStepPosition);
}
...
TA_Base_Core::ActivePlanStepsDetails *PlanAgentAccess::getAllActivePlanDetails()
{
...
TA_Base_Core::ActivePlanStepsDetails *PlanAgentAccess::getAllActivePlanDetailsAtLocation(unsigned long location)
{
...
void PlanAgentAccess::addPlan(TA_Base_Core::NodeId categoryNodeId, TA_Base_Core::ENode nodeType)
{
    ...
    PAA_BEGIN_TRY
    {
        ...
        m_planAgentMap.getDefaultPlanAgent().setPlanAgentTimeout(PLAN_AGENT_PLAN_LONG_TIMEOUT);
        // ++TD15049
        m_planAgentMap.getDefaultPlanAgent().insertPlan(getSessionId().c_str(), categoryNodeId, nodeType);
    }
...
void PlanAgentAccess::addPlanToRoot(TA_Base_Core::ENode nodeType)
{
    ...
    PAA_BEGIN_TRY
    {
        ...
        m_planAgentMap.getDefaultPlanAgent().setPlanAgentTimeout(PLAN_AGENT_PLAN_LONG_TIMEOUT);
        // ++TD15049
        m_planAgentMap.getDefaultPlanAgent().insertPlanIntoRoot(getSessionId().c_str(), nodeType);
    }
...
void PlanAgentAccess::updatePlanDetail( TA_Base_Core::PlanDetail planDetail )
{
    FUNCTION_ENTRY( "updateCategory" );
    ...
    PAA_BEGIN_TRY
    {
        ...
        m_planAgentMap.getDefaultPlanAgent().setPlanAgentTimeout( PLAN_AGENT_PLAN_LONG_TIMEOUT );
        // ++TD15049
        m_planAgentMap.getDefaultPlanAgent().updatePlanDetail( getSessionId().c_str(), planDetail );
    }
    PAA_END_TRY( updateCategoryDetail );
