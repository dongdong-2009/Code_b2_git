...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanBrowserDoc.h $
// @author:  Bart Golab
// @version: $Revision: #8 $
//
...
namespace TA_Base_App
{
    ...
    public:
        ...
        virtual void activePlanCleared(const unsigned long ulLocationKey);
        virtual void activePlanStateChanged(const TA_Base_Core::ActivePlanDetail &activePlanDetail);
        virtual void activeStepStateChanged(const TA_Base_Core::PlanExecuteStepUpdate &activePlanDetail);
    ...
    private:
        ...
        typedef CViewUpdate<unsigned long> ActivePlanClearedUpdate;
        typedef CViewUpdate<TA_Base_Core::ActivePlanDetail> ActivePlanDetailUpdate;
        typedef CViewUpdate<TA_Base_Core::PlanExecuteStepUpdate> ActiveStepDetailUpdate;
        ...
        SynchronisedQueue<ActivePlanClearedUpdate*> m_activePlanClearedUpdateQueue;
        SynchronisedQueue<ActivePlanDetailUpdate*> m_activePlanDetailUpdateQueue;
        SynchronisedQueue<ActiveStepDetailUpdate*> m_activeStepDetailUpdateQueue;
    ...
    protected:
        ...
        afx_msg void OnActiveStepDetailUpdate();
        afx_msg void OnActivePlanClearedUpdate();
