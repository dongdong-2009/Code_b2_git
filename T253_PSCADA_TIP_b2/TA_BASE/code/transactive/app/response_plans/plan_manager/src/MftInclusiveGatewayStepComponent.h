#ifndef __MFT_INCLUSIVE_GATEWAY_STEP_COMPONENT_H_
#define __MFT_INCLUSIVE_GATEWAY_STEP_COMPONENT_H_
...
{
    class  MftInclusiveGatewayStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftInclusiveGatewayStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftInclusiveGatewayStepComponentImpl();
        ~MftInclusiveGatewayStepComponentImpl();
        MftInclusiveGatewayStepComponentImpl( const MftInclusiveGatewayStepComponentImpl& );
        MftInclusiveGatewayStepComponentImpl& operator=( const MftInclusiveGatewayStepComponentImpl& );

    };

    typedef ACE_Singleton<MftInclusiveGatewayStepComponentImpl, ACE_Recursive_Thread_Mutex> MftInclusiveGatewayStepComponent;
}
