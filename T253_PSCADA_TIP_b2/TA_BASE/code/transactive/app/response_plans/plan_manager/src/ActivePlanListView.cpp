...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/ActivePlanListView.cpp $
// @author:  Bart Golab
// @version: $Revision: #5 $
//
...
void CActivePlanListView::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
    ...
    if (pesUpdate)
    {
        SendMessageToDescendants(WM_ACTIVE_STEP_DETAIL_UPDATE, (WPARAM) &pesUpdate->GetUpdateData(), 0);
...
CActivePlanDoc* CActivePlanListView::GetDocument()
{
