#ifndef __MFT_END_STEP_COMPONENT_H_
#define __MFT_END_STEP_COMPONENT_H_
...
{
    class  MftEndStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftEndStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftEndStepComponentImpl();
        ~MftEndStepComponentImpl();
        MftEndStepComponentImpl( const MftEndStepComponentImpl& );
        MftEndStepComponentImpl& operator=( const MftEndStepComponentImpl& );

    };

    typedef ACE_Singleton<MftEndStepComponentImpl, ACE_Recursive_Thread_Mutex> MftEndStepComponent;
}
