...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanStepPastePositionDlg.cpp $
// @author:  Bart Golab
// @version: $Revision: #5 $
//
...
CPlanStepPastePositionDlg::CPlanStepPastePositionDlg(bool disableBeforeSelection, bool disableAfterSelection, CWnd* pParent /*=NULL*/) :
...
BOOL CPlanStepPastePositionDlg::OnInitDialog()
{
    ...
    GetDlgItem(IDC_PASTE_BEFORE_SELECTION_RADIO)->EnableWindow(!m_disableBeforeSelection);
    GetDlgItem(IDC_PASTE_AFTER_SELECTION_RADIO)->EnableWindow(!m_disableAfterSelection);
	CheckDlgButton(m_disableAfterSelection ? IDC_PASTE_BEFORE_SELECTION_RADIO : IDC_PASTE_AFTER_SELECTION_RADIO, BST_CHECKED);
