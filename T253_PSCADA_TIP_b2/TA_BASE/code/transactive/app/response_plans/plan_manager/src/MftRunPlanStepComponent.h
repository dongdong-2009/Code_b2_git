#ifndef __MFT_RUN_PLAN_STEP_COMPONENT_H_
#define __MFT_RUN_PLAN_STEP_COMPONENT_H_
...
{
    class  MftRunPlanStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftRunPlanStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftRunPlanStepComponentImpl();
        ~MftRunPlanStepComponentImpl();
        MftRunPlanStepComponentImpl( const MftRunPlanStepComponentImpl& );
        MftRunPlanStepComponentImpl& operator=( const MftRunPlanStepComponentImpl& );

    };

    typedef ACE_Singleton<MftRunPlanStepComponentImpl, ACE_Recursive_Thread_Mutex> MftRunPlanStepComponent;
}
