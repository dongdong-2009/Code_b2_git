...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/AbstractToolBarManager.cpp $
// @author:  Bart Golab
// @version: $Revision: #4 $
//
// Last modification: $DateTime: 2016/01/25 18:18:01 $
...
CToolBar *AbstractToolBarManager::createToolBar(UINT toolBarID)
{
    ...
    toolBar->CreateEx(m_toolBarParent, style1, style2, CRect(0,0,0,0));
