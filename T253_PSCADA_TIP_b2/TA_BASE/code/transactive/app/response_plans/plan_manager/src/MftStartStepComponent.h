...
{
class  MftStartStepComponentImpl: public EditorStepComponent, public IActivityComponent
{

public:
    friend class ACE_Singleton<MftStartStepComponentImpl, ACE_Recursive_Thread_Mutex>;
...
private:
    MftStartStepComponentImpl();
    ~MftStartStepComponentImpl();
    MftStartStepComponentImpl(const MftStartStepComponentImpl&);
    MftStartStepComponentImpl& operator=(const MftStartStepComponentImpl&);

};

typedef ACE_Singleton<MftStartStepComponentImpl, ACE_Recursive_Thread_Mutex> MftStartStepComponent;
}