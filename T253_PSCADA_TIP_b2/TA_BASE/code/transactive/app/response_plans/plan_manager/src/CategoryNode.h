...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/CategoryNode.h $
// @author:  Bart Golab
// @version: $Revision: #4 $
//
...
namespace TA_Base_App
{
    ...
    public:
        ...
        virtual void newPlan(TA_Base_Core::ENode nodeType);
