...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/LabelMaker.cpp $
// @author:  Bart Golab
// @version: $Revision: #2 $
//
// Last modification: $DateTime: 2015/03/03 17:46:14 $
...
CString LabelMaker::getStepListRemarkColumnLabel()
{
    FUNCTION_ENTRY("getStepListRemarkColumnLabel");
    FUNCTION_EXIT;
    return getLabel(IDS_STEP_LIST_REMARK_COLUMN, "Remark");
}
