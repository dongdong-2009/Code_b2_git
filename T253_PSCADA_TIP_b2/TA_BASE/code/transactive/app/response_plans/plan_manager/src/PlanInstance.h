...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanInstance.h $
// @author:  Bart Golab
// @version: $Revision: #7 $
//
// Last modification: $DateTime: 2014/12/16 18:07:43 $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        void getStepExecDetails( std::vector<TA_Base_Core::ActiveStepDetail>& vecDetails );
        ...
        virtual void update(const TA_Base_Core::PlanExecuteStepUpdate &activeStepDetail);
