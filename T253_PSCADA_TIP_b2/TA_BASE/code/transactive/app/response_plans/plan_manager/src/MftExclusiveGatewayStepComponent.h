#ifndef __MFT_EXCLUSIVE_GATEWAY_STEP_COMPONENT_H_
#define __MFT_EXCLUSIVE_GATEWAY_STEP_COMPONENT_H_
...
{
    class  MftExclusiveGatewayStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftExclusiveGatewayStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftExclusiveGatewayStepComponentImpl();
        ~MftExclusiveGatewayStepComponentImpl();
        MftExclusiveGatewayStepComponentImpl( const MftExclusiveGatewayStepComponentImpl& );
        MftExclusiveGatewayStepComponentImpl& operator=( const MftExclusiveGatewayStepComponentImpl& );

    };

    typedef ACE_Singleton<MftExclusiveGatewayStepComponentImpl, ACE_Recursive_Thread_Mutex> MftExclusiveGatewayStepComponent;
}
