...
namespace TA_Base_App
{
    ...
    template <typename KeyType, typename ItemType>
    KeyType TA_Base_App::SynchronisedMap<KeyType, ItemType>::frontKey()
    {
        TA_Base_Core::ThreadGuard mapLock(*this);
    ...
    template <typename KeyType, typename ItemType>
    ItemType& TA_Base_App::SynchronisedMap<KeyType, ItemType>::back()
    {
        TA_Base_Core::ThreadGuard mapLock( *this );
    ...
    template <typename KeyType, typename ItemType>
    KeyType TA_Base_App::SynchronisedMap<KeyType, ItemType>::backKey()
    {
        TA_Base_Core::ThreadGuard mapLock( *this );
