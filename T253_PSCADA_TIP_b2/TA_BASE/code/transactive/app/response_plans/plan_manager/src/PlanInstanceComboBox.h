...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanInstanceComboBox.h $
// @author:  Bart Golab
// @version: $Revision: #2 $
//
...
namespace TA_Base_App
{
    ...
    public:
        ...
        virtual void AddInstance(const TA_Base_Core::NodeId& planId, const PlanInstanceId& instanceId);
        virtual void RemoveInstance(const PlanInstanceId &planInstanceId);
        virtual void RemoveInstances(const unsigned long ulLocationKey);
