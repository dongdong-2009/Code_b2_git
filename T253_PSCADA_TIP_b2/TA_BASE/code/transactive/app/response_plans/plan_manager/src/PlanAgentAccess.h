...
#include <string>
#include "app/response_plans/plan_step_plugin/common_editor/src/IPlanAgentAccess.h"
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /**
          ...
          * @exception    PlanDataAccessException
          */
        TA_Base_Core::SequenceFlows *getSequenceFlows(TA_Base_Core::NodeId planNodeId);
        ...
        /**
          ...
          * @exception    PlanDataAccessException
          */
        TA_Base_Core::ParameterNames *getParameterNames(const int stepType);
        ...
        /**
          ...
          * @exception    PlanDataAccessException
          */
        virtual std::vector<std::string> getStepParameters( const unsigned long stepId );

        //TA_Base_Core::StepParameterSeq *getStepParametersSeq(TA_Base_Core::StepId stepId);
        ...
        /**
          ...
          * @exception    PlanDataAccessException
          */
        virtual std::string getNodePath(const unsigned long nodeId);
        ...
        /**
          ...
          * @exception    PlanDataAccessException
          */
        TA_Base_Core::StepNumber getStepPosition(TA_Base_Core::NodeId planId, TA_Base_Core::StepId stepId);
        ...
        /**
          ...
          * @exception    PlanDataAccessException
          */
        TA_Base_Core::ActivePlanStepsDetails *getAllActivePlanDetails();
        ...
        /**
          ...
          * @exception    PlanDataAccessException
          */
        TA_Base_Core::ActivePlanStepsDetails *getAllActivePlanDetailsAtLocation(unsigned long location);
        ...
        *
        ...
        /** addPlan
          ...
          * @exception    PlanDataEditException
          */
        void addPlan(TA_Base_Core::NodeId categoryNodeId, TA_Base_Core::ENode nodeType);
        ...
        /** addPlanToRoot
          ...
          * @exception    PlanDataEditException
          */
        void addPlanToRoot(TA_Base_Core::ENode nodeType);
        ...
        * @exception    PlanDataEditException
        */
        void updatePlanDetail( TA_Base_Core::PlanDetail planDetail );
