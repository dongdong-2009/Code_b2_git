...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/CategoryNodeView.cpp $
// @author:  Bart Golab
// @version: $Revision: #5 $
//
// Last modification: $DateTime: 2015/09/29 10:12:43 $
...
void CCategoryNodeView::PostNcDestroy()
{
    ...
    if (::IsWindow(m_categoryListCtrl.GetSafeHwnd()))
    {
        m_categoryListCtrl.DestroyWindow();
    }
