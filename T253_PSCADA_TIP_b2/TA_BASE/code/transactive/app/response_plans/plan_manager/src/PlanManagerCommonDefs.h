...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanManagerCommonDefs.h $
// @author:  Bart Golab
// @version: $Revision: #3 $
//
...
namespace TA_Base_App
{
    ...
    #define WM_PLAN_MODIFIED                            (WM_USER + 700)
    #define WM_WORK_FLOW_EDITOR_CMD                     (WM_USER + 710)
    #define WM_WORK_FLOW_EDITOR_CMD_UI_UPDATE           (WM_USER + 720)
    #define WM_PLAN_SAVING                              (WM_USER + 730)
    #define WM_PLAN_NODE_TYPE_UPGRADE                    (WM_USER + 731)
