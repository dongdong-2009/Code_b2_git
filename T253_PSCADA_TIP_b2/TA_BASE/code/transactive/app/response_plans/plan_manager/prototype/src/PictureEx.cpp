/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/prototype/src/PictureEx.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
{
    FUNCTION_ENTRY( "ResetDataPointer" );
...
{
    FUNCTION_ENTRY( "SkipNextGraphicBlock" );
...
{
    FUNCTION_ENTRY( "GetSubBlocksLen" );
...
{
    FUNCTION_ENTRY( "GetNextBlockLen" );
...
{
    FUNCTION_ENTRY( "_ThreadAnimation" );
...
{
    FUNCTION_ENTRY( "ThreadAnimation" );
...
HGLOBAL CPictureEx::GetNextGraphicBlock(UINT *pBlockLen,
    ...
    UINT *pDisposal)
{
    FUNCTION_ENTRY( "GetNextGraphicBlock" );
...
{
    FUNCTION_ENTRY( "WriteDataOnDisk" );
