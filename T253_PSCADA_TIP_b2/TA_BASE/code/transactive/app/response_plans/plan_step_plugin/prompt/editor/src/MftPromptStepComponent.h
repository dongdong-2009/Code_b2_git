...
{
    class MftPromptStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftPromptStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftPromptStepComponentImpl();
        ~MftPromptStepComponentImpl();
        MftPromptStepComponentImpl( const MftPromptStepComponentImpl& );
        MftPromptStepComponentImpl& operator=( const MftPromptStepComponentImpl& );

    };

    typedef ACE_Singleton<MftPromptStepComponentImpl, ACE_Recursive_Thread_Mutex> MftPromptStepComponent;
}
