...
{
    ActiveVmsBlankoutStep::ActiveVmsBlankoutStep(const BasicParameter& detail, IActivePlan& flowControl)
		: ActiveStep(m_params, flowControl),
	      m_params(detail)
    {
    }

    ActiveVmsBlankoutStep::~ActiveVmsBlankoutStep()
    {
    }

    bool ActiveVmsBlankoutStep::executeImpl()
    {
