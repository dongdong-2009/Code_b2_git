/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/PAStationZones.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    class CPAStationZones : public CPlanStepParameterEditDlg
    {
        // Construction
    public:
        CPAStationZones(CString stationName, unsigned long stationLocationKey, StationStepParameter& parameter, bool canEdit, const std::map<unsigned long, std::string>& mapLocations);
