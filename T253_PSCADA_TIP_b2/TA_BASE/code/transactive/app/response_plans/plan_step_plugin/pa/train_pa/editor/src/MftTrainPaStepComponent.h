#ifndef __MFT_TRAIN_PA_STEP_COMPONENT_H_
#define __MFT_TRAIN_PA_STEP_COMPONENT_H_
...
{
    class MftTrainPaStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftTrainPaStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftTrainPaStepComponentImpl();
        ~MftTrainPaStepComponentImpl();
        MftTrainPaStepComponentImpl( const MftTrainPaStepComponentImpl& );
        MftTrainPaStepComponentImpl& operator=( const MftTrainPaStepComponentImpl& );

    };

    typedef ACE_Singleton<MftTrainPaStepComponentImpl, ACE_Recursive_Thread_Mutex> MftTrainPaStepComponent;
}
