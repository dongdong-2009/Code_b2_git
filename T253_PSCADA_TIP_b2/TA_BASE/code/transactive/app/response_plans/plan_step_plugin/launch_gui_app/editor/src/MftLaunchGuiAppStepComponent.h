#ifndef __MFT_LAUNCH_GUI_APP_STEP_COMPONENT_H_
#define __MFT_LAUNCH_GUI_APP_STEP_COMPONENT_H_
...
{
    class MftLaunchGuiAppStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftLaunchGuiAppStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftLaunchGuiAppStepComponentImpl();
        ~MftLaunchGuiAppStepComponentImpl();
        MftLaunchGuiAppStepComponentImpl( const MftLaunchGuiAppStepComponentImpl& );
        MftLaunchGuiAppStepComponentImpl& operator=( const MftLaunchGuiAppStepComponentImpl& );

    };

    typedef ACE_Singleton<MftLaunchGuiAppStepComponentImpl, ACE_Recursive_Thread_Mutex> MftLaunchGuiAppStepComponent;
}
