#ifndef __MFT_EXECUTE_SCRIPT_STEP_COMPONENT_H_
#define __MFT_EXECUTE_SCRIPT_STEP_COMPONENT_H_
...
{
    class MftExecuteScriptStepComponentImpl: public EditorStepComponent, IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftExecuteScriptStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftExecuteScriptStepComponentImpl();
        ~MftExecuteScriptStepComponentImpl();
        MftExecuteScriptStepComponentImpl( const MftExecuteScriptStepComponentImpl& );
        MftExecuteScriptStepComponentImpl& operator=( const MftExecuteScriptStepComponentImpl& );

    };

    typedef ACE_Singleton<MftExecuteScriptStepComponentImpl, ACE_Recursive_Thread_Mutex> MftExecuteScriptStepComponent;
}
