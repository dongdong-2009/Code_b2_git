...
{
    ActiveVmsSetSceneStep::ActiveVmsSetSceneStep(const BasicParameter& detail, IActivePlan& flowControl)
		: ActiveStep(m_params, flowControl),
          m_params(detail)
    {
    }

    ActiveVmsSetSceneStep::~ActiveVmsSetSceneStep()
    {
    }

    bool ActiveVmsSetSceneStep::executeImpl()
    {
