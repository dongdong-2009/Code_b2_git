...
// in any form.
//
// Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/DecisionDlg.h $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
namespace TA_Base_App
{
    ...
    public:
		CDecisionDlg(const int eType, const unsigned int ulLocation, const unsigned int ulPlanId, 
