#ifndef __MFT_DECISION_STEP_COMPONENT_H_
#define __MFT_DECISION_STEP_COMPONENT_H_
...
{
    class MftDecisionStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftDecisionStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftDecisionStepComponentImpl();
        ~MftDecisionStepComponentImpl();
        MftDecisionStepComponentImpl( const MftDecisionStepComponentImpl& );
        MftDecisionStepComponentImpl& operator=( const MftDecisionStepComponentImpl& );

    };

    typedef ACE_Singleton<MftDecisionStepComponentImpl, ACE_Recursive_Thread_Mutex> MftDecisionStepComponent;
}
