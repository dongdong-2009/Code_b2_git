#ifndef __MFT_EVALUATE_EXPRESSION_STEP_COMPONENT_H_
#define __MFT_EVALUATE_EXPRESSION_STEP_COMPONENT_H_
...
{
    class MftExpressionStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftExpressionStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftExpressionStepComponentImpl();
        ~MftExpressionStepComponentImpl();
        MftExpressionStepComponentImpl( const MftExpressionStepComponentImpl& );
        MftExpressionStepComponentImpl& operator=( const MftExpressionStepComponentImpl& );

    };

    typedef ACE_Singleton<MftExpressionStepComponentImpl, ACE_Recursive_Thread_Mutex> MftExpressionStepComponent;
}
