/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/ApplicationFont.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
HGDIOBJ ApplicationFont::getFont( const std::string& strFontName, const int nPointSize, const bool bItalic, const bool bBold )
{
    ...
    if ( NULL == hFont )
    {
        ...
        hFont = ::CreateFont( nHeight, 0, 0, 0, (bBold ? FW_BOLD : FW_NORMAL), bItalic, 0, 0, ANSI_CHARSET,
...
{
	// Prevent custom font from setting at real time as the correct font is already set at design time in the .rc file
	return;
