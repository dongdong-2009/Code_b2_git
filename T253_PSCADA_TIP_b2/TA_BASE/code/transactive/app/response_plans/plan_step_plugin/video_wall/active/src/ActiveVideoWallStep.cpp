...
{
    ActiveVideoWallStep::ActiveVideoWallStep(const BasicParameter& detail, IActivePlan& flowControl)
		: ActiveStep(m_params, flowControl),
          m_params(detail)
    {
    }

    ActiveVideoWallStep::~ActiveVideoWallStep()
    {
    }

    bool ActiveVideoWallStep::executeImpl()
    {
