#ifndef __MFT_PLAN_SET_TIMER_STEP_COMPONENT_H_
#define __MFT_PLAN_SET_TIMER_STEP_COMPONENT_H_
...
{
    class MftPlanSetTimerStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftPlanSetTimerStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftPlanSetTimerStepComponentImpl();
        ~MftPlanSetTimerStepComponentImpl();
        MftPlanSetTimerStepComponentImpl( const MftPlanSetTimerStepComponentImpl& );
        MftPlanSetTimerStepComponentImpl& operator=( const MftPlanSetTimerStepComponentImpl& );

    };

    typedef ACE_Singleton<MftPlanSetTimerStepComponentImpl, ACE_Recursive_Thread_Mutex> MftPlanSetTimerStepComponent;
}
