#ifndef __MFT_PLANCHECK_STEP_COMPONENT_H_
#define __MFT_PLANCHECK_STEP_COMPONENT_H_
...
{
    class MftPlanCheckStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftPlanCheckStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftPlanCheckStepComponentImpl();
        ~MftPlanCheckStepComponentImpl();
        MftPlanCheckStepComponentImpl( const MftPlanCheckStepComponentImpl& );
        MftPlanCheckStepComponentImpl& operator=( const MftPlanCheckStepComponentImpl& );
    };

    typedef ACE_Singleton<MftPlanCheckStepComponentImpl, ACE_Recursive_Thread_Mutex> MftPlanCheckStepComponent;
}
