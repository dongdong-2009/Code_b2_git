#ifndef __MFT_JUMP_STEP_COMPONENT_H_
#define __MFT_JUMP_STEP_COMPONENT_H_
...
{
    class MftJumpStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftJumpStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftJumpStepComponentImpl();
        ~MftJumpStepComponentImpl();
        MftJumpStepComponentImpl( const MftJumpStepComponentImpl& );
        MftJumpStepComponentImpl& operator=( const MftJumpStepComponentImpl& );

    };

    typedef ACE_Singleton<MftJumpStepComponentImpl, ACE_Recursive_Thread_Mutex> MftJumpStepComponent;
}
