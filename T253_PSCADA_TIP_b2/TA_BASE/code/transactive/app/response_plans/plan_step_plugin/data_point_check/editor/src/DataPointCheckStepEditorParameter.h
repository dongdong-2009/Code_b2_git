...
{
class DataPointCheckStepParameter;
class DataPointCheckStepEditorParameter : public InteractiveParameter, public IStringEditor, public ITreePicker, public IListPicker
{
public:
    DataPointCheckStepEditorParameter( DataPointCheckStepParameter& refParameter, IPlanNode& parent );
    ~DataPointCheckStepEditorParameter();
...
private:
    DataPointCheckStepParameter& m_refParameter;
    DataPointEditorHelper m_datapointEditorHelper;
    PlanStepEditorHelper m_planStepEditorHelper;
    DataPointTestTypeEditorHelper m_datapointTestTypeEditorHelper;
};
