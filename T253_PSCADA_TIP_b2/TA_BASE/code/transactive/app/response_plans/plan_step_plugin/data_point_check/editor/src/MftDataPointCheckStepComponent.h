#ifndef __MFT_DATAPOINT_CHECK_STEP_COMPONENT_H_
#define __MFT_DATAPOINT_CHECK_STEP_COMPONENT_H_
...
{
    class MftDataPointCheckStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftDataPointCheckStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftDataPointCheckStepComponentImpl();
        ~MftDataPointCheckStepComponentImpl();
        MftDataPointCheckStepComponentImpl( const MftDataPointCheckStepComponentImpl& );
        MftDataPointCheckStepComponentImpl& operator=( const MftDataPointCheckStepComponentImpl& );

    };

    typedef ACE_Singleton<MftDataPointCheckStepComponentImpl, ACE_Recursive_Thread_Mutex> MftDataPointCheckStepComponent;
}
