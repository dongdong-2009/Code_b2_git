#ifndef __MFT_POPUP_MFT_MESSAGE_STEP_COMPONENT_H_
#define __MFT_POPUP_MFT_MESSAGE_STEP_COMPONENT_H_
...
{
    class MftPopupMftMessageStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftPopupMftMessageStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftPopupMftMessageStepComponentImpl();
        ~MftPopupMftMessageStepComponentImpl();
        MftPopupMftMessageStepComponentImpl( const MftPopupMftMessageStepComponentImpl& );
        MftPopupMftMessageStepComponentImpl& operator=( const MftPopupMftMessageStepComponentImpl& );

    };

    typedef ACE_Singleton<MftPopupMftMessageStepComponentImpl, ACE_Recursive_Thread_Mutex> MftPopupMftMessageStepComponent;
}
