...
{
    return TA_Base_App::MftLaunchSchematicStepComponent::instance();
}

extern "C" Plan_Export void destroyMftStepComponent()
{
    return TA_Base_App::MftLaunchSchematicStepComponent::close();
}