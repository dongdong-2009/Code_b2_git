...
{
class LaunchSchematicStepParameter;
class LaunchSchematicStepEditorParameter : public InteractiveParameter, public IStringEditor, public IListPicker
{
public:
    LaunchSchematicStepEditorParameter( LaunchSchematicStepParameter& refParameter );
    ~LaunchSchematicStepEditorParameter();
...
private:
    LaunchSchematicStepParameter& m_refParameter;
    SchematicStepEditorHelper m_schematicEditorHelper;
};
