#ifndef __MFT_DATA_POINT_TIME_CHECK_STEP_COMPONENT_H_
#define __MFT_DATA_POINT_TIME_CHECK_STEP_COMPONENT_H_
...
{
    class MftDataPointTimeCheckStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftDataPointTimeCheckStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftDataPointTimeCheckStepComponentImpl();
        ~MftDataPointTimeCheckStepComponentImpl();
        MftDataPointTimeCheckStepComponentImpl( const MftDataPointTimeCheckStepComponentImpl& );
        MftDataPointTimeCheckStepComponentImpl& operator=( const MftDataPointTimeCheckStepComponentImpl& );

    };

    typedef ACE_Singleton<MftDataPointTimeCheckStepComponentImpl, ACE_Recursive_Thread_Mutex> MftDataPointTimeCheckStepComponent;
}
