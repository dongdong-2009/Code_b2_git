#ifndef __MFT_SHUTDOWN_SYSTEM_STEP_COMPONENT_H_
#define __MFT_SHUTDOWN_SYSTEM_STEP_COMPONENT_H_
...
{
    class MftShutdownSystemStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftShutdownSystemStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftShutdownSystemStepComponentImpl();
        ~MftShutdownSystemStepComponentImpl();
        MftShutdownSystemStepComponentImpl( const MftShutdownSystemStepComponentImpl& );
        MftShutdownSystemStepComponentImpl& operator=( const MftShutdownSystemStepComponentImpl& );

    };

    typedef ACE_Singleton<MftShutdownSystemStepComponentImpl, ACE_Recursive_Thread_Mutex> MftShutdownSystemStepComponent;
}
