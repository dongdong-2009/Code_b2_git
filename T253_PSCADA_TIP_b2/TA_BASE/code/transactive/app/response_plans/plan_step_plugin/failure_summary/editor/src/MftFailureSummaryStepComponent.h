...
{
    class MftFailureSummaryStepComponentImpl: public EditorStepComponent, public IActivityComponent
    {
        
    public:
        friend class ACE_Singleton<MftFailureSummaryStepComponentImpl, ACE_Recursive_Thread_Mutex>;
    ...
    private:
        MftFailureSummaryStepComponentImpl();
        ~MftFailureSummaryStepComponentImpl();
        MftFailureSummaryStepComponentImpl( const MftFailureSummaryStepComponentImpl& );
        MftFailureSummaryStepComponentImpl& operator=( const MftFailureSummaryStepComponentImpl& );

    };

    typedef ACE_Singleton<MftFailureSummaryStepComponentImpl, ACE_Recursive_Thread_Mutex> MftFailureSummaryStepComponent;
}
