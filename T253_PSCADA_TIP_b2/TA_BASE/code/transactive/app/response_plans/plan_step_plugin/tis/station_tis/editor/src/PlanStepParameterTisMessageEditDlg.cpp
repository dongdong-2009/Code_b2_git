...
void CPlanStepParameterTisMessageEditDlg::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_STATIONTIS_LIBRARY_TYPE, m_libraryType);
    DDX_Text(pDX, IDC_STATIONTIS_DEST_LIBRARY_VERSION, m_destinationLibraryVersion);
    DDX_Text(pDX, IDC_STATIONTIS_MSG_LIBRARY_VERSION, m_messageLibraryVersion);
    DDX_Control(pDX, IDC_STATIONTIS_MESSAGE_LIST, m_messageList);
    // }}AFX_DATA_MAP
...
BEGIN_MESSAGE_MAP(CPlanStepParameterTisMessageEditDlg, CPlanStepParameterEditDlg)
    ...
    ON_NOTIFY(LVN_ITEMCHANGED, IDC_STATIONTIS_MESSAGE_LIST, OnMessageListItemChanged)
    // }}AFX_MSG_MAP
END_MESSAGE_MAP()
