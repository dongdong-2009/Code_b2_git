/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/TA_Product_ECSPlan/TA_BASE/transactive/app/response_plans/plan_manager/src/TisConfigAccess.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
std::string TisConfigAccess::getSTisMessageText(const TISMessage& message)
{
...
std::string TisConfigAccess::getTTisMessageText(const TISMessage& message)
{
...
std::string TisConfigAccess::getTisMessageText(const TISMessage& message, const std::string& libraryType)
{
...
TisConfigAccess::PredefinedTisMessageList TisConfigAccess::getSTisMessages(unsigned long libraryVersion)
{
...
TisConfigAccess::PredefinedTisMessageList TisConfigAccess::getTTisMessages(unsigned long libraryVersion)
{
...
void TisConfigAccess::getTisMessages(unsigned long libraryVersion, const std::string& libraryType, PredefinedTisMessageList& messages)
{
