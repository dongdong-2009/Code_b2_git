...
{
const unsigned short TisConfig::PredefinedTisMessage::TIS_UNDEFINED_MESSAGE_ID = 0xFFFF;

std::string TisConfig::getSTisMessageText(const TISMessage& message)
{
...
std::string TisConfig::getTTisMessageText(const TISMessage& message)
{
...
std::string TisConfig::getTisMessageText(const TISMessage& message, const std::string& libraryType)
{
    FUNCTION_ENTRY("getTisMessageText");

    std::string messageText("");

    if(message.messageId != PredefinedTisMessage::TIS_UNDEFINED_MESSAGE_ID)
    {
        try
        {
...
TisConfig::PredefinedTisMessageList TisConfig::getSTisMessages(unsigned long libraryVersion)
{
...
TisConfig::PredefinedTisMessageList TisConfig::getTTisMessages(unsigned long libraryVersion)
{
...
void TisConfig::getTisMessages(unsigned long libraryVersion, const std::string& libraryType, PredefinedTisMessageList& messages)
{
...
TisConfig::TisStationNameSet TisConfig::getSTisStations()
{
    ...
    try
    {
        ...
        columnNames.push_back("STATION_NAME");
...
TisConfig::TisStationLevelSet TisConfig::getSTisLevels(const std::string& stationName)
{
...
TisConfig::TisPidSet TisConfig::getSTisPids(const std::string& stationName)
{
