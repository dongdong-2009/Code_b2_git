#if !defined(AFX_BurnDvdDlg_H__1468A462_430F_4418_BC92_334001E5F340__INCLUDED_)
#define AFX_BurnDvdDlg_H__1468A462_430F_4418_BC92_334001E5F340__INCLUDED_
...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/data_management/archive_manager/src/BurnDvdDlg.h $
  * @author:  Alan Brims
  * @version: $Revision: #2 $
  *
...
#include "IMediaAccess.h"
#include "ICallbackBurnStatus.h"
...
{
    class BurnDvdDlg : public CDialog, public TA_Base_Core::Thread, public ICallbackBurnStatus
    {
    public:
        /**
          * BurnDvdDlg
        ...
        BurnDvdDlg( const std::string& volumeLabel, const std::string& cdLabel, 
        ...
        /**
          * terminate
          *
          * If the thread is still running, it tells the thread to stop when Media Acess API decides
          * it is safe to do so.
          */
    ...
    private:
        ...
        BurnDvdDlg( const BurnDvdDlg& );
        BurnDvdDlg& operator=( const BurnDvdDlg& );
...
#endif // !defined(AFX_BurnDvdDlg_H__1468A462_430F_4418_BC92_334001E5F340__INCLUDED_)
