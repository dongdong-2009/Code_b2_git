/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/data_management/archive_manager/src/RestoreArchiveHelper.cpp $
...
namespace TA_Base_App
{
	...
	*/
    ...
    void RestoreArchiveHelper::loadImportCommand()
    {
        ...
        m_genericImpCommand << "fromuser=" << components[2] << " ";
        m_genericImpCommand << "touser=" << components[2] << " ";
