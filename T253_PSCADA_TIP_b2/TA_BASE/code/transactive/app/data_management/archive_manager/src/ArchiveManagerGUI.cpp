/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/data_management/archive_manager/src/ArchiveManagerGUI.cpp $
  * @author:  Alan Brims
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_App
{
    ...
    void ArchiveManagerGUI::checkEntity(TA_Base_Core::IEntityData* guiEntity)
    {
        ...
        if ( entityData->isArchiveManagerAlreadyRunning( workstationName ) )
        {
            ...
            UINT selectedButton = userMsg.showMsgBox(IDS_UE_050108);
    ...
    void ArchiveManagerGUI::prepareForClose()
    {
        ...
        catch ( TA_Base_Core::UserSettingsException& e )
        {
            ...
            UINT selectedButton = userMsg.showMsgBox(IDS_UW_050017);
        }
