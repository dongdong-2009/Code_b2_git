/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/data_management/archive_manager/src/BurnCdDlg.cpp $
  * @author:  Alan Brims
  * @version: $Revision: #2 $
  *
        ...
        try
        {
            ...
            try
            {
				...
				m_buttonCancel.SetWindowText( "Close" );
				 ...
				 if(!bfound)
				 {
					 LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugDebug, "Any bruned file is not exists in DVD, so returning Abort" );
