/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/T253_PSCADA_TIP/TA_BASE/transactive/app/data_management/archive_manager/src/SelectDeletionDateDlg.cpp $
...
namespace TA_Base_App
{
    ...
    void SelectDeletionDateDlg::OnOK() 
    {
        ...
        if ( m_date < TOMORROWS_DATE )
        {
            ...
            UINT selectedButton = userMsg.showMsgBox(IDS_UI_050059);
