...
// - The CMenuToolBar version number (Example CMenuToolBar 1.10)
...
IMPLEMENT_DYNAMIC(CMenuToolBar, CToolBar)
...
BEGIN_MESSAGE_MAP(CMenuToolBar, CToolBar)
  ON_WM_NCPAINT()
  ON_WM_ERASEBKGND()
...
COLORREF CMenuToolBar::MakeGrayAlphablend(CBitmap* pBitmap, int weighting, COLORREF blendcolor)
{
  CDC myDC;
...
// CMenuToolBar message handlers
void CMenuToolBar::DrawGripper(CDC* pDC, const CRect& rect)
{
...
void CMenuToolBar::OnNcPaint()
{
  EraseNonClient();
}

void CMenuToolBar::EraseNonClient()
{
...
void CMenuToolBar::DrawBorders(CDC* pDC, CRect& rect)
{
  switch (CNewMenu::GetMenuDrawMode())
  {
  case CNewMenu::STYLE_XP:
...
BOOL CMenuToolBar::OnEraseBkgnd(CDC* pDC)
{
...
BOOL CMenuToolBar::LoadHiColor(LPCTSTR lpszResourceName,COLORREF transparentColor/*=CLR_DEFAULT*/)
{
  int nColors = 0;
...
BOOL CMenuToolBar::LoadToolBar(LPCTSTR lpszResourceName)
{
...
BOOL CMenuToolBar::LoadToolBar(UINT nIDResource)
{
  return LoadToolBar(MAKEINTRESOURCE(nIDResource));
}

void CMenuToolBar::PaintOrangeState(CDC *pDC, CRect rc, bool bHot)
{
  CPen penBlue;
  //dunkelblauer rahmen
...
BOOL CMenuToolBar::PaintHotButton(LPNMCUSTOMDRAW lpNMCustomDraw)
{
...
void CMenuToolBar::PaintTBButton(LPNMCUSTOMDRAW pInfo)
{	
...
void CMenuToolBar::OnNMCustomdraw(NMHDR *pNMHDR, LRESULT *pResult)
{
...
int CMenuToolBar::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CMenuToolBar::OnBarStyleChange(DWORD dwOldStyle, DWORD dwNewStyle)
{
  switch (CNewMenu::GetMenuDrawMode())
  {
  case CNewMenu::STYLE_XP_2003_NOBORDER:
...
void CMenuToolBar::PaintCorner(CDC *pDC, LPCRECT pRect, COLORREF color)
{
...
void CMenuToolBar::PaintToolBarBackGnd(CDC* pDC)
{
  if((m_dwStyle & CBRS_FLOATING))
  {
    return;
