/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/core/data_access_interface/ats/src/AtsPSDDataHelper.cpp $
  * @author:  Nick Jardine
  * @version: $Revision: #4 $
  *
...
namespace TA_IRS_Core
{
    ...
    void AtsPSDDataHelper::reload()
    {
		...
		sql << KEY_COL << " = " << m_idKey;*/
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_PSD_ENTITY_MAP_STD_SELECT_49012, m_idKey);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_PSD_ENTITY_MAP_SELECT_49012, m_idKey);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_PSD_ENTITY_MAP_SELECT_49012, m_idKey);
...
//		strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_PSD_ENTITY_MAP_STD_DELETE_49401, m_idKey);
//		strSql  = databaseConnection->prepareSQLStatement(AT_PSD_ENTITY_MAP_DELETE_49401, m_idKey);

		databaseConnection->prepareSQLStatement(strSql, AT_PSD_ENTITY_MAP_DELETE_49401, m_idKey);
    ...
    void AtsPSDDataHelper::modifyExistingAtsPSDData() throw(TA_Base_Core::TransactiveException)
    {
       ...
       /* std::ostringstream sql;
        ...
        // get a connection to the database
        TA_Base_Core::IDatabase* databaseConnection = TA_Base_Core::DatabaseFactory::getInstance().getDatabase(TA_Base_Core::Ats_Cd, TA_Base_Core::Write);
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_PSD_ENTITY_MAP_STD_UPDATE_49151, m_platformKey,
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_PSD_ENTITY_MAP_UPDATE_49151, m_platformKey,
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_PSD_ENTITY_MAP_UPDATE_49151, m_platformKey,
			m_psdNumber, m_psdDataPointEntityKey, m_psdDataPointType, m_psdDataPointNameOfType, m_idKey);
        databaseConnection->executeModification(strSql);
    ...
    void AtsPSDDataHelper::addNewAtsPSDData() throw(TA_Base_Core::TransactiveException)
    {
        ...
        sql << "insert into AT_PSD_ENTITY_MAP (" 
            ...
            << m_psdDataPointType << "', '" 
            << m_psdDataPointNameOfType << "')";*/
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_PSD_ENTITY_MAP_STD_INSERT_49301, newKey,
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_PSD_ENTITY_MAP_INSERT_49301, newKey,
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_PSD_ENTITY_MAP_INSERT_49301, newKey,
			m_platformKey, m_psdNumber, m_psdDataPointEntityKey, m_psdDataPointType, m_psdDataPointNameOfType);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_PSD_ENTITY_MAP_Oracle_SELECT_49051);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_PSD_ENTITY_MAP_SELECT_49051);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_PSD_ENTITY_MAP_SELECT_49051);
