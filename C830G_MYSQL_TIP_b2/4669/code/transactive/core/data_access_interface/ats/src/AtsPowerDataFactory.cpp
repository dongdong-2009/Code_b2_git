/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/core/data_access_interface/ats/src/AtsPowerDataFactory.cpp $
  * @author:  Ripple
  * @version: $Revision: #4 $
  *
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_STD_SELECT_48502, aLocationKey);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_SELECT_48502, aLocationKey);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_SELECT_48502, aLocationKey);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_STD_SELECT_48503, aMSSZone);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_SELECT_48503, aMSSZone);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_SELECT_48503, aMSSZone);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_STD_SELECT_48504);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_SELECT_48504);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_SELECT_48504);
