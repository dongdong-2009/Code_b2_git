  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/pa/src/PaTrainDvaMessage.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Core
{
    ...
    private:
        ...
        TA_IRS_Core::PaTrainDvaMessageHelper * m_paTrainDvaMessageHelper;
    };
} // closes TA_IRS_Core
