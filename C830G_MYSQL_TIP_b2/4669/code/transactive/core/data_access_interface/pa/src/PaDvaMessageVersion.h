  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/pa/src/PaDvaMessageVersion.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Core
{
    ...
    public:
        ...
        virtual std::string getMessageVersion(IPaDvaMessageVersion::ELocation location, unsigned long stationDvaMessageId);
    ...
    private:
        ...
        TA_IRS_Core::PaDvaMessageVersionHelper * m_paDvaMessageVersionHelper;
    };
} // closes TA_IRS_Core
