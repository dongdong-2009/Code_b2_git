/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/core/data_access_interface/incident_dai/src/CtaIncidentReportData.h $
  * @author:  Grace Koh
  * @version: $Revision: #4 $
  *
...
namespace TA_IRS_Core
{
	...
	public:
		...
		*/
		...
		virtual std::string getDisplayReportId();

		virtual bool isStationReportValid();
