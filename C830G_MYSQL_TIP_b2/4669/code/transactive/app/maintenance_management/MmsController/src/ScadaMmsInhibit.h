/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/maintenance_management/MmsController/src/ScadaMmsInhibit.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
	class MmsControllerModel;
 	...
 	class CScadaMmsInhibit : public CPropertyPage
	{
		// Construction
	public:		
