/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/maintenance_management/proto/MMSDlg.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
	...
	: CDialog(CMMSDlg::IDD, pParent)
{
	...
	m_equipment_id = _T("CDBG/ES/PDS/MSB02MCCB17");
	m_requestor = _T("John Doe");
	m_problem = _T("Please repair ASAP.");
	m_alarmMessage = _T("1 - Urgent, MSB Feeder MCCB 17 MSCBPosition: LV Switchrm 02, DpGeneral0 (INCONSISTENT)");
	//}}AFX_DATA_INIT
...
void CMMSDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, m_equipment_id);
