/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/telephone/telephone_manager/src/TelephoneDirectLinesMessageSubscriber.cpp $
  * @author:  Raymond Pau
  * @version: $Revision: #1 $
  *
...
void TelephoneDirectLinesMessageSubscriber::ExtractMessageData(const TA_Base_Core::CommsMessageCorbaDef& message)
{
    ...
    const TA_IRS_Bus::DirectLineEvent *directLineEvent;
