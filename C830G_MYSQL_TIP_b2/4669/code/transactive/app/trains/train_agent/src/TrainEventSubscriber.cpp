/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/trains/train_agent/src/TrainEventSubscriber.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
	...
	m_operationModeManager(operationModeManager)
{
	...
	m_radioEntityKey = getRadioAgentEntityKey(locationKey);
