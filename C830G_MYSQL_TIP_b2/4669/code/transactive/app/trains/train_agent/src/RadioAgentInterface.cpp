...
namespace TA_IRS_App
{
                                                         ...
                                                         const std::string& sessionId )
    {
        ...
        try
        {
			...
			// Bohong++ for CL-20875
			(operatorSession->getRadioSessionObject()).setObjectTimeout(DGNA_TIMEOUT);
                                            ...
                                            const std::string& sessionId )
    {
        ...
        {
            LOG_EXCEPTION_CATCH( SourceInfo, "TA_Base_Bus::IRadioCorbaDef::dataCallInProgressException", "" );
                                              ...
                                              const std::string& sessionId )
    {
        ...
        {
            LOG_EXCEPTION_CATCH( SourceInfo, "TA_Base_Bus::IRadioCorbaDef::dataCallNotInProgressException", "" );
        }
        catch ( TA_Base_Bus::IRadioCorbaDef::radioException& e )
        {
            LOG_EXCEPTION_CATCH( SourceInfo, "TA_Base_Bus::IRadioCorbaDef::radioException", e.what.in() );
    ...
    bool RadioAgentInterface::inFallback()
    {
        ...
        try
        {
            ...
            CORBA_CALL_RETURN( inFallback, m_serverSession, inFallback, (); );//limin
        }
