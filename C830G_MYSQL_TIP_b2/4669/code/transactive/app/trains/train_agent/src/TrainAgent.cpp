/**
  ...
  * @version: $Revision: #4 $
  *
  * Last modification: $Date: 2010/01/08 $
...
namespace TA_IRS_App
{
	...
	*/
	void TrainAgent::agentSetMonitor()
	{
        ...
        // This will terminate all train transactions in progress.
        ...
        m_stateUpdateManager->notifyOperationStateChange( TA_Base_Core::Monitor );//limin++, CL-29779
	...
	*/
	void TrainAgent::agentSetControl()
	{
        ...
        m_stateUpdateManager->notifyOperationStateChange( TA_Base_Core::Control);//limin++, CL-29779
