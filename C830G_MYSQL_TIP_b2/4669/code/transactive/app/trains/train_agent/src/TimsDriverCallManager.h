...
namespace TA_IRS_App
{
    ...
    private:
        ...
        typedef std::map< TA_IRS_Bus::CommonTypes::TrainIdType, boost::shared_ptr< TA_Base_Core::Condition > > ConditionMap;

        ConditionMap m_EndOfOccCallEventConditionMap;

        TA_Base_Core::NonReEntrantThreadLockable m_EndOfOccCallEventConditionMapLock;

        static const std::string RPARAM_WAIT_END_OF_OCC_CALL_EVENT_TIMEOUT;

        int waitEndOfOccCallEvent( TA_IRS_Bus::CommonTypes::TrainIdType trainId );
        void signalEndOfOccCallEvent( TA_IRS_Bus::CommonTypes::TrainIdType trainId );
        //++limin, ECP-0654 CL-20794
    };
