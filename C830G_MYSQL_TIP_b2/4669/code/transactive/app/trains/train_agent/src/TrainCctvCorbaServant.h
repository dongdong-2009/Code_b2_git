/**
  ...
  *
  */
#if !defined(TrainCctvCorbaServant_H)
#define TrainCctvCorbaServant_H
...
namespace TA_IRS_App
{
    ...
    /**
     * This is the corba servant for the ITrainCctvCorba interface
     * @author adamr
     * @version 1.0
     * @created 01-Apr-2008 2:48:25 PM
     */
    class TrainCctvCorbaServant : public TA_Base_Core::ServantBase, 
                                  public POA_TA_Base_Bus::ITrainCctvCorba
    {
    ...
    public:
        ...
        /**
         *
         * @param timsCctvManager    to delegate calls to
         */
        TrainCctvCorbaServant( ITimsCctvManager& timsCctvManager );


        /**
         * Destructor
         */
        virtual ~TrainCctvCorbaServant();


        /**
         * Activate the given train CCTV broadcast. If there are no conflicts, this will activate the train, and set the default broadcast state for the train.
         *
         ...
         * @param sessionId    The operator performing the action
         */
        void setCarrierOnDelocalisedTrain( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
        ...
        /**
         * Activate the given train CCTV broadcast and set the image to the given camera. If there are no conflicts, this will activate the train, and set the default broadcast state for the train.
         *
         ...
         * @param sessionId    The operator performing the action
         */
        void setSingleScreen( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
                              TA_Base_Bus::ITrainCctvCorba::ECctvCamera camera,
                              const char* sessionId );


        /**
         * Activate the given train CCTV broadcast and set the image to the given quad. If there are no conflicts, this will activate the train, and set the default broadcast state for the train.
         *
         ...
         */
        void setQuadScreen( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
        ...
        /**
         * Activate the given train CCTV broadcast and set the image to the given sequence. If there are no conflicts, this will activate the train, and set the default broadcast state for the train.
         *
         ...
         * @param sessionId    The operator performing the action
         */
        void setSequence( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
        ...
        /**
         * Activate the given train CCTV broadcast and set the image to the given camera list. If there are no conflicts, this will activate the train, and set the default broadcast state for the train.
         *
         ...
         * @param sessionId    The operator performing the action
         */
        void addAlarmImage( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
         ...
         * @param sessionId    The operator performing the action
         */
        void addAlarmImageDelocalisedTrain( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
                                            const TA_Base_Bus::ITrainCctvCorba::TrainCameraSequence& cameraIds,
                                            CORBA::ULong trainLocation,
                                            const char* sessionId );
         ...
         * @param sessionId    The operator performing the action
         */
        void removeAlarmImage( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
         ...
         * @param stageID
         */
        TA_Base_Bus::ITrainCctvCorba::CctvSwitchState getActiveTrainForStage( CORBA::ULong stageID );

		TA_Base_Bus::ITrainCctvCorba::CctvSwitchState getCctvState( TA_Base_Bus::ITrainCommonCorba::TrainId trainId );
    ...
    private:
         ...
         * Constructor
         */
        TrainCctvCorbaServant();


        /**
         * Used to delegate calls to
         */
        ITimsCctvManager& m_timsCctvManager;

    };

} // TA_IRS_App

#endif // !defined(TrainCctvCorbaServant_H)
