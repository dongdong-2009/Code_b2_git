/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/radio/radio_manager_gui/src/dlgbars.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
public:
    ...
    void SetForwardingText(const CString& str, bool enable);
...
private:
    ...
    CString m_forwardingText;

    UINT    m_flashTimerID;
    bool    m_backgroundRed;
};
