/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/EcsOverallTimetableSettingDlg.cpp $
  * @author:  Ripple
  * @version: $Revision: #12 $
  *
  * Last modification: $DateTime: 2009/06/19 16:15:41 $
...
//		LoadStations();
	...
	void COverallEcsTimetableSettingDlg::OnDestroy()
	{
		//zn++ CL-20847
		terminateAndWait();
	...
	void COverallEcsTimetableSettingDlg::run()
	{
        backgroundInitialiseDataPointsProxy();
	}

	void COverallEcsTimetableSettingDlg::terminate()
	{
