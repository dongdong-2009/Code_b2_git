#if !defined(AFX_ECSManagerGUI_H__2A63FC16_95CE_48E6_9464_A662B7478D49__INCLUDED_)
#define AFX_ECSManagerGUI_H__2A63FC16_95CE_48E6_9464_A662B7478D49__INCLUDED_
...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/ECSManagerGUI.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
// 7196-End	
using TA_Base_Core::EObjectType;

namespace TA_IRS_App
{
    class ECSManagerGUI : public TA_Base_Bus::AbstractDialogGUI
    {
    public:
        ...
        */
		...
		/**
        * getEObjectTypeFromApplicationType
        *
        * This returns the EObject type for different dialog types
        *
        * 
        */
		EObjectType getEObjectTypeFromApplicationType();
		// 7196-End	
    private:
        /**
         * Copy Constructor
         ...
         */
        ECSManagerGUI( const ECSManagerGUI& );
         ...
         * Hidden as a private method so it is not used.
         */
        ECSManagerGUI& operator=( const ECSManagerGUI& );
...
#endif // !defined(AFX_ECSManagerGUI_H__2A63FC16_95CE_48E6_9464_A662B7478D49__INCLUDED_)
