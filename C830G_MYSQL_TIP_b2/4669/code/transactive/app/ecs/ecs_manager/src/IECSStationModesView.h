...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/IECSStationModesView.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        /** 
          ...
          */
        virtual void setLocations( const LocationNames& locations ) = 0;
        ...
        /** 
          ...
          */
        virtual void setStationModeDetails( const StationModeDetails& stationModeDetails ) = 0;
        ...
        /** 
          ...
          */
        virtual void setCurrentStationMode( const std::string& stationMode, ECurrentStationModeType currentStationModeType ) = 0;
        ...
        /** 
          ...
          *
          */
        virtual void setStationModeProposalState( unsigned int stationModeIndex, EModeProposalState stationModeProposalState ) = 0;
