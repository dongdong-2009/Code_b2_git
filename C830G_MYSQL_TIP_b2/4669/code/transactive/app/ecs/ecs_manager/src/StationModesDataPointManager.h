...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/StationModesDataPointManager.h $
  * @author:  Robert Young
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2009/06/19 16:11:40 $
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          ...
          *
          */
        void refreshDataPointProxies( const LocationKeys& locationKeys, 
		...
		void setAutoModeStatusForLocationAndType(unsigned long locationKey,ECurrentStationAutoModeType currentStationAutoModeType );
    ...
    private:
        ...
        /** 
          ...
          */
        void populateStatusAndControlDataPointProxies( const LocationKeys& locationKeys );
        ...
        /** 
          ...
          */
        void populateProxiesFromDataPointEntityData( const LocationKeys& locationKeys, 
        ...
        /** 
          ...
          */
        void cleanUpSpecifiedDataPointProxies( const LocationKeys& locationKeys, bool doStatusAndControl);
       ...
       /** 
		...
		void populateProxiesForAutoModeControl(const LocationKeys& locationKeys);		
