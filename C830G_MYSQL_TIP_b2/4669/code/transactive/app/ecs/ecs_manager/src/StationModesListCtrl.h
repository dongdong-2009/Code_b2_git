...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/StationModesListCtrl.h $
  * @author:  Robert Young
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2009/03/11 12:13:53 $
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          ...
          */
        void populateStationModeDetails( const TA_IRS_App::StationModeDetails& stationModeDetails );
        ...
        /** 
          ...
          */
        void setStationModeProposalState( int stationModeIndex, TA_IRS_App::EModeProposalState stationModeProposalState );
        ...
        /** 
          ...
          */
        TA_IRS_App::EModeProposalState getStationModeProposalState( int stationModeIndex );
