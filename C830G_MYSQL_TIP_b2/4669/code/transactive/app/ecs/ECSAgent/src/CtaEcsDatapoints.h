...
// Station ECS Agent datapoint access
    ...
    virtual /*unsigned*/ long getCurrentStationMode();	//dahe++ for CL-21046
...
// Master ECS Agent datapoint access
    ...
    virtual /*unsigned*/ long getCurrentMasterMode();	//dahe++ for CL-21046
    virtual void setCurrentMasterMode(/*unsgined*/ long value, bool fInit = false);	//dahe++ for CL-21046
...
private:
    ...
    void waitEcsDatapointSyncDone();
    void waitDpQualityGood( TA_Base_Bus::DataPoint* pDatapoint );
