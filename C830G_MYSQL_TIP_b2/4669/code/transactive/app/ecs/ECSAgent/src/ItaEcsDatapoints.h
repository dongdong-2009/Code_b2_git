/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ECSAgent/src/ItaEcsDatapoints.h $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
// Station ECS Agent datapoint access
    ...
    virtual /*unsigned*/ long getCurrentStationMode()=0;	//dahe++ for CL-21046
...
// Master ECS Agent datapoint access
    ...
    virtual /*unsigned*/ long getCurrentMasterMode()=0;	//dahe++ for CL-21046
    virtual void setCurrentMasterMode(/*unsigned*/ long value, bool fInit=false)=0;	//dahe++ for CL-21046
