/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ECSAgent/src/ItaEcsCachedMaps.h $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
...
public:
   ...
   /**
    ...
    virtual unsigned long getZoneIdFromMasterMode(/*unsigned*/ long masterMode)=0;	//dahe++ for CL-21046

    virtual MasterModePair getMasterModePairFromMasterMode(/*unsigned*/ long masterMode)=0;	//dahe++ for CL-21046

    virtual TA_IRS_Bus::EcStationModeKeys getEcStationModeKeysFromMasterMode(/*unsigned*/ long masterMode)=0;	//dahe++ for CL-21046
