/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ECSAgent/src/CtaEcsAuditing.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
void CtaEcsAuditing::sendEcsStationModeRequest(/*unsigned*/ long fromMode,	//dahe++ for CL-21046
...
void CtaEcsAuditing::sendEcsStationModeResult(/*unsigned*/ long fromMode,	//dahe++ for CL-21046
                                               /*unsigned*/ long toMode,	//dahe++ for CL-21046
...
void CtaEcsAuditing::sendEcsMasterModeRequest(/*unsigned*/ long fromMode,	//dahe++ for CL-21046
                                               /*unsigned*/ long toMode,	//dahe++ for CL-21046
                                               const std::string& sessionId)
{
...
void CtaEcsAuditing::sendEcsMasterModeResult(/*unsinged*/ long fromMode,	//dahe++ for CL-21046
                                              /*unsigned*/ long toMode,	  //dahe++ for CL-21046
                                              const std::string& failuresIfAny,
