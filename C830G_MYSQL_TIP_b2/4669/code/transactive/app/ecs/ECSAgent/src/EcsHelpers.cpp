/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ECSAgent/src/EcsHelpers.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
std::string EcsHelpers::toString(/*unsigned*/ long param)	//dahe++ for CL-21046
{
...
unsigned long EcsHelpers::getMaxExternalTemperatureInCelsius(const TA_IRS_Bus::IAtsEcsCorbaDef::AtsEcsMessageCorbaDef& packet)
     ...
     ProposedModeSet& to)
{
    ...
    for (int index = 0; index< from.length(); ++index, ++it)
    {
