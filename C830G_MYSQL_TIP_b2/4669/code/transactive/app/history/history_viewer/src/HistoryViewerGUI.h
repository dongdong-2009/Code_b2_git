#ifndef HistoryViewerGUI_H
#define HistoryViewerGUI_H
...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/history/history_viewer/src/HistoryViewerGUI.h $
  * @author:  A. Lee
  * @version: $Revision: #1 $
  *
...
namespace TA_App
{
    class HistoryViewerGUI : public TA_Bus::AbstractDialogGUI
	{
	public:
	  /**
	    * Constructor
	...
	private:
        ...
        //HistoryCommsSubscriber* m_HistoryCommsSubscriber;
	};
	
} // TA_App

#endif // HistoryViewerGUI_H