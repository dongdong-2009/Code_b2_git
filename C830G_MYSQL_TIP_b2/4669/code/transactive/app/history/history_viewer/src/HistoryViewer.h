/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/history/history_viewer/src/HistoryViewer.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_App
{
        ...
        class CHistoryViewerApp : public TA_Bus::TransActiveWinApp
    {
    public:
        CHistoryViewerApp();
