 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/4669/transactive/app/wild/wild_agent/src/DataCorrelation.h $
 * @author:  <Andy Siow>
 * @version: $Revision: #2 $
 *
 * Last modification: $DateTime: 2009/11/20 15:34:11 $
...
namespace TA_IRS_App
{
	...
	// Member functions
        ...
        WILDDetails* extractWILDDataDecimalEncoding(const std::string& dataPointValue);//limin++, CL-21009
		...
		void submitCriticalAlarm( const std::string& trainName,long timeStamp);
		//
