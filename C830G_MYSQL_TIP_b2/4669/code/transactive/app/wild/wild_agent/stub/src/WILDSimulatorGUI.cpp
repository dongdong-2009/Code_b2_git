/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/wild/wild_agent/stub/src/WILDSimulatorGUI.cpp $
  * @author:  Andy Siow
  * @version: $Revision: #1 $
  *
...
WILDSimulatorGUI::WILDSimulatorGUI()
{   
}
...
void WILDSimulatorGUI::createApplicationObject()
{
	setApplicationWnd(*(new CWILDSimulatorDlg(this)));
}


unsigned long WILDSimulatorGUI::getApplicationType()
{
...
void WILDSimulatorGUI::checkEntity(TA_Base_Core::IEntityData* guiEntity)
{
	setGuiEntity(*guiEntity);
}


void WILDSimulatorGUI::checkCommandLine()
{  
}


void WILDSimulatorGUI::entityChanged(const std::vector<std::string>& changes)
{
...
void WILDSimulatorGUI::serverIsDown()
{
...
void WILDSimulatorGUI::serverIsUp()
{
    // TODO: This method is used to ensure the GUI can handle when the server goes
	//up or down. The GUI should be updated to indicate the network status.
	//If the server has gone down it should enter some sort of read-only mode and
...
void WILDSimulatorGUI::loadAllUserSettings()
{
...
void WILDSimulatorGUI::saveAllUserSettings()
{
...
void WILDSimulatorGUI::prepareForClose()
{
