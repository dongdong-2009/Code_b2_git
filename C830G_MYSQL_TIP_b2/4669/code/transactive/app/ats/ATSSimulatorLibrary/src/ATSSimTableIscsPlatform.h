#ifndef ATS_SIM_TABLE_ISCSPLATFORM_H
#define ATS_SIM_TABLE_ISCSPLATFORM_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ats/ATSSimulatorLibrary/src/ATSSimTableIscsPlatform.h $
  ...
  * 
  * Declaration file for ATSSimTableIscsPlatform class
  */
...
namespace ATS_Sim
{
    ...
    /**
      ...
      *
      * ATSSimTableIscsPlatform is a derived table class.
      *
      * TABLE IscsPlatform 
      *
      */
    class ATSSimTableIscsPlatform : public ATSSimTable
    {
    ...
    public:
        /**
          ...
          */
        ATSSimTableIscsPlatform(ATSSimTableQueryProcessor * parent, LocationType loc, ATSSimTableAtsPlatform * atsPlatformTable);

        /**
          * Destructor
          */
        ~ATSSimTableIscsPlatform();
    ...
    private:
        /**
          ...
          */
        typedef struct ATSSimTableIscsPlatformRecord
        {
            Word            platformAreaId;
            Byte            closeRequest;
            Byte            openRequest;
        ...
        /**
          * 
          */
        ATSSimTableIscsPlatformRecord * m_tableData;
        ...
        ///
        ///
        ATSSimTableAtsPlatform * m_atsPlatformTable;
    }; // class ATSSimTableIscsPlatform
} // namespace ATS_Sim
} // namespace TA_IRS_App
#endif // #ifndef ATS_SIM_TABLE_ISCSPLATFORM_H
