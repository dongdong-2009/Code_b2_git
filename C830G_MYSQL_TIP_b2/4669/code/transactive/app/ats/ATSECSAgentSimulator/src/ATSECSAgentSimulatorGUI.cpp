/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ats/ATSECSAgentSimulator/src/ATSECSAgentSimulatorGUI.cpp $
  * @author:  
  * @version: $Revision: #1 $
  *
...
void ATSECSAgentSimulatorGUI::createApplicationObject()
{
    ...
    ECSAgentUpdater::getInstance()->setEntityKey(getGUIEntity()->getKey());
}
...
void ATSECSAgentSimulatorGUI::checkEntity(TA_Core::IEntityData* guiEntity)
{
