/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/ttis_manager/src/TrainSelectFreeTextPage.cpp $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
typedef TA_IRS_App::CTrainSelectFreeTextPage::AdHocMessage AdHocMessage;
