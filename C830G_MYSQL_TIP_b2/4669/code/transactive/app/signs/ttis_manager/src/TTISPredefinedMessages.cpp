/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/ttis_manager/src/TTISPredefinedMessages.cpp $
  * @author:  Adam Radics
  * @version: $Revision: #4 $
  *
...
namespace TA_IRS_App
{
    ...
    void TTISPredefinedMessages::notifyWindowsOfCurrentVersionChange()
    {
        ...
        postMessageToWindows(m_currentWindowsToNotify, WM_UPDATE_CURRENT_TTIS_VERSION);
    }
    ...
    void TTISPredefinedMessages::notifyWindowsOfNextVersionChange()
    {
        ...
        postMessageToWindows(m_nextWindowsToNotify, WM_UPDATE_NEXT_TTIS_VERSION);
    }
    ...
    void TTISPredefinedMessages::postMessageToWindows(const std::vector<CWnd*>& windows, int message)
    {
    ...
    void TTISPredefinedMessages::loadTTISPredefinedMessages()
    {
        ...
        try
        {
            ...
            m_defaultAttributes = ttisMessageLibrary->getDefaultTTISLedAttributes();
