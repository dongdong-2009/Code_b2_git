/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/app/signs/ttis_manager/src/CurrentDownloadsListCtrl.cpp $
  * @author Adam Radics
  * @version $Revision: #1 $
                                                  ...
                                                  const std::string& serviceNo)
{
    ...
    if (nItem < 0)
    {
        ...
        InsertItem(nItem, getTrainIdString(*download, serviceNo));
