...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/tis_agent/stis_simulator/src/STISMessageProcessor.h $
...
namespace TA_IRS_App
{
	...
	public:
       ...
       /**
		...
		void updateNextLibraryVersion( const std::string& libraryType, int version );

		// Updates the Current STIS library version
		void updateCurrentSTISLibraryVersion( int version );

		// This function upgrades the CURRENT message library version (only applicable to STIS)
		void upgradeSTISLibrary( int version );
	...
	private:
		...
		int m_newStisLibrary;
		int m_newTtisLibrary;
		int m_currentStisLibrary;
