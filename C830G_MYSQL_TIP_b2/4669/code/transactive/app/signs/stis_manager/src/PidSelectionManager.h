/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/stis_manager/src/PidSelectionManager.h $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          * setRatisMode
          *
          * Sets whether PID selection is in ratis mode.
          * if so the PID list clears and disables.
          *
          * @param ratisMode
          */
        void setRatisMode(bool ratisMode);
    ...
    private:
        ...
        // whether the ratis tab is selected
        bool m_RATISMode;
