/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/incidents/incident_manager/src/IncidentManagerFramework.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
	...
	void IncidentManagerFramework::checkEntity(TA_Base_Core::IEntityData* guiEntity)
	{
		...
		TA_Base_Core::IEntityDataPtr guiEntityData(TA_Base_Core::EntityAccessFactory::getInstance().getEntity(getGUIEntity()->getKey()));
