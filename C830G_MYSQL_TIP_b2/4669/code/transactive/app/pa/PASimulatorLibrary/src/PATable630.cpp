/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/pa/PASimulatorLibrary/src/PATable630.cpp $
  ...
  *
  *
  * Definition file for class PATable630.
  */
...
PATable630::PATable630(PATableRequestProcessor * parent)
: PASimTable(630,parent)
{
    Byte * bp = (Byte *)m_tableArray;
    size_t sz = sizeof(Table630DataArray);
...
PATable630::~PATable630()
{
}



UserReply * PATable630::processUserRead(UserRequest * ur)
{
    return PASimTable::processUserRead(ur);
}


UserReply * PATable630::processUserWrite(UserRequest * ur)
{
