/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/pa/PAAgent/src/Table1301.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
#if !defined(Table1301_B323CC80_49BA_4d42_98A5_8CE9884F7924__INCLUDED_)
#define Table1301_B323CC80_49BA_4d42_98A5_8CE9884F7924__INCLUDED_
...
class Table1301 : public TA_IRS_App::AbstractWriteablePASTable
{

    friend class WriteTable1301;

public:

    Table1301( TA_IRS_Bus::Scheduler& socketScheduler,
...
private:
    Table1301( const Table1301& theTable1301);
    virtual ~Table1301();
...
/**
 * Event that will write data to Table 1301 in the PAS.
 */
class WriteTable1301 : public TA_IRS_App::PASWriteEvent
{
public:
    /**
     * Constructs an instance of this class.
     * @param table The reference to Table 1301 instance.
     ...
     */
    WriteTable1301( Table1301& table,
    ...
    virtual ~WriteTable1301();
    /**
     * writeTable called by PASWriteEvent::consume().  In this case, the data will be written out to PAS
     */
...
private:
    /** The reference to Table 1301. */
    Table1301& m_table;
    /** The message sequence id defining the index of the message in Table 1302. */
...
#endif // !defined(Table11301_B323CC80_49BA_4d42_98A5_8CE9884F7924__INCLUDED_)
