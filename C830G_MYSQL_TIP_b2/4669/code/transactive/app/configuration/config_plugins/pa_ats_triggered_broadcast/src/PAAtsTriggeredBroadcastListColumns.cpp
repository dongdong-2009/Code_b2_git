/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/PAAtsTriggeredBroadcastListColumns.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
  *
...
PaAtsTriggeredBroadcastListColumns::PaAtsTriggeredBroadcastListColumns()
{
    ...
    setColumnParams(COL_DEST_LOCATION,  80,     "Dest Location", COMPARE_STRING);    

    setColumnParams(COL_ZONE_GROUP,     120,    "Zone Group",   COMPARE_STRING);
    setColumnParams(COL_PLATFORM_ID,    80,     "Platform",     COMPARE_STRING);

    setColumnParams(COL_DVA_MESSAGE,    120,    "DVA Message",  COMPARE_STRING);
    setColumnParams(COL_DVA_MESSAGE_VERSION,    80, "DVA Version",  COMPARE_STRING);
    
    setColumnParams(COL_ATS_EVENT_TYPE, 80,     "Event Type",   COMPARE_STRING);
    setColumnParams(COL_IS_LAST_TRAIN,  60,     "Last Train",   COMPARE_STRING);
