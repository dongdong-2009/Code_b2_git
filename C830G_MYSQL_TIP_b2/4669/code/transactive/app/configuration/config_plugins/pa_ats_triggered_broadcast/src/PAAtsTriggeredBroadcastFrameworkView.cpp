/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/PAAtsTriggeredBroadcastFrameworkView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int PaAtsTriggeredBroadcastFrameworkView::TOP_PANE      = 0;
    const int PaAtsTriggeredBroadcastFrameworkView::BOTTOM_PANE   = 1;
    const int PaAtsTriggeredBroadcastFrameworkView::ZERO_COLUMN   = 0;

    const int PaAtsTriggeredBroadcastFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(PaAtsTriggeredBroadcastFrameworkView, CView)


    PaAtsTriggeredBroadcastFrameworkView::PaAtsTriggeredBroadcastFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(PaAtsTriggeredBroadcastFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(PaAtsTriggeredBroadcastFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL PaAtsTriggeredBroadcastFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void PaAtsTriggeredBroadcastFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* PaAtsTriggeredBroadcastFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(PaAtsTriggeredBroadcastDetailView);
    }


    CRuntimeClass* PaAtsTriggeredBroadcastFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(PaAtsTriggeredBroadcastListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // PaAtsTriggeredBroadcastFrameworkView diagnostics

    #ifdef _DEBUG
    void PaAtsTriggeredBroadcastFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void PaAtsTriggeredBroadcastFrameworkView::Dump(CDumpContext& dc) const
    {
