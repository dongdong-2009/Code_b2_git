/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/PAAtsTriggeredBroadcastComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(PaAtsTriggeredBroadcastComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PaAtsTriggeredBroadcastComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PaAtsTriggeredBroadcastComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        PaAtsTriggeredBroadcastComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PaAtsTriggeredBroadcastComponent();
    ...
    private:
         ...
         */
        PaAtsTriggeredBroadcastComponent( const PaAtsTriggeredBroadcastComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PaAtsTriggeredBroadcastComponent& operator=(const PaAtsTriggeredBroadcastComponent&);
    ...
    public:
        ...
        static const DWORD RESOURCE_ID;
        static const DWORD RIGHTS_ACTION_ID;
...
#endif // !defined(PaAtsTriggeredBroadcastComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
