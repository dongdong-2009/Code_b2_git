/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/src/MessageSender.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    private:
        ...
        TA_Core::AuditMessageSender* m_auditMessageSender;


        // This is used to send configuration update messages indicating changes to the configuration data.
        TA_Core::ConfigUpdateMessageSender* m_configMessageSender;
