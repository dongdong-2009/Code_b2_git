/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_platform/src/AtsPlatformListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all Ats Platforms available to be configured. This view must
  * communicate with the AtsPlatformDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_AtsPlatformListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_AtsPlatformListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_
...
{
    class AtsPlatformListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
	    ...
	    virtual ~AtsPlatformListView();

	    DECLARE_DYNCREATE(AtsPlatformListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(AtsPlatformListView)
	    public:
    ...
    private:
	   ...
	   */
        ...
        *                 m_actions vector
        * @param LPARAM - This is a pointer to this object. ie the AtsPlatformListView object.
        */
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);


        static const int APPLIED_COLUMN;
		static const int PLATFORMID_COLUMN;
        static const int STATION_COLUMN;
		static const int PLATFORMNAME_COLUMN;
        static const int TISPLATFORMID_COLUMN;

        static const CString APPLIED_COLUMN_NAME;
		static const CString PLATFORMID_COLUMN_NAME;
        static const CString STATION_COLUMN_NAME;
		static const CString PLATFORMNAME_COLUMN_NAME;
        static const CString TISPLATFORMID_COLUMN_NAME;

        static const int APPLIED_COLUMN_WIDTH;
		static const int PLATFORMID_COLUMN_WIDTH;
        static const int STATION_COLUMN_WIDTH;
		static const int PLATFORMNAME_COLUMN_WIDTH;
        static const int TISPLATFORMID_COLUMN_WIDTH;
        ...
        // sort the columns.
        std::map<unsigned long,AtsPlatformDatabaseAccessor::AtsPlatformRecord> m_currentDisplayedItems;
...
#endif // !defined(AFX_AtsPlatformListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
