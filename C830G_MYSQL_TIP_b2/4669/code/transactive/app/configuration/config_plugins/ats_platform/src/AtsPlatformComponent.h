/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_platform/src/AtsPlatformComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AtsPlatformComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AtsPlatformComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AtsPlatformComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        AtsPlatformComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~AtsPlatformComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ATS_PLATFORM;
        }
    ...
    private:
         ...
         */
        AtsPlatformComponent( const AtsPlatformComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AtsPlatformComponent& operator=(const AtsPlatformComponent&);
...
#endif // !defined(AtsPlatformComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
