/** 
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/radio_itsi_groups/src/TA_RadioITSIGroupsConfigPlugin.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
{
	static AFX_EXTENSION_MODULE TA_RadioITSIGroupsConfigPluginDLL = { NULL, NULL };
	...
	DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
	{
		...
		{
			TRACE0("TA_RADIOITSIGROUPSCONFIGPLUGIN.DLL Initializing!\n");
			
			// Extension DLL one-time initialization
			if (!AfxInitExtensionModule(TA_RadioITSIGroupsConfigPluginDLL, hInstance))
				return 0;
			...
			new CDynLinkLibrary(TA_RadioITSIGroupsConfigPluginDLL);
		}
		else if (dwReason == DLL_PROCESS_DETACH)
		{
			TRACE0("TA_RADIOITSIGROUPSCONFIGPLUGIN.DLL Terminating!\n");
			// Terminate the library before destructors are called
			AfxTermExtensionModule(TA_RadioITSIGroupsConfigPluginDLL);
		}
		return 1;   // ok
	}
		...
		/**
		  ...
		  *
		  * @return IConfigurableComponent*		A new ITSIGroupsComponent object which implements
		...
		{
			return new ITSIGroupsComponent(componentName);
		}
