/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/video_triggering_event/src/VideoTriggeringEventComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(VideoTriggeringEventComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define VideoTriggeringEventComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class VideoTriggeringEventComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        VideoTriggeringEventComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~VideoTriggeringEventComponent();
    ...
    private:
         ...
         */
        VideoTriggeringEventComponent( const VideoTriggeringEventComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        VideoTriggeringEventComponent& operator=(const VideoTriggeringEventComponent&);
...
#endif // !defined(VideoTriggeringEventComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
