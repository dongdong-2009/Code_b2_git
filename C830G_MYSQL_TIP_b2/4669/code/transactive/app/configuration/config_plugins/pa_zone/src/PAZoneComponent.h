/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone/src/PAZoneComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(PaZoneComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PaZoneComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PaZoneComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        PaZoneComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PaZoneComponent();
    ...
    private:
         ...
         */
        PaZoneComponent( const PaZoneComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PaZoneComponent& operator=(const PaZoneComponent&);
...
#endif // !defined(PaZoneComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
