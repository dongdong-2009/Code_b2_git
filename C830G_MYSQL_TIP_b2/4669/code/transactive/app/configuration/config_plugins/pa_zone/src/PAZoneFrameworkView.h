/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone/src/PAZoneFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a splitter. It then loads the top of the splitter as a list of PA Zones
  * and the bottom as a view for the user to configure a single PA Zones details.
  */


#if !defined(AFX_PaZoneFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_PaZoneFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class PaZoneFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
	    ...
	    DECLARE_DYNCREATE(PaZoneFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(PaZoneFrameworkView)
	    //}}AFX_VIRTUAL
...
#endif // !defined(AFX_PaZoneFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
