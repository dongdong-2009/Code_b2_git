/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/sequence_entity/src/TA_SequenceEntityConfigPlugin.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
{
    static AFX_EXTENSION_MODULE TA_SequenceEntityConfigPluginDLL = { NULL, NULL };
    ...
    DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
    {
	    ...
	    {
		    TRACE0("TA_SEQUENCEENTITYCONFIGPLUGIN.DLL Initializing!\n");
		    
		    // Extension DLL one-time initialization
		    if (!AfxInitExtensionModule(TA_SequenceEntityConfigPluginDLL, hInstance))
			    return 0;
		    ...
		    new CDynLinkLibrary(TA_SequenceEntityConfigPluginDLL);
	    }
	    else if (dwReason == DLL_PROCESS_DETACH)
	    {
		    TRACE0("TA_SEQUENCEENTITYCONFIGPLUGIN.DLL Terminating!\n");
		    // Terminate the library before destructors are called
		    AfxTermExtensionModule(TA_SequenceEntityConfigPluginDLL);
	    }
	    return 1;   // ok
    }
    ...
    /**
      ...
      * @param const std::vector<std::string>& - The entity types to load. If the entity type cannot be found in 
      *                                          the database an error will be reported to the user later.
      *
      * @return IConfigurableComponent*		A new SequenceEntityComponent object which implements
    ...
    {
	    return new SequenceEntityComponent(componentName, entityTypes);
    }
