/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/sequence_entity/src/EntityDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
         ...
         * getAllRegions
         *
         * This returns a all regions and keys to the caller. This goes to the database each time
         * this method is called.
         *
         * @return map<unsigned long, string> - This returns all the region keys and names. This is all
         *                                      information needed by entities to update their data and
         *                                      to display to the user
         */
        std::map<unsigned long, std::string> getAllRegions();
         ...
         *
         * This is called to increase the member variable m_subStringItemNamesNumber's count
         * 
         * @param CString locName - This is an OUT parameter.
         */
		void increaseLocationCount(const CString& locName,const CString& prevText);
    ...
    private:
        ...
        bool m_isLoaded;          // This indicates if we have loaded the entities before or not. If we
                                  ...
                                  // shouldn't load them.
		std::map<CString,unsigned long> m_subStringItemNamesNumber;//this stores all the locations along with the total number fetched by sequences
