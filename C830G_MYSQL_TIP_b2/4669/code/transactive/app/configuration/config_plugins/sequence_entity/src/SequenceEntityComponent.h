/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/sequence_entity/src/SequenceEntityComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(SequenceEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define SequenceEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class EntityView;
    class EntityFrameworkView;
    class EntityDatabaseAccessor;

    class SequenceEntityComponent : public AbstractComponent
    {
    ...
    public:
         ...
         *                          represent
         */
        SequenceEntityComponent(const std::string& componentName,
         ...
         * Destructor
         */
	    virtual ~SequenceEntityComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ENTITIES;
        }
    ...
    private:
         ...
         */
        SequenceEntityComponent( const SequenceEntityComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        SequenceEntityComponent& operator=(const SequenceEntityComponent&);
...
#endif // !defined(SequenceEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
