/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/sequence_entity/src/EntityView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#include "app/configuration/config_plugins/sequence_entity/src/EntityView.h"
...
#include "app/configuration/config_plugins/sequence_entity/src/EntityListView.h"
...
namespace TA_Base_App
{
    ...
    const int EntityView::DESCRIPTION_FIELD_LENGTH = 90; // TD16193
...
END_MESSAGE_MAP()
    ...
    void EntityView::onButtonChangeLocation() 
    {
        ...
        try
        {
			...
			m_databaseAccessor->increaseLocationCount(dlg.getSelectedName(),currentLocation);
