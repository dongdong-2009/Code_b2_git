/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ecs_station_mode/src/ECSStationModeListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all ECS Station Modes available to be configured. This view must
  * communicate with the ECSStationModeDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_ECSStationModeListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_ECSStationModeListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_
...
{
    class ECSStationModeListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    ECSStationModeListView();

	    virtual ~ECSStationModeListView();

	    DECLARE_DYNCREATE(ECSStationModeListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(ECSStationModeListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(ECSStationModeListView)
    ...
    private:
	   ...
	   */
        ...
        *                 m_actions vector
        * @param LPARAM - This is a pointer to this object. ie the ECSStationModeListView object.
        */
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        static const int STATION_MODE_COLUMN;
        static const int LOCATION_COLUMN;
        static const int OPERATION_COLUMN;
        static const int TRACK_COLUMN;
        static const int CONDITION_COLUMN;
        static const int CONGESTION_COLUMN;
        ...
        static const CString CONGESTION_COLUMN_NAME;

        static const int APPLIED_COLUMN_WIDTH;
        static const int KEY_COLUMN_WIDTH;
        static const int STATION_MODE_COLUMN_WIDTH;
        static const int LOCATION_COLUMN_WIDTH;
        static const int OPERATION_COLUMN_WIDTH;
        static const int TRACK_COLUMN_WIDTH;
        static const int CONDITION_COLUMN_WIDTH;
        static const int CONGESTION_COLUMN_WIDTH;
        ...
        // sort the columns.
        std::map<unsigned long,ECSStationModeDatabaseAccessor::ECSStationModeRecord> m_currentDisplayedItems;
...
#endif // !defined(AFX_ECSStationModeListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
