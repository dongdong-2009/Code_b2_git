/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ecs_station_mode/src/ECSStationModeDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(ECSStationModeDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
#define ECSStationModeDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_
...
{
    class ECSStationModeDatabaseAccessor : public TA_Base_App::IDatabaseAccessor
    {
    ...
    public:
        ...
        struct ECSStationModeRecord
        {
            ...
            CString key;                // The ECS Station Mode primary key
            CString stationMode;        // The ECS Station Mode
            CString location;           // The Location description associated with the location key
            CString operation;          // The Operation description
            CString track;              // The Track
            CString condition;          // The Operating Condition 
            CString congestionLogic;    // The Operating Condition 
        };

        /**
         * Constructor
         */
        ECSStationModeDatabaseAccessor();


        /**
         * Destructor
         */
        virtual ~ECSStationModeDatabaseAccessor();


        /**
         * loadItems
         *
         * This will retrieve all the ECS Station Mode records from the database and store them in m_ECSStationModes.
         *
         * @exception DataException - This will be thrown if there is an error with the ECS Station Mode
         ...
         * getItemNames
         *
         * This method cannot be used by ECS Station Modes and will just assert
         */
         ...
         *
         * @return map<unsigned long, ECSStationModeRecord> - This is all the ECS Station Modes keyed
         *                                                    on their unique identifier
         */
        std::map<unsigned long,ECSStationModeRecord> getAllItemDetails(CProgressCtrl& progress);
         ...
         *
         * @return ECSStationModeRecord - This is all the ECS Station Mode details
         */
        ECSStationModeRecord getItemDetails(unsigned long identifier);
    ...
    private:
         ...
         */
        ECSStationModeDatabaseAccessor( const ECSStationModeDatabaseAccessor& theECSStationModeDatabaseAccessor){ };
         ...
         * Hidden as a private method so it is not used.
         */
        ECSStationModeDatabaseAccessor& operator=(const ECSStationModeDatabaseAccessor& pm);

        typedef std::map<unsigned long, TA_IRS_Core::IConfigECSStationMode*>    ConfigItems;
        typedef ConfigItems::iterator                                       ConfigItemsIt;


        ConfigItems             m_configItems;      // This is all the ECS Station Modes loaded from the database
        LocationKeyToNameMap    m_locationMap;
        

        bool m_isLoaded;                // This indicates if we have loaded the ECS Station Modes before or not.
                                        // If we have never loaded the ECS Station Modes then when we are told
                                        // to refresh we shouldn't load them.

    };
}

#endif // !defined(ECSStationModeDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
