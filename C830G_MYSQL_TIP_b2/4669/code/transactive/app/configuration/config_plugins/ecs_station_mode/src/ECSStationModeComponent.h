/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ecs_station_mode/src/ECSStationModeComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(ECSStationModeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define ECSStationModeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class ECSStationModeComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        ECSStationModeComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~ECSStationModeComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ECS_STATION_MODES;
        }
    ...
    private:
         ...
         */
        ECSStationModeComponent( const ECSStationModeComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        ECSStationModeComponent& operator=(const ECSStationModeComponent&);
...
#endif // !defined(ECSStationModeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
