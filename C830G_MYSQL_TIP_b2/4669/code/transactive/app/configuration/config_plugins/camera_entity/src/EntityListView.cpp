/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/camera_entity/src/EntityListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    {
        m_componentIcon = LoadIcon(GetModuleHandle(CameraEntityComponent::DLL_NAME), MAKEINTRESOURCE(IDI_CONFIG_ENTITY) );
    }
