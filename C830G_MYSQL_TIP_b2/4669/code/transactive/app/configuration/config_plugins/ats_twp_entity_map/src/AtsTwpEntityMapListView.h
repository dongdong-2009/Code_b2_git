/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_twp_entity_map/src/AtsTwpEntityMapListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * communicate with the AtsTwpEntityMapDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_AtsTwpEntityMapListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_AtsTwpEntityMapListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_
...
{
    class AtsTwpEntityMapListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsTwpEntityMapListView();

	    virtual ~AtsTwpEntityMapListView();

	    DECLARE_DYNCREATE(AtsTwpEntityMapListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(AtsTwpEntityMapListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(AtsTwpEntityMapListView)
    ...
    private:
	   ...
	   */
       ...
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        // sort the columns.
        std::map<unsigned long,AtsTwpEntityMapDatabaseAccessor::AtsTwpEntityMapRecord> m_currentDisplayedItems;
...
#endif // !defined(AFX_AtsTwpEntityMapListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
