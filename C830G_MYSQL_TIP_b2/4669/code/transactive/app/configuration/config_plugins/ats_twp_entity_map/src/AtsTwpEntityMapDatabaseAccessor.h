/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_twp_entity_map/src/AtsTwpEntityMapDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AtsTwpEntityMapDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
#define AtsTwpEntityMapDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_
...
{
    class AtsTwpEntityMapDatabaseAccessor : public TA_Base_App::IDatabaseAccessor
    {
    ...
    public:
         ...
         * Constructor
         */
        AtsTwpEntityMapDatabaseAccessor();


        /**
         * Destructor
         */
        virtual ~AtsTwpEntityMapDatabaseAccessor();


        /**
         * loadItems
         *
         * This will retrieve all the ATS PSD Entity Map records from the database and store them in m_AtsTwpEntityMaps.
         *
         ...
         *
         * @return map<unsigned long, AtsTwpEntityMapRecord> - This is all the ATS PSD Entity Maps keyed
         *                                                    on their unique identifier
         */
        std::map<unsigned long,AtsTwpEntityMapRecord> getAllItemDetails(CProgressCtrl& progress);
         ...
         *
         * @return AtsTwpEntityMapRecord - This is all the ATS PSD Entity Map details
         */
        AtsTwpEntityMapRecord getItemDetails(unsigned long identifier);
    ...
    protected:
		AtsTwpEntityMapRecord formatItemDetails(TA_IRS_Core::IConfigAtsTWPData* config);
    ...
    private:
         ...
         */
        AtsTwpEntityMapDatabaseAccessor( const AtsTwpEntityMapDatabaseAccessor& theAtsTwpEntityMapDatabaseAccessor){ };
         ...
         * Hidden as a private method so it is not used.
         */
        AtsTwpEntityMapDatabaseAccessor& operator=(const AtsTwpEntityMapDatabaseAccessor& pm);

        typedef std::map<unsigned long, TA_IRS_Core::IConfigAtsTWPData*>   ConfigItems;
...
#endif // !defined(AtsTwpEntityMapDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
