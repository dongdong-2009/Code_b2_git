/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_twp_entity_map/src/AtsTwpEntityMapFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_AtsTwpEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_AtsTwpEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class AtsTwpEntityMapFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsTwpEntityMapFrameworkView();

	    DECLARE_DYNCREATE(AtsTwpEntityMapFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(AtsTwpEntityMapFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~AtsTwpEntityMapFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(AtsTwpEntityMapFrameworkView)
...
#endif // !defined(AFX_AtsTwpEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
