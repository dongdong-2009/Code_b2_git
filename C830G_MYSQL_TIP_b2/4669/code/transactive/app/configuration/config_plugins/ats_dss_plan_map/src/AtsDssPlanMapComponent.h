/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_dss_plan_map/src/AtsDssPlanMapComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AtsDssPlanMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AtsDssPlanMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AtsDssPlanMapComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        AtsDssPlanMapComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~AtsDssPlanMapComponent();
    ...
    private:
         ...
         */
        AtsDssPlanMapComponent( const AtsDssPlanMapComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AtsDssPlanMapComponent& operator=(const AtsDssPlanMapComponent&);
...
#endif // !defined(AtsDssPlanMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
