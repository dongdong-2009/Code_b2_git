/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_dss_plan_map/src/AtsDssPlanMapListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
//using TA_IRS_App::AtsDssPlanMapDatabaseAccessor::AtsDssPlanMap;
...
END_MESSAGE_MAP()
    ...
    void AtsDssPlanMapListView::loadAllItems()
    {
        ...
        //using AtsDssPlanMapDatabaseAccessor::AtsDssPlanMap;
