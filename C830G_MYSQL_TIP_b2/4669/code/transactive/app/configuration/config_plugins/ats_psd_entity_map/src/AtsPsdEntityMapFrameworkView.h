/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_psd_entity_map/src/AtsPsdEntityMapFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_AtsPsdEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_AtsPsdEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class AtsPsdEntityMapFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsPsdEntityMapFrameworkView();

	    DECLARE_DYNCREATE(AtsPsdEntityMapFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(AtsPsdEntityMapFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~AtsPsdEntityMapFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(AtsPsdEntityMapFrameworkView)
...
#endif // !defined(AFX_AtsPsdEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
