/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_branch_track/src/AtsBranchTrackListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all Ats Branch Tracks available to be configured. This view must
  * communicate with the AtsBranchTrackDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_AtsBranchTrackListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_AtsBranchTrackListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_
...
{
    class AtsBranchTrackListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsBranchTrackListView();

	    virtual ~AtsBranchTrackListView();

	    DECLARE_DYNCREATE(AtsBranchTrackListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(AtsBranchTrackListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(AtsBranchTrackListView)
    ...
    private:
	   ...
	   */
       ...
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        // sort the columns.
        std::map<unsigned long,TA_IRS_App::AtsBranchTrackDatabaseAccessor::AtsBranchTrackRecord> m_currentDisplayedItems;
...
#endif // !defined(AFX_AtsBranchTrackListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
