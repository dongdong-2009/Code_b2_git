/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station/src/PAStationFrameworkView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int PaStationFrameworkView::TOP_PANE      = 0;
    const int PaStationFrameworkView::BOTTOM_PANE   = 1;
    const int PaStationFrameworkView::ZERO_COLUMN   = 0;
    
    const int PaStationFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(PaStationFrameworkView, CView)


    PaStationFrameworkView::PaStationFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(PaStationFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(PaStationFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    BOOL PaStationFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void PaStationFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* PaStationFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(PaStationDetailView);
    }


    CRuntimeClass* PaStationFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(PaStationListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // PaStationFrameworkView diagnostics

    #ifdef _DEBUG
    void PaStationFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void PaStationFrameworkView::Dump(CDumpContext& dc) const
    {
