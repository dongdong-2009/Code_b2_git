/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station/src/PAStationDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#include "core/data_access_interface/pa_4669/src/IConfigPaStation.h"
...
namespace TA_IRS_App
{
    ...
    std::map<CString,unsigned long> PaStationDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
