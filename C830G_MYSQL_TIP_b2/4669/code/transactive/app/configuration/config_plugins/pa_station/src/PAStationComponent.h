/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station/src/PAStationComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(PaStationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PaStationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PaStationComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        PaStationComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PaStationComponent();
    ...
    private:
         ...
         */
        PaStationComponent( const PaStationComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PaStationComponent& operator=(const PaStationComponent&);
...
#endif // !defined(PaStationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
