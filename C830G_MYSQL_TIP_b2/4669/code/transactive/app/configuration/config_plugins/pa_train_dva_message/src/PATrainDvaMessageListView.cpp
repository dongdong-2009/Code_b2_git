/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_train_dva_message/src/PATrainDvaMessageListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * with the PaTrainDvaMessageDetailView as this will show the details of the item selected in this view.
  */
...
namespace TA_IRS_App
{
    ...
    const CString PaTrainDvaMessageListView::NEW = "New";
    const CString PaTrainDvaMessageListView::MODIFIED = "Modified";
    const CString PaTrainDvaMessageListView::UPTODATE = "";

    const bool PaTrainDvaMessageListView::ASCENDING = true;
    const bool PaTrainDvaMessageListView::DESCENDING = false;

    IMPLEMENT_DYNCREATE(PaTrainDvaMessageListView, CListView)


    PaTrainDvaMessageListView::PaTrainDvaMessageListView()
    :     m_sortOrder(DESCENDING),        // Set to descending so the first time we sort it switches to ASCENDING
          m_sortColumn(PaTrainDvaMessageListColumns::getDefaultSortColumn())
    {
        m_componentIcon = LoadIcon(GetModuleHandle(PaTrainDvaMessageComponent::DLL_NAME), MAKEINTRESOURCE(IDI_CONFIG_PA_TRAIN_DVA_MESSAGES) );
    }
...
BEGIN_MESSAGE_MAP(PaTrainDvaMessageListView, AbstractListView)
	//{{AFX_MSG_MAP(PaTrainDvaMessageListView)
	ON_WM_CREATE()
    ON_WM_SIZE()
...
END_MESSAGE_MAP()
    ...
    int PaTrainDvaMessageListView::OnCreate(LPCREATESTRUCT lpCreateStruct) 
    {
    ...
    void PaTrainDvaMessageListView::OnInitialUpdate() 
    {
    ...
    void PaTrainDvaMessageListView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    void PaTrainDvaMessageListView::loadAllItems()
    {
        ...
        PaTrainDvaMessageDatabaseAccessor* dbAccessor = dynamic_cast<PaTrainDvaMessageDatabaseAccessor*>(getDatabaseAccessor());
        ...
        for (std::map<unsigned long, PaTrainDvaMessageDatabaseAccessor::PaTrainDvaMessageRecord>::iterator iter 
    ...
    void PaTrainDvaMessageListView::itemDetailsChanged(unsigned long id, const CString& name)
    {
        ...
        PaTrainDvaMessageDatabaseAccessor::PaTrainDvaMessageRecord details = dbAccessor->getItemDetails( id );
        ...
        std::map<unsigned long, PaTrainDvaMessageDatabaseAccessor::PaTrainDvaMessageRecord>::iterator matching;
        ...
        else
        {
            m_currentDisplayedItems.insert( 
                std::map<unsigned long, PaTrainDvaMessageDatabaseAccessor::PaTrainDvaMessageRecord>::value_type(id, details) );
        }
    ...
    void PaTrainDvaMessageListView::copyItem()
    {
    ...
    void PaTrainDvaMessageListView::newItem()
    {
 ...
 /*   void PaTrainDvaMessageListView::deleteItem()
    {
    ...
    void PaTrainDvaMessageListView::onColumnclick(NMHDR* pNMHDR, LRESULT* pResult) 
    {
	...
	void PaTrainDvaMessageListView::updateHeaderSort(const unsigned int column)
	{
        ...
        headerItem.hbm = (HBITMAP)LoadImage(GetModuleHandle(PaTrainDvaMessageComponent::DLL_NAME), MAKEINTRESOURCE(resourceToLoad), IMAGE_BITMAP, 0, 0, LR_LOADMAP3DCOLORS);
    ...
    int CALLBACK PaTrainDvaMessageListView::compareItems(LPARAM index1, LPARAM index2, LPARAM listCtrl)
    {
        PaTrainDvaMessageListView* list = reinterpret_cast<PaTrainDvaMessageListView*>(listCtrl);
        // Double check it has converted ok
        list = dynamic_cast<PaTrainDvaMessageListView*>(list);
        ...
        std::map<unsigned long, PaTrainDvaMessageDatabaseAccessor::PaTrainDvaMessageRecord>::iterator item1 
                                                        = list->m_currentDisplayedItems.find( index1 );
        std::map<unsigned long, PaTrainDvaMessageDatabaseAccessor::PaTrainDvaMessageRecord>::iterator item2 
    ...
    void PaTrainDvaMessageListView::OnDraw(CDC* pDC)
    {
    ...
    /////////////////////////////////////////////////////////////////////////////
    // PaTrainDvaMessageListView diagnostics

    #ifdef _DEBUG
    void PaTrainDvaMessageListView::AssertValid() const
    {
	    AbstractListView::AssertValid();
    }

    void PaTrainDvaMessageListView::Dump(CDumpContext& dc) const
    {
