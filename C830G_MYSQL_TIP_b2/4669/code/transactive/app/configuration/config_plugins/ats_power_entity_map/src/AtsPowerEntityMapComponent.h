/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_power_entity_map/src/AtsPowerEntityMapComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AtsPowerEntityMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AtsPowerEntityMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AtsPowerEntityMapComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        AtsPowerEntityMapComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~AtsPowerEntityMapComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ATS_POWER_ENTITY_MAP;
        }
    ...
    private:
         ...
         */
        AtsPowerEntityMapComponent( const AtsPowerEntityMapComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AtsPowerEntityMapComponent& operator=(const AtsPowerEntityMapComponent&);
...
#endif // !defined(AtsPowerEntityMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
