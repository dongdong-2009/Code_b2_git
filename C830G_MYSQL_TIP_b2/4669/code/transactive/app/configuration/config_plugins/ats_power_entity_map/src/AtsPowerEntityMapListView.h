/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_power_entity_map/src/AtsPowerEntityMapListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * communicate with the AtsPowerEntityMapDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_AtsPowerEntityMapListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_AtsPowerEntityMapListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_
...
{
    class AtsPowerEntityMapListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsPowerEntityMapListView();

	    virtual ~AtsPowerEntityMapListView();

	    DECLARE_DYNCREATE(AtsPowerEntityMapListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(AtsPowerEntityMapListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(AtsPowerEntityMapListView)
    ...
    private:
	   ...
	   */
        ...
        *                 m_actions vector
        * @param LPARAM - This is a pointer to this object. ie the AtsPowerEntityMapListView object.
        */
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        static const int       SUBSECTION_COLUMN;			
        ...
        static const CString   SUBSECTION_COLUMN_NAME;	
        ...
        static const int       SUBSECTION_COLUMN_WIDTH;	
        ...
        // sort the columns.
        std::map<unsigned long,AtsPowerEntityMapDatabaseAccessor::AtsPowerEntityMapRecord> m_currentDisplayedItems;
...
#endif // !defined(AFX_AtsPowerEntityMapListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
