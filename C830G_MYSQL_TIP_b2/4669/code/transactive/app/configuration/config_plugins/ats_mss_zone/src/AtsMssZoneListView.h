/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_mss_zone/src/AtsMssZoneListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all Ats MSS Zones available to be configured. This view must
  * communicate with the AtsMssZoneDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_AtsMssZoneListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_AtsMssZoneListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_
...
{
    class AtsMssZoneListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
	    ...
	    virtual ~AtsMssZoneListView();

	    DECLARE_DYNCREATE(AtsMssZoneListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(AtsMssZoneListView)
	    public:
    ...
    private:
	   ...
	   */
        ...
        *                 m_actions vector
        * @param LPARAM - This is a pointer to this object. ie the AtsMssZoneListView object.
        */
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        // sort the columns.
        std::map<unsigned long,AtsMssZoneDatabaseAccessor::AtsMssZoneRecord> m_currentDisplayedItems;
...
#endif // !defined(AFX_AtsMssZoneListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
