/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/tis_ratis_destination/src/TisRatisDestinationDatabaseAccessor.cpp $
  * @author:  James
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    std::map<CString,unsigned long> TisRatisDestinationDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
