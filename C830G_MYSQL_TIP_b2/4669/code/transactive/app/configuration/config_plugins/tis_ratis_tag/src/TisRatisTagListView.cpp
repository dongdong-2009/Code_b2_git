/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/tis_ratis_tag/src/TisRatisTagListView.cpp $
  * @author:  James
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all Tis Ratis Tags available to be configured. This view must communicate
  * with the TisRatisTagDetailView as this will show the details of the item selected in this view.
  */
...
//using TA_IRS_App::TisRatisTagDatabaseAccessor::TisRatisTagRecord;
typedef TA_IRS_App::TisRatisTagDatabaseAccessor::TisRatisTagRecord TisRatisTagRecord;

using  namespace TA_Base_App::TA_Configuration;

namespace TA_IRS_App
{
    // These are the possible values for the status of each Tis Ratis Tag
    const CString TisRatisTagListView::NEW = "New";
    const CString TisRatisTagListView::MODIFIED = "Modified";
    const CString TisRatisTagListView::UPTODATE = "";

    const bool TisRatisTagListView::ASCENDING = true;
    const bool TisRatisTagListView::DESCENDING = false;

    IMPLEMENT_DYNCREATE(TisRatisTagListView, CListView)


    TisRatisTagListView::TisRatisTagListView()
    :     m_sortOrder(DESCENDING),        // Set to descending so the first time we sort it switches to ASCENDING
          m_sortColumn(TisRatisTagListColumns::getDefaultSortColumn())
    {
        m_componentIcon = LoadIcon(GetModuleHandle(TisRatisTagComponent::DLL_NAME), MAKEINTRESOURCE(IDI_CONFIG_TIS_RATIS_TAGS) );
    }
...
BEGIN_MESSAGE_MAP(TisRatisTagListView, AbstractListView)
	//{{AFX_MSG_MAP(TisRatisTagListView)
	ON_WM_CREATE()
    ON_WM_SIZE()
...
END_MESSAGE_MAP()
    ...
    int TisRatisTagListView::OnCreate(LPCREATESTRUCT lpCreateStruct) 
    {
    ...
    void TisRatisTagListView::OnInitialUpdate() 
    {
    ...
    void TisRatisTagListView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    void TisRatisTagListView::loadAllItems()
    {
        ...
        TisRatisTagDatabaseAccessor* dbAccessor = dynamic_cast<TisRatisTagDatabaseAccessor*>(getDatabaseAccessor());
        TA_ASSERT( dbAccessor != NULL, "DB accessor could not be cast to an Tis Ratis Tag one");
        ...
        for (std::map<unsigned long,TisRatisTagRecord>::iterator iter = m_currentDisplayedItems.begin(); 
    ...
    void TisRatisTagListView::itemDetailsChanged(unsigned long id, const CString& name)
    {
        ...
        TisRatisTagRecord details = dbAccessor->getItemDetails( id );
        ...
        std::map<unsigned long,TisRatisTagRecord>::iterator matching;
        ...
        {
            m_currentDisplayedItems.insert( std::map<unsigned long,TisRatisTagRecord>::value_type(id,details) );
        }
    ...
    void TisRatisTagListView::copyItem()
    {
    ...
    void TisRatisTagListView::newItem()
    {
    ...
    void TisRatisTagListView::deleteItem()
    {
    ...
    void TisRatisTagListView::onColumnclick(NMHDR* pNMHDR, LRESULT* pResult) 
    {
	...
	void TisRatisTagListView::updateHeaderSort(const unsigned int column)
	{
        ...
        headerItem.hbm = (HBITMAP)LoadImage(GetModuleHandle(TisRatisTagComponent::DLL_NAME), MAKEINTRESOURCE(resourceToLoad), IMAGE_BITMAP, 0, 0, LR_LOADMAP3DCOLORS);
    ...
    int CALLBACK TisRatisTagListView::compareItems(LPARAM index1, LPARAM index2, LPARAM listCtrl)
    {
        TisRatisTagListView* list = reinterpret_cast<TisRatisTagListView*>(listCtrl);
        // Double check it has converted ok
        list = dynamic_cast<TisRatisTagListView*>(list);
        ...
        std::map<unsigned long,TisRatisTagRecord>::iterator item1 = list->m_currentDisplayedItems.find( index1 );
        std::map<unsigned long,TisRatisTagRecord>::iterator item2 = list->m_currentDisplayedItems.find( index2 );
    ...
    void TisRatisTagListView::OnDraw(CDC* pDC)
    {
    ...
    /////////////////////////////////////////////////////////////////////////////
    // TisRatisTagListView diagnostics

    #ifdef _DEBUG
    void TisRatisTagListView::AssertValid() const
    {
	    AbstractListView::AssertValid();
    }

    void TisRatisTagListView::Dump(CDumpContext& dc) const
    {
