/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_fixed_block_map/src/AtsFixedBlockMapComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AtsFixedBlockMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define AtsFixedBlockMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class AtsFixedBlockMapComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        AtsFixedBlockMapComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~AtsFixedBlockMapComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ATS_FIXED_BLOCK_MAP;
        }
    ...
    private:
         ...
         */
        AtsFixedBlockMapComponent( const AtsFixedBlockMapComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        AtsFixedBlockMapComponent& operator=(const AtsFixedBlockMapComponent&);
...
#endif // !defined(AtsFixedBlockMapComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
