/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ecs_station_colour/src/ECSStationColourDatabaseAccessor.h $
  * @author:  Andy Siow
  * @version: $Revision: #1 $
  *
...
#if !defined(ECSStationColourDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
#define ECSStationColourDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_
...
{
    class ECSStationColourDatabaseAccessor : public TA_Base_App::IDatabaseAccessor
    {
    ...
    public:
         ...
         * Constructor
         */
        ECSStationColourDatabaseAccessor();


        /**
         * Destructor
         */
        virtual ~ECSStationColourDatabaseAccessor();


        /**
         * loadItems
         *
         * This will retrieve all the items from the database and store them in m_alarm severities.
         *
         * @exception DataException - This will be thrown if there is an error with the ECSStationColour data and it
         ...
         * getItemNames
         *
         * This returns all ECSStationColour names and keys to the caller. 
         ...
         *
         * @return map<CString, unsigned long> - This returns a map of all the ECSStationColour names. The map also
         *                                       contains the identifier of the ECSStationColour as the caller will probably
         *                                       need this later to specify a specific ECSStationColour.
         *
         * @exception DataException - This will be thrown if there is an error with the ECSStationColour's data and it
         *                            cannot be retrieved for some reason.
         * @exception DatabaseException - This will be thrown if there is an error communicating with the
         *                                database.
         */
         ...
         *                been applied.
         */
         bool areCurrentChangesPending(std::vector<std::string>& AlarmSeveritiesNotApplied);
    ...
    private:
         ...
         */
        ECSStationColourDatabaseAccessor( const ECSStationColourDatabaseAccessor& theECSStationColourDatabaseAccessor){ };
         ...
         * Hidden as a private method so it is not used.
         */
        ECSStationColourDatabaseAccessor& operator=(const ECSStationColourDatabaseAccessor& pm);


        // This is a map of IConfigECSStationColourData* objects stored by their ECSStationColour key (unsigned long)
        typedef std::map<unsigned long, TA_Base_Core::IConfigECSStationColourData*> LoadedECSStationColours;

        LoadedECSStationColours m_ecsStationColours;   // This is all the alarm severities loaded from the database

        bool m_isLoaded;          // This indicates if we have loaded the alarm severities before or not. If we
                                  // have never loaded the alarm severities then when we are told to refresh we
                                  // shouldn't load them.

    };
}

#endif // !defined(ECSStationColourDatabaseAccessor_40D09158_85E4_464f_81D1_E7B9225238D9__INCLUDED_)
