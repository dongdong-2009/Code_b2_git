/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station_dva_message/src/PAStationDvaMessageDetailView.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2011/01/24 14:43:04 $
...
namespace TA_IRS_App
{
    ...
    private:
		...
		std::vector<TA_Base_Core::PaDvaMessageAccessFactory::TisMessage> getAllCurrentLibraryTisMessage();

		bool updateConfigItemsTisMessage(unsigned long tisKey);
    ...
    private:
        ...
        TA_Base_Core::IConfigPaTisMessageMap* m_configItem; // The current PA Station DVA Message the user
		...
		std::vector<TA_Base_Core::PaDvaMessageAccessFactory::TisMessage> m_currentLocationTisMessages;
    };
/////////////////////////////////////////////////////////////////////////////
