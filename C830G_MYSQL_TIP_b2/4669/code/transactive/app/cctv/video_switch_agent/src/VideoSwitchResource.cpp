/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/src/VideoSwitchResource.cpp $
        ...
        , m_userPrivilegeVerifier( UserPrivilegeVerifier::getInstance() ) // HuangQi++
    {
		if ( 0 == m_videoSwitchResourceData.get() )
		{
            TA_THROW( TA_Base_Core::VideoSwitchAgentInternalException( 
                ...
                "The provided entity data is not VideoSwitchResource data." ) );
		}
