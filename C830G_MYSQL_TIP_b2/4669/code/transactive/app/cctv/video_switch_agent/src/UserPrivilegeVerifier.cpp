/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/src/UserPrivilegeVerifier.cpp $
...
{
    UserPrivilegeVerifier* UserPrivilegeVerifier::s_pInstance = 0;
    TA_Base_Core::NonReEntrantThreadLockable UserPrivilegeVerifier::s_singletonLock;

    UserPrivilegeVerifier& UserPrivilegeVerifier::getInstance()
    {
        if ( 0 == s_pInstance )
        {
            ...
            if ( 0 == s_pInstance )
            {
                s_pInstance = new UserPrivilegeVerifier();
                TA_ASSERT( ( 0 != s_pInstance ), "Can't not create instance of UserPrivilegeVerifier" );
            }
        }
    ...
    UserPrivilegeVerifier::UserPrivilegeVerifier()
        ...
        //: m_rightsLibrary( m_rightsFactory.buildRightsLibrary( TA_Base_Bus::ALWAYS_TRUE_RL ) ),
    ...
    // verifyRights
    //
    void UserPrivilegeVerifier::verifyRights( const std::string& sessionId, 
