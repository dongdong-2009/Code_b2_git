/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/src/StateUpdateSubscriber.cpp $
...
namespace TA_IRS_App
{
    ...
    void StateUpdateSubscriber::receiveSpecialisedMessage( const TA_Base_Core::StateUpdateMessageCorbaDef& message )
    {
        ...
        else 
        {
            ...
            TA_Base_Bus::RecordingUnitCorbaDef::RecordingUnitState* recordingUnitState = 0;
            ...
            TA_Base_Bus::MovementControlCorbaDef::CameraPreset* preset = 0;
            ...
            TA_Base_Bus::BVSStageCorbaDef::BVSStageState* bvsStageState = 0;
           ...
           TA_Base_Bus::VideoInputCorbaDef::VideoInputState* videoInputState = 0;
			...
			TA_Base_Bus::SwitchManagerCorbaDef::AlarmStack* alarmStack = 0;
	...
	// updateAlarmStack
	//
	void StateUpdateSubscriber::updateAlarmStack( TA_Base_Bus::SwitchManagerCorbaDef::AlarmStack& stack)
	{
