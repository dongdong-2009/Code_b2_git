/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/src/VideoInput.cpp $
...
namespace TA_IRS_App
{
	...
	VideoInput::VideoInput( TA_Base_Core::IEntityDataPtr entityData )
        ...
        m_videoInputData( boost::dynamic_pointer_cast<TA_Base_Core::VideoInput>(entityData) ),
          m_pdVideoInput( 0 ),
          m_superimposedTextControl( 0 ),  // HuangQi++
    ...
    //
    TA_Base_Bus::VideoInputCorbaDef::SupportedVideoInputFeatures VideoInput::getSupportedVideoInputFeatures()
    {
        TA_Base_Bus::VideoInputCorbaDef::SupportedVideoInputFeatures features;
    ...
    TA_Base_Bus::VideoInputCorbaDef::VideoInputState* VideoInput::getVideoInputState()
    {
        ...
        if ( 0 == state )
        {
            throw TA_Base_Bus::VideoSwitchAgentException( "Failed to create new state object." );
        }
	...
	//
    TA_Base_Bus::SuperimposedTextControlCorbaDef_ptr VideoInput::getSuperimposedTextControl()
	{
    ...
    void VideoInput::createControls()
    {
        ...
        try
        {
            ...
            if ( PDInterfaceFactory::isSuperimposedTextControlSupported() )
            {
