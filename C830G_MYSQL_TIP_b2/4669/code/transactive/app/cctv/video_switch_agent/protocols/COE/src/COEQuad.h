...
/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/COEQuad.h $
  * @author:   Rob Young
  * @version:  $Revision: #2 $
  *
...
{
    class COEQuad : public IPDQuad, public virtual IStateValidationItem
    {
    public:
        ...
        COEQuad( TA_Base_Core::QuadPtr QuadData );
        ...
        /**
          ...
          */
        virtual void requestSwitchOfInput( TA_Base_Bus::QuadCorbaDef::EQuadSegment segment, unsigned long videoInputEntityKey, bool isDemand );
    ...
    private:
        ...
        COEQuad( const COEQuad& theCOEQuad );
        COEQuad& operator=( const COEQuad& );
        ...
        TA_Base_Bus::QuadCorbaDef::QuadState m_quadState;    // The current state of this Quad.
