/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/TrainCameraAlarmAckCommand.cpp $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    //
    // TrainCameraAlarmAckCommand (IAgentRequestCommand intended constructor)
    //
    TrainCameraAlarmAckCommand::TrainCameraAlarmAckCommand( unsigned long stageId, unsigned long monitorId )
        : AbstractCOERequestCommand()
    {
        ...
        commandPacket[ TA_COE::COMMAND_BYTE ] = TA_COE::TRAIN_ALARM_ACK_COMMAND;
    ...
    // processResponse
    //
    bool TrainCameraAlarmAckCommand::processResponse( const std::vector< unsigned char >& data )
    {
        FUNCTION_ENTRY( "processResponse" );
		//theres not alot we can do except make sure the response is valid
        if ( processGenericResponsePacketAttributes( data,  TA_COE::TRAIN_ALARM_ACK_COMMAND, TA_COE::PACKET_HEADER_LENGTH,
