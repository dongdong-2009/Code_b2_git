/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/COEVideoInput.cpp $
  * @author:   Rob Young
  * @version:  $Revision: #2 $
  *
...
namespace TA_IRS_App
{
	...
	void COEVideoInput::verifyUserHoldsLock( const std::string& sessionId )
    {
		...
		{
			throw TA_Base_Bus::VideoSwitchAgentException( m_lockOwner.c_str() );
		}
	}
