...
/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/COECamera.h $
  * @author:   Rob Young
  * @version:  $Revision: #2 $
  *
...
{
    class COECamera : public IPDCamera
	{
	public:
    ...
    private:
        ...
        COECamera( const COECamera& theCOECamera );
        COECamera& operator=( const COECamera& );
