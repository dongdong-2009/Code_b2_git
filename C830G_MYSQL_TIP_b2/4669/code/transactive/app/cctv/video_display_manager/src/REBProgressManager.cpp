/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_display_manager/src/REBProgressManager.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
void REBProgressManager::BeginProgressDialog()
{
    ...
    CWnd::FromHandle(m_hwndParent)->GetWindowRect(&ParentRect);
    CWnd::FromHandle(g_hwndProgress)->GetWindowRect(&ChildRect);
//    LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,"libo ParentRect.x = %d,parentRect.y = %d,cx = %d, cy = %d",ParentRect.left,ParentRect.top,ParentRect.Width(),ParentRect.Height());
//    LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,"libo ChildRect.x = %d,ChildRect.y = %d,cx = %d, cy = %d",ChildRect.left,ChildRect.top,ChildRect.Width(),ChildRect.Height());
    ::MoveWindow(g_hwndProgress,ParentRect.left+(ParentRect.Width()-ChildRect.Width())/2.0,ParentRect.top+(ParentRect.Height()-ChildRect.Height())/2.0,ChildRect.Width(),ChildRect.Height(),TRUE);
//    CWnd::FromHandle(g_hwndProgress)->GetWindowRect(&ChildRect);
//    LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,"libo_new ChildRect.x = %d,ChildRect.y = %d,cx = %d, cy = %d",ChildRect.left,ChildRect.top,ChildRect.Width(),ChildRect.Height());
    // libo 17762
