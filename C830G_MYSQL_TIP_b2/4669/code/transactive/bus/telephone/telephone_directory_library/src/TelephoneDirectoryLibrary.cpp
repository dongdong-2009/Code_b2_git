/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/bus/telephone/telephone_directory_library/src/TelephoneDirectoryLibrary.cpp $
  * @author:  Raymond Pau
  * @version: $Revision: #1 $
  *
...
vector<TelephoneDirectoryEntryData> TelephoneDirectoryLibrary::getAllEntries()
{
    ...
    try
    {
		...
		TelephoneSubDirectoryAccessFactory::getInstance().getAllAssociatedSubdirectoryMap();
		//++libo
