...
namespace TA_IRS_Bus
{
    ...
    bool LocationCache::isInControlOfLocation(unsigned long locationKey)
    {
        ...
        LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugDebug, "CL-21050: Entered Function isInControlOfLocation" );
        
        if ( 0 == locationKey )
        {
            LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugDebug, "CL-21050: Exited Function isInControlOfLocation with true" );
            return true;
        }
        ...
        LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugDebug, "CL-21050: Exited Function isInControlOfLocation with %s", ( findIter != m_controlledLocations.end() ) ? "true" : "false" );
