...
namespace TA_IRS_Bus
{
          ...
          m_radioInFallback( false )
    {
        ...
        m_pecNumberLookupTable[ ProtocolPecTypes::PecOne ] = "A1";  //limin TD20582
        m_pecNumberLookupTable[ ProtocolPecTypes::PecTwo ] = "B2";  //limin TD20582
        m_pecNumberLookupTable[ ProtocolPecTypes::PecThree ] = "A3";//limin TD20582
        m_pecNumberLookupTable[ ProtocolPecTypes::PecFour ] = "B4"; //limin TD20582
    ...
    bool PECCallFactory::trainHasPecAnsweredByDriver( CommonTypes::TrainIdType trainId )
    {
              ...
              callEntryIter != calls.end(); ++callEntryIter )
        {
            ...
            if ( PecTypes::PecSourceDriver == callEntry->getPecSource() && callEntry->getTrainId() == trainId )//limin TD20656
            {
                FUNCTION_EXIT;
                return true;
            }
    ...
    TrainInformationTypes::TrainDetails PECCallFactory::getDetailsForTrain( CommonTypes::TrainIdType trainId )
    {
        ...
        FUNCTION_EXIT;
        return TrainInformationTypes::TrainDetails();
    }
