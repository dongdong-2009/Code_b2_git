/**
  ...
  * @version: $Revision: #2 $
  *
  * Last modification: $Date: 2010/08/05 $
...
namespace TA_IRS_Bus
{
    ...
    public:
		...
		/*
		* Posts a message to UI to display MessageBox
		*/
		...
		void activateCCTV(){ setStatusActivatingCctv(); PostMessage(ACTIVATE_CCTV);}
    ...
    private:
        ...
        */
		...
		static const DWORD SHOW_ERROR_MESSAGE,ACTIVATE_CCTV;
