/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaZoneGroupCachedMap.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         *
         */
        void refreshKeyToPaZoneGroupRecordMap(unsigned long locationKey = TA_Base_Core::DatabaseKey::getInvalidKey()) ;
         ...
         *
         */
        void removePaZoneGroup(unsigned int locationKey, 
    ...
    public: // Give public access to these filter classes
        ...
        public:
            ...
            ZoneGroupFilter(bool isOccZoneGroup, unsigned long depotLocationKey);
            virtual bool isMatch(const PaZoneRecord& record) const;       
            
        private:
            bool m_isOccZoneGroup;
