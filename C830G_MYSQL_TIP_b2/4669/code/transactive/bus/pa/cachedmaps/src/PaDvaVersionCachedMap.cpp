/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaDvaVersionCachedMap.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Bus
{
         ...
         //throw (TA_Base_Core::InvalidPasConfigurationException)
    {
        ...
        // OCC only has public messages 
        result.m_privateAdhoc1 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC1);
        result.m_privateAdhoc2 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC2);
        result.m_privateAdhoc3 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC3);
        result.m_privateAdhoc4 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC4);
        result.m_privateAdhoc5 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC5);
        result.m_privateAdhoc6 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC6);
        result.m_privatePreRecorded = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PRIVATE_PRERECORDED);
    
        // DEPOT only has private messages
        result.m_publicAdhoc1 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC1);
        result.m_publicAdhoc2 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC2);
        result.m_publicAdhoc3 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC3);
        result.m_publicAdhoc4 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC4);
        result.m_publicAdhoc5 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC5);
        result.m_publicAdhoc6 = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC6);
        result.m_publicPreRecorded = item.getVersionData(TA_Base_Core::IPaDvaMessageVersion::PUBLIC_PRERECORDED);
        ...
        if (writeChangesToDataBase)
        {
            ...
            if (isExistingRecord)
            {
                ...
                TA_Base_Core::IPaDvaMessageVersion* paDvaMessageVersion = 
                    TA_Base_Core::PaDvaMessageVersionAccessFactory::getInstance().getPaDvaMessageVersion(record.m_pKey, true);
            ...
            try
            {
                ...
                configPaDvaMessageVersion->setVersionData(record.m_privateAdhoc1, TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC1);
                configPaDvaMessageVersion->setVersionData(record.m_privateAdhoc2, TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC2);
                configPaDvaMessageVersion->setVersionData(record.m_privateAdhoc3, TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC3);
                configPaDvaMessageVersion->setVersionData(record.m_privateAdhoc4, TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC4);
                configPaDvaMessageVersion->setVersionData(record.m_privateAdhoc5, TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC5);
                configPaDvaMessageVersion->setVersionData(record.m_privateAdhoc6, TA_Base_Core::IPaDvaMessageVersion::PRIVATE_ADHOC6);
                configPaDvaMessageVersion->setVersionData(record.m_privatePreRecorded, TA_Base_Core::IPaDvaMessageVersion::PRIVATE_PRERECORDED);
                configPaDvaMessageVersion->setVersionData(record.m_publicAdhoc1, TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC1);
                configPaDvaMessageVersion->setVersionData(record.m_publicAdhoc2, TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC2);
                configPaDvaMessageVersion->setVersionData(record.m_publicAdhoc3, TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC3);
                configPaDvaMessageVersion->setVersionData(record.m_publicAdhoc4, TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC4);
                configPaDvaMessageVersion->setVersionData(record.m_publicAdhoc5, TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC5);
                configPaDvaMessageVersion->setVersionData(record.m_publicAdhoc6, TA_Base_Core::IPaDvaMessageVersion::PUBLIC_ADHOC6);
                configPaDvaMessageVersion->setVersionData(record.m_publicPreRecorded, TA_Base_Core::IPaDvaMessageVersion::PUBLIC_PRERECORDED);
