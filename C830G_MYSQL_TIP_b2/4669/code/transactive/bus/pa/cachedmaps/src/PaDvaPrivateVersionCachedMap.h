/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaDvaPrivateVersionCachedMap.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
#if !defined PaDvaPrivateVersionCachedMap_H
#define PaDvaPrivateVersionCachedMap_H
...
namespace TA_IRS_Bus
{
    ...
    : 
    public GenericCachedMap<DvaPrivateVersionRecord, TA_Base_Core::IPaDvaMessagePrivateVersion>
    {
    public:
    

        PaDvaPrivateVersionCachedMap();
        ~PaDvaPrivateVersionCachedMap();
         ...
         */
        DvaPrivateVersionRecord getRecordFromLocation(unsigned long locationKey);
         ...
         *
         */
        void setRecord(DvaPrivateVersionRecord& record, bool writeChangesToDatabase = false);
    ...
    protected:
         ...
         *
         */
        void    validateRecordData(const DvaPrivateVersionRecord& paZone);
         ...
         *
         */
        TA_Base_Core::IPaDvaMessagePrivateVersion* getRecordFromDatabaseUsingKey(unsigned long pKey, bool readWrite);
         ...
         *
         */
        virtual DvaPrivateVersionRecord 
                 createRecordFromInterface(TA_Base_Core::IPaDvaMessagePrivateVersion& item);
    ...
    protected:
        ...
        class FilterByLocationKey
            : public ICachedMapFilter<DvaPrivateVersionRecord>
        {
        public:
            FilterByLocationKey(unsigned long locationKey) : m_locationKey(locationKey) 
            {}

            virtual bool isMatch(const DvaPrivateVersionRecord& record) const
...
#endif //!defined PaDvaPrivateVersionCachedMap_H
