/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaStationDvaMessageCachedMap.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         * 
         * If the record is new, the record.m_pKey must be set to TA_Base_Core::DatabaseKey::getInvalidKey() 
         ...
         *
         * Note: Code will assert if record m_pKey == TA_Base_Core::DatabaseKey::getInvalidKey()
         *          and writeChangesToDatabase == false
         * 
         * @param record the DVA message details.  Specify TA_Base_Core::DatabaseKey::getInvalidKey()
         ...
         *
         */
        void refreshKeyToStationDvaMessageRecordMap(unsigned long locationKey = TA_Base_Core::DatabaseKey::getInvalidKey()) ;
         ...
         * getMinMaxAdhocRange
         *
         * Obtains the minimum and maximum ranges for the adhoc IDs
         *
         * @param dvaSet the particular set we're querying
         *
         * @param minMessageId[OUT] the minimum message ID for an adhoc message (inclusive)
         *
         * @param maxMessageId[OUT] the maximum message ID for an adhoc message (inclusive)
         *
         */
        static void getMinMaxAdhocRange(TA_Base_Bus::IPAAgentCorbaDef::EDvaSet dvaSet,
         ...
         * isAdhocMessageId
         *
         * @return true if the input parameters identify an adhoc message
         *
         * @param dvaSet the particular set we're querying
         *
         * @param id the ID of the message we're querying for
         *
         */
        static bool isAdhocMessageId(TA_Base_Bus::IPAAgentCorbaDef::EDvaSet dvaSet,
                                     unsigned long id);
    ...
    public: // Give public access to these filter classes
        ...
        class FilterStationDvaMessageByIdAndLocation
            : public ICachedMapFilter<StationDvaMessageRecord>
        {
        public:
            FilterStationDvaMessageByIdAndLocation
        ...
        public:
             ...
             *      TA_Base_Core::DatabaseKey::getInvalidKey() for all locations
             * @param minId, maxId defines closed bounds for message ID range minId <= id <= maxId         
             */
            FilterStationDvaMessageIdRange(unsigned long locationKey, 
                                                unsigned long minId, 
                                                unsigned long maxId);
