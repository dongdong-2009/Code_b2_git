/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaZoneCachedMap.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Bus
{
    ...
    private:
        ...
        class FilterPaZoneByIdAndLocation
        ...
        class FilterPaZoneByEquipmentEntityName
            : public ICachedMapFilter<PaZoneRecord>
        {
        public:
        ...
        class FilterPaZoneByLocationKey
            : public ICachedMapFilter<PaZoneRecord>
        {
        public:
