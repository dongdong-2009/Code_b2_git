#
# $Source: /cvs/1TS-9999-T/code/tools/BuildSystem/createSolarisBuildFile.pl,v $
# $Revision: 1.1.2.3 $
# $Date: 2003/07/07 03:21:45 $
# $Author: adamr $
#
...
# $reason: made it order the make targets closer to their dependecies$
