...
/* #ident	"@(#)fml:libfml/fml32.h	60.8" */
#ifndef TMENV_H
#include <tmenv.h>
#endif
#ifndef NOWHAT
static	char	h_fml32[] = "@(#)fml:libfml/fml32.h	60.8";
#endif
...
extern int _TM_FAR * _TMDLLENTRY _Fget_Ferror_addr32(void);
...
#define Ferror32	FMLerror32
extern int FMLerror32;
#else
_TMIFML32 extern int Ferror32;
#endif
#endif
...
int _TMDLLENTRY Fcodeset _((unsigned char _TM_FAR *codeset)); /* no 32 */
