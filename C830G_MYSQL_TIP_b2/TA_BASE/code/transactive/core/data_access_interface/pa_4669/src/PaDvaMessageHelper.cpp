/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/pa_4669/src/PaDvaMessageHelper.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #12 $
  *
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(PA_DVA_MESSAGE_UPDATE_41701,getLocalDatabaseName(),
		...
		databaseConnection->prepareSQLStatement(strSql, PA_DVA_MESSAGE_UPDATE_41701,getLocalDatabaseName(),
			m_locationKey.getValue(), m_id.getValue(),databaseConnection->escapeAQSQLString(m_label), m_type.getValue(),
			m_key);
