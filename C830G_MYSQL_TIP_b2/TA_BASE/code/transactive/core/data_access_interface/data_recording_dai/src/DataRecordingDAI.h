 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/data_recording_dai/src/DataRecordingDAI.h $
 * @author:  Jade Welton
 * @version: $Revision: #3 $
 *
 * Last modification: $DateTime: 2012/02/28 18:34:56 $
