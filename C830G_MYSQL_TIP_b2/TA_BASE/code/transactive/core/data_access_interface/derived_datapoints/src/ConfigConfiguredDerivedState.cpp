/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/derived_datapoints/src/ConfigConfiguredDerivedState.cpp $
  * @author Karen Graham
  * @version $Revision: #3 $
  *
  * Last modification: $DateTime: 2012/03/13 09:37:23 $
