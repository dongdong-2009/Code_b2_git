/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/ConfigScadaDisplay.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #5 $
  *
...
namespace TA_Base_Core
{
    ...
    const std::string ConfigScadaDisplay::s_name = "Name";
    const std::string ConfigScadaDisplay::s_path = "Path";
    const std::string ConfigScadaDisplay::s_location = "Location";
    ...
    void ConfigScadaDisplay::setName(const std::string& name)
    {
        ...
        updateChanges(s_name, m_displayHelper->getName(), name);
    ...
    void ConfigScadaDisplay::setPath(const std::string& path)
    {
        ...
        updateChanges(s_path, m_displayHelper->getPath(), path);
    ...
    void ConfigScadaDisplay::setLocation(const unsigned long location)
    {
        ...
        updateChanges(s_location, oldLocation, newLocation);
