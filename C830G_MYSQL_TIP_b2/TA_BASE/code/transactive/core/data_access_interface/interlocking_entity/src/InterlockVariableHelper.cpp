/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/interlocking_entity/src/InterlockVariableHelper.cpp $
  * @author:  Robert Stagg
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    void InterlockVariableHelper::reload()
    {
        ...
        sql << "FROM LK_VARIABLE_TYPES WHERE ENTITY_TYPE = '" << m_entityType << "'";
