...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/entity_access/src/VideoSwitchAgent.h $
  * @author:  Robert Young
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
		...
		/**
          ...
          *             Thrown if the MaxSwitchResponseTime parameter cannot be converted to an unsigned long.
          */
        unsigned long getMaxSummaryPollingResponseTime();
        ...
        /**
          ...
          *             Thrown if the ActiveSwitchPollInterval parameter cannot be converted to an unsigned long.
          */
        unsigned long getSummaryPollingInterval();
    ...
    private:
		...
		static const std::string MAX_SUMMARY_POLLING_RESPONSE_TIME;
		static const std::string SUMMARY_POLLING_INTERVAL;
