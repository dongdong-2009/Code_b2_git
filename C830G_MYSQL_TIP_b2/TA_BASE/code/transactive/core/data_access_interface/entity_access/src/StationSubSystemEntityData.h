/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/entity_access/src/StationSubSystemEntityData.h $
  * @author HoaVu
  * @version $Revision: #3 $
  * Last modification: $DateTime: 2012/04/09 11:10:16 $
