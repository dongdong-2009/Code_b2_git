/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/entity_access/src/ControlStation.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_Core
{
    ...
    IOperator* ControlStation::getLoginOperator()
    {
		...
		{
			LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugError, "Entity Access exception catch: getLoginOperator");
		}
    ...
    IProfile* ControlStation::getLoginProfile()
    {
		...
		{
			LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugError, "Entity Access exception catch: getLoginProfile");
		}
    ...
    ILocation* ControlStation::getLoginLocation()
    {
		...
		{
			LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugError, "Entity Access exception catch: getLoginLocation");
		}
