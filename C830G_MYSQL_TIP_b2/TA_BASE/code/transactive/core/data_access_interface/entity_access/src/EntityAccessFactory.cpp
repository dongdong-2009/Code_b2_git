/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/entity_access/src/EntityAccessFactory.cpp $
  * @author Nick Jardine
  * @version $Revision: #14 $
  * Last modification: $DateTime: 2016/08/05 10:49:54 $
...
namespace TA_Base_Core
{
    ...
    void EntityAccessFactory::setUpMap()
    {
        ...
        // OpcServerAgent entity
        m_entityTypes.insert(EntityTypeMap::value_type(OpcServerAgentEntityData::getStaticType(), OpcServerAgentEntityData::clone));
		...
		// add for TrainBorneManager //++ hongzhi
		m_entityTypes.insert(EntityTypeMap::value_type(TrainBorneManagerEntityData::getStaticType(), TrainBorneManagerEntityData::clone) );
