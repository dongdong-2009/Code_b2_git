/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/utilities/src/Matrix.inl $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	template <typename RowId, typename ColumnId, typename ElementType>
	void Matrix<RowId, ColumnId, ElementType>::getElement(RowId rowId, ColumnId columnId, ElementType& elementType)
	{
		ThreadGuard matrixGuard(*this);
		...
		if (elementIter != m_elementMap.end())
		{
			elementType = elementIter->second;
		}
		else
		{
			// The element could not be found - raise an exception
