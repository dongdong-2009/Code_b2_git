...
* in any form.
*
* Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/database/src/ConnectionReaper.cpp $
* @author:  Ripple
* @version: $Revision: #4 $
*
* Last modification: $DateTime: 2014/01/15 12:21:19 $
	...
	*/
	...
	void ConnectionReaper::deleteUnusedConnections()
	{
		...
		while ( it != m_monitoredConnections.end() )
		{
			...
			//if ( (*it)->hasMore() )
			{
				//fix bug: first delete connection then delete query crash
				it++;
				continue;
#if 0
