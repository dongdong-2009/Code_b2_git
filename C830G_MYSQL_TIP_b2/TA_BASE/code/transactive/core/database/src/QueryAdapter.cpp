...
QueryAdapter::QueryAdapter( ocl::OraQuery* pQuery ) : 
m_pQuery( pQuery ),
...
void QueryAdapter::fetchInitial( int numColumns, Buffer& data, long lMaxRows )
{
    ThreadGuard guardQuery( m_queryLock );
...
void QueryAdapter::fetchMore( int numColumns, Buffer& data, long lMaxRows )
{
...
void QueryAdapter::fillDataBuffer( int numColumns, Buffer& data, long lMaxRows )
{
    ThreadGuard guardQuery( m_queryLock );
...
bool QueryAdapter::isActive( unsigned long ulMaxTimeoutInSecs )
{
...
void QueryAdapter::updateLatestActionTime()
{
