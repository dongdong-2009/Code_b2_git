...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/corba/src/CorbaUtil.h $
	...
	public:
      ...
      /**
		...
		*/
		...
		std::string exceptionToString(const CORBA::Exception& ex);
		...
		*/
		 ...
		 */
		static CORBA::Boolean commFailureExceptionHandler( void* cookie, 
