/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mfc_extensions/src/auto_sort_list_ctrl/AutoSortListCtrl.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
  *
        ...
        for (int i = 0; i < headerCtrl->GetItemCount(); i++)
        {
            ...
            if ( (i == columnIndex) && (sortData.m_sortState.at(columnIndex) != UNKNOWN) )
            {
	            ...
	            headerItem.hbm = (HBITMAP)LoadImage(GetModuleHandle("TA_MFCExtensions_d.dll"),
                                          MAKEINTRESOURCE((sortData.m_sortState.at(columnIndex) == ASCENDING)
