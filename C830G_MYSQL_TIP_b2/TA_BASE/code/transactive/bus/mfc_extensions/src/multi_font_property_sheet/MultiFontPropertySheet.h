...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mfc_extensions/src/multi_font_property_sheet/MultiFontPropertySheet.h $
  * @author:  Rob Young
  * @version: $Revision: #1 $
  *
...
// Construction
public:
	CMultiFontPropertySheet(UINT nIDCaption, CWnd* pParentWnd = NULL, UINT iSelectPage = 0);
	CMultiFontPropertySheet(LPCTSTR pszCaption, CWnd* pParentWnd = NULL, UINT iSelectPage = 0);
