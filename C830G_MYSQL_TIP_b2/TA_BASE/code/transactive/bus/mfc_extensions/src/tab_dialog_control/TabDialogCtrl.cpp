/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mfc_extensions/src/tab_dialog_control/TabDialogCtrl.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
void CTabDialogCtrl::ResizeDialogs()
{
	...
	for (it=m_dlgInfo.begin();it!=m_dlgInfo.end();it++)
	{
		(*it).pDlg->SetWindowPos(NULL,rect.left-2,rect.top-offset,rect.Width(),rect.Height(),SWP_NOZORDER);
	}
}
