/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mfc_extensions/src/print_list_ctrl/ListCtrlPrint.cpp $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2008/12/31 14:59:28 $
...
CString CListCtrlPrint::GetTextSizedToColumn(CDC * pDC, int nItem, int nSubitem, CRect colRect)
{
    ...
    // hidden col, return the whole string without any change
    if ( 0 == colWidth )
    {
        return remainText;
    }
