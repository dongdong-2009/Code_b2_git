...
bool AlarmStoreManager::passesPrefilter(const TA_Base_Core::AlarmDetailCorbaDef& alarm) 
{
	...
	//LOG( SourceInfo, TA_Base_Core::DebugUtil::GenericLog, TA_Base_Core::DebugUtil::DebugDebug,"after thread guard");
	...
	FUNCTION_EXIT;
	//LOG( SourceInfo, TA_Base_Core::DebugUtil::GenericLog, TA_Base_Core::DebugUtil::DebugDebug,"Not thread guard");
