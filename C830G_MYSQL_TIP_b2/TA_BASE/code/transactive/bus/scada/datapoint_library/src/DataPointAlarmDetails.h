/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/datapoint_library/src/DataPointAlarmDetails.h $
  * @author  J. Welton
  * @version $Revision: #1 $
...
namespace TA_Base_Bus
{
	...
	public:
		...
		*/
		 ...
		 *
		 */
		virtual void setOperationMode ( bool inControl );
    ...
    class DataPointAlarmDetailsWorkItem : public TA_Base_Core::IWorkItem
	{

	public:

		DataPointAlarmDetailsWorkItem(DataPointAlarmDetails& parent);

		virtual ~DataPointAlarmDetailsWorkItem();
	...
	protected:
		...
		DataPointAlarmDetails& m_parent;
	};
