/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/datapoint_library/src/MeteredDataPoint.cpp $
  * @author  HoaVu
  * @version $Revision: #2 $
  * Last modification : $DateTime: 2010/08/05 09:40:31 $
...
namespace TA_Base_Bus
{
	...
	void MeteredDataPoint::persistAccumulatedValue()
	{
	...
	void MeteredDataPoint::correct ( double newValue, std::string sessionId )
	{
		// make sure only one thread can access this object
		ThreadGuard guard ( m_ownLock );
