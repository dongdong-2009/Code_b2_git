/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_Review_Branch/TA_BASE/transactive/bus/scada/proxy_library/src/DataNodeBulkPollingSynchronizer.cpp $
		...
		while (!isTerminating())
		{
            try
            {
			    ...
			    if( !isTerminating() )
			    {
				    ...
				    {
                        LOG_GENERIC( SourceInfo, DebugUtil::DebugDebug, "BulkPoll %s - polling", m_agentName.c_str());
