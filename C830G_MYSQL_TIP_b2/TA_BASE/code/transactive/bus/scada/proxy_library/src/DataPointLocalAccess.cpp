...
namespace TA_Base_Bus
{
	...
	*/
	void DataPointLocalAccess::submitWriteRequest(const std::string& sessionId, 
	...
	{
		m_dataPointLocalObject->submitWriteRequest(sessionId,value,triggeringEntityKey,triggeringEntityValue,isLogingEvent,cancelTime,controlUUID);
	}
