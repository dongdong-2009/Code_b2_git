/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/proxy_library/src/AgentSynchronisationInterface.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    protected:
        enum ERequestType {EmptyQueue, Add, Remove};
