...
namespace TA_Base_Bus
{
   ...
   class DataPointProxyManager;
	...
	class DataPointProxy : public IDataPointProxy, public ProxyObserverNotifier				   
	{
		...
		public:
			...
			*/
			...
			/**
			  ...
			  * @exception ScadaProxyException raised if the proxy is not initialised.
			  */
			void			setValue(std::string value, std::string sessionId = "", unsigned long triggeringEntityKey = 0, char * triggeringEntityValue = NULL,
										bool auditEventLoggingEnabled = true, timeb time=SCADA_DEFAULT_TIMEB); //TD15649
			...
			/**
			  ...
			  */
			virtual void			setBoolValue(bool value, std::string sessionId, timeb time=SCADA_DEFAULT_TIMEB);
			...
			/**
			  ...
			  */
			virtual void			setAnalogueValue(double value, std::string sessionId, timeb time=SCADA_DEFAULT_TIMEB);
		...
		private:
			void setValueImpl(const std::string& sessionId, 
