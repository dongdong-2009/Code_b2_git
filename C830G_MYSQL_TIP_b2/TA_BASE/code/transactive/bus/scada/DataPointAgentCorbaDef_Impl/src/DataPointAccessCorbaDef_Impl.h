...
namespace TA_Base_Bus
{
	...
	public:
		...
		virtual void submitWriteRequest(CORBA::ULong dpKey, const char* sessionId, const ScadaCorbaTypes::UTag& value, CORBA::ULong triggeringEntity, const char* triggeringEntityValue,
			CORBA::Boolean isLogingEvent, const ScadaCorbaTypes::STimeStamp& cancelTime, const char* controlUUID);
