...
namespace TA_Base_Bus
{
	...
	public:
	    ...
	    /**
	      ...
	      * @exception <exceptions> Optional
	      */
        void saveDataPointDisplayUpdateDetails(unsigned long key,boost::shared_ptr<TA_Base_Bus::DataPointCorbaTypes::DataPointDisplayState> displayUpdate);
	...
	private:
        ...
        typedef std::map<unsigned long,boost::shared_ptr<TA_Base_Bus::DataPointCorbaTypes::DataPointDisplayState> > DataPointDisplayStateMap;
        DataPointDisplayStateMap m_mapOfUpdateDetails;
