/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/TA_BASE/transactive/bus/modbus_comms/src/ModbusConnection.h $
  * @author  A. Ivankovic
  * @version $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    public:
        ...
        /**
          ...
          *         communicates to.
          */
        virtual int getDeviceAddress() const            { return m_device; }
        ...
        /**
          ...
          *
          */
        virtual void setDeviceAddress( int device )    { m_device = device; }
    ...
    protected:
        ...
        /**
          ...
          */
        inline int ToInt( char data ) const   { return 0xff & (unsigned) data; }
