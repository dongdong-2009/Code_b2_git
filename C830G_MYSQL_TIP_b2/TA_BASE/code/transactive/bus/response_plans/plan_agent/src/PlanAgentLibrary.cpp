...
* in any form.
*
* Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/response_plans/plan_agent/src/PlanAgentLibrary.cpp $
* @author:  Ripple
* @version: $Revision: #1 $
*
...
//lizettejl++ (DP-changes)
void PlanAgentLibrary::resumePlanAtStep(const char* session, const TA_Base_Core::ActivePlanId& plan, TA_Base_Core::StepNumber step)
{
	CORBA_CALL( m_planAgent,
	            resumePlanAtStep,
	            ( session, plan, step ) );
