/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/response_plans/plan_agent/src/PlanAgentLibrary.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    public:
		...
		void resumePlanAtStep(const char* session, const TA_Base_Core::ActivePlanId& plan, TA_Base_Core::StepNumber step);
		//++lizettejl
