/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/response_plans/active_plans_display/src/ComparablePlanInstance.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
bool ComparablePlanInstance::operator==(const TA_Base_Core::ActivePlanDetail& activePlanDetail)
{
    ...
    COleDateTime thisActivationTime, otherActivationTime;
    thisActivationTime.ParseDateTime(m_activePlanDetail.timeOfInstantiation.in());
    otherActivationTime.ParseDateTime(activePlanDetail.timeOfInstantiation.in());

    if (thisActivationTime != otherActivationTime)
    {
        return false;
    }
