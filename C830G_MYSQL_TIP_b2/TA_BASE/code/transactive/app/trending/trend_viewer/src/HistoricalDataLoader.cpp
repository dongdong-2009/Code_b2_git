...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/trending/trend_viewer/src/HistoricalDataLoader.cpp $
  * @author:  Craig Grant
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    // TD17884 - executeSql
    //
    PlotData HistoricalDataLoader::executeSql(const std::string& sql, unsigned long entityKey, time_t startTime, time_t endTime, unsigned long samplePeriod)
    {
	...
	std::string HistoricalDataLoader::generateSql(DayComponents& dayComponents, unsigned long entityKey, 
	...
	{	
		...
		std::string dateFormatStr = m_DateFormat.getDateFormat(TA_Base_Core::DateFormat::DateFormat1b);
	...
	TA_Base_Core::IData* HistoricalDataLoader::executeQuery(TA_Base_Core::IDatabase* dbConnection, const std::string& sql, std::vector<std::string>& columnNames)
	{
		//TD17935 
	...
	*/
    ...
    // executeSql
    //
    PlotData HistoricalDataLoader::executeSql(const std::string& sql)
    {
        FUNCTION_ENTRY("executeSql");
