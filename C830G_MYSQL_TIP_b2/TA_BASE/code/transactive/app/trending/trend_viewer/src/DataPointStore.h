...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/trending/trend_viewer/src/DataPointStore.h $
  * @author:  Craig Grant
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_App
{
    ...
    private:
        ...
        TA_Base_Core::IData* getData(TA_Base_Core::IDatabase* databaseConnection, const std::string& query, std::vector<std::string> columnNames);
