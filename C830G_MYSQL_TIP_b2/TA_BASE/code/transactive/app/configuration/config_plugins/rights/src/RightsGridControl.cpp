/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/configuration/config_plugins/rights/src/RightsGridControl.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
END_MESSAGE_MAP()
    ...
    void RightsGridControl::OnEndEditCell(int nRow, int nCol, CString str)
    {
        ...
        try
        {
            ...
            long key = TA_Base_Core::IConfigRights::INVALID_ACTIONGROUP;
