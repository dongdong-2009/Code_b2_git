/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/configuration/config_plugins/alarm_type/src/AlarmTypeDetailView.cpp $
...
namespace TA_Base_App
{
    ...
    const char* AlarmTypeDetailView::CHANGE_ALARMSEVERITY_DIALOG_TITLE = "Change Alarm Severity";
...
END_MESSAGE_MAP()
    ...
    void AlarmTypeDetailView::showItemDetails(bool isShown)
    {
        ...
        GetDlgItem(IDC_SYSTEM_BITMAP)->ShowWindow(isShown);
    ...
    void AlarmTypeDetailView::populateItemDetails(TA_Base_Core::IConfigItem* currentItem)
    {
        ...
        try
        {
            ...
            m_name.SetWindowText( m_currentAlarmType->getName().c_str() );
...
//            }
			...
			if (m_currentAlarmType->isSystemAlarm()) m_parameterList.populateControl(m_currentAlarmType);
