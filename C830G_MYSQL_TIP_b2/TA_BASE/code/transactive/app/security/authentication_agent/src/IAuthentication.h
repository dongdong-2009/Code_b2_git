 ...
 * 
 * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/authentication_agent/src/IAuthentication.h $
 * @author:   Nick Jardine
 * @version:  $Revision: #1 $
 *
...
namespace TA_Base_App
{
    ...
    public:
         ...
         * log in attempt.
	     */
        virtual std::string requestSession(unsigned long userId, unsigned long profileId, unsigned long locationId, unsigned long workstationId, const std::string & password) =0;
         ...
         */
        virtual std::string changeProfile(const std::string & sessionId, unsigned long profileId, unsigned long locationId, const std::string & password) =0;
