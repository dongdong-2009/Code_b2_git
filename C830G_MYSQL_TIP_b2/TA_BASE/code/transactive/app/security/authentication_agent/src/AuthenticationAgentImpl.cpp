/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/authentication_agent/src/AuthenticationAgentImpl.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
                                                  ...
                                                  const char* password)
    {
        ...
        try
        {
            sessionId = m_authentication.requestSession( userId, profileId, locationId, workstationId, password );
        }
                                                 ...
                                                 const char* password)
    {
        ...
        try
        {
            newSessionId = m_authentication.changeProfile( sessionId, profileId, locationId, password );
        }
        catch(AuthenticationSecurityException& ex)
        {
            TA_Base_Bus::IAuthenticationAgentCorbaDef::AuthenticationSecurityException exception;
