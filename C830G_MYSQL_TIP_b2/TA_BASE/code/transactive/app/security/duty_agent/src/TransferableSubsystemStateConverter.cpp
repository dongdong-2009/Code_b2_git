 ...
 * 
 * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/duty_agent/src/TransferableSubsystemStateConverter.cpp $
...
namespace TA_Base_App
{
	...
	void TransferableSubsystemStateConverter::subsystemRemove(const TA_Base_Bus::DutyPrimitive& session)
	{
		...
		//this ghost session information will cause DutyManager cannot get transferable subsystem information
