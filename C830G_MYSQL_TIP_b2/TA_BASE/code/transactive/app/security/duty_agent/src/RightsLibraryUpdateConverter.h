 ...
 * 
 * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/duty_agent/src/RightsLibraryUpdateConverter.h $
...
#if !defined(RIGHTSLIBRARYUPDATECONVERTER_H_INCLUDED)
#define RIGHTSLIBRARYUPDATECONVERTER_H_INCLUDED

namespace TA_Base_App
{
	class RightsLibraryUpdateConverter : public TA_Base_Bus::IDutyStateConverter
	{

	public:

		RightsLibraryUpdateConverter();

		const TA_Base_Bus::DutyAgentTypeCorbaDef::RightsLibraryUpdateSequence& getUpdate() const;
	...
	private:
		...
		void subUpdate( const std::string& session );

		TA_Base_Bus::DutyAgentTypeCorbaDef::RightsLibraryUpdateSequence m_update;

		CORBA::ULong m_regIdx;
		CORBA::ULong m_subIdx;
		CORBA::ULong m_sesIdx;
...
#endif // !defined(RIGHTSLIBRARYUPDATECONVERTER_H_INCLUDED)
