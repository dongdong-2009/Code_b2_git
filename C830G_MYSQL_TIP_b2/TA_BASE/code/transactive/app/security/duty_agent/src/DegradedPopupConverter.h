 ...
 * 
 * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/duty_agent/src/DegradedPopupConverter.h $
...
#if !defined(DEGRADEDPOPUPCONVERTER_H_INCLUDED)
#define DEGRADEDPOPUPCONVERTER_H_INCLUDED

namespace TA_Base_App
{
	class DegradedPopupConverter : public TA_Base_Bus::IDutyStateConverter
	{
	public:

		typedef std::vector<TA_Base_Bus::DutyAgentTypeCorbaDef::DutyPopup> PopupData;

		DegradedPopupConverter();
	...
	private:
		...
		typedef std::map<TA_Base_Bus::DutyPrimitive, TA_Base_Bus::DASType::SubsystemMap > InternalPopupMap;
...
#endif // !defined(DEGRADEDPOPUPCONVERTER_H_INCLUDED)
