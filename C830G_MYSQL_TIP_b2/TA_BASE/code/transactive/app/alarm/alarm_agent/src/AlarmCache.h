...
namespace TA_Base_App
{
    ...
    public:
        ...
        /**
          ...
          *            type is found.
          */
        bool insert( const TA_Base_Core::AlarmDetailCorbaDef& p_alarm,
        ...
        /**
          * updateMMSState
          *
          * This method updates the MMMS State of a given alarm.
          *
          * @param The alarm id
    ...
    private:
        ...
        /**
          ...
          */
		void raiseExceededMaxAlarm(std::string problem/*, bool raise=false*/);
        ...
        std::map<std::string, std::string> m_operatorMap;
