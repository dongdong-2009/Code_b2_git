/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_Review_Branch/TA_BASE/transactive/app/alarm/alarm_agent/src/MMSRule.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2011/05/23 09:43:13 $
...
namespace TA_Base_App
{
                           ...
                           TA_Base_App::AbstractRule::ETriggerType trigger)
    {
		...
		catch ( const TA_Base_Bus::MmsConnectionFailure& ex ) 
		{
			...
			AlarmCache::getInstance()->updateMMSState(message.alarmID.in(), TA_Base_Core::MMS_AUTO);
		}
		...
		{
			LOG( SourceInfo, TA_Base_Core::DebugUtil::GenericLog, TA_Base_Core::DebugUtil::DebugError, "fail to resolve MMSAgent when submitMmsAlarmMessage(): Unknown reason " );
			AlarmCache::getInstance()->updateMMSState(message.alarmID.in(), TA_Base_Core::MMS_FAILED);
		}
		// ++TD18552
    }
