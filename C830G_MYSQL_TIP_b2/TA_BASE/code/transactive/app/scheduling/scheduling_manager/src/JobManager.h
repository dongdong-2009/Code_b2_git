/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_manager/src/JobManager.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /** 
          ...
          *
          */
        void deleteJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& id);
        ...
        /** 
          ...
          *
          */
        void enableJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& id, const bool enable);
