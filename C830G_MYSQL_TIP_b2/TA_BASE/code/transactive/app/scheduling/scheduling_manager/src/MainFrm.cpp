/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_manager/src/MainFrm.cpp $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
/*for jianghp
    ...
    LRESULT CMainFrame::onJobSelectionChange(WPARAM theJob, LPARAM forceCheckRights)
    {
        ...
        bool needToCheckRights = static_cast<bool>(forceCheckRights) || (m_lastSelectedJobs == NULL) || (jobs == NULL);
