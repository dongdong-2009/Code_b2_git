/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_manager/src/SchedulingManagerView.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    private: // methods
		...
		/** 
          ...
          * @param jobId 
          */
		bool isJobEditLockedForSelection(TA_Base_Bus::SchedulingAgentCorbaDef::JobID jobId);
		...
		/**
		  ...
		  * @param lock 
          */
		void updateEditLock(TA_Base_Bus::SchedulingAgentCorbaDef::JobID jobId, bool lock);
		//++TD16352
