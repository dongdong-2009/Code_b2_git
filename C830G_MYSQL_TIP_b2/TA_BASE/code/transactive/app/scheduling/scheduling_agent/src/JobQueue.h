/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/JobQueue.h $
...
class JobQueue :
    public TA_Base_Core::Thread, public TA_Base_Core::ReEntrantThreadLockable
{
...
public:
     ...
     *  thrown if there is a problem communicating with the database
	 */
    void removeJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobID, std::string sessionId = "");
...
protected:
    ...
    <
        unsigned long,
        TA_Base_Bus::SchedulingAgentCorbaDef::JobID
    >
    ScheduledJobsQueue;
     ...
     */
    void removeCompletedJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobToRemoveID);
    ...
    /** 
      ...
      *
      */
    void removeJobUnlocked(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobToRemoveID, bool deleteJobFromDb = true, std::string sessionId = "");
     ...
     */
    ScheduledJobsQueue::iterator findScheduledJob(
