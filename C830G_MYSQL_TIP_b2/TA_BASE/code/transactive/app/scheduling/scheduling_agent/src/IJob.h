/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/IJob.h $
...
public:
     ...
     *  if there is a problem with the format of the data.
     */
    virtual TA_Base_Bus::SchedulingAgentCorbaDef::JobID getID() = 0;
     ...
     *  if there is a problem with the format of the data.
     */
	virtual TA_Base_Bus::SchedulingAgentCorbaDef::LocationID getLocationID() = 0;
     ...
     *  if there is a problem with the format of the data.
     */
	virtual TA_Base_Bus::SchedulingAgentCorbaDef::ProfileID getProfileID() = 0;
