/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/SchedulingMonitor.h $
...
public:
     ...
     */
    void batchUpdateReceivedFromController(
        const TA_Base_Bus::SchedulingAgentCorbaDef::JobSequence& jobs);
