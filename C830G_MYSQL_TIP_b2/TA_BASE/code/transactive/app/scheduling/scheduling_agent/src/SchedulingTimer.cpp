/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/SchedulingTimer.cpp $
...
// These make the code a lot easier to read
...
unsigned long SchedulingTimer::getNextTimeInMinutes(ptime nextTime)
{
    if ( *m_now >= nextTime )
    {
        TA_ASSERT(false, "Time can not be in the past");
    }
