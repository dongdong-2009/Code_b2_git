/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/AlarmGeneratorJob.h $
...
public:
    ...
    /** 
      ...
      */
    AlarmGeneratorJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobID);
