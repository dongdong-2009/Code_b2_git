/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/JobFactory.h $
...
public:
     ...
     *
     */
    virtual IJob* getJobFromStore(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& id);
