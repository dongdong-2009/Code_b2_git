/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/AbstractJob.h $
...
public:
     ...
     *  if there is a problem with the format of the data.
     */
    virtual TA_Base_Bus::SchedulingAgentCorbaDef::JobID getID();
     ...
     *  if there is a problem with the format of the data.
     */
	virtual TA_Base_Bus::SchedulingAgentCorbaDef::LocationID getLocationID();
     ...
     *  if there is a problem with the format of the data.
     */
	virtual TA_Base_Bus::SchedulingAgentCorbaDef::ProfileID getProfileID();
     ...
     *             if any of the schedule's fields are out of range.
     */
    AbstractJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobID);
