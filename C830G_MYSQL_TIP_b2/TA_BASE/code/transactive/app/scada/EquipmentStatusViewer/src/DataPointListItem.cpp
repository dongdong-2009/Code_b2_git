/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/DataPointListItem.cpp $
  * @author:  Alan Brims
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_App
{
    ...
    DataPointListItem::DataPointListItem(unsigned long entitykey, HWND hwndToNotify)
        : EquipmentStatusListItem(entitykey, hwndToNotify), m_dataPoint(NULL)
    {
    ...
    void DataPointListItem::loadParentDataNode(unsigned long parentKey)
    {
        try
        {
			...
			m_dataNode = boost::shared_ptr<TA_Base_Core::DataNodeEntityData>(pDnData);                 
        }
        catch (...)
        {
