  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/scada/OpcBridgeLib/src/DataPointAgentProxy.cpp $
  * @author:  Ripple
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2013/07/26 15:28:36 $
				...
				//lock1 block
				{
					...
					for (unsigned int i = 0; i < updateSize && !m_toBeTerminated; ++i)
					{
						...
						LOG_GENERIC(SourceInfo, DebugUtil::DebugDebug,
							"MarkA--DataPointAgentProxy %s - received an update for entity %d",
