/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/inspector_panel/src/DataPointListCtrl.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
		...
		try
		{
			...
			switch ( dataPoint->getStatus() & TA_Base_Bus::QUALITY_MASK )
			{
				case TA_Base_Bus::QUALITY_GOOD:
				{
					...
					{
						iconIndex = m_orangeIconIndex;	// orange
					}
					else if (dataPoint->getStatus() == TA_Base_Bus::QUALITY_GOOD_NO_SPECIFIC_REASON)
					{
