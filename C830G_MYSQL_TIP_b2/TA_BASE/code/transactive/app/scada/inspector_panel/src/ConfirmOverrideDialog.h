/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/inspector_panel/src/ConfirmOverrideDialog.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	// Construction
	public:
		CConfirmOverrideDialog(CWnd* pParent, int iPoint, CEquipment *equipment);
