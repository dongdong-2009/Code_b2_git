/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/inspector_panel/src/OverrideListCtrl.h $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	class COverrideListCtrl : public CAbstractDataPointListCtrl, ICellManager
	{
		...
		protected:
			...
			void submitAuditMessage(std::string value, std::string addRemove, 
