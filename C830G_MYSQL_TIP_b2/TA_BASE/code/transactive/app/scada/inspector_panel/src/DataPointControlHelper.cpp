/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/inspector_panel/src/DataPointControlHelper.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
		...
		{	
			if (dataPoint->isDerived())
			{
				...
				catch (TA_Base_Core::ScadaProxyException&)
				{
					...
					message << dataPoint->getDescription() << ": Invalid selection for control.";
