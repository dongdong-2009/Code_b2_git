/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/inspector_panel/src/OverrideListCtrl.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_App
{
	...
	void COverrideListCtrl::setupList()
	{
		...
		this->SetColumnWidth(OVERRIDE_ENABLE_COLUMN,	35);
	...
	void COverrideListCtrl::submitAuditMessage(std::string value, std::string addRemove, 
