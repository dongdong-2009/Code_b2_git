...
namespace TA_Base_App
{
	...
	public:
		...
		/**
		  ...
		  *
		  */
		ACE_Future<TA_Base_Core::EActivePlanState> run( const std::string& session, const std::string& pmId, TA_Base_Core::ActivePlanId& plan, 
		...
		/**
		  ...
		  *
		  */
		ACE_Future<TA_Base_Core::EActivePlanState> spawn( const std::string& session, const std::string& pmId, const TA_Base_Core::ActivePlanId& parentPlan, 
        ...
        void publishPlanStart( const std::string& session, const std::string& pmId, const TA_Base_Core::ActivePlanId& plan, 
            TA_Base_Core::EActivePlanState initialState, const bool manExecution );
	...
	private:
		...
		/**
		  ...
		  *
		  */
		ACE_Future<TA_Base_Core::EActivePlanState> runInterlocked( std::auto_ptr<ActivePlan> activePlan );

		void processMessages( ActivePlan& activePlan, ActivePlanMessageQueuePtr mq );

        ActivePlanMessageQueuePtr getMq( const TA_Base_Core::ActivePlanId& plan ) const;
        void makeMq( const TA_Base_Core::ActivePlanId& plan );


		ACE_Activation_Queue m_activationQueue;
		
		//const ACE_Time_Value m_aqTimeout;
		const ACE_Time_Value m_mqTimeout;

		typedef std::map<SortablePlanId,ActivePlanMessageQueuePtr> PlanMqMap;
