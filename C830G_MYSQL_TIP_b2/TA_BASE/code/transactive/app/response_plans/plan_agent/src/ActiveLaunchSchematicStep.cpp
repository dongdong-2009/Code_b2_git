/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_agent/src/ActiveLaunchSchematicStep.cpp $
  *  @author:  Bart Golab
  *  @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	{
		LOG( SOURCE_INFO, GENERIC_LOG_TYPE, DEBUG_LOG_LEVEL, "Launch Schematic step %lu", getStepNumber() );

		TA_Base_Core::EActiveStepState stepState = TA_Base_Core::LOADED_ACTIVE_STEP_STATE;

		m_remark = "Waiting for schematic to be launched";
				...
				if ( planManager != NULL )
				{
					...
					else
                    {
                        ...
                        {   
				            ...
				            m_remark = "Schematic unable to launch. ";
