...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/4669_Review_Branch/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanHouseKeepingMethodObject.h $
  *  @author:  jian.huang
  *  @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    //Class declaration
    //class PlanHouseKeepingMethodObject : public ACE_Method_Object
