/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/StationStepParameter.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
void StationStepParameter::setStation(const std::string& station)
{
