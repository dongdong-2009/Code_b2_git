...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/MainFrame.cpp $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
LRESULT CMainFrame::onInitCorba(WPARAM wParam, LPARAM lParam)
{
    ...
    cus.Restore();
    m_progress.SetPos(0);
    m_statusBar.SetPaneText(1, "Ready");
