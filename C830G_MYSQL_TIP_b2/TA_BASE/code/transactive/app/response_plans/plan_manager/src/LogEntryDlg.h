...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/LogEntryDlg.h $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
namespace TA_Base_App
{
    ...
    public:
        CLogEntryDlg(const TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail& stepDetail);
