/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/PAStationZones.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
#include "core/data_access_interface/pa_4669/Src/PaZoneGroup.h"
...
CPAStationZones::CPAStationZones(CString stationName, unsigned long stationLocationKey, StationStepParameter& parameter, bool canEdit) :
...
void CPAStationZones::PopulateZoneGroups ()
{
    ...
    try
    {
        ...
        for (TA_Base_Core::IPaZoneGroupsIt it = zoneGroups.begin(); it != zoneGroups.end(); ++it)
        {
            ...
            zoneGroupName = zoneGroup->getName().c_str ();
            // Place the zone name in the available-zones listbox
