...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanManagerCommonDefs.h $
// @author:  Bart Golab
// @version: $Revision: #2 $
//
...
namespace TA_Base_App
{
    ...
    const char *const RPARAM_MAXCATEGORY = "MaxCategoryDepth";
     ...
     static const CString NO_MESSAGE = "No message selected";
