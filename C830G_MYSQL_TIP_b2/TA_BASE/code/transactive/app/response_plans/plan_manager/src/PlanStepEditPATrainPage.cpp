/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanStepEditPATrainPage.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
void CPlanStepEditPATrainPage::UpdateParameters()
{
    ...
    cyclicParameter->setAffirmative (m_cyclicBtn.GetCheck());
...
{
	CPaMessagesDlg messagesDlg (PA_TRAIN_MESSAGE_TYPE, m_messageParameter, false);   
