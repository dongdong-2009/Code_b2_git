 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/Filter.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #2 $
 *
...
const std::string Filter::FILTER_TOTIME("ToTime");
const std::string Filter::FILTER_FROMTIME("FromTime");
...
// 	{
// 		for (unsigned int i = 0;i < m_displayItems.size();i++)
// 		{
// 			if (NULL != m_displayItems[i])
// 			{
// 				delete m_displayItems[i];
// 				m_displayItems[i] = NULL;
// 			}
// 		}
// 	}
// 	else
...
// 		{
// 			// Determine the page button status.
// 			LPARAM pageStatus = MASK_REFRESH;
// 			if ( 0 < m_currentPage )
// 			{
// 				// If we aren't on the first page, we can move up.
// 				pageStatus |= MASK_PAGEUP;
...
// 
// 			// Send the message.
// 			PostMessage( AfxGetMainWnd()->GetSafeHwnd(), WM_USER_LIST_UPDATE, m_displayItems.size(), pageStatus );
// 		}
// 		else
		{
			// Determine the page button status.
