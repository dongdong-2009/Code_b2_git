...
namespace TA_Base_App
{
    ...
    void RestoreArchiveHelper::loadImportCommand()
    {
        ...
        try
        {
            ...
            //LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugDebug, "FromUser = %s, ToUser = %s",fromUser.c_str(),toUser.c_str() );
        ...
        m_genericImpCommand << "fromuser=" << (fromUser.empty()? components[1] : fromUser) << " ";
        m_genericImpCommand << "touser=" << (toUser.empty()? components[1] : toUser) << " ";
