...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/reporting/crystal_reports_viewer/src/crutilGui.h $
  * @author:  Basil Carbopnaro
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    {
        class crutilGui : public TA_Base_Bus::AbstractDialogGUI
        {
        public:
