/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/system_control/control_station/src/DutyNotificationDialog.cpp $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
const CString DutyNotificationDialog::GAIN_FORMAT = "You have gained duty from\n\t%s/%s\n";
const CString DutyNotificationDialog::GAIN_DUTYLESS_FORMAT = "You have gained duty\n";
const CString DutyNotificationDialog::DENIED_FORMAT = "You have been denied duty by\n\t%s/%s\n";
const CString DutyNotificationDialog::LOST_FORMAT = "You have lost duty to\n\t%s/%s\n";
const CString DutyNotificationDialog::CHANGED_FORMAT = "You have duty changed to\n\t%s/%s\n"; // TD19075
const CString DutyNotificationDialog::CHANGE_DUTYLESS_FORMAT = "You have changed duty\n"; // TD19075
const CString DutyNotificationDialog::LOST_DUTYLESS_FORMAT = "You have lost duty\n";
