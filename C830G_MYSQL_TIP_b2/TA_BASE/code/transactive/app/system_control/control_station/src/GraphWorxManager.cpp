/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/system_control/control_station/src/GraphWorxManager.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
 ...
 :  m_numberOfGraphWorxInstancesReady(0), m_screenPositions(screenPositions)
{
    ...
    if (TA_Base_Core::RunParams::getInstance().isSet("NoGraphWorx"))
    {
        return;
    }
