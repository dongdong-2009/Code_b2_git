...
/**
  ...
  *
  * Source:    $File: //depot/GZL6_TIP/TA_BASE/transactive/bus/cctv/video_switch_agent/agent_access/src/VideoSwitchAgentFactory.h $
...
namespace TA_Base_Bus_GZL9
{
    ...
    public:
        ...
        //
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef,
			                          TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::VideoOutputGroupCorbaDef_var >    VideoOutputGroupNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::VideoMonitorCorbaDef,
			                          TA_Base_Bus_GZL9::VideoMonitorCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::VideoMonitorCorbaDef_var >        VideoMonitorNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::RecordingUnitCorbaDef,
			                          TA_Base_Bus_GZL9::RecordingUnitCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::RecordingUnitCorbaDef_var >       RecordingUnitNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::CameraCorbaDef,
			                          TA_Base_Bus_GZL9::CameraCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::CameraCorbaDef_var >              CameraNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::QuadCorbaDef,
			                          TA_Base_Bus_GZL9::QuadCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::QuadCorbaDef_var >                QuadNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::BVSStageCorbaDef,
			                          TA_Base_Bus_GZL9::BVSStageCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::BVSStageCorbaDef_var >            BVSStageNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::SequenceCorbaDef,
			                          TA_Base_Bus_GZL9::SequenceCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::SequenceCorbaDef_var >            SequenceNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::VideoOutputCorbaDef,
			                          TA_Base_Bus_GZL9::VideoOutputCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::VideoOutputCorbaDef_var >         VideoOutputNamedObject;
        typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::VideoInputCorbaDef,
			                          TA_Base_Bus_GZL9::VideoInputCorbaDef_ptr,
			                          TA_Base_Bus_GZL9::VideoInputCorbaDef_var >          VideoInputNamedObject;
		
		typedef TA_Base_Core::NamedObject< TA_Base_Bus_GZL9::SwitchManagerCorbaDef,
									  TA_Base_Bus_GZL9::SwitchManagerCorbaDef_ptr,
									  TA_Base_Bus_GZL9::SwitchManagerCorbaDef_var >		SwitchManagerNamedObject;
