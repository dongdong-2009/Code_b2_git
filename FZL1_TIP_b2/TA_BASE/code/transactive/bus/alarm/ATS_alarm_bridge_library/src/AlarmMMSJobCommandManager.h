...
{
	class AlarmMMSJobCommandManager : public CacheDataManager<std::string,  I_ALARM_PROVIDER::AlarmMmsJobCommand>
	{
	public:
...
// 		virtual unsigned long getCacheDataKey(AlarmMmsJobCommand* cacheData);
		virtual bool writeCacheDataToMem(I_ALARM_PROVIDER::AlarmMmsJobCommand* cacheData,ShareMemoryHelper* mem, char* pos);
		virtual bool readCacheDataFromMem(I_ALARM_PROVIDER::AlarmMmsJobCommand* cacheData,ShareMemoryHelper* mem, char* pos);
...
// 		};
		...
		{	
            ...
            AssetNameSize=I_ALARM_PROVIDER::ASSERT_NAME_SIZE+LongSharedMemoryData,		
			OperatorIdSize=I_ALARM_PROVIDER::OPERATOR_ID_SIZE+LongSharedMemoryData,	
            TargetDateSize=ULongSharedMemoryData,
			ProblemReportSize=I_ALARM_PROVIDER::PROBLEM_REPORT_SIZE+LongSharedMemoryData,			 
