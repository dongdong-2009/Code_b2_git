...
{
	class DataStoreUpdaterATSProfile  :public DataStoreUpdater<std::string , I_ALARM_PROVIDER::ExtProfileInfo,ATSProfileManager>
	{
	public:

		virtual ~DataStoreUpdaterATSProfile();
		void Initialize(std::vector< boost::shared_ptr<I_ALARM_PROVIDER::ExtProfileInfo> >& batch);
