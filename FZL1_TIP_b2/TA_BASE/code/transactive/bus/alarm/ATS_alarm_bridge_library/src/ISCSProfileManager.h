...
{
	class ISCSProfileManager : public CacheDataManager<unsigned long, I_ALARM_PROVIDER::ISCSProfileInfo>
	{
	public:
...
// 		virtual unsigned long getCacheDataKey(ISCSProfileInfo* cacheData);
		virtual bool writeCacheDataToMem(I_ALARM_PROVIDER::ISCSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos);
		virtual bool readCacheDataFromMem(I_ALARM_PROVIDER::ISCSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos);
