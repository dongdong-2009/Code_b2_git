...
namespace TA_Base_Bus
{
   ...
   boost::shared_ptr<ISCSProfileInfo> DataStoreReceiverISCSProfile::getProfileWithoutLock()
   {
	   std::vector<boost::shared_ptr<ISCSProfileInfo>  >*  datas= getDataWithoutLock();
