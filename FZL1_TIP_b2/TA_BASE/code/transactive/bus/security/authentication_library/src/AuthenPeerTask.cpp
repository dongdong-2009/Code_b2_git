...
namespace TA_Base_Bus
{
	...
	AuthenPeerTask::AuthenPeerTask(AuthenticationAgentNamedObjPtr pAuthAgent, 
		AuthenticationLibrary * pAuthLib, unsigned long locationId)
		:m_pAuthAgent(pAuthAgent),
		 m_pAuthLib( pAuthLib),
		 m_locationId(locationId)
	{
		TA_Assert( m_pAuthLib != NULL && m_pAuthAgent.get() != NULL );
	}
	...
	{
		TA_Assert( m_pAuthAgent.get() != NULL && m_pAuthLib != NULL );
