...
********************************************************************/
	...
	/// This method will be called when receive asdu type 45 with originator address field.
	virtual void handleSingleCommand(int rtuAddr,int iInfoAddr,b_ui8 btCot,b_ui8 bSco, b_ui8 bOriAddr){};
...
//---------------------------------------------- -----------------------
	...
	/// This method will be called when receive asdu type 58 with originator address
	virtual void handleSingleCommandWithTimeTag(int rtuAddr,int iInfoAddr,b_ui8 bCot,b_ui8 bSco,b_ui8 bOriAddr,SFepTime timeTag){};
