...
#define DEFAULT_RESOLVE_TIMEOUT 3000 // Millisecond precision (20 seconds)
...
enum GENAServerState
{
	GENAServer_Active = 0,
	GENAServer_Passive,
	GENAServer_Disconnected,
	GENAServer_Unknown
};

enum GENAConnectionStatus
{
	GENA_CONN_StatusGood_Active = 0,
	GENA_CONN_StatusGood_Passive=1,
	GENA_CONN_StatusBad=2,      //Single connection is in bad status 
	GENA_CONN_StatusBad_ALL=3,  //When all connections are in bad status, client application will receive two notifications: 1. BAD or Passive; 2 BAD_ALL
	GENA_CONN_StatusUnknown=4	  //Initial status
};
...
struct GenaServerParams
{
	...
	{}
	 GenaServerParams(const GenaServerParams& a)
	 {
