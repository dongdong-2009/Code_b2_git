/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/TA_BASE/transactive/app/configuration/configuration_editor/src/SessionHandler.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    private:
        ...
        */
         ...
         * connectToDatabase
         *
         * This attempts to initialise and connect directly to a database. It provides the
         * user the opportunity to login.
         *
         * @param string - This is the reason why the System Controller connection would not work
         *                 so we can display it to the user.
         *
         * @exception UserCancelException - This means the user wants to exit the application
         */
        void connectToDatabase(const std::string& reasonMessage);

        /**
         * locateSystemController
         *
         * This attempts to connect to the System Controller using the host name and the
         * port specified in RunParams.
         *
         * @exception CannotUseSysControllerException - This means we failed trying to connect using the
         *                                              System Controller.
         */
