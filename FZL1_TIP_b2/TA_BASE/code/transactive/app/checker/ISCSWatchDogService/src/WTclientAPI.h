...
// ChangeOPCItemState(...)
//
// Allows the Application to activate and deactivate an OPC Item
//
_declspec(dllexport) BOOL  WINAPI ChangeOPCItemState (HANDLE hConnect, HANDLE hGroup, HANDLE hItem, BOOL Active);
