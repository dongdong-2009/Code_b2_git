/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/TA_BASE/transactive/app/system_control/system_manager/src/ProcessListCtrl.h $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /**
          ...
          */
        virtual void populate(const std::vector<TA_Base_Core::ProcessData>& processData);
        virtual void updateChange(const std::vector<TA_Base_Core::ProcessData>& processData);
        ...
        /**
          ...
          * @param processData  The vector of ProcessData structures
          */
        void update(const std::vector<TA_Base_Core::ProcessData>&);
    ...
    private:
        ...
        int findIndex(const std::string& processId);
        ...
        std::vector<TA_Base_Core::ProcessData> m_processes;
