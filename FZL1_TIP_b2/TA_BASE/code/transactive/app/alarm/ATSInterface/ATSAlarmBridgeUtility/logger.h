...
namespace log4cxx
{
    ...
    public:
		...
		void debug(std::string strLogData)
		{
	...
	public:
		~Level(){};
		Level(){};
		static Level* getFatal() { return NULL; };
		static Level* getWarn() { return NULL; };
		static Level* getError() { return NULL; };
		static Level* getInfo() { return NULL; };
		static Level* getDebug() { return NULL; };
		static Level* getTrace() { return NULL; };
	};
