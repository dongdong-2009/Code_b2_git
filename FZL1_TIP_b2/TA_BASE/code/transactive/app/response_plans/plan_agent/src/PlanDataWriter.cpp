...
////-------------
		...
		{	//Add Step into step_details
            ...
            case TA_Base_Core::STATION_TRAVELLER_INFO_SYSTEM_STEP:
            {
                ...
                //like so:"stionid,downtrack,uptrack,concourse,gateway",and PidsDestinations is separated by SEPARATOR2
                ...
                for ( unsigned int i = 0; i < refParams.destinationList.length(); i++ )
                {
					...
					ostrstrm << refParams.destinationList[i].gateway << SEPARATOR;
