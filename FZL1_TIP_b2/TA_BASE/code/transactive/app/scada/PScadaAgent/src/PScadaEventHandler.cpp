...
void PScadaEventHandler::handleSingleCommand(int rtuAddr,int iInfoAddr,b_ui8 btCot,b_ui8 bSco,b_ui8 bOriAddr)
{
	FUNCTION_ENTRY("handleSingleCommand(int rtuAddr,int iInfoAddr,b_ui8 btCot,b_ui8 bSco,b_ui8 bOriAddr)");
	//bOriAddr is not used in PSCADA interface, so no need to process it.
	handleSingleCommand(rtuAddr,iInfoAddr,btCot,bSco);
	FUNCTION_EXIT("handleSingleCommand(int rtuAddr,int iInfoAddr,b_ui8 btCot,b_ui8 bSco,b_ui8 bOriAddr)");
}
