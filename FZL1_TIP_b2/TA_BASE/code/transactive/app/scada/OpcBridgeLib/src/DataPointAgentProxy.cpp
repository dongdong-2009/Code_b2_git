  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/app/scada/OpcBridgeLib/src/DataPointAgentProxy.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	void DataPointAgentProxy::run()
	{
		...
		while( !m_toBeTerminated )
		{
			...
			{
				LOG_EXCEPTION_CATCH(SourceInfo, "TA_Base_Core::BadParameterException", "Caught Bad Parameter exception, need reset observerID." );
