/**
  ...
  * any form.
  *
  * Source:		$File: //depot/FLZ1_TIP/TA_BASE/transactive/app/scada/PEnergyAgent/src/PEnergyAgent.h $
  * @author:	Liu Yong
  * @version:	$Revision: #1 $
  *
  ...
  * Description:
  *
  *	PEnergyAgent implementes the GenericAgent interface.  PEnergyAgent monitors and controls the 
  * the entities associated with its process, such as PEnergy Controller and the DataPoint entities.
  *
  */

#ifndef PENERGYAGENT_H
#define PENERGYAGENT_H
...
namespace TA_Base_App
{
	...
	class PEnergyAgent : public virtual TA_Base_Bus::IGenericAgentUser,
	...
	public:
		...
		PEnergyAgent ( int argc, char* argv[] );
		virtual ~PEnergyAgent();
		...
		*/
		...
		//
		// opearations specific to PEnergyAgent
		//

		/**
		  * startPEnergyAgent
		  *
		  * Start this PEnergyAgent process
		  *
		  */
		void startPEnergyAgent();
	...
	private:
		...
		/**
		  ...
		  *
		  * Load the PEnergyAgent entity's parameter from the database
		  *
		  */
		...
		/**
		  * startProcessors
		  *
		  * Start up all processors associated with the PEnergyAgent entity
		  *
		  */
		...
		/**
		  * stopProcessors
		  *
		  * Stop all processors associated with the PEnergyAgents entity
		  *
		  */
		void stopProcessors();
		...
		void updatePEnergyAgentConfiguration ( const TA_Base_Core::ConfigUpdateDetails & updateEvent);
		 ...
		 *
		 * create PEnergy internal worker utilities
		 *
		 */
        void createPEnergyWorkers();
	private:

		// attributes
		unsigned long m_PEnergyAgentPrimaryKey;
