...
OCIOTLQueryAdapter::OCIOTLQueryAdapter( otl_stream* pQuery ) : 
m_pQuery( pQuery ),
...
OCIOTLQueryAdapter::~OCIOTLQueryAdapter()
{
    cleanQuery();
}

bool OCIOTLQueryAdapter::hasMore()
{
...
void OCIOTLQueryAdapter::fetchInitial( int numColumns, Buffer& data, long lMaxRows )
{
    ThreadGuard guardQuery( m_queryLock );
...
void OCIOTLQueryAdapter::fetchMore( int numColumns, Buffer& data, long lMaxRows )
{
...
void OCIOTLQueryAdapter::fillDataBuffer( int numColumns, Buffer& data, long lMaxRows )
{
    ThreadGuard guardQuery( m_queryLock );
...
bool OCIOTLQueryAdapter::cleanQuery()
{
...
bool OCIOTLQueryAdapter::isActive( unsigned long ulMaxTimeoutInSecs )
{
...
void OCIOTLQueryAdapter::updateLatestActionTime()
{
...
int OCIOTLQueryAdapter::_GetColumnCount(otl_stream* pQuery)
{
...
std::string OCIOTLQueryAdapter::_GetColumnName(otl_stream* pQuery, int nColumnIndex)
{
	std::string strValue;
	otl_column_desc* p_otl_column_desc = NULL;
	int nColumnCount = 0;//nColumnCount;
...
std::string OCIOTLQueryAdapter::_GetColumnValue(otl_stream* pQuery, int nColumnIndex)
{
	std::string strValue;
	otl_column_desc* p_otl_column_desc = NULL;
	int nColumnCount = 0;//nColumnCount;
