/**
  ...
  * 
  * Source:    $File: //depot/4669_Review_Branch/4669/transactive/bus/ats/ats_agent/CommonATS/src/AtsCctvData.cpp $
...
namespace TA_IRS_Bus
{
	...
	bool AtsCctvData::isAtsDepot()
	{
		FUNCTION_ENTRY( "isAtsDepot" );
		FUNCTION_EXIT;
		return m_locationType == TA_Base_Core::AtsAgentEntityData::Depot ;
