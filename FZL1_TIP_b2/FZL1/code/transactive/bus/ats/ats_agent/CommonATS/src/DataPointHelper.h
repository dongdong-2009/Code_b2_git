/**
  ...
  * 
  * Source:    $File: //depot/4669_Review_Branch/4669/transactive/app/ats/AtsAgent/src/DataPointHelper.h $
...
namespace TA_IRS_Bus
{
    ...
    public:
		...
		DataPointHelper (TA_Base_Core::AtsAgentEntityDataPtr entityData,IPowerStatusUpdate* powerUpdate);
	...
	protected:
		...
		IPowerStatusUpdate* m_powerUpdate;
	};
}
