/**
  ...
  *
  */
#if !defined(PaResetCommand_H)
#define PaResetCommand_H
...
namespace TA_IRS_Bus
{
     ...
     */
    class PaResetCommand : public TimsCommand
    {
    ...
    public:
         ...
         */
        PaResetCommand( CommonTypes::TrainIdType trainId,
    ...
    typedef boost::shared_ptr< PaResetCommand > PaResetCommandPtr;

}

#endif // !defined(PaResetCommand_H)
