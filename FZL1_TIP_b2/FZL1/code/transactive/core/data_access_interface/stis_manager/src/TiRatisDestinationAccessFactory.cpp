/**
  ...
  * in any form.
  *
  * Source: $File: //depot/GZL6_TIP/3002/transactive/core/data_access_interface/stis_manager/src/TiRatisDestinationAccessFactory.cpp $
  * @author chunzhong
  * @version $Revision: #1 $
...
namespace TA_IRS_Core
{
    ...
    ITiRatisDestination* TiRatisDestinationAccessFactory::getTiRatisDestination(const unsigned long key,const bool readWrite)
    {
		...
		databaseConnection->prepareSQLStatement(sql, TI_RATIS_DEST_SELECT_55501, key);
    ...
    void TiRatisDestinationAccessFactory::setDestination(std::string newDestination)
    {
		...
		/*TI_RATIS_DEST_UPDATE_55701=comment on table ti_ratis_dest is  '%s'*/
		TA_Base_Core::SQLStatement sql;
		databaseConnection->prepareSQLStatement(sql, TI_RATIS_DEST_UPDATE_55701, tableDestination.str());
        // Execute the query. The method can throw a DatabaseException.
        // This is documented in the comment of this method.
