/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_Review_Branch_DBSync/3001/transactive/core/data_access_interface/telephone/telephone_direct_lines_dai/src/DatabaseQueryHelper.h $
  * @author:  Jade Lee
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2013/01/25 15:26:08 $
...
namespace DatabaseQueryHelper
{
     ...
     *
     */
	void appendWhereClause(TA_Base_Core::SQLStatement& rSqlStatement, 
