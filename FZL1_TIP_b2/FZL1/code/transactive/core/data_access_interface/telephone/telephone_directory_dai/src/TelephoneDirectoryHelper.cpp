/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_Review_Branch_DBSync/3001/transactive/core/data_access_interface/telephone/telephone_directory_dai/src/TelephoneDirectoryHelper.cpp $
  * @author:  Wong Soh Sum
  * @version: $Revision: #2 $
  *
    ...
    void TelephoneDirectoryHelper::reload()
    {
       ...
       /* std::ostringstream sql;
        sql << "select "
            ...
            << " where "
            << DIR_PRI_KEY << "=" << m_key;*/
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), TE_DIRECTORY_ENTRY_STD_SELECT_57007, m_key);
//		std::string strSql  = databaseConnection->prepareSQLStatement(TE_DIRECTORY_ENTRY_SELECT_57007, m_key);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, TE_DIRECTORY_ENTRY_SELECT_57007, m_key);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), TE_DIRECTORY_ENTRY_STD_DELETE_57401, m_key);
//		std::string strSql  = databaseConnection->prepareSQLStatement(TE_DIRECTORY_ENTRY_DELETE_57401, m_key);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, TE_DIRECTORY_ENTRY_DELETE_57401, m_key);
        try
        {
        ...
        //throw(TA_Base_Core::TransactiveException)
    {
       ...
       /* std::ostringstream sql;
        sql << "update "
            ...
            << " where "
            <<      DIR_PRI_KEY << "=" << m_key;*/
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), TE_DIRECTORY_ENTRY_STD_UPDATE_57151, m_subDirKey,
//		std::string strSql  = databaseConnection->prepareSQLStatement(TE_DIRECTORY_ENTRY_UPDATE_57151, m_subDirKey,
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, TE_DIRECTORY_ENTRY_UPDATE_57151, m_subDirKey,
			databaseConnection->escapeInsertString(m_teleNum), databaseConnection->escapeInsertString(m_fullName),
			databaseConnection->escapeInsertString(m_location), m_status, m_key);
        ...
        //throw(TA_Base_Core::TransactiveException)
    {
       ...
       /* std::ostringstream sql;
        sql << "insert into "
            ...
            << m_status << ")" ;*/
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), TE_DIRECTORY_ENTRY_STD_INSERT_57301, m_key,
//		std::string strSql  = databaseConnection->prepareSQLStatement(TE_DIRECTORY_ENTRY_INSERT_57301, m_key,
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, TE_DIRECTORY_ENTRY_INSERT_57301, m_key,
			m_subDirKey, databaseConnection->escapeInsertString(m_teleNum),databaseConnection->escapeInsertString(m_fullName),
			databaseConnection->escapeInsertString(m_location), m_status);
...
//			std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), TE_DIRECTORY_ENTRY_STD_SELECT_57008, m_key);
//			std::string strSql  = databaseConnection->prepareSQLStatement(TE_DIRECTORY_ENTRY_SELECT_57008, m_key);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, TE_DIRECTORY_ENTRY_SELECT_57008, m_key);
            TA_Base_Core::IData* data = databaseConnection->executeQuery(strSql,columnNames);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), TE_SUBDIRECTORY_STD_SELECT_57501, entityKey);
//		std::string strSql  = databaseConnection->prepareSQLStatement(TE_SUBDIRECTORY_SELECT_57501, entityKey);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, TE_SUBDIRECTORY_SELECT_57501, entityKey);
        TA_Base_Core::IData* data = databaseConnection->executeQuery(strSql,columnNames);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), TE_DIRECTORY_ENTRY_STD_SELECT_57009, 
//		std::string strSql  = databaseConnection->prepareSQLStatement(TE_DIRECTORY_ENTRY_SELECT_57009, 
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, TE_DIRECTORY_ENTRY_SELECT_57009,
			databaseConnection->escapeInsertString(m_teleNum), m_status, m_key);
