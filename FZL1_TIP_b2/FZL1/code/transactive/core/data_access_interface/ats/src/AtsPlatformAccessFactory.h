/**
  ...
  * in any form.
  *
  * Source: $File: //depot/GZL6_TIP/3002/transactive/core/data_access_interface/ats/src/AtsPlatformAccessFactory.h $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_IRS_Core
{
	...
	public:
        ...
        /**
         * getAtsStationIdWhere 
         *
         * Retrieves all Station Id based on the input AtsPlatformId 
         *
         *
         * @return A stationId
         *
         ...
         *
         */
		unsigned long getAtsStationIdWhere(long plantformId);
