  ...
  * in any form.
  *
  * Source: $File: //depot/GZL6_TIP/3002/transactive/core/data_access_interface/ats/src/AtsFbMapRecord.cpp $
  * @author Nick Jardine
  * @version $Revision: #2 $
...
namespace TA_IRS_Core
{
	...
	unsigned long AtsFbMapRecord::getArmId()
	{
	...
	std::string AtsFbMapRecord::getBranchName ()
	{
		TA_ASSERT(m_atsFbMapRecordHelper != NULL,"The AtsFbMapRecordHelper pointer is null.");
		return m_atsFbMapRecordHelper->getBranchName();
	}
