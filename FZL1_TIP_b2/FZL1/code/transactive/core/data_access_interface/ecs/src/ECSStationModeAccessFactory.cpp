/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/core/data_access_interface/ecs/src/ECSStationModeAccessFactory.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_Core
{
 ...
 //           << "from EC_STATION_MODE where ECSMOD_ID in (" << keys.str() << ")";
    ...
    IConfigECSStationMode* ECSStationModeAccessFactory::copyECSStationMode(const IConfigECSStationMode* ECSStationModeToCopy)
    {
        ...
        TA_ASSERT(ECSStationModeToCopy !=  NULL, "The ECSStationMode to copy was NULL");
        
        const ConfigECSStationMode* cast = dynamic_cast<const ConfigECSStationMode*>(ECSStationModeToCopy);

        TA_ASSERT(cast != NULL, "ECSStationMode passed could not be converted into a ConfigECSStationMode");
