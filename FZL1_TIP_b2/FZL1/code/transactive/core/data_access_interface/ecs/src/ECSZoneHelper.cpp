/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_Review_Branch_DBSync/3001/transactive/core/data_access_interface/ecs/src/ECSZoneHelper.cpp $
  * @author:  Nick Jardine
  * @version: $Revision: #2 $
  *
...
namespace TA_IRS_Core
{
    ...
    void ECSZoneHelper::setECSZoneId(int idKey)
    {
        ...
        TA_ASSERT(m_isNew,"An existing ECS Zone ID cannot be modified.");
    ...
    void ECSZoneHelper::invalidate()
    {
        ...
        TA_ASSERT(!m_isNew,"Attempted to call invalidate() on a new ECSZone");
    ...
    void ECSZoneHelper::reload()
    {
        ...
        TA_ASSERT(!m_isNew, "This ECSZone does not yet exist in the database. Therefore it cannot be reloaded.");
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(EC_ZONE_SELECT_51553, m_idKey);
    ...
    {       
        ...
        {
            TA_THROW(TA_Base_Core::DataConfigurationException("ECSZone data not fully specified. ECSZone cannot be written to database",
                                                         fieldNames));
        }
    ...
    void ECSZoneHelper::deleteECSZone(bool cascade)
    {
        ...
        TA_ASSERT(!m_isNew, "This ECSZone does not yet exist in the database, and therefore cannot be deleted");
