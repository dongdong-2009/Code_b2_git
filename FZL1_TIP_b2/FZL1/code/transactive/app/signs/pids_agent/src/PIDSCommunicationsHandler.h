...
/**
  ...
  *
  * Source:    $File: //depot/3002_TIP/3002/transactive/app/signs/pids_agent/src/PIDSCommunicationsHandler.h $
...
//		bool m_connected;   // Is the socket connected to the remote host
		...
		boost::shared_ptr<TA_Base_Bus::IModbusHelper>            m_pModbusHelperSignalling;
