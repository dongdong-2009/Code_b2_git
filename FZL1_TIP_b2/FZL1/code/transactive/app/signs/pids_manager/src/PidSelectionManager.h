...
public:
	...
	std::string getPidsString(int trainNo);
...
private:
	...
	static std::map<unsigned long, std::string> m_stationIdLocationDisplayNameMap;		//used for generate event description
