...
private:
    ...
    void changeIconPosition(bool isRestore);
    void parallelMoveIcon(CWnd* pWnd, long lLeftDiff, long lRightDiff, bool isRestore );
...
private:
    ...
    ScheduleBroadcastDlg* m_pScheduleBroadcastDlg;
