...
#if !defined(MASTERLIVEBROADCAST__INCLUDED_)
#define MASTERLIVEBROADCAST__INCLUDED_
...
public:
    ...
    MasterLiveBroadcast( TA_Base_Bus::IPAAgentCorbaDef::BroadcastConfig* broadcastConfigP,
