...
const unsigned long PAS_MAX_DVA_RECORDING_DURATION = 30u;
...
const int PAS_POLLING_OCC_CONSOLE_END = 110;
...
const unsigned long PAS_MULTI_MESSAGES_COUNT_ONE = 1u;
const unsigned short MASK_PAS_MULTI_MESSAGES_COUNT_VALUE = 0xFFFF;
...
const unsigned short PA_ZONE_ID_MAX = 32u;
const unsigned short PA_ZONE_ID_MIN = 1u;
const unsigned short PA_STATION_ID_MAX = 30u;
const unsigned short PA_STATION_ID_MIN = 1u;
const unsigned short PA_DVA_MSG_ID_MAX = 700u;
const unsigned short PA_DVA_MSG_ID_MIN = 1u;
