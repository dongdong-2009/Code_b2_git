...
typedef std::map< unsigned long, std::vector<unsigned long> > StationIdToZoneIdsMap;
typedef std::map< unsigned long, std::vector<unsigned long> >::iterator StationIdToZoneIdsIt;
...
public:
    ...
    unsigned long getPaPriorityIdBySessionId( const std::string& strSessionId );
    void getStationZoneIdsByZoneKeys( StationIdToZoneIdsMap& mapStaionZoneIds, const std::vector<unsigned long>& keys );
    void getDvaMsgIdsByDvaMsgKeys( std::vector<unsigned long>& vecDvaMsgIds, const std::vector<unsigned long>& keys );
	...
	void submitPaStopBroadcastStationDvaRequestAuditMessage( const TA_Base_Bus::IPAAgentCorbaDef::ZoneCoverage& zones, const std::string& sessionId );

	void submitPaStopBroadcastStationLiveRequestAuditMessage( const TA_Base_Bus::IPAAgentCorbaDef::ZoneCoverage& zones, const std::string& sessionId );

	void submitPaBroadcastMonitoringRequestAuditMessage( const TA_Base_Bus::IPAAgentCorbaDef::ZoneCoverage& zones, const std::string& sessionId );

	void submitPaStopBroadcastMonitoringRequestAuditMessage( const std::string& sessionId );
    ...
    void sendPAAgentRemovedBroadcastUpdate(unsigned long ulScheduleKey);
    void sendPAAgentNewBroadcastUpdate(const TA_Base_Bus::IPAAgentCorbaDef::BroadcastConfig& updateData);
    void sendPAAgentNewBroadcastUpdate(const TA_Base_Bus::IPAAgentCorbaDef::TriggeredBroadcastConfig& updateData);
    ...
    void sendScheduleBroadcastsUpdate( const TA_Base_Bus::IPAAgentCorbaDef::ScheduleBroadcastsUpdateData& updateData );
