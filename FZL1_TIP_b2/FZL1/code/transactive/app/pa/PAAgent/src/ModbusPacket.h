...
enum BROADCAST_TYPE_SOURCE
{
	...
	LIVE_BROADCAST_START_SOURCE = 0x2,
	BACKGROUND_MUSIC_START_SOURCE = 0x3,
	ZONE_MONITORING_START_SOURCE = 0x4,
	DVA_BROADCAST_STOP_SOURCE = 0x5,
	LIVE_BROADCAST_STOP_SOURCE = 0x6,
	BACKGROUND_MUSIC_STOP_SOURCE = 0x7,
	ZONE_MONITORING_STOP_SOURCE = 0x8
};
...
protected:
    ...
    virtual void setDVAMessageId( unsigned long ulMessageId );
