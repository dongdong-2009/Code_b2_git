 ...
 * in any form.
 *
 * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/wild/wild_agent/src/DataPointCache.cpp $
 * @author:  <Andy Siow>
 * @version: $Revision: #1 $
 *
                ...
                if(inhibitedIter != m_alarmInhitedProxyVirtualDpMap.end())
                {
                    ...
                    if(isPresent == false) // No existing record
                    {
                        ...
                        LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, 
                            "%s set to alarm inhibit by wheel %d", (itr->second)->getDataPointName(), wildDpKey);
                    }
                }
            }
