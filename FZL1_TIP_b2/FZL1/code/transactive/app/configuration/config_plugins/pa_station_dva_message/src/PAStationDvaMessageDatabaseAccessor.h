/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/pa_station_dva_message/src/PAStationDvaMessageDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
         ...
         * Performs function passthrough
         */
		virtual unsigned long getLocationOrderIdFromKey( unsigned long ulLocationKey ) {return 0;}
        /**
         * getLocationNameFromKey
         * Performs function passthrough
         */
        virtual std::string getLocDisplayNameFromKey(unsigned long locationKey) { return getLocationName(locationKey); }
    ...
    private:
        ...
        typedef std::map<unsigned long, TA_Base_Core::IConfigPaDvaMessage*>    ConfigItems;
