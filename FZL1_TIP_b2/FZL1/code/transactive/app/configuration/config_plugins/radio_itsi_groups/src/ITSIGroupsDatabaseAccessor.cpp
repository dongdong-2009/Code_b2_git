/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/radio_itsi_groups/src/ITSIGroupsDatabaseAccessor.cpp $
  * @author:  Derrick Liew
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    std::multimap<CString,unsigned long> ITSIGroupsDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
