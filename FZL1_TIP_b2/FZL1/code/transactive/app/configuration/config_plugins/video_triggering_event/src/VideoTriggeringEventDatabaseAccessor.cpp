/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/video_triggering_event/src/VideoTriggeringEventDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    std::multimap<CString,unsigned long> VideoTriggeringEventDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
