/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/ats_dss_plan_map/src/AtsDssPlanMapDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    std::multimap<CString,unsigned long> AtsDssPlanMapDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
