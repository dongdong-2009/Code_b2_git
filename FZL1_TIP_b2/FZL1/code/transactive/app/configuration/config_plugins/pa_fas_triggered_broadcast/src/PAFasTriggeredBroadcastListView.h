/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3002_TIP/3002/transactive/app/configuration/config_plugins/pa_fas_triggered_broadcast/src/PAFasTriggeredBroadcastListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * communicate with the PaFasTriggeredBroadcastDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_PaFasTriggeredBroadcastListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_PaFasTriggeredBroadcastListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/pa_fas_triggered_broadcast/src/PaFasTriggeredBroadcastListColumns.h"
...
{
    class PaFasTriggeredBroadcastListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    PaFasTriggeredBroadcastListView();

	    virtual ~PaFasTriggeredBroadcastListView();

	    DECLARE_DYNCREATE(PaFasTriggeredBroadcastListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(PaFasTriggeredBroadcastListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(PaFasTriggeredBroadcastListView)
    ...
    private:
         ...
         *                 m_actions vector
         * @param LPARAM - This is a pointer to this object. ie the PaFasTriggeredBroadcastListView object.
         */
        ...
        // sort the columns.
        std::map<unsigned long,PaFasTriggeredBroadcastDatabaseAccessor::CfgPaFasTriggeredBroadcastRecord> m_currentDisplayedItems;

        PaFasTriggeredBroadcastListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_PaFasTriggeredBroadcastListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
