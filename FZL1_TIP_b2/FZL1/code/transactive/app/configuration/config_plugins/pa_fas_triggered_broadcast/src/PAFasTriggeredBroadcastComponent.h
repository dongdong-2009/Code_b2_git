/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3002_TIP/3002/transactive/app/configuration/config_plugins/pa_fas_triggered_broadcast/src/PAFasTriggeredBroadcastComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(PaFasTriggeredBroadcastComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PaFasTriggeredBroadcastComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PaFasTriggeredBroadcastComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        PaFasTriggeredBroadcastComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PaFasTriggeredBroadcastComponent();
    ...
    private:
         ...
         */
        PaFasTriggeredBroadcastComponent( const PaFasTriggeredBroadcastComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PaFasTriggeredBroadcastComponent& operator=(const PaFasTriggeredBroadcastComponent&);
...
#endif // !defined(PaFasTriggeredBroadcastComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
