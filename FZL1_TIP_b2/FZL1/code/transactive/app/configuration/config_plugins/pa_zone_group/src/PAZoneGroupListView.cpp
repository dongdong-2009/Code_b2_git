/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const CString PaZoneGroupListView::NEW = "新建的";
    const CString PaZoneGroupListView::MODIFIED = "已修改";
