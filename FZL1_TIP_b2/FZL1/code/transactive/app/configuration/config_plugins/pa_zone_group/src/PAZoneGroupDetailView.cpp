/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupDetailView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const CString PaZoneGroupDetailView::CHANGE_LOCATION_DIALOG_TITLE = "选择车站";
    const CString PaZoneGroupDetailView::SELECT_ZONES_TITLE = "选择广播区域";
...
END_MESSAGE_MAP()
    ...
    void PaZoneGroupDetailView::OnInitialUpdate() 
    {
        ...
        if ( NULL != pMyFont )
        {
            ...
            m_fntZoneList.CreateFontIndirect( &stFontSetting );
            m_zoneListCtrl.SetFont( &m_fntZoneList );
        }
    ...
    void PaZoneGroupDetailView::populateItemDetails(TA_Base_Core::IConfigItem* currentItem)
    {
        ...
        try
        {
            ...
            {
                buffer = m_databaseAccessor->getLocDisplayName(m_configItem->getLocationKey()).c_str();
