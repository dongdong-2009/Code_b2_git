/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/sequence_entity/src/EntityDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    private:
        ...
        bool m_isLoaded;          // This indicates if we have loaded the entities before or not. If we
                                  ...
                                  // shouldn't load them.
		std::multimap<CString,unsigned long> m_subStringItemNamesNumber;//this stores all the locations along with the total number fetched by sequences
