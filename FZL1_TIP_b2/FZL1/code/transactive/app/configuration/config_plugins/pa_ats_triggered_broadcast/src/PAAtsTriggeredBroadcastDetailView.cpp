/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/PAAtsTriggeredBroadcastDetailView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const CString PaAtsTriggeredBroadcastDetailView::CHANGE_LOCATION_DIALOG_TITLE = "选择车站";
    const CString PaAtsTriggeredBroadcastDetailView::SELECT_ZONE_GROUP_TITLE = "选择广播区域组";
    const CString PaAtsTriggeredBroadcastDetailView::SELECT_PLATFORM_ID_TITLE = "选择站台";
    const CString PaAtsTriggeredBroadcastDetailView::SELECT_DVA_MESSAGE_TITLE = "选择预存广播消息";
    const CString PaAtsTriggeredBroadcastDetailView::SELECT_EVENT_TYPE_TITLE = "选择事件类型";
