/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/TA_PAAtsTriggeredBroadcastConfigPlugin.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
