/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/PAAtsTriggeredBroadcastComponent.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const DWORD PaAtsTriggeredBroadcastComponent::RIGHTS_ACTION_ID = TA_Base_Bus::aca_CE_CONFIGURE_EVENT_TRIGGERING;
