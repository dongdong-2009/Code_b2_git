/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/history/history_viewer/src/DataPointInfo.cpp $
  * @author:  Craig Grant
  * @version: $Revision: #1 $
  *
...
namespace TA_App
{
  ...
  */
    ...
    void CDataPointInfo::parseStationNames(const std::string& runParamString, std::vector<std::string>& stationNames)
    {
        ...
        std::string::size_type delimPos = runParamString.find(",", startPos);
