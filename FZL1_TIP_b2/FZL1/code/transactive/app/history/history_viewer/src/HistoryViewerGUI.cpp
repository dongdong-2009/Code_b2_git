...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/history/history_viewer/src/HistoryViewerGUI.cpp $
  * @author:  A. Lee
  * @version: $Revision: #1 $
  *
...
namespace TA_App
{
    ...
    void HistoryViewerGUI::checkCommandLine()
    {
        ...
        if(!startTime.empty())
        {
            ...
            std::string::size_type firstSlash = startTime.find_first_of("/");
            std::string::size_type secondSlash = startTime.find_first_of("/", firstSlash+1);
            ...
            std::string::size_type comma = startTime.find_first_of(",");
            ...
            std::string::size_type colon = startTime.find_first_of(":");
