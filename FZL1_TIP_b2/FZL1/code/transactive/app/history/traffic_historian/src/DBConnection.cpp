/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/history/traffic_historian/src/DBConnection.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
DBConnection::DBConnection()
{
	...
	std::string::size_type pos2 = param.find( ':', pos1+1 );
	assert( pos2 != std::string::npos );
	assert( pos2 > pos1 );
	m_Username = param.substr( pos1+1, pos2 - pos1 - 1 );

	// Extract the password
	std::string::size_type pos3 = param.find( ':', pos2+1 );
