...
* in any form.
*
* Source:   $File: //depot/GZL6_TIP/3002/transactive/app/cctv/video_display_manager/src/VideoSourcesListBox.cpp $
* @author:  Ripple
* @version: $Revision: #2 $
*
...
namespace TA_IRS_App
{
    ...
    VideoSourcesListBox::VideoSourcesListBox(bool withPrefix)
        : m_prevSelection(0),
          m_nCurItem(-1),
          m_bCapture(FALSE),
          m_wndTip(),
    ...
    void VideoSourcesListBox::setToolTipTimes(UINT tipInitialiseDelay,
                                              UINT tipPopDelay,
    ...
    void VideoSourcesListBox::OnKillfocus()
    {
        ...
        if(GetParent()->IsKindOf(RUNTIME_CLASS(TA_IRS_App::SequenceEditorDlg)))
        {
            if(((SequenceEditorDlg*)(GetParent()))->enableRemoveButton(FALSE))
            {
                ...
                if((-1 != GetCurSel()) && (focusWnd != m_wndTip.GetSafeHwnd()))
                {
                    ...
                    SetCurSel(-1);
                    ((SequenceEditorDlg*)(GetParent()))->enableOrderButtons(FALSE,
                                                                            FALSE,
                                                                            FALSE,
                                                                            FALSE);
                }
    ...
    void VideoSourcesListBox::updateButtonEnable()
    {
        ...
        if(GetParent()->IsKindOf(RUNTIME_CLASS(TA_IRS_App::SequenceEditorDlg)))
        {
            ...
            if(curSel != LB_ERR)
            {
                ...
                ((SequenceEditorDlg*)(GetParent()))->enableOrderButtons(top,
                                                                        up,
                                                                        down,
                                                                        bottom);
