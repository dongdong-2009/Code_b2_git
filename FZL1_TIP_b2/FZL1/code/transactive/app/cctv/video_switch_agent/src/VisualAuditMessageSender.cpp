/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/src/VisualAuditMessageSender.cpp $
...
namespace TA_IRS_App
{
    ...
    {
		return *(ACE_Singleton<VisualAuditMessageSender, ACE_Recursive_Thread_Mutex>::instance());
    }
