...
/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/src/EntityCreationFactory.h $
...
namespace TA_IRS_App
{
    ...
    {
		friend class ACE_Singleton<EntityCreationFactory, ACE_Recursive_Thread_Mutex>;
        public:
            //
