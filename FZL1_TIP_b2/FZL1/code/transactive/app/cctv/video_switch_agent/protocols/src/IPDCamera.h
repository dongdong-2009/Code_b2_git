...
/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/src/IPDCamera.h $
...
namespace TA_IRS_App
{
	...
	public:
        ...
        virtual void ptzRequest(TA_Base_Bus::CameraCorbaDef::PTZCtrlCmd cmd) = 0;
	};
