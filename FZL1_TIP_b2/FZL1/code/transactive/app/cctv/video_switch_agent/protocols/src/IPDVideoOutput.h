...
/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/src/IPDVideoOutput.h $
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        virtual void requestSwitchOfInput( unsigned long videoInputEntityKey, bool isDemand ) = 0;

		virtual void assignQuad( unsigned long cameraW,
								unsigned long cameraX,
								unsigned long cameraY,
								unsigned long cameraZ, 
								bool isDemand ) = 0;

        virtual void requestRecordingPlayBack(::CORBA::ULong cameraKey, const ::TA_Base_Bus::VideoOutputCorbaDef::Time& startTime, const ::TA_Base_Bus::VideoOutputCorbaDef::Time& endTime) = 0;
        virtual void playBackCtrl(TA_Base_Bus::VideoOutputCorbaDef::PlayBackCtrlCmd cmd) = 0;
