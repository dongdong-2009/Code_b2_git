/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/COE/src/COESequence.cpp $
...
namespace TA_IRS_App
{
    ...
    COESequence::COESequence(TA_Base_Core::SequencePtr sequenceData)
        : m_sequenceData(sequenceData), m_dwellTime(PREDEFINE_DWELL_TIME), m_videoInputs()
    {
