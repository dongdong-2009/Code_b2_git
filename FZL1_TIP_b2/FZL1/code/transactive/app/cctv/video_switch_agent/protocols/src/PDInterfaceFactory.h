...
/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/src/PDInterfaceFactory.h $
  * @author:   Katherine Thomson
  * @version:  $Revision: #3 $
  *
  * Last modification: $DateTime: 2013/07/16 10:46:44 $
...
namespace TA_IRS_App
{
	...
	public:
        ...
        static IPDCommunicationsHandler* createCommunicationsHandler( TA_Base_Core::VideoSwitchAgentPtr videoSwitchAgentData );
        ...
        static IPDVideoInput* createVideoInput( TA_Base_Core::VideoInputPtr videoInputData );
        ...
        static bool isSuperimposedTextControlSupported();
        ...
        static IPDSuperimposedTextControl* createSuperimposedTextControl(
            TA_Base_Core::VideoInputPtr videoInputData );
		...
		/**
          ...
          */
		static IPDSequence* createSequence( TA_Base_Core::SequencePtr sequenceData );
		...
		/**
          ...
          */
		//static IPDQuad* createQuad( TA_Base_Core::QuadPtr quadData );
        ...
        static IPDCamera* createCamera( TA_Base_Core::CameraPtr cameraData );
        ...
        static bool isMovementControlSupported();
        ...
        static IPDMovementControl* createMovementControl( TA_Base_Core::CameraPtr cameraData );
        ...
        static bool isFocusIrisControlSupported();
        ...
        static IPDFocusIrisControl* createFocusIrisControl( TA_Base_Core::CameraPtr cameraData );
        ...
        static bool isWashWipeControlSupported();
        ...
        static IPDWashWipeControl* createWashWipeControl( TA_Base_Core::CameraPtr cameraData );
        ...
        static IPDVideoOutput* createVideoOutput( TA_Base_Core::VideoOutputPtr videoOutputData );
        ...
        static IPDRecordingUnit* createRecordingUnit( TA_Base_Core::RecordingUnitPtr recordingUnitData );
