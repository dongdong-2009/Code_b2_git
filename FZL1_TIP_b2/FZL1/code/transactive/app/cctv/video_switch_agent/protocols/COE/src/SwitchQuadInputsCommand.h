...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/COE/src/SwitchQuadInputsCommand.h $
  * @author:  Robert Young
  * @version: $Revision: #4 $
  *
    ...
    class SwitchQuadInputsCommand : public AbstractCOERequestCommand
    {
        public:
            ...
            /**
              ...
              */
            SwitchQuadInputsCommand(unsigned long topLeftVideoInput,
        ...
        private:
            ...
            void fillUpCameraAddressPairByKey(std::pair< unsigned short, unsigned short >& addressPair, unsigned long cameraKey);
