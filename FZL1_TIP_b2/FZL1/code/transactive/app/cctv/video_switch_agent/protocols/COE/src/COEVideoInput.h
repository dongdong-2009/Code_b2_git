...
/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/COE/src/COEVideoInput.h $
  * @author:   Rob Young
  * @version:  $Revision: #4 $
  *
...
{
    class COEVideoInput : public IPDVideoInput, boost::noncopyable
    {
        public:
