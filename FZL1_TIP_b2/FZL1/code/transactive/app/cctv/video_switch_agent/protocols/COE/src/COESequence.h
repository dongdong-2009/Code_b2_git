...
/**
  ...
  *
  * Source:    $File: //depot/WXL1_TIP/3002/transactive/app/cctv/video_switch_agent/protocols/COE/src/COESequence.h $
...
{
    class COESequence : public IPDSequence, boost::noncopyable
    {
