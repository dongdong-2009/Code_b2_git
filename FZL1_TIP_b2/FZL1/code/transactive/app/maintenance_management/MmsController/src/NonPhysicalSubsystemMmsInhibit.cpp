/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/maintenance_management/MmsController/src/NonPhysicalSubsystemMmsInhibit.cpp $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
...
{	
	...
	CNonPhysicalSubsystemMmsInhibit::CNonPhysicalSubsystemMmsInhibit(CWnd* pParent /*=NULL*/)
		: CDialog(CNonPhysicalSubsystemMmsInhibit::IDD, pParent) 
	{
	...
	BEGIN_MESSAGE_MAP(CNonPhysicalSubsystemMmsInhibit, CDialog)
	...
	void CNonPhysicalSubsystemMmsInhibit::OnNonPhysicalSubsystemApplyClick() 
	{
		...
		{	
			...
			if (IDYES == userMsg.showMsgBox(IDS_UW_190004))
			{
