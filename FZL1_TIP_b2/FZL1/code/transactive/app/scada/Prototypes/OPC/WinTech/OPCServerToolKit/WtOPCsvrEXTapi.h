...
typedef HRESULT (CALLBACK *AEREFRESHEVENTPROC)(DWORD, DWORD);
#else /* !STRICT */
typedef FARPROC WRITENOTIFYPROC2;
typedef FARPROC AEACKCONDITIONPROC;
typedef FARPROC AEREFRESHEVENTPROC;
#endif
...
_declspec(dllexport) BOOL WINAPI EnableAERefreshEventCallback (AEREFRESHEVENTPROC lpCallback);
