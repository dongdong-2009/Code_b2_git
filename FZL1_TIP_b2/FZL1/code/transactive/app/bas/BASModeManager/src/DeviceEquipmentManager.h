#if !defined(TA_GF_3002_app_bas_BasDevieceEquipmentManager_EquipmentManager)
#define TA_GF_3002_app_bas_BasDevieceEquipmentManager_EquipmentManager
#pragma once
...
#endif //TA_GF_3002_app_bas_BasDevieceEquipmentManager_EquipmentManager
