...
const std::string CDeviceList::m_HEADER_DEVICENUM = "设备号码";
const std::string CDeviceList::m_HEADER_DEVICENAME = "设备名称";
const std::string CDeviceList::m_HEADER_AUTOMANUAL = "手/自动";
...
void CDeviceList::setupListCtrl()
{
	...
	InsertColumn(m_COLUMN_INDEX_DEVICENUM, _T(m_HEADER_DEVICENUM.c_str()), LVCFMT_CENTER, 100);
	InsertColumn(m_COLUMN_INDEX_DEVICENAME, _T(m_HEADER_DEVICENAME.c_str()), LVCFMT_CENTER, 100);
	InsertColumn(m_COLUMN_INDEX_AUTOMANUAL, _T(m_HEADER_AUTOMANUAL.c_str()), LVCFMT_CENTER, 100);
	InsertColumn(m_COLUMN_INDEX_CURRENTSTATUS, _T(m_HEADER_CURRENTSTATUS.c_str()), LVCFMT_CENTER, 100);
	InsertColumn(m_COLUMN_INDEX_EXPECTSTATUS, _T(m_HEADER_EXPECTSTATUS.c_str()), LVCFMT_CENTER, 100);
	FUNCTION_EXIT;
}
