...
{
    FUNCTION_ENTRY("getModeTimeoutFlag");
...
void SubSystemStatus::updateSubsystemModeExecuteForClean(unsigned long locationKey, unsigned long subsystemKey, ModeSet::subsystemModeType modeType)
{
	FUNCTION_ENTRY("updateSubsystemModeExecuteFail");
...
void SubSystemStatus::updateSubsystemMode(unsigned long locationKey, unsigned long subsystemKey, unsigned long value, ModeSet::subsystemModeType modeType)
{
