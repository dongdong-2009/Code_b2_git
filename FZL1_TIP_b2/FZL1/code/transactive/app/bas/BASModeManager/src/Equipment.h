...
#if !defined (TA_3002_App_Bas_BasManager_Equipment_H)
#define TA_3002_App_Bas_BasManager_Equipment_H
...
public:
	...
	Equipment(unsigned long locationKey, BasManagerSubscriber* basSubscriberPtr, TA_IRS_Core::SubSystem_SmartPtr subsystem, std::string equipmentName);
	~Equipment(void);
...
#endif //TA_3002_App_Bas_BasManager_Equipment_H
