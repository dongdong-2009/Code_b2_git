#if !defined (Transactive_3002_GF_App_Bas_BASManager_BASManagerGUI)
#define Transactive_3002_GF_App_Bas_BASManager_BASManagerGUI
#if _MSC_VER > 1000
#pragma once
#endif
...
#endif //Transactive_3002_GF_App_Bas_BASManager_BASManagerGUI