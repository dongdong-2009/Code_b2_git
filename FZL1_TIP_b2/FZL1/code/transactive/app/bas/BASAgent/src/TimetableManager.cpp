/**
  ...
  * any form.
  *
  * Source:		$File: //depot/FZL1_TIP/FZL1/transactive/app/bas/BASAgent/src/TimetableManager.cpp $
  * @author:	Huang Jian
  * @version:	$Revision: #6 $
  *
  * Last modification:	$DateTime: 2015/11/27 14:18:04 $
...
{
    const int MAXTIMETABLELENGTH = 30;
