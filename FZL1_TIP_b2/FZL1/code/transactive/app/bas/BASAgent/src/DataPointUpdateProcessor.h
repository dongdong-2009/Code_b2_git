/**
  ...
  * any form.
  *
  * Source:		$File: //depot/FZL1_TIP/FZL1/transactive/app/bas/BASAgent/src/DataPointUpdateProcessor.h $
  * @author:	Huang Jian
  * @version:	$Revision: #1 $
  *
  ...
  *
  */
#if !defined(DATAPOINTUPDATEPROCESSOR_H)
#define DATAPOINTUPDATEPROCESSOR_H
...
{
    class DataPointUpdateProcessorImpl: public TA_Base_Bus::IDataPointObserverNotification, public IDataPointUpdateObserver
    {
    public:
...
#endif //DATAPOINTUPDATEPROCESSOR_H