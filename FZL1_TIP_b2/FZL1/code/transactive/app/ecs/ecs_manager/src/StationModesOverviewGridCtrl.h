...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/StationModesOverviewGridCtrl.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
	...
	typedef std::map<int, TA_IRS_App::TA_ECSManagerCommonDefs::ECurrentStationAutoModeType> LocationIndexAndAutoModeMap;
	...
	typedef std::pair<int, TA_IRS_App::TA_ECSManagerCommonDefs::ECurrentStationAutoModeType> LocationIndexAndAutoModeType;
    ...
    public:
		...
		void setCurrentStationAutoModeControlState( int locationIndex, TA_IRS_App::TA_ECSManagerCommonDefs::ECurrentStationAutoModeType autoModeType);
        ...
        /** 
          ...
          */
        void setCurrentProposedStationMode( int locationIndex, TA_IRS_App::TA_ECSManagerCommonDefs::EProposedStationModeType proposedStationModeType,
            const std::string& proposedStationMode, TA_IRS_App::TA_ECSManagerCommonDefs::EModeProposalState proposalState );
