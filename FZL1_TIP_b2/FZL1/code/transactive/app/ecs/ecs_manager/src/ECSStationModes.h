...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/ECSStationModes.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    private:
        ...
        TA_ECSManagerCommonDefs::LocationKeys m_locationKeys; // Ordered (inbound) container of location (station) keys.

        unsigned long m_currentUsersLocationKey; // Key of current user's location.

        TA_ECSManagerCommonDefs::LocationNames m_locationNames; // Ordered (inbound) container of location (station) names.
        ...
        TA_ECSManagerCommonDefs::StationModeDetails m_currentStationModeDetails; // Container of Station Modes loaded for currently selected location.
