/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/ProposedStationModeUpdateSubscriber.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
	...
	: m_auditSender(NULL), m_proposedStationModeObserver(observer)
	{
		...
		try
		{
			...
			TA_ASSERT(MasterECSAgentData.size() == 1, "There can only be one Master ECS Agent at a particular location");
