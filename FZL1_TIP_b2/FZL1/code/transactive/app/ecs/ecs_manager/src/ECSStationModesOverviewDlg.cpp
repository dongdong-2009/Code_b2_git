/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/ECSStationModesOverviewDlg.cpp $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
// using TA_IRS_App::StationModesOverviewGridCtrl::LocationIndexAndProposedType;
// using TA_IRS_App::StationModesOverviewGridCtrl::LocationIndexAndAutoModeType;

typedef  TA_IRS_App::TA_ECSManagerCommonDefs::LocationNames LocationNames;
#define ECurrentStationModeType  TA_IRS_App::TA_ECSManagerCommonDefs::ECurrentStationModeType
#define ECurrentStationAutoModeType  TA_IRS_App::TA_ECSManagerCommonDefs::ECurrentStationAutoModeType
#define EProposedStationModeType  TA_IRS_App::TA_ECSManagerCommonDefs::EProposedStationModeType
#define EModeProposalState  TA_IRS_App::TA_ECSManagerCommonDefs::EModeProposalState
typedef  TA_IRS_App::StationModesOverviewGridCtrl::LocationIndexAndProposedType LocationIndexAndProposedType;
typedef  TA_IRS_App::StationModesOverviewGridCtrl::LocationIndexAndAutoModeType LocationIndexAndAutoModeType;
...
namespace TA_IRS_App
{
	...
	// Reduce launching manager time
	DWORD WINAPI ECSStationModesOverviewDlg::ThreadFunction(LPVOID lpThreadParameter)
	{
		ECSStationModesOverviewDlg* ECSSMD = (ECSStationModesOverviewDlg*) lpThreadParameter;
		ECSSMD->onInitialise();
		return TRUE;
	}
	// Reduce launching manager time
	...
	BEGIN_MESSAGE_MAP( ECSStationModesOverviewDlg, TransActiveDialog )
		...
		ON_REGISTERED_MESSAGE(WM_ENABLE_CLOSE, onEnableCloseButton )
	...
	BOOL ECSStationModesOverviewDlg::OnInitDialog()
	{
		...
		properties.maxHeight = -1;//properties.minHeight;
		properties.maxWidth = -1;//properties.minWidth;
...
LRESULT ECSStationModesOverviewDlg::onEnableCloseButton(WPARAM wParam, LPARAM lParam)
	{
	...
	LRESULT ECSStationModesOverviewDlg::onSetCurrentStationAutoModeControlState( WPARAM wParam, LPARAM lParam )
	{
		...
		autoModeType = TA_IRS_App::TA_ECSManagerCommonDefs::CURRENT_STATION_AUTO_MODE_OFF;
    ...
    // OnClose
    //
	void ECSStationModesOverviewDlg::OnClose() 
	{
		...
		for (int iCt =0; iCt<3; iCt++)		
		{
			if (gridCtrlArray[iCt]->GetRowSelectedFlag() || gridCtrlArray[iCt]->GetMultiSelectedFlag())	// CL-20791 add multi-selection
			{
					 ...
					 ++nvIter)
				{
					...
					if ( ((*nvIter).second == TA_ECSManagerCommonDefs::PROPOSED_FOR_CONGESTION) || 
						 //((*nvIter).second == TA_ECSManagerCommonDefs::PROPOSED_FOR_EMERGENCY) ||	//zn++ CL-17276
						 ((*nvIter).second == TA_ECSManagerCommonDefs::PROPOSED_FOR_NORMAL) )	// zn++ CL-17276 Multi Select Normal Mode
					// End   TD17268
					{
