...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/ECSStationModesOverviewDlg.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          ...
          */
        virtual void setLocations( const TA_ECSManagerCommonDefs::LocationNames& locationNames );
        ...
        /** 
          ...
          */
        virtual void setCurrentStationMode( int locationIndex, const std::string& stationMode, TA_ECSManagerCommonDefs::ECurrentStationModeType stationModeType );
        ...
        virtual void setCurrentProposedStationMode( int locationIndex, TA_ECSManagerCommonDefs::EProposedStationModeType proposedStationModeType, 
            const std::string& proposedStationMode, TA_ECSManagerCommonDefs::EModeProposalState proposalState );
