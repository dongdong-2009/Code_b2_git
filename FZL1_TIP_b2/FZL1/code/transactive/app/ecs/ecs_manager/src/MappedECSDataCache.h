...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/MappedECSDataCache.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          ...
          */
        // No longer relevant
        //TA_ECSManagerCommonDefs::ZoneDirectionKeys getZoneDirectionKeys() const;
        ...
        /** 
          ...
          */
        TA_ECSManagerCommonDefs::StationModeDetail getStationModeDetailFromKey( unsigned long stationModeKey ) const;
        ...
        /** 
          ...
          */
        TA_ECSManagerCommonDefs::MasterModeDetail getMasterModeDetailFromKey( unsigned long masterModeKey ) const;
    ...
    private:
        ...
        typedef std::map< unsigned long, TA_ECSManagerCommonDefs::StationModeDetail >   StationModeKeyToDetail;
        ...
        typedef std::map< unsigned long, TA_ECSManagerCommonDefs::MasterModeDetail >    MasterModeKeyToDetail;
        ...
        //TA_ECSManagerCommonDefs::ZoneDirectionKeys  m_zoneDirectionKeys;
