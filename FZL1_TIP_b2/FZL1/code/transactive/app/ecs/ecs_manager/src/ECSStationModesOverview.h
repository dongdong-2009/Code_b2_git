...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/ECSStationModesOverview.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          ...
          */
        void proposedStationModeSelected( int locationIndex, TA_ECSManagerCommonDefs::EProposedStationModeType proposedStationModeType );
        ...
        /** 
          ...
          * @param EProposedStationModeType - Enum corresponding to type of selected proposed Station Mode.
          */
        void applySelectedProposedStationMode( int locationIndex, TA_ECSManagerCommonDefs::EProposedStationModeType proposedStationModeType );
		...
		void confirmApplyProposedStationMode(std::map<int, TA_IRS_App::TA_ECSManagerCommonDefs::EProposedStationModeType> allProposedIndexAndType);
   ...
   private:
    ...
    private:
        ...
        typedef std::pair< int,  TA_ECSManagerCommonDefs::EProposedStationModeType > LocationAndProposedType;
        ...
        /** 
          ...
          */
        TA_ECSManagerCommonDefs::EProposedStationModeType getProposedStationModeType( unsigned long locationKey,
		...
		//zn++ CL-17444 ITEM1
		bool isStationInOverrideOfType(int index, TA_ECSManagerCommonDefs::EProposedStationModeType type);
		//++zn
    ...
    private:
        ...
        TA_ECSManagerCommonDefs::LocationKeys m_locationKeys; // Container of location (Station) keys inbound order.

        TA_ECSManagerCommonDefs::LocationNames m_locationNames; // Container of location (Station) names inbound order.
		...
		// wenching++ 
		// bug 134 (TD)
        typedef  std::multimap<int, unsigned long> CongestionModePairLocationKey;
		typedef CongestionModePairLocationKey::iterator  CongestionModePairLocationKeyIt;
