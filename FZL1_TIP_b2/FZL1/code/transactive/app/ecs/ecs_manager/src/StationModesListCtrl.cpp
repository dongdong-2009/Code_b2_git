/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/StationModesListCtrl.cpp $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    void StationModesListCtrl::setStationModeProposalState( int stationModeIndex, EModeProposalState stationModeProposalState )
    {
        ...
        {
            if ( std::binary_search( m_blinkingItemIndexes.begin(), m_blinkingItemIndexes.end(), stationModeIndex ) )
            {
                m_blinkingItemIndexes.erase( std::lower_bound( m_blinkingItemIndexes.begin(), m_blinkingItemIndexes.end(), 
                    stationModeIndex ) );
            }
        }
