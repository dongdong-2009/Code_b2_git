...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ecs_manager/src/IECSMasterModesView.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          ...
          */
        virtual void setMasterModeDetails( const TA_ECSManagerCommonDefs::MasterModeDetails& masterModeDetails ) = 0;
        ...
        /** 
          ...
          */
        virtual void setCurrentProposedMasterMode( int masterModeIndex, TA_ECSManagerCommonDefs::EModeProposalState proposalState ) = 0;
