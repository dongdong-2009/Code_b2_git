/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/GZL6_TIP/3002/transactive/app/ecs/ECSAgent/src/ItaEcsCachedMaps.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
public:
   ...
   /**
    ...
    virtual MasterModePair getMasterModePairFromMasterMode(unsigned long masterMode)=0;
