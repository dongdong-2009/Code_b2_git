...
namespace TA_IRS_App
{
    ...
    void StationOperationModeManager::logFailureStates()
    {
        ...
        LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,
                     "[Group Offline: %s][Local Duty: %s][Radio Fallback: %s][Double ATS Failure: %s]",
                     m_groupOffline ? "True" : "False",
                     m_localDuty ? "True" : "False",
                     m_fallbackMode ? "True" : "False",
                     m_doubleAtsFailure ? "True" : "False" );
