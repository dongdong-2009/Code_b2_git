/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/incidents/incident_manager/src/AssetDialog.cpp $
  * @author:  Wu Min Tao
  * @version: $Revision: #1 $
  *
		...
		try
		{
			...
			if (assetData != NULL && (assetData->getNumRows() == 1))
			{
				...
				LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,
					...
					m_currentAsset.id,
					m_currentAsset.subsystem.c_str(),
					m_currentAsset.description.c_str());    
			}
			else
			{
