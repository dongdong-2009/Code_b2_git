...
namespace TA_IRS_App
{
    ...
    StationOperationModeManager::StationOperationModeManager( ITrainAgentConfiguration& configuration,
            ...
            : OperationModeManager( configuration,
              ...
              m_localDuty( false ),
              m_previousLocalSubsystemState( static_cast< TA_Base_Bus::ESubsystemState >( -1 ) ) //limin++, CL-21120
    {
    ...
    void StationOperationModeManager::processSubsystemStateChange( const SubsystemDutyState& dutyState )
    {
        ...
        m_previousLocalSubsystemState = dutyState.dutyState; //limin++, CL-21120
    ...
    void StationOperationModeManager::controlModeInitialisation()
    {
        ...
        try
        {
            ...
            m_previousLocalSubsystemState = localSubsystemState;//limin++, CL-21120
    ...
    void StationOperationModeManager::syncWithDutyAgent()
    {
        ...
        try
        {
            ...
            if ( localSubsystemState == m_previousLocalSubsystemState )
            {
                FUNCTION_EXIT;
                return;
            }

            m_previousLocalSubsystemState = localSubsystemState;
