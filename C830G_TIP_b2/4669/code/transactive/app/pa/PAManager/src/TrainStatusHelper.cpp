/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/app/pa/PAManager/src/TrainStatusHelper.cpp $
  * @author Jade Lee
  * @version $Revision: #2 $
                                    ...
                                    bool hasOverrideOption)
{
    ...
    CORBA_CALL( agent, retryTrainBroadcast, ( broadcastId.c_str(), 
                               trains,
                               hasOverrideOption,
