/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/pa/PASimulatorLibrary/src/PATable301.cpp $
  ...
  *
  *
  * Definition file for class PATable301.
  */
...
PATable301::PATable301(PATableRequestProcessor * parent)
: PASimTable(301,parent)
{
    Byte * bp = &(m_tableArray.messageSequenceId);
    size_t sz = sizeof(Table301DataArray);
...
PATable301::~PATable301()
{
}



UserReply * PATable301::processUserRead(UserRequest * ur)
{
    return PASimTable::processUserRead(ur);
}


UserReply * PATable301::processUserWrite(UserRequest * ur)
{
