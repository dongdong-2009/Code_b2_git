#ifndef PA_TABLE_1301_H
#define PA_TABLE_1301_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/pa/PASimulatorLibrary/src/PATable1301.h $
  ...
  * 
  * Declaration file for PATable1301 class
  */
...
namespace TA_App
{
    /**
      * @class PATable1301
      *
      * PATable1301 is a derived table class.
      */
    class PATable1301 : public PASimTable
    {
    ...
    public:
        /**
          ...
          */
        PATable1301(PATableRequestProcessor * parent);
        ...
        /**
          * overridden to set up dependency on table 301
          */
...
#pragma pack(push,1)
#endif // #ifdef WIN32
        typedef struct Table1301Record
        {
            ...
            unsigned long   stop;
            Byte            eventTriggered;
            Byte            globalCoverage[MAXSTNID][4];
        }
#ifdef __GNUG__
...
#pragma pack(pop)
        ...
        /**
          *
          */
        typedef Table1301Record Table1301DataArray;

        /**
          * The table data
          */
        Table1301DataArray m_tableArray;
