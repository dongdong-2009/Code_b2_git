/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_branch_track/src/AtsBranchTrackFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_AtsBranchTrackFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_AtsBranchTrackFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class AtsBranchTrackFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsBranchTrackFrameworkView();

	    DECLARE_DYNCREATE(AtsBranchTrackFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(AtsBranchTrackFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~AtsBranchTrackFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(AtsBranchTrackFrameworkView)
...
#endif // !defined(AFX_AtsBranchTrackFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
