/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_branch_track/src/AtsBranchTrackDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    std::map<CString,unsigned long> AtsBranchTrackDatabaseAccessor::getItemNames(CProgressCtrl& progress)
    {
