/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station/src/PAStationListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all PA Stations available to be configured. This view must
  * communicate with the PaStationDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_PaStationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_PaStationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/pa_station/src/PaStationListColumns.h"
...
{
    class PaStationListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
	    ...
	    virtual ~PaStationListView();

	    DECLARE_DYNCREATE(PaStationListView)
    ...
    private:
        ...
        // These are the possible values for the status of each PA Station
        ...
        // sort the columns.
        std::map<unsigned long,PaStationDatabaseAccessor::PaStationRecord> m_currentDisplayedItems;

        PaStationListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_PaStationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
