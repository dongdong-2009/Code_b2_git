/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/video_station/src/VideoStationListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * communicate with the VideoStationDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_VideoStationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_VideoStationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/Video_station/src/VideoStationListColumns.h"
...
{
    class VideoStationListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    VideoStationListView();

	    virtual ~VideoStationListView();

	    DECLARE_DYNCREATE(VideoStationListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(VideoStationListView)
	    public:
    ...
    private:
         ...
         *                 m_actions vector
         * @param LPARAM - This is a pointer to this object. ie the VideoStationListView object.
         */
        ...
        // sort the columns.
        std::map<unsigned long,VideoStationDatabaseAccessor::VideoStationRecord> m_currentDisplayedItems;

        VideoStationListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_VideoStationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
