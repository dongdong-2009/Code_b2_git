/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/video_station/src/VideoStationComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(VideoStationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define VideoStationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class VideoStationComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        VideoStationComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~VideoStationComponent();
    ...
    private:
         ...
         */
        VideoStationComponent( const VideoStationComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        VideoStationComponent& operator=(const VideoStationComponent&);
...
#endif // !defined(VideoStationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
