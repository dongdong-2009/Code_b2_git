/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_fixed_block_map/src/AtsFixedBlockMapFrameworkView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int AtsFixedBlockMapFrameworkView::TOP_PANE      = 0;
    const int AtsFixedBlockMapFrameworkView::BOTTOM_PANE   = 1;
    const int AtsFixedBlockMapFrameworkView::ZERO_COLUMN   = 0;

    const int AtsFixedBlockMapFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(AtsFixedBlockMapFrameworkView, CView)


    AtsFixedBlockMapFrameworkView::AtsFixedBlockMapFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(AtsFixedBlockMapFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(AtsFixedBlockMapFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL AtsFixedBlockMapFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void AtsFixedBlockMapFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* AtsFixedBlockMapFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(AtsFixedBlockMapDetailView);
    }


    CRuntimeClass* AtsFixedBlockMapFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(AtsFixedBlockMapListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // AtsFixedBlockMapFrameworkView diagnostics

    #ifdef _DEBUG
    void AtsFixedBlockMapFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void AtsFixedBlockMapFrameworkView::Dump(CDumpContext& dc) const
    {
