/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/tis_ratis_destination/src/TisRatisDestinationListView.h $
  * @author:  James
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all Tis Ratis Destinations available to be configured. This view must
  * communicate with the TisRatisDestinationDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_TisRatisDestinationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_TisRatisDestinationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/tis_ratis_destination/src/TisRatisDestinationListColumns.h"
...
{
    class TisRatisDestinationListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    TisRatisDestinationListView();

	    virtual ~TisRatisDestinationListView();

	    DECLARE_DYNCREATE(TisRatisDestinationListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(TisRatisDestinationListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(TisRatisDestinationListView)
    ...
    private:
	   ...
	   */
        ...
        *                 m_actions vector
        * @param LPARAM - This is a pointer to this object. ie the TisRatisDestinationListView object.
        */
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        // sort the columns.
        std::map<unsigned long,TisRatisDestinationDatabaseAccessor::TisRatisDestinationRecord> m_currentDisplayedItems;

        TisRatisDestinationListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_TisRatisDestinationListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
