/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/tis_ratis_destination/src/TisRatisDestinationComponent.h $
  * @author:  James
  * @version: $Revision: #1 $
  *
...
#if !defined(TisRatisDestinationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define TisRatisDestinationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class TisRatisDestinationComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        TisRatisDestinationComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~TisRatisDestinationComponent();
    ...
    private:
         ...
         */
        TisRatisDestinationComponent( const TisRatisDestinationComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        TisRatisDestinationComponent& operator=(const TisRatisDestinationComponent&);
...
#endif // !defined(TisRatisDestinationComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
