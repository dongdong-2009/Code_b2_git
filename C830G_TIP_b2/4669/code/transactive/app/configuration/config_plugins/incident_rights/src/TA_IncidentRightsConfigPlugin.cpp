/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/incident_rights/src/TA_IncidentRightsConfigPlugin.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
  ...
  *
  */
// incident_rights.cpp : Defines the initialization routines for the DLL.
//
...
{
	static AFX_EXTENSION_MODULE TA_IncidentRightsConfigPluginDLL = { NULL, NULL };
		...
		DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
	{
		...
		{
			TRACE0("TA_INCIDENTRIGHTSCONFIGPLUGIN.DLL Initializing!\n");
			
			// Extension DLL one-time initialization
			if (!AfxInitExtensionModule(TA_IncidentRightsConfigPluginDLL, hInstance))
				return 0;
			...
			new CDynLinkLibrary(TA_IncidentRightsConfigPluginDLL);
		}
		else if (dwReason == DLL_PROCESS_DETACH)
		{
			TRACE0("INCIDENT_RIGHTS.DLL Terminating!\n");
			// Terminate the library before destructors are called
			AfxTermExtensionModule(TA_IncidentRightsConfigPluginDLL);
		}
		return 1;   // ok
	}
    ...
    /**
      ...
      *
      * @return IConfigurableComponent*		A new RightsComponent object which implements
    ...
    {
	    return new IncidentRightsComponent(componentName);
    }
