/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/video_triggering_event/src/VideoTriggeringEventListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all Video Stations available to be configured. This view must
  * communicate with the VideoTriggeringEventDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_VideoTriggeringEventListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_VideoTriggeringEventListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/video_triggering_event/src/VideoTriggeringEventListColumns.h"
...
{
    class VideoTriggeringEventListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    VideoTriggeringEventListView();

	    virtual ~VideoTriggeringEventListView();

	    DECLARE_DYNCREATE(VideoTriggeringEventListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(VideoTriggeringEventListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(VideoTriggeringEventListView)
    ...
    private:
         ...
         *                 m_actions vector
         * @param LPARAM - This is a pointer to this object. ie the VideoTriggeringEventListView object.
         */
        ...
        // sort the columns.
        std::map<unsigned long,VideoTriggeringEventDatabaseAccessor::VideoTriggeringEventRecord> m_currentDisplayedItems;

        VideoTriggeringEventListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_VideoTriggeringEventListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
