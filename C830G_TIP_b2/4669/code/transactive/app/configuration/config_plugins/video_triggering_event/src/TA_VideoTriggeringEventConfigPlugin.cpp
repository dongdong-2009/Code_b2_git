/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/video_triggering_event/src/TA_VideoTriggeringEventConfigPlugin.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
{
    static AFX_EXTENSION_MODULE TA_VideoTriggeringEventConfigPluginDLL = { NULL, NULL };
    ...
    DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
    {
	    ...
	    {
		    TRACE0("TA_VIDEOTRIGGERINGEVENTCONFIGPLUGIN.DLL Initializing!\n");
		    
		    // Extension DLL one-time initialization
		    if (!AfxInitExtensionModule(TA_VideoTriggeringEventConfigPluginDLL, hInstance))
			    return 0;
		    ...
		    new CDynLinkLibrary(TA_VideoTriggeringEventConfigPluginDLL);
	    }
	    else if (dwReason == DLL_PROCESS_DETACH)
	    {
		    TRACE0("TA_VIDEOTRIGGERINGEVENTCONFIGPLUGIN.DLL Terminating!\n");
		    // Terminate the library before destructors are called
		    AfxTermExtensionModule(TA_VideoTriggeringEventConfigPluginDLL);
	    }
	    return 1;   // ok
    }
    ...
    /**
      ...
      *
      * @return IConfigurableComponent*		A new VideoTriggeringEventComponent object which implements
    ...
    {
	    return new VideoTriggeringEventComponent(componentName);
    }
