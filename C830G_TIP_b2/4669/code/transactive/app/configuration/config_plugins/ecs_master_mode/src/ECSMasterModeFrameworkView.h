/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ecs_master_mode/src/ECSMasterModeFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_ECSMasterModeFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_ECSMasterModeFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class ECSMasterModeFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    ECSMasterModeFrameworkView();

	    DECLARE_DYNCREATE(ECSMasterModeFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(ECSMasterModeFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~ECSMasterModeFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(ECSMasterModeFrameworkView)
...
#endif // !defined(AFX_ECSMasterModeFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
