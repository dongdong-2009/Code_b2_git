/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ecs_master_mode/src/ECSMasterModeComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(ECSMasterModeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define ECSMasterModeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class ECSMasterModeComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        ECSMasterModeComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~ECSMasterModeComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ECS_MASTER_MODES;
        }
    ...
    private:
         ...
         */
        ECSMasterModeComponent( const ECSMasterModeComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        ECSMasterModeComponent& operator=(const ECSMasterModeComponent&);
...
#endif // !defined(ECSMasterModeComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
