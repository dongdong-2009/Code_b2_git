/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_twp_entity_map/src/AtsTwpEntityMapFrameworkView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#include "app/configuration/config_plugins/ats_twp_entity_map/src/AtsTwpEntityMapFrameworkView.h"
...
namespace TA_IRS_App
{
    ...
    const int AtsTwpEntityMapFrameworkView::TOP_PANE      = 0;
    const int AtsTwpEntityMapFrameworkView::BOTTOM_PANE   = 1;
    const int AtsTwpEntityMapFrameworkView::ZERO_COLUMN   = 0;

    const int AtsTwpEntityMapFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(AtsTwpEntityMapFrameworkView, CView)


    AtsTwpEntityMapFrameworkView::AtsTwpEntityMapFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(AtsTwpEntityMapFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(AtsTwpEntityMapFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL AtsTwpEntityMapFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void AtsTwpEntityMapFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* AtsTwpEntityMapFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(AtsTwpEntityMapDetailView);
    }


    CRuntimeClass* AtsTwpEntityMapFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(AtsTwpEntityMapListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // AtsTwpEntityMapFrameworkView diagnostics

    #ifdef _DEBUG
    void AtsTwpEntityMapFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void AtsTwpEntityMapFrameworkView::Dump(CDumpContext& dc) const
    {
