/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ecs_station_mode/src/ECSStationModeFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_ECSStationModeFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_ECSStationModeFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class ECSStationModeFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    ECSStationModeFrameworkView();

	    DECLARE_DYNCREATE(ECSStationModeFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(ECSStationModeFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~ECSStationModeFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(ECSStationModeFrameworkView)
...
#endif // !defined(AFX_ECSStationModeFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
