/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone/src/TA_PAZoneConfigPlugin.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
{
    static AFX_EXTENSION_MODULE TA_PaZoneConfigPluginDLL = { NULL, NULL };
    ...
    DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
    {
	    ...
	    {
		    TRACE0("TA_PAZONECONFIGPLUGIN.DLL Initializing!\n");
		    
		    // Extension DLL one-time initialization
		    if (!AfxInitExtensionModule(TA_PaZoneConfigPluginDLL, hInstance))
			    return 0;
		    ...
		    new CDynLinkLibrary(TA_PaZoneConfigPluginDLL);
	    }
	    else if (dwReason == DLL_PROCESS_DETACH)
	    {
		    TRACE0("TA_PAZONECONFIGPLUGIN.DLL Terminating!\n");
		    // Terminate the library before destructors are called
		    AfxTermExtensionModule(TA_PaZoneConfigPluginDLL);
	    }
	    return 1;   // ok
    }
    ...
    /**
      ...
      *
      * @return IConfigurableComponent*		A new PaZoneComponent object which implements
    ...
    {
	    return new PaZoneComponent(componentName);
    }
