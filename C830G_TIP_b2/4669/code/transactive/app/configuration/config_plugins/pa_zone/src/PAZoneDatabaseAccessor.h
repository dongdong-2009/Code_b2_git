/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone/src/PAZoneDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        {
            return m_entityNameCache.getInternalMap();
        }
        ...
        std::string getEntityName(unsigned long entityKey);
        unsigned long getLocationKey(const std::string& locationName);
        unsigned long getEntityKey(const std::string& entityName);
    ...
    private:
        ...
        ItemKeyToNameMap<TA_Base_Core::IEntityData> m_entityNameCache;
