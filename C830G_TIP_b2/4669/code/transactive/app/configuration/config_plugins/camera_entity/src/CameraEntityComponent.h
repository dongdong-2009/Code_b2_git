/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/camera_entity/src/CameraEntityComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(CameraEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define CameraEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
namespace TA_Base_App
{
    ...
    class CameraEntityComponent : public AbstractComponent
    {
    ...
    public:
         ...
         *                          represent
         */
        CameraEntityComponent(const std::string& componentName,
    ...
    private:
         ...
         */
        CameraEntityComponent( const CameraEntityComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        CameraEntityComponent& operator=(const CameraEntityComponent&);
...
#endif // !defined(CameraEntityComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
