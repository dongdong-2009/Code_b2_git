/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_mss_zone/src/AtsMssZoneFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_AtsMssZoneFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_AtsMssZoneFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class AtsMssZoneFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsMssZoneFrameworkView();

	    DECLARE_DYNCREATE(AtsMssZoneFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(AtsMssZoneFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~AtsMssZoneFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(AtsMssZoneFrameworkView)
...
#endif // !defined(AFX_AtsMssZoneFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
