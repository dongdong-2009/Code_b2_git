/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_power_entity_map/src/AtsPowerEntityMapFrameworkView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(AFX_AtsPowerEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_AtsPowerEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class AtsPowerEntityMapFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    AtsPowerEntityMapFrameworkView();

	    DECLARE_DYNCREATE(AtsPowerEntityMapFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(AtsPowerEntityMapFrameworkView)
	    //}}AFX_VIRTUAL
    ...
    // Implementation
    protected:
	    virtual ~AtsPowerEntityMapFrameworkView();
    #ifdef _DEBUG
    ...
    protected:
	    //{{AFX_MSG(AtsPowerEntityMapFrameworkView)
...
#endif // !defined(AFX_AtsPowerEntityMapFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
