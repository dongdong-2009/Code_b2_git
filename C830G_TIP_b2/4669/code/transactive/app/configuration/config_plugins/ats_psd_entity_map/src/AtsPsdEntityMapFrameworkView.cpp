/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/ats_psd_entity_map/src/AtsPsdEntityMapFrameworkView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int AtsPsdEntityMapFrameworkView::TOP_PANE      = 0;
    const int AtsPsdEntityMapFrameworkView::BOTTOM_PANE   = 1;
    const int AtsPsdEntityMapFrameworkView::ZERO_COLUMN   = 0;

    const int AtsPsdEntityMapFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(AtsPsdEntityMapFrameworkView, CView)


    AtsPsdEntityMapFrameworkView::AtsPsdEntityMapFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(AtsPsdEntityMapFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(AtsPsdEntityMapFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL AtsPsdEntityMapFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void AtsPsdEntityMapFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* AtsPsdEntityMapFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(AtsPsdEntityMapDetailView);
    }


    CRuntimeClass* AtsPsdEntityMapFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(AtsPsdEntityMapListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // AtsPsdEntityMapFrameworkView diagnostics

    #ifdef _DEBUG
    void AtsPsdEntityMapFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void AtsPsdEntityMapFrameworkView::Dump(CDumpContext& dc) const
    {
