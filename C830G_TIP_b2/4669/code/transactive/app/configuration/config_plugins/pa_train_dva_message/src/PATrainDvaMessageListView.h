/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_train_dva_message/src/PATrainDvaMessageListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all PA Train DVA Messages available to be configured. This view must
  * communicate with the PaTrainDvaMessageDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_PaTrainDvaMessageListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_PaTrainDvaMessageListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/pa_train_dva_message/src/PaTrainDvaMessageListColumns.h"
...
{
    class PaTrainDvaMessageListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    PaTrainDvaMessageListView();

	    virtual ~PaTrainDvaMessageListView();

	    DECLARE_DYNCREATE(PaTrainDvaMessageListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(PaTrainDvaMessageListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(PaTrainDvaMessageListView)
    ...
    private:
         ...
         *                 m_actions vector
         * @param LPARAM - This is a pointer to this object. ie the PaTrainDvaMessageListView object.
         */
        ...
        // These are the possible values for the status of each PA Train DVA Message
        ...
        // sort the columns.
        std::map<unsigned long,PaTrainDvaMessageDatabaseAccessor::PaTrainDvaMessageRecord> m_currentDisplayedItems;

        PaTrainDvaMessageListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_PaTrainDvaMessageListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
