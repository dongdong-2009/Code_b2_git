/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_train_dva_message/src/PaTrainDvaMessageGlobalView.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
END_MESSAGE_MAP()
    ...
    void PaTrainDvaMessageGlobalView::onVersionChanged()
    {        
        ...
        else
        {
            ...
            m_enteredVersion.setValue(atol(versionString.GetBuffer(0)));
        }        
