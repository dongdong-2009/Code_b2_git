/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_train_dva_message/src/PATrainDvaMessageComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(PaTrainDvaMessageComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PaTrainDvaMessageComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PaTrainDvaMessageComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        PaTrainDvaMessageComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PaTrainDvaMessageComponent();
    ...
    private:
         ...
         */
        PaTrainDvaMessageComponent( const PaTrainDvaMessageComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PaTrainDvaMessageComponent& operator=(const PaTrainDvaMessageComponent&);
...
#endif // !defined(PaTrainDvaMessageComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
