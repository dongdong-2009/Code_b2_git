/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station_dva_message/src/PAStationDvaMessageListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * communicate with the PaStationDvaMessageDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_PaStationDvaMessageListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_PaStationDvaMessageListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/pa_station_dva_message/src/PaStationDvaMessageListColumns.h"
...
{
    class PaStationDvaMessageListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    PaStationDvaMessageListView();

	    virtual ~PaStationDvaMessageListView();

	    DECLARE_DYNCREATE(PaStationDvaMessageListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(PaStationDvaMessageListView)
	    public:
    ...
    protected:
	    //{{AFX_MSG(PaStationDvaMessageListView)
    ...
    private:
         ...
         *                 m_actions vector
         * @param LPARAM - This is a pointer to this object. ie the PaStationDvaMessageListView object.
         */
        ...
        // sort the columns.
        std::map<unsigned long,PaStationDvaMessageDatabaseAccessor::PaStationDvaMessageRecord> m_currentDisplayedItems;

        PaStationDvaMessageListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_PaStationDvaMessageListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
