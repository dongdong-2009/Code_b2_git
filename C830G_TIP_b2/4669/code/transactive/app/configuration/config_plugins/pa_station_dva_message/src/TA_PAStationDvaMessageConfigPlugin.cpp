/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station_dva_message/src/TA_PAStationDvaMessageConfigPlugin.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
{
    static AFX_EXTENSION_MODULE TA_PaStationDvaMessageConfigPluginDLL = { NULL, NULL };
    ...
    DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
    {
	    ...
	    {
		    TRACE0("TA_PASTATIONDVAMESSAGECONFIGPLUGIN.DLL Initializing!\n");
		    
		    // Extension DLL one-time initialization
		    if (!AfxInitExtensionModule(TA_PaStationDvaMessageConfigPluginDLL, hInstance))
			    return 0;
		    ...
		    new CDynLinkLibrary(TA_PaStationDvaMessageConfigPluginDLL);
	    }
	    else if (dwReason == DLL_PROCESS_DETACH)
	    {
		    TRACE0("TA_PASTATIONDVAMESSAGECONFIGPLUGIN.DLL Terminating!\n");
		    // Terminate the library before destructors are called
		    AfxTermExtensionModule(TA_PaStationDvaMessageConfigPluginDLL);
	    }
	    return 1;   // ok
    }
    ...
    /**
      ...
      *
      * @return IConfigurableComponent*		A new PaStationDvaMessageComponent object which implements
    ...
    {
	    return new PaStationDvaMessageComponent(componentName);
    }
