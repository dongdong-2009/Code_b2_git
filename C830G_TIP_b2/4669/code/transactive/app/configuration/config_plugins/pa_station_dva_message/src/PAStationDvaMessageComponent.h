/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station_dva_message/src/PAStationDvaMessageComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(PaStationDvaMessageComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PaStationDvaMessageComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PaStationDvaMessageComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        PaStationDvaMessageComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PaStationDvaMessageComponent();
    ...
    private:
         ...
         */
        PaStationDvaMessageComponent( const PaStationDvaMessageComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PaStationDvaMessageComponent& operator=(const PaStationDvaMessageComponent&);
...
#endif // !defined(PaStationDvaMessageComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
