/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station_dva_message/src/PAStationDvaMessageListColumns.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
  *
...
PaStationDvaMessageListColumns::PaStationDvaMessageListColumns()
{
    ...
    setColumnParams(COL_TIS_LIBRARY_SECTION,    100,    "TIS Library Section",     COMPARE_INTEGER);
    setColumnParams(COL_TIS_LIBRARY_VERSION,    100,    "TIS Library Version",     COMPARE_INTEGER);            
