/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_station_dva_message/src/PAStationDvaMessageFrameworkView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int PaStationDvaMessageFrameworkView::TOP_PANE      = 0;
    const int PaStationDvaMessageFrameworkView::BOTTOM_PANE   = 1;
    const int PaStationDvaMessageFrameworkView::ZERO_COLUMN   = 0;

    const int PaStationDvaMessageFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(PaStationDvaMessageFrameworkView, CView)


    PaStationDvaMessageFrameworkView::PaStationDvaMessageFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(PaStationDvaMessageFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(PaStationDvaMessageFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL PaStationDvaMessageFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void PaStationDvaMessageFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* PaStationDvaMessageFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(PaStationDvaMessageDetailView);
    }


    CRuntimeClass* PaStationDvaMessageFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(PaStationDvaMessageListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // PaStationDvaMessageFrameworkView diagnostics

    #ifdef _DEBUG
    void PaStationDvaMessageFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void PaStationDvaMessageFrameworkView::Dump(CDumpContext& dc) const
    {
