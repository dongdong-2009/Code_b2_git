/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/tis_ratis_tag/src/TisRatisTagComponent.h $
  * @author:  James
  * @version: $Revision: #1 $
  *
...
#if !defined(TisRatisTagComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define TisRatisTagComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class TisRatisTagComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        TisRatisTagComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~TisRatisTagComponent();
    ...
    private:
         ...
         */
        TisRatisTagComponent( const TisRatisTagComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        TisRatisTagComponent& operator=(const TisRatisTagComponent&);
...
#endif // !defined(TisRatisTagComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
