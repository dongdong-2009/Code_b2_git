/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/tis_ratis_tag/src/TisRatisTagListView.h $
  * @author:  James
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all Tis Ratis Tags available to be configured. This view must
  * communicate with the TisRatisTagDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_TisRatisTagListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_TisRatisTagListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/tis_ratis_tag/src/TisRatisTagListColumns.h"
...
{
    class TisRatisTagListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
	    ...
	    virtual ~TisRatisTagListView();

	    DECLARE_DYNCREATE(TisRatisTagListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(TisRatisTagListView)
	    public:
    ...
    private:
	   ...
	   */
        ...
        *                 m_actions vector
        * @param LPARAM - This is a pointer to this object. ie the TisRatisTagListView object.
        */
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        // sort the columns.
        std::map<unsigned long,TisRatisTagDatabaseAccessor::TisRatisTagRecord> m_currentDisplayedItems;

        TisRatisTagListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_TisRatisTagListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
