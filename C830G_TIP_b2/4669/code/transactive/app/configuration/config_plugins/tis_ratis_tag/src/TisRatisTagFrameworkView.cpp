/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/tis_ratis_tag/src/TisRatisTagFrameworkView.cpp $
  * @author:  James
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int TisRatisTagFrameworkView::TOP_PANE      = 0;
    const int TisRatisTagFrameworkView::BOTTOM_PANE   = 1;
    const int TisRatisTagFrameworkView::ZERO_COLUMN   = 0;

    const int TisRatisTagFrameworkView::TOP_PANE_SIZE = 500;

    IMPLEMENT_DYNCREATE(TisRatisTagFrameworkView, CView)


    TisRatisTagFrameworkView::TisRatisTagFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(TisRatisTagFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(TisRatisTagFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL TisRatisTagFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void TisRatisTagFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* TisRatisTagFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(TisRatisTagDetailView);
    }


    CRuntimeClass* TisRatisTagFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(TisRatisTagListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // TisRatisTagFrameworkView diagnostics

    #ifdef _DEBUG
    void TisRatisTagFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void TisRatisTagFrameworkView::Dump(CDumpContext& dc) const
    {
