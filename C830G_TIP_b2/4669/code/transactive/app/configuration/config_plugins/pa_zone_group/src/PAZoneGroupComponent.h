/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#if !defined(PaZoneGroupComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PaZoneGroupComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PaZoneGroupComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        PaZoneGroupComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PaZoneGroupComponent();
    ...
    private:
         ...
         */
        PaZoneGroupComponent( const PaZoneGroupComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PaZoneGroupComponent& operator=(const PaZoneGroupComponent&);
...
#endif // !defined(PaZoneGroupComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
