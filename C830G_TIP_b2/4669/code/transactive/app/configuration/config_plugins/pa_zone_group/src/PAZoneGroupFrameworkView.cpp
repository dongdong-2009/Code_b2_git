/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupFrameworkView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int PaZoneGroupFrameworkView::TOP_PANE      = 0;
    const int PaZoneGroupFrameworkView::BOTTOM_PANE   = 1;
    const int PaZoneGroupFrameworkView::ZERO_COLUMN   = 0;

    const int PaZoneGroupFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(PaZoneGroupFrameworkView, CView)


    PaZoneGroupFrameworkView::PaZoneGroupFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(PaZoneGroupFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(PaZoneGroupFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL PaZoneGroupFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void PaZoneGroupFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* PaZoneGroupFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(PaZoneGroupDetailView);
    }


    CRuntimeClass* PaZoneGroupFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(PaZoneGroupListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // PaZoneGroupFrameworkView diagnostics

    #ifdef _DEBUG
    void PaZoneGroupFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void PaZoneGroupFrameworkView::Dump(CDumpContext& dc) const
    {
