/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    private:
        ...
        TA_IRS_Bus::PaZoneCachedMap* m_zoneCachedMap;

        // Store a cached copy for efficiency
        TA_Base_Core::PrimitiveWrapper<unsigned long> m_occLocationKey, m_depotLocationKey;
    };
}
