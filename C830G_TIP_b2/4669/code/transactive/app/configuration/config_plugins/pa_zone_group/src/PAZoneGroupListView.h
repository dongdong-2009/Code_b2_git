/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a list of all PA Zone Groups available to be configured. This view must
  * communicate with the PaZoneGroupDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_PaZoneGroupListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_PaZoneGroupListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/pa_zone_group/src/PaZoneGroupListColumns.h"
...
{
    class PaZoneGroupListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
	    ...
	    virtual ~PaZoneGroupListView();

	    DECLARE_DYNCREATE(PaZoneGroupListView)
    ...
    public:
	    ...
	    //{{AFX_VIRTUAL(PaZoneGroupListView)
	    public:
    ...
    private:
         ...
         *                 m_actions vector
         * @param LPARAM - This is a pointer to this object. ie the PaZoneGroupListView object.
         */
        ...
        // These are the possible values for the status of each PA Zone Group
        ...
        // sort the columns.
        std::map<unsigned long,PaZoneGroupDatabaseAccessor::PaZoneGroupRecord> m_currentDisplayedItems;

        PaZoneGroupListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_PaZoneGroupListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
