/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupListColumns.h $
  * @author Jade Lee
  * @version $Revision: #1 $
  *
...
class PaZoneGroupListColumns 
:
public ListColumnsBase<TA_IRS_App::PaZoneGroupDatabaseAccessor::PaZoneGroupRecord, PaZoneGroupListColumns>
{
public:

    PaZoneGroupListColumns();

    // getAssociatedEquipmentEntities() isn't covered in the columns
    enum EColumn
    {
        COL_MOD_STATUS,
        COL_KEY,                // IPaZoneGroup::getKey()
        COL_LOCATION,           // IPaZoneGroup::getLocationKey()
        COL_LABEL,              // IPaZoneGroup::getLabel()
        COL_IS_EVENT_GROUP,     // IPaZoneGroup::getIsEventGroup()
        COL_MAX        
    };    
     ...
     */
    static const CString getFieldFromRecord(DWORD column, const TA_IRS_App::PaZoneGroupDatabaseAccessor::PaZoneGroupRecord& details);
};
