/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/configuration/config_plugins/pa_zone_group/src/PAZoneGroupDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    void PaZoneGroupDatabaseAccessor::deleteItem(unsigned long key)
    {
        ...
        if (!matching->second->isNew())
        {
            ...
            matching->second->deleteThisObject(auditInfo);
        }
