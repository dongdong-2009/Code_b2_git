/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/system_control/banner/pages/call_page/src/VettingManager.cpp $
...
#include "bus\signs_4669\tis_agent_access\src\TISAgentAccessFactory.h"
...
namespace TA_IRS_App
{
        ...
        : m_callback(callback)
    {
        ...
        try
        {
            ...
            */
            ...
            CORBA_CALL_RETURN( vetting, TA_Base_Bus::TISAgentAccessFactory::getInstance().getOccSTISAgent(), isRATISVettingOn, () );//limin
    ...
    void VettingManager::setVettingState(bool vettingState)
    {
        ...
        try
        {
            ...
            CORBA_CALL( TA_Base_Bus::TISAgentAccessFactory::getInstance().getOccSTISAgent(), setRATISVetting, ( isVetting, sessionId.c_str() ) );//limin
        }
