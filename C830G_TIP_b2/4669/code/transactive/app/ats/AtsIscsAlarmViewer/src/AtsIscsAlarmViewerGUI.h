#ifndef AtsIscsAlarmViewerGUI_H
#define AtsIscsAlarmViewerGUI_H
...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ats/AtsIscsAlarmViewer/src/AtsIscsAlarmViewerGUI.h $
  * @author:  Anita Lee
  * @version: $Revision: #1 $
  *
  ...
  * 
  * Integrated Alarm Viewer GUI Application class. All GUIs implementing the Generic GUI framework requires a 
...
{
    class AtsIscsAlarmViewerGUI : public TA_Base_Bus::AbstractDialogGUI
	{
	public:
	  /**
	    * Constructor
