#ifndef ATS_SIM_TABLE_ISCSALARM_H
#define ATS_SIM_TABLE_ISCSALARM_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ats/ATSSimulatorLibrary/src/ATSSimTableIscsAlarm.h $
  ...
  * 
  * Declaration file for ATSSimTableIscsAtcData class
  */
...
namespace ATS_Sim
{
    ...
    /**
      * @class ATSSimTableIscsAtcData
      *
      * ATSSimTableIscsAtcData is a derived table class.
      *
      * TABLE IscsAtcData 
      *
      */
    class ATSSimTableIscsAtcData : public ATSSimTable
    {
    ...
    public:
        /**
          ...
          */
        ATSSimTableIscsAtcData(ATSSimTableQueryProcessor * parent, LocationType loc);

        /**
          * Destructor
          */
        ~ATSSimTableIscsAtcData();
    ...
    private:
        /**
          ...
          */
        typedef struct ATSSimTableIscsAtcDataRecord
        {
        ...
        /**
          * 
          */
        ATSSimTableIscsAtcDataRecord * m_tableData;
...
#endif // #ifndef ATS_SIM_TABLE_ISCSALARM_H
