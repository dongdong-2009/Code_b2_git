#ifndef ATS_SIM_UTILITY_H
#define ATS_SIM_UTILITY_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ats/ATSSimulatorLibrary/src/ATSSimUtility.h $
  ...
  * 
  * Declaration file for ATSSimUtility class
  */
...
namespace ATS_Sim
{
    ...
    /**
      * @class ATSSimUtility
      *
      * ATSSimUtility is a utility class for ATSSim Tables.  It contains only static
      * methods.
      *
      */
    class ATSSimUtility
    ...
    public:
        ...
        /**
          ...
          *        with either 'Ats' or 'Iscs' then this parameter gives the
          *        assumed prefix.
          * @return the tableAddress value, zero (0) if the table name is not
          *         valid.
          */
        static TableIdentifier string2TableIdentifier(const std::string & s, std::string assume_prefix="ats");
        ...
        /** fills the string s with a representation of the given date values
          * as YYMMDDhhmmss.  Useful for the strings in Ats Platform, Train and
          * WILD tables.
          *
    ...
    inline Byte ATSSimUtility::getByte(const ByteVector & v, int & i)
    {
    ...
    inline Word ATSSimUtility::getWord(const ByteVector & v, int & i)
    {
        TwoByteUnion tbu;
        tbu.the_bytes[0] = v[i];
    ...
    inline void ATSSimUtility::putByte(Byte b, ByteVector & v)
    {
        v.push_back(b);
    }


    inline void ATSSimUtility::putWord(Word w, ByteVector & v)
    {
        TwoByteUnion tbu;
	...
	inline void ATSSimUtility::putDWord(DWord w, ByteVector & v)
    {
        FourByteUnion tbu;
...
#endif // #ifndef ATS_SIM_UTILITY_H
