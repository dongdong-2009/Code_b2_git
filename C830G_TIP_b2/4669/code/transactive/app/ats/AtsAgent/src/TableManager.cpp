/**
  ...
  * 
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/ats/AtsAgent/src/TableManager.cpp $
  * @author:   Ross Tucker
  * @version:  $Revision: #1 $
...
namespace TA_IRS_App
{
	...
	void TableManager::readAtsWatchdog(int connection)
	{
		...
		if (readSuccessful)
		{
			...
			{
				watchDogData.updateConnectionState(connection, WatchDogData::ConnectionWriteRead);
			}
			else
			{
