/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ECSAgent/src/EcsArrowManager.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
		...
		else
		{
			...
			catch(TA_Base_Core::CachedMappingNotFoundException&)
			{
				...
				LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugError, 
							"Cannot find Selected Master Mode %ld in configuration.  Reverting to ECS_NONE_OR_INVALID", 
							m_currentSelectedMasterMode);
			}
		}
	}
	...
	if (updateType != SELECTED)  //TD16709
	{
		...
		else
		{
			...
			catch(TA_Base_Core::CachedMappingNotFoundException&)
			{
				// Do nothing and use default values
				LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugError, 
							"Cannot find Applied Master Mode %ld in configuration.  Reverting to ECS_NONE_OR_INVALID", 
							m_currentAppliedMasterMode);
			}   
		}
	}
