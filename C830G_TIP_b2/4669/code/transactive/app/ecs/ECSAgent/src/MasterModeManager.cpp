...
/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/4669/transactive/app/ecs/ECSAgent/src/MasterModeManager.cpp $
  * @author  A. Parker
  * @version $Revision: #3 $
										  ...
										  const char* sessionId)
{
    ...
    ////////////////////////////////////////////
	LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "getCurrentMasterMode = %li!!!", m_theDatapoints.getCurrentMasterMode() );
