/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ECSAgent/src/CtaEcsCachedConfig.h $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
public:
    ...
    virtual TA_Base_Core::DataPointEntityDataPtr        getModeControlDpEntityData();  
    virtual TA_Base_Core::DataPointEntityDataPtr        getModeInProgressDpEntityData();  
    virtual TA_Base_Core::DataPointEntityDataPtr        getAutoModeDpEntityData();  
...
private:
    ...
    {
        return (m_memberToInitialisedFlagMap[(void* )member]==true);
    }

    void setMemberInitialised(void* member) 
    {
        m_memberToInitialisedFlagMap[(void* )member]=true;
    }
    ...
    TA_Base_Core::DataPointEntityDataPtr        m_modeControlDpEntity;
    TA_Base_Core::DataPointEntityDataPtr        m_modeInProgressDpEntity;
    TA_Base_Core::DataPointEntityDataPtr        m_autoModeDpEntity;
    ...
    typedef MemberPointerToBoolMap::iterator    MemberPointerToBoolMapIt;
