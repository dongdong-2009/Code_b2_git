...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/ECSStationModesDlg.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
	class ECSStationModesDlg : public TA_Base_Bus::TransActiveDialog, public virtual IECSStationModesView, TA_Base_Core::Thread
    {
    ...
    public:
        ...
        /** 
          ...
          */
        virtual void setLocations( const LocationNames& locations );
        ...
        /** 
          ...
          */
        virtual void setStationModeDetails( const StationModeDetails& stationModeDetails );
        ...
        /** 
          ...
          */
        virtual void setCurrentStationMode( const std::string& stationMode, ECurrentStationModeType currentStationModeType );
        ...
        /** 
          ...
          *
          */
        virtual void setStationModeProposalState( unsigned int stationModeIndex, EModeProposalState stationModeProposalState );
    ...
    protected:
		...
		afx_msg LRESULT onEnableLocationSelectionControl(WPARAM wParam, LPARAM lParam);
		afx_msg LRESULT onSetColourMap(WPARAM wParam, LPARAM lParam);
		afx_msg LRESULT onSetInboundLocation(WPARAM wParam, LPARAM lParam);
		afx_msg LRESULT onSetLocations(WPARAM wParam, LPARAM lParam);
		afx_msg LRESULT onSetOutboundLocation(WPARAM wParam, LPARAM lParam);
		afx_msg LRESULT onSetSelectedLocationIndex(WPARAM wParam, LPARAM lParam);
		afx_msg LRESULT onSetStationModeDetails(WPARAM wParam, LPARAM lParam);
