...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/MasterModesGridCtrl.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        /** 
          ...
          */
        void populateMasterModeDetails( const TA_IRS_App::MasterModeDetails& masterModeDetails );
        ...
        /** 
          ...
          */
        void setCurrentProposedMasterMode( int masterModeIndex, TA_IRS_App::EModeProposalState proposalState );
