...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/ecs/ecs_manager/src/ECSMasterModesDlg.h $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
{
	class ECSMasterModesDlg : public TA_Base_Bus::TransActiveDialog, public virtual IECSMasterModesView, TA_Base_Core::Thread
    {
    ...
    protected:
		...
		afx_msg LRESULT onSetMasterModeDetails(WPARAM wParam, LPARAM lParam);
