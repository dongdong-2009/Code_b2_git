/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/COECommunicationsChannel.cpp $
  * @author:  Robert Young
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    COECommunicationsChannel::COECommunicationsChannel( unsigned int commsChannelIndex, const std::string& address, const std::string& port, unsigned long connectTimeout, unsigned long maxResponseTime, 
        unsigned long pollInterval, COECommunicationsHandler& commsHandler, ReceivedDataProcessor& receivedDataProcessor, 
    ...
    void COECommunicationsChannel::sendCommand( IAgentRequestCommand& command  )
    {
        ...
        else
        {
			...
			//LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, dataToSend.c_str() );
