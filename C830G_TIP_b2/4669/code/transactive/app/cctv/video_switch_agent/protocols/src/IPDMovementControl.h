...
/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/src/IPDMovementControl.h $
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        virtual void panAndTilt( TA_Base_Bus::MovementControlCorbaDef::EPanDirection panDirection,
        ...
        virtual TA_Base_Bus::MovementControlCorbaDef::CameraPreset* getActivePreset() = 0;
        ...
        virtual TA_Base_Bus::MovementControlCorbaDef::CameraPresetSequence* getAllPresets() = 0;
        ...
        virtual void storePreset( const TA_Base_Bus::MovementControlCorbaDef::CameraPreset& preset ) = 0;
