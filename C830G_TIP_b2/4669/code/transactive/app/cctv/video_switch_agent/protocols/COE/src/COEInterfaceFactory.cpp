/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/COEInterfaceFactory.cpp $
  * @author:   Rob Young
  * @version:  $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    // createQuad
    //
    IPDQuad* PDInterfaceFactory::createQuad( TA_Base_Core::QuadPtr quadData )
    {
        COEQuad* quad = new COEQuad( quadData );
        if ( 0 == quad )
        {
            TA_THROW( TA_Base_Core::VideoSwitchAgentInternalException( 
    ...
    {
        COEBVSStage* bvsStage = new COEBVSStage( BVSStageData );
        if ( 0 == bvsStage )
        {
            TA_THROW( TA_Base_Core::VideoSwitchAgentInternalException( 
    ...
    // createRecordingUnit
    //
    IPDRecordingUnit* PDInterfaceFactory::createRecordingUnit( TA_Base_Core::RecordingUnitPtr recordingUnitData )
    {
        COERecordingUnit* recordingUnit = new COERecordingUnit( recordingUnitData );
        if ( 0 == recordingUnit )
        {
            TA_THROW( TA_Base_Core::VideoSwitchAgentInternalException( 
