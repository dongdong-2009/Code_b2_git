...
/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/COEVideoOutput.h $
  * @author:   Rob Young
  * @version:  $Revision: #2 $
  *
...
{
    class COEVideoOutput : public IPDVideoOutput, public virtual IStateValidationItem
    {
    public:
        /**
          * COEVideoOutput
