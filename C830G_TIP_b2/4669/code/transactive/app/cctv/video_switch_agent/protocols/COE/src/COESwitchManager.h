...
/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/COE/src/COESwitchManager.h $
  * @author:   Rob Young 
  * @version:  $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
	    ...
	    /**
          * getRecordingUnit
          *
	      * Retrieves a COERecordingUnit by entity key.
          *
          * @return     COERecordingUnit*
          *             The requested COERecordingUnit or
          *             0 if the entity key is not known.
          *
          * @param      unsigned long entityKey
          *             The entity key of the COERecordingUnit to retrieve.
	      */

        COERecordingUnit* getRecordingUnit( unsigned long entityKey );

        COERecordingUnit* getRecordingUnitFromId( unsigned short id );
        ...
        /** 
          * addRecordingUnit
          *
          * Adds the given COERecordingUnit.
          *
          * @param      COERecordingUnit& recordingUnit
          *             The new RecordingUnit.
          *
          * @exception  ObjectAlreadyExistsException
          *             Thrown if a COERecordingUnit with the given entity key already exists.
          */
        
        void addRecordingUnit( COERecordingUnit& recordingUnit );

        /** 
          * removeRecordingUnit
          *
          * Removes the given COERecordingUnit. This method does nothing if it
          * can't find a COERecordingUnit with the given entity key.
          *
          * @param      unsigned long entityKey
          *             The COERecordingUnit to remove.
          */
    ...
    private:
        ...
        typedef std::map< unsigned short, COERecordingUnit* >  IdToRecordingUnit;
        ...
        typedef std::map< unsigned long, COERecordingUnit* >   RecordingUnitMap;
