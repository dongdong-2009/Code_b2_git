...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/protocols/src/IPDRecordingUnit.h $
  * @author:  Robert Young
  * @version: $Revision: #2 $
  *
...
namespace TA_IRS_App
{
	...
	public:
		...
		/**
		  ...
		  */
        virtual TA_Base_Bus::RecordingUnitCorbaDef::SupportedRecordingUnitFeatures getSupportedFeatures() = 0;
		...
		/**
		  ...
		  */
		virtual TA_Base_Bus::RecordingUnitCorbaDef::RecordingUnitState getRecordingUnitState() = 0;
		...
		/**
		  ...
		  *				Thrown if the agent is in Monitor mode.
		  */
		virtual TA_Base_Bus::RecordingUnitCorbaDef::recordingSpeedSequence* getRecordingSpeeds() = 0;
        ...
        /**
          ...
          */
        virtual void updateState( const TA_Base_Bus::RecordingUnitCorbaDef::RecordingUnitState& state ) = 0;
