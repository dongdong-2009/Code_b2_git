/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/src/MovementControl.cpp $
...
namespace TA_IRS_App
{
    ...
    // updateState
    //
    void MovementControl::updateState( const TA_Base_Bus::CameraCorbaDef::CameraState& state )
    {
    ...
    void MovementControl::panAndTilt( TA_Base_Bus::MovementControlCorbaDef::EPanDirection panDirection,
    ...
    // getActivePreset
    //
    TA_Base_Bus::MovementControlCorbaDef::CameraPreset* MovementControl::getActivePreset()
    {
        TA_ASSERT( hasInitialised(), "The object handling the protocol dependent Camera movement control is NULL" );
    ...
    // getAllPresets
    //
    TA_Base_Bus::MovementControlCorbaDef::CameraPresetSequence* MovementControl::getAllPresets()
    {
        TA_ASSERT( hasInitialised(), "The object handling the protocol dependent Camera movement control is NULL" );
    ...
    // storePreset
    //
    void MovementControl::storePreset( const TA_Base_Bus::MovementControlCorbaDef::CameraPreset& preset, const char* sessionId )
    {
