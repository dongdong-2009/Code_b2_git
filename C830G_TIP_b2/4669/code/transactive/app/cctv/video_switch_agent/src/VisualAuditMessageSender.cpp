/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_switch_agent/src/VisualAuditMessageSender.cpp $
...
namespace TA_IRS_App
{
                                                ...
                                                const std::string& optionalParameter2 )
    {
		...
		TA_Base_Core::NameValuePair name_v2( "Sequence", optionalParameter2 );
		// TD14548
