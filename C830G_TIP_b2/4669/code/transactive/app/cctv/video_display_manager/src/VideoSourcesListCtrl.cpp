/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/app/cctv/video_display_manager/src/VideoSourcesListCtrl.cpp $
  * @author Adam Radics
  * @version $Revision: #1 $
...
namespace TA_IRS_App
{
    ...
    bool VideoSourcesListCtrl::trainIsInCurrentStage(const TA_IRS_Bus::TrainInformationTypes::TrainDetails& td)
    {
        ...
        // if at a station, and the stage has been set
