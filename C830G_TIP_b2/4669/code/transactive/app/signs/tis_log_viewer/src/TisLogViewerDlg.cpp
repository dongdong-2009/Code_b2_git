/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/tis_log_viewer/src/TisLogViewerDlg.cpp $
  * @author:  Adam Radics
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2009/01/02 13:33:10 $
...
namespace TA_IRS_App
{
        ...
        void TisLogViewerDlg::requestSelectionChanged(RequestType requestType, bool isReinstatable)
        {
			...
			while(strLength>0)
			{
				currentLength = strLength - previousLength;
				if(currentLength<=87)
					messageText.Insert(++strLength,"\r\n");
				else
				{
					strLength=previousLength+87;
					messageText.Insert(strLength,"\r\n");
				...
				strLength=messageText.Find(_T("."),strLength);
