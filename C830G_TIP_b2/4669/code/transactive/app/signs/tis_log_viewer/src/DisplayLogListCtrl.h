/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/app/signs/tis_log_viewer/src/DisplayLogListCtrl.h $
  * @author Adam Radics
  * @version $Revision: #2 $
...
namespace TA_IRS_App
{
    ...
    protected:
		...
		afx_msg LRESULT onAddDsiplayRequests(WPARAM wParam, LPARAM lParam);
    ...
    private:
		...
		void addDisplayRequests(std::vector<IDisplayRequest*> *requests);
