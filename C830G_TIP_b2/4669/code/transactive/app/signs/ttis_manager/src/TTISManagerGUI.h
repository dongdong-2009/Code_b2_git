/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_Review_Branch/4669/transactive/app/signs/ttis_manager/src/TTISManagerGUI.h $
  * @author:  Adam Radics
  * @version: $Revision: #4 $
  *
...
#if !defined(AFX_TISMANAGERGUI_H__4F99FEB2_FD1A_4478_B3C4_9942A9CAFFD1__INCLUDED_)
#define AFX_TISMANAGERGUI_H__4F99FEB2_FD1A_4478_B3C4_9942A9CAFFD1__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// TISManagerGUI.h : header file
//

#include "bus/generic_gui/src/AbstractDialogGUI.h"

/////////////////////////////////////////////////////////////////////////////
// TTISManagerGUI window

namespace TA_IRS_App
{
	extern bool guiInitCompleted;
    class TTISManagerGUI : public TA_Base_Bus::AbstractDialogGUI
    {
    // Construction
    public:
    /**
    ...
    private:
        ...
        // are not needed.
        // 
        TTISManagerGUI( const TTISManagerGUI& theTTISManagerGUI);
        TTISManagerGUI& operator=(const TTISManagerGUI &);
    };
...
#endif // !defined(AFX_TISMANAGERGUI_H__4F99FEB2_FD1A_4478_B3C4_9942A9CAFFD1__INCLUDED_)
