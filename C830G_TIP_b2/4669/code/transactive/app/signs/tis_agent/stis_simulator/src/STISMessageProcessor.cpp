/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/tis_agent/stis_simulator/src/STISMessageProcessor.cpp $
...
namespace //anonymous
{
	...
	int const DESTINATION_STATION_SZ = 3;	    //The size (in bytes) of the Destination station field
	...
	int const PRIORITY_SZ       = 3;	        //The size (in bytes) of the Destination station field
...
namespace TA_IRS_App
{
	...
	void STISMessageProcessor::processStationStatusRequest(std::vector< unsigned char >& packet)
	{
		...
		std::string seqmessage = "Received Station Status Request message:  SequenceNumber = " ;
	...
	void STISMessageProcessor::processPredefinedDisplayRequest(std::vector< unsigned char >& packet)
	{
		...
		char messageTag[13];
		std::copy(packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ)), 
				packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ),
			messageTag);
		messageTag[12] = '\0';
		...
		std::copy(packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ), 
				packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ),
			startTime);
		...
		std::copy(packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ), 
				packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ),
			endTime);
		...
		char priority[2];
		std::copy(packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ), 
				packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ + PRIORITY_SZ),
			priority);
	...
	void STISMessageProcessor::processAdhocDisplayRequest(std::vector< unsigned char >& packet)
	{
		...
		// Display effects
		char displayMode[2];
		std::copy(packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ + PRIORITY_SZ), 
				packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ + PRIORITY_SZ + DISPLAY_MODE_SZ),
			displayMode);

		displayMode[1] = '\0';
		seqmessage << "\nDisplay Mode: ";

		switch( atoi(displayMode) )
		{
		case 0:
		...
		case 1:
			...
			break;
		case 2:
			seqmessage << "Scroll Up";
			break;
		case 3:
			seqmessage << "Scroll Down";
			break;
		case 4:
		...
		char scrollSpeed[2];
		std::copy(packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ + PRIORITY_SZ + DISPLAY_MODE_SZ), 
				packet.begin()+( STX_SZ + SQN_SZ + TIMESTAMP_SZ + MESSAGE_ID_SZ + DATA_LENGTH_SZ + SYSTEM_ID_SZ + DESTINATION_STATION_SZ + NUMBER_PIDS_SZ + (numberOfPids*PID_ADDRESS_SZ) + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ + PRIORITY_SZ + DISPLAY_MODE_SZ + SCROLL_SPEED_SZ),
			scrollSpeed);

		scrollSpeed[1] = '\0';
		seqmessage << "\nScroll Speed: ";
		switch( atoi(scrollSpeed) )
		{
		case 0:
			seqmessage << "No Scroll";
			break;
		case 1:
			seqmessage << "Slow";
			break;
		case 8:
			seqmessage << "Medium";
			break;
		case 15: // Note - this is sent as hex 'F'
			seqmessage << "Fast"; 
			break;
		}
		std::string message;
	...
	void STISMessageProcessor::processApprovedRATISDisplayRequest( std::vector< unsigned char >& packet )
	{
        ...
        std::string content((char*)packet.begin()+( endDestinationIndex + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ + RATIS_PRIORITY_SZ + RATIS_VETTING_SZ + RATIS_OVERRIDE_SZ + RATIS_CLEARING_SZ + RATIS_MESSAGE_LENGTH_SZ), 
				(char*)packet.begin()+( endDestinationIndex + MESSAGE_TAG_SZ + START_TIME_SZ + END_TIME_SZ + RATIS_PRIORITY_SZ + RATIS_VETTING_SZ + RATIS_OVERRIDE_SZ + RATIS_CLEARING_SZ + RATIS_MESSAGE_LENGTH_SZ + length));
	...
	void STISMessageProcessor::processPIDControlRequest(std::vector< unsigned char >& packet)
	{
        ...
        std::string destination((char*)packet.begin() + 26, (char*)packet.end() - 3);
...
/*		else
	...
	void STISMessageProcessor::sendDisplayReport( std::vector< unsigned char >& command )
	{
		...
		// Now the data length - this is always 3 bytes, i.e just the 'Report Station' field
		messageStream << "0003";
	...
	void STISMessageProcessor::sendOCCStatusReport( std::vector< unsigned char >& command )
	{
		...
		// New predefined TTIS message library version
		if( m_newTtisLibrary < 10 )
		{
			dataStream << "00";
			dataStream << m_newTtisLibrary;
		}
		else if( m_newTtisLibrary < 100 )
		{
			dataStream << "0";
			dataStream << m_newTtisLibrary;
		}
...
#ifdef WIN32
        std::string tmp((char*)command.begin(), (char*)command.end());
#else
	...
	void STISMessageProcessor::updateNextLibraryVersion( const std::string& libraryType, int version )
	{
	...
	void STISMessageProcessor::updateCurrentSTISLibraryVersion( int version )
	{
	...
	void STISMessageProcessor::upgradeSTISLibrary( int version )
	{
		m_currentStisLibrary = version;
	...
	void STISMessageProcessor::initialise( const std::string& location )
	{
		...
		{
			int i;
			for( i=0 ; i < 0 ; i++ ) // UNKNOWN PIDs at TSN
			{
				m_pidStatusMap.insert( std::pair<int,int>( i+1 , 1 ) ); // Assign initial status of '1' - 'ON'
			}
		...
		{
			int i;
			for( i=0 ; i < 0 ; i++ ) // UNKOWN PIDs at WCT
			{
				m_pidStatusMap.insert( std::pair<int,int>( i+1 , 1 ) ); // Assign initial status of '1' - 'ON'
			}
