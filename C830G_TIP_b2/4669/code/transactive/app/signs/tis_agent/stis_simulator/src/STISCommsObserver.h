...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/tis_agent/stis_simulator/src/STISCommsObserver.h $
...
namespace TA_IRS_App
{
	...
	public:
		...
		void updateLibraryVersion( const std::string& libraryType, int version );
