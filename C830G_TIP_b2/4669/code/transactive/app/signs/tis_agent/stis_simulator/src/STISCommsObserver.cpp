/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/app/signs/tis_agent/stis_simulator/src/STISCommsObserver.cpp $
...
//#include <boost/tokenizer.hpp>
	...
	void STISCommsObserver::updateLibraryVersion( const std::string& libraryType, int version )
	{
		m_stisMessageProcessor->updateNextLibraryVersion( libraryType, version );
	}

	void STISCommsObserver::updateCurrentSTISLibraryVersion( int version )
	{
