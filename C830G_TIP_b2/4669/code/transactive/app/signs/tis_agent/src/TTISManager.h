...
{
    class TTISApprovedRATISDisplayRequest;
    ...
    class TTISApprovedRATISClearRequest;
...
namespace TA_IRS_App
{
	...
	public:
        ...
        /**
         *
         * @param timeSchedulePkey
         * @param changeType
         * @param sessionID
         */
        virtual void timeScheduleChanged( unsigned long timeSchedulePkey,
         ...
         * @param sessionId
         */
        virtual void downloadCurrentTimeSchedule( const TA_Base_Core::TrainList& trains, const char* sessionId );


        /**
         * This method allows clients to send an upgrade command to inform a train to switch to the recently downloaded time schedule.
         * The result will be sent asynchronously back in a TrainDownloadStatus message
         *
         * @exception TA_Base_Core::OperationModeException If the agent is not in the control state
         * @exception TA_Base_Core::AccessDeniedException If the operator does not have the correct rights or duty to perform this operation
         ...
         * @param sessionId
         */
        virtual void upgradeTimeSchedule( const TA_Base_Core::TrainList& trains, const char* sessionId );


        /**
         * This will submit an approved RATIS request to some or all trains.
         * An alarm will be raised if there are any failures, indicating the failed trains.
         *
         * @exception TISAgentException if there was a global error submitting the request
         *
         * @param message    The RATIS display message
         * @param sessionId    The session ID of the approving operator
         */
        virtual void submitRatisDisplayRequest( TA_IRS_Core::IRATISMessage* message, const std::string& sessionId );


        /**
         * This will submit an approved RATIS clear request to some or all trains.
         * An alarm will be raised if there are any failures, indicating the failed trains.
         *
         * @exception TISAgentException if there was a global error submitting the request
         *
         * @param message    The RATIS clear message
         * @param sessionId    The session ID of the approving operator
         */
        virtual void submitRatisClearRequest( TA_IRS_Core::IRATISMessage* message, const std::string& sessionId );
    ...
    private:
         ...
         * @param version
         */
        void sendDownloadUpdateMessage( const TA_Base_Core::TrainDownloadStatus& downloadStatus, unsigned short version );
        ...
        std::string raiseLibraryVersionAlarm( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
                                              unsigned short trainVersion,
                                              unsigned short iscsVersion );


        /**
         * Raises a schedule version mismatch alarm
         *
         * @return the alarm ID
         *
         * @param trainId    The train
         ...
         * @param iscsVersion    The ISCS library version
         */
        std::string raiseScheduleVersionAlarm( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
                                               unsigned short trainVersion,
                                               unsigned short iscsVersion );
        ...
        /**
         * Raises an alarm when a ratis request failed on one or more trains
         *
         * @param failedTrains    The list of failed trains
         */
        void raiseRatisDisplayRequestAlarm( const TA_IRS_Bus::CommonTypes::TrainIdList& failedTrains );
        ...
        /**
         * Loads the given time schedule from the database, and formats it into its raw downloadable format.
         *
         * @exception DatabaseException, DataException if there are any problems loading it from the DB
         *
         * @param scheduleKey    The time schedule key
         */
        TA_IRS_Bus::TtisTypes::LibraryDataType loadCurrentTimeSchedule( unsigned long scheduleKey );
        ...
        TA_IRS_Bus::ProtocolTtisTypes::ETtisFontSize convertTisFontSizeToTrain( TA_Base_Core::ELEDFontSize fontSize );
        ...
        /**
         * Given a priority number, get the clear type to send for a RATIS clear
         *
         * @eturn the clear type
         *
         * @param priority    The priority (in numeric form)
         */
        TA_Base_Core::ETTISClearType getClearTypeFromPriority( const short priority ) const;
         ...
         * Otherwise empty.
         */
        std::string m_otherAgentLocationName;
        ...
        /**
         * The list of ratis clear requests in progress
         */
        TTISApprovedRATISClearRequestList m_ratisClearInProgress;


        /**
         * The lock for m_ratisClearInProgress
         */
        TA_Base_Core::NonReEntrantThreadLockable m_ratisClearLock;


        /**
         * The list of ratis display requests in progress
         */
        TTISApprovedRATISDisplayRequestList m_ratisDisplayInProgress;


        /**
         * The lock for m_ratisDisplayInProgress
         */
        TA_Base_Core::NonReEntrantThreadLockable m_ratisDisplayLock;
    };
}
