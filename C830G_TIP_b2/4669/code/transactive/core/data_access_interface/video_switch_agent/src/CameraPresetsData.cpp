/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/video_switch_agent/src/CameraPresetsData.cpp $
...
namespace TA_IRS_Core
{
    ...
    void CameraPresetsData::reload()
    {
        ...
        TA_Base_Core::IData* data = pDB->executeQuery( sql.str(), columnNames );
    ...
    void CameraPresetsData::updatePresetInDatabase( unsigned short presetIndex, const std::string& presetName )
    {
        ...
        pDB->executeModification( sql.str() );
