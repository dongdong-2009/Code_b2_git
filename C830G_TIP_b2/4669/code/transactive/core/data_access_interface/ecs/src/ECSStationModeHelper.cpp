/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/ecs/src/ECSStationModeHelper.cpp $
  * @author:  Nick Jardine
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_Core
{
    ...
    void ECSStationModeHelper::invalidate()
    {
        ...
        TA_ASSERT(!m_isNew,"Attempted to call invalidate() on a new ECSStationMode");
    ...
    void ECSStationModeHelper::reload()
    {
        ...
        TA_ASSERT(0 != m_key, "This ECSStationMode does not yet exist in the database. Therefore it cannot be reloaded.");
    ...
    {       
        ...
        {
            TA_THROW(TA_Base_Core::DataConfigurationException("ECSStationMode data not fully specified. ECSStationMode cannot be written to database",
                                                         fieldNames));
        }
    ...
    void ECSStationModeHelper::deleteECSStationMode(bool cascade)
    {
        ...
        TA_ASSERT(!m_isNew, "This ECSStationMode does not yet exist in the database, and therefore cannot be deleted");
