...
* in any form.
*
* Source:   $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/ecs/src/ECSMasterModeAccessFactory.cpp $
* @author:  Ripple
* @version: $Revision: #1 $
*
...
namespace TA_IRS_Core
{
    ...
    IConfigECSMasterMode* ECSMasterModeAccessFactory::copyECSMasterMode(const IConfigECSMasterMode* ECSMasterModeToCopy)
    {
        ...
        TA_ASSERT(ECSMasterModeToCopy !=  NULL, "The ECSMasterMode to copy was NULL");
        
        const ConfigECSMasterMode* cast = dynamic_cast<const ConfigECSMasterMode*>(ECSMasterModeToCopy);
		
        TA_ASSERT(cast != NULL, "ECSMasterMode passed could not be converted into a ConfigECSMasterMode");
