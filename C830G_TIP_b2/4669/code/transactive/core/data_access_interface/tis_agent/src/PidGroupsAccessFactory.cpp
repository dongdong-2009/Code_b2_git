/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/tis_agent/src/PidGroupsAccessFactory.cpp $
	   ...
	   //precondition checks:
		...
		try
		{
			...
			for( ; it != pidPkeys.end(); it++) 
			{
				...
				databaseConnection->executeModification( insertPidSql.str() );
			}
		}
		catch(...)
		{
