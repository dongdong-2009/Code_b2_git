...
/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/stis_manager/src/IRATISMessage.h $
...
namespace TA_IRS_Core
{
    ...
    public:
		...
		virtual TA_IRS_Core::ERATISMessageType getType() = 0;  
		virtual TA_IRS_Core::ERATISMessageStatus getStatus() = 0;			
		...
		virtual void setType( TA_IRS_Core::ERATISMessageType type ) = 0;  
		virtual void setStatus( TA_IRS_Core::ERATISMessageStatus status ) = 0;		
