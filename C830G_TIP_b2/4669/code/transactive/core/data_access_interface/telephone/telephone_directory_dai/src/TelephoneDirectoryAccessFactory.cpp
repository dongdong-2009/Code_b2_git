/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/telephone/telephone_directory_dai/src/TelephoneDirectoryAccessFactory.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_Core
{
                                        ...
                                        const TelephoneDirectoryItemStatus stateOfRecords)
    {
        ...
        FUNCTION_EXIT;
        return getAllTelephoneDirectories(readWrite, sql.str());
    }
    ...
    ITelephoneDirectories TelephoneDirectoryAccessFactory::getAllTelephoneDirectories(const bool readWrite, const std::string& sql)
    {
        FUNCTION_ENTRY("getAllTelephoneDirectories");
