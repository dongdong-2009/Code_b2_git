/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/telephone/telephone_directory_dai/src/TelephoneDirectoryAccessFactory.h $
  * @author:  Wong Soh Sum
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_Core
{
    ...
    private:
         ...
         *            3) Error while attempting to execute a database query
	     */
        ITelephoneDirectories getAllTelephoneDirectories(const bool readWrite, const std::string& sql);
