/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/telephone/telephone_directory_dai/src/TelephoneSubDirectoryAccessFactory.h $
  * @author:  Wong Soh Sum
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_Core
{
	...
	public:
		...
		//std::map<long, std::string> getAllAssociatedSubdirectoryMap();
		void getAllAssociatedSubdirectoryMap();
		//++libo
    ...
    private:
         ...
         *          - NO_VALUE, if no record can be found
	     */
        static ITelephoneSubDirectory* getSubDirectoryWhere( const std::string& sql, const bool readWrite = false);
         ...
         *          - NO_VALUE, if no record can be found
	     */
        static ITelephoneSubDirectories getSubDirectoriesWhere(const std::string& sql, const bool readWrite = false);
