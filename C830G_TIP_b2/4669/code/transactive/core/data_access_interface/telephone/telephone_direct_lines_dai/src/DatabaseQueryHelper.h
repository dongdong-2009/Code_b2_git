/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/4669/transactive/core/data_access_interface/telephone/telephone_direct_lines_dai/src/DatabaseQueryHelper.h $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
namespace DatabaseQueryHelper
{
     ...
     *
     */
    void appendWhereClause(std::ostringstream& selectStatement, 
     ...
     */
    std::string createBasicSelectStatement(
