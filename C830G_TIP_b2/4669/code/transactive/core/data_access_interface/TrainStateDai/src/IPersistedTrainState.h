...
namespace TA_IRS_Core
{
    ...
    public:
         ...
         * @exception DataBaseException if there was a problem connecting to the database
         */
        virtual unsigned short getTtisLibraryVersion() = 0;

        virtual unsigned short getNextTtisLibraryVersion() = 0;
         ...
         * @exception DataBaseException if there was a problem connecting to the database
         */
        virtual unsigned short getTtisScheduleVersion() = 0;
        virtual unsigned short getNextTtisScheduleVersion() = 0;
