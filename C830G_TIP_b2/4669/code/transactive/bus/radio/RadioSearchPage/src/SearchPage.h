/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_Review_Branch/4669/transactive/bus/radio/RadioSearchPage/src/SearchPage.h $
  * @author Nick Jardine / Andy Parker
  * @version $Revision: #4 $
  *
  * Last modification: $DateTime: 2011/06/03 18:02:56 $
...
namespace TA_IRS_Bus
{
    ...
    private:
		...
		std::list<CString>	m_listSubscriberName;
