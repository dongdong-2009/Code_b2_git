/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaStationCachedMap.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
{
    static const int MAX_RELATIVE_ZONE = 32;

    class PaStationCachedMap 
    : 
    public GenericCachedMap<PaStationRecord, TA_Base_Core::IPaStation>
    {
    public:
         ...
         */
             ...
             //throw(TA_Base_Core::CachedMappingNotFoundException);
         {
             ...
             relativeZoneId = ((absoluteZoneId-1) % 32) + 1;
         ...
         void relativeToAbsoluteZoneId(unsigned long& absoluteZoneId,
             ...
             //throw(TA_Base_Core::CachedMappingNotFoundException);
         {
            absoluteZoneId = MAX_RELATIVE_ZONE*(getPasStationIdFromLocationKey(locationKey)-1) 
                           + relativeZoneId;
         }
