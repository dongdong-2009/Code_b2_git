/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaTrainDvaMessageCachedMap.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_IRS_Bus
{
    ...
    PaTrainDvaMessageCachedMap::~PaTrainDvaMessageCachedMap()
    {
        ...
        TA_ASSERT(0 == m_registeredGlobalVersionObservers.size(), "Observers remaining");
    }
