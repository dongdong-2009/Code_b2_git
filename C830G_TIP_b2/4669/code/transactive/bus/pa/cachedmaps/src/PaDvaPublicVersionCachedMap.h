/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/pa/cachedmaps/src/PaDvaPublicVersionCachedMap.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
#if !defined PaDvaPublicVersionCachedMap_H
#define PaDvaPublicVersionCachedMap_H
...
namespace TA_IRS_Bus
{
    ...
    : 
    public GenericCachedMap<DvaPublicVersionRecord, TA_Base_Core::IPaDvaMessagePublicVersion>
    {
    public:
    

        PaDvaPublicVersionCachedMap();
        ~PaDvaPublicVersionCachedMap();
         ...
         */
        DvaPublicVersionRecord getRecordFromLocation(unsigned long locationKey);
         ...
         *
         */
        void setRecord(DvaPublicVersionRecord& record, bool writeChangesToDatabase = false);
    ...
    protected:
         ...
         *
         */
        void    validateRecordData(const DvaPublicVersionRecord& paZone);
         ...
         *
         */
        TA_Base_Core::IPaDvaMessagePublicVersion* getRecordFromDatabaseUsingKey(unsigned long pKey, bool readWrite);
         ...
         *
         */
        virtual DvaPublicVersionRecord 
                 createRecordFromInterface(TA_Base_Core::IPaDvaMessagePublicVersion& item);
    ...
    protected:
        ...
        class FilterByLocationKey
            : public ICachedMapFilter<DvaPublicVersionRecord>
        {
        public:
            FilterByLocationKey(unsigned long locationKey) : m_locationKey(locationKey) 
            {}

            virtual bool isMatch(const DvaPublicVersionRecord& record) const
...
#endif //!defined PaDvaPublicVersionCachedMap_H
