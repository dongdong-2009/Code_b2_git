/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/4669/transactive/bus/trains/TrainSelectionComponent/src/MFCTrainSelectorGUI.h $
  * @author:   Adam Radics
  * @version:  $Revision: #2 $
  *
...
namespace TA_IRS_Bus
{
    ...
    public:
		...
		*/
		 ...
		 * isLocationInControl();
		 */
		bool isLocationInControl(unsigned long trainLocation, unsigned long trainCommunicationLocation);//limin++, ECP-338 CL-21050
