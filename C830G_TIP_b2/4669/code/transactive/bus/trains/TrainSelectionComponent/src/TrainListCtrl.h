/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/4669/transactive/bus/trains/TrainSelectionComponent/src/TrainListCtrl.h $
  * @author Adam Radics
  * @version $Revision: #1 $
...
namespace TA_IRS_Bus
{
    ...
    protected:
		...
		//afx_msg void onHideScrollBars(UINT wParam, LONG lParam);
        afx_msg LRESULT onHideScrollBars(WPARAM wParam, LPARAM lParam);
	    //}}AFX_MSG
	    DECLARE_MESSAGE_MAP()
