/**
  ...
  *
  */
#if !defined(PaRequestForResetEvent_H)
#define PaRequestForResetEvent_H
...
namespace TA_IRS_Bus
{
    ...
    /**
     * Incoming request for reset or continue
     * @author Adam Radics
     * @version 1.0
     * @created 05-Feb-2008 3:20:18 PM
     */

    class PaRequestForResetEvent : public TimsEvent
    {
    ...
    public:
         ...
         */
        PaRequestForResetEvent( const TrainMessageData& data,
         ...
         * Destructor
         */
        virtual ~PaRequestForResetEvent();
     ...
     * @created 05-Feb-2008 3:20:18 PM
     */
    typedef boost::shared_ptr< PaRequestForResetEvent > PaRequestForResetEventPtr;

}  //end of namespace

#endif // !defined(PaRequestForResetEvent_H)
