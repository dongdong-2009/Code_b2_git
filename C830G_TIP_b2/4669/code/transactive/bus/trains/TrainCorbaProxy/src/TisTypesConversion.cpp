...
namespace TA_IRS_Bus
{
    ...
    TA_Base_Bus::ITrainTisCorba::TtisPredefinedDisplayParameters TisTypesConversion::convertToCorba( const TtisTypes::TtisPredefinedDisplayParameters& cppType )
    {
        ...
        ttisPredefinedDisplayParameters.identifierType = cppType.identifierType;
        ttisPredefinedDisplayParameters.identifierOffset = cppType.identifierOffset;
        ttisPredefinedDisplayParameters.priority = convertToCorba( cppType.priority );
        ttisPredefinedDisplayParameters.displayPeriod = convertToCorba( cppType.displayPeriod );
    ...
    TA_Base_Bus::ITrainTisCorba::TisLibraryVersionUpdate TisTypesConversion::convertToCorba( const TtisTypes::TisLibraryVersionUpdate& cppType )
    {
		...
		tisLibraryVersionUpdate.nextlibraryVersion = cppType.nextlibraryVersion;
		tisLibraryVersionUpdate.nextscheduleVersion = cppType.nextscheduleVersion;
    ...
    TA_Base_Bus::ITrainTisCorba::ETtisDisplayMode TisTypesConversion::convertToCorba( const ProtocolTtisTypes::ETtisDisplayMode& cppType )
    {
        ...
        switch ( cppType )
        {
            ...
            case ProtocolTtisTypes::TtisDisplayModeInstantOn:
                eTtisDisplayMode = TA_Base_Bus::ITrainTisCorba::TtisDisplayModeInstantOn;
                break;
    ...
    TA_Base_Bus::ITrainTisCorba::TtisFreeTextDisplayParameters TisTypesConversion::convertToCorba( const TtisTypes::TtisFreeTextDisplayParameters& cppType )
    {
        ...
        ttisFreeTextDisplayParameters.priority = convertToCorba( cppType.priority );
        ttisFreeTextDisplayParameters.displayPeriod = convertToCorba( cppType.displayPeriod );
        ttisFreeTextDisplayParameters.repeatInterval = cppType.repeatInterval;
    ...
    ProtocolTtisTypes::ETtisDisplayMode TisTypesConversion::convertToCpp( const TA_Base_Bus::ITrainTisCorba::ETtisDisplayMode& CorbaType )
    {
        ...
        switch ( CorbaType )
        {
            ...
            case TA_Base_Bus::ITrainTisCorba::TtisDisplayModeInstantOn:
    ...
    TtisTypes::TtisPredefinedDisplayParameters TisTypesConversion::convertToCpp( const TA_Base_Bus::ITrainTisCorba::TtisPredefinedDisplayParameters& CorbaType )
    {
        ...
        ttisPredefinedDisplayParameters.identifierType = CorbaType.identifierType;
        ttisPredefinedDisplayParameters.identifierOffset = CorbaType.identifierOffset;
        ttisPredefinedDisplayParameters.priority = convertToCpp( CorbaType.priority );
        ttisPredefinedDisplayParameters.displayPeriod = convertToCpp( CorbaType.displayPeriod );
    ...
    TtisTypes::TisLibraryVersionUpdate TisTypesConversion::convertToCpp( const TA_Base_Bus::ITrainTisCorba::TisLibraryVersionUpdate& CorbaType )
    {
		...
		tisLibraryVersionUpdate.nextlibraryVersion = CorbaType.nextlibraryVersion;
		tisLibraryVersionUpdate.nextscheduleVersion = CorbaType.nextscheduleVersion;
    ...
    TtisTypes::TtisFreeTextDisplayParameters TisTypesConversion::convertToCpp( const TA_Base_Bus::ITrainTisCorba::TtisFreeTextDisplayParameters& CorbaType )
    {
        ...
        ttisFreeTextDisplayParameters.priority = convertToCpp( CorbaType.priority );
        ttisFreeTextDisplayParameters.displayPeriod = convertToCpp( CorbaType.displayPeriod );
        ttisFreeTextDisplayParameters.repeatInterval = CorbaType.repeatInterval;
