 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/EventListComponent.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #3 $
 *
...
BOOL EventListComponent::clearList()
{
	...
	//add by xiangmei. When a new filter applied, we should  clear the previous sort column ID.
	//and delete the sort icon from the column.
...
void EventListComponent::print()
{
	...
	CString header = "Event Viewer : " + CTime::GetCurrentTime().Format(dateFormatStr.c_str());
	// ++ TD12474
...
// 
// 		// Load events with the new sort order.
// 		loadEvents(false);
// 
...
// 	else
	...
	// With new visibility rule, sorting is not implemented in database side,
	// No need to load events with the new sort order again.
	}
