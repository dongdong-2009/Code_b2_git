/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/DutyAdapter.cpp $
  * @author:  Bradley Cleaver
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2009/01/02 14:07:11 $
...
TA_Base_Core::CombinedEventAccessFactory::FullDutyMap DutyAdapter::getFullDutyMap( const KeyList& locationKeys, const KeyList& physicalSubsystemKeys, const KeyList& applicationSubsystemKeys )
{
    ...
    try
    {
		...
		for( int i=0; i<subsystemStateSeq->length(); i++)
		{
