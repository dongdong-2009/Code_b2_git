/**
  ...
  * 
  * Source:    $File: //depot/4669_Review_Branch/TA_BASE/transactive/app/alarm/alarm_agent/src/AlarmAgentImpl.h $
  * @author:   Ross Tucker
  * @version:  $Revision: #5 $
  *
  * Last modification: $DateTime: 2011/06/07 09:53:02 $
    ...
    public:
		...
		* @return Alarms cannot be found on alarm agent
        ...
        /**
          ...
          *
          * @param The entity key , if the value is 0, it will return active(open) alarms of all entities
          *
          * @return All currently open and/or unacknowledged alarms
          */
