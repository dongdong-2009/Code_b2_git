...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/trending/trend_viewer/src/HistoryViewerGUI.h $
  * @author:  A. Lee
  * @version: $Revision: #1 $
  *
...
{
    class HistoryViewerGUI : public TA_Base_Bus::AbstractDialogGUI
    {
    public:
      /**
        * Constructor
    ...
    private:
        ...
        HistoryViewerGUI( const HistoryViewerGUI& theGUI);
        HistoryViewerGUI& operator=(const HistoryViewerGUI &);
    };
