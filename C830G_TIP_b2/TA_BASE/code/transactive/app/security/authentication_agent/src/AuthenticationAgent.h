 ...
 * 
 * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/authentication_agent/src/AuthenticationAgent.h $
 * @author:   Nick Jardine
 * @version:  $Revision: #2 $
 *
...
namespace TA_Base_App
{
	...
	private:
		...
		std::vector<std::string> m_overrideSessionVec;
    };
}
