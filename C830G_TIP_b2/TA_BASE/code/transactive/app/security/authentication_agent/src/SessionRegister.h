 ...
 * 
 * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/authentication_agent/src/SessionRegister.h $
 * @author:   Nick Jardine
 * @version:  $Revision: #6 $
 *
 * Last modification: $DateTime: 2010/01/25 17:44:48 $
