...
{	
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugDebug,"[CL-21875] begin DutyManagerDlg::initialiseSubsystemDutyGridThreadFun");
	...
	try
	{
		...
		if (pDlg->isShowOhterSession())
		{
			LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "Begin populating duty data(true,true,false)");

			TA_Base_Bus::DutyDataStore::populate(true, true,false); 
		}
		else
		{
			LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "Begin populating duty data(true,true,true)");
	...
	{
		LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "failed to retrieve duty info!");
	}
	
	pDlg->PostMessage(WM_POPULATE_DATA, rtnCode,0);
...
{
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugDebug,"[CL-21875] begin DutyManagerDlg::init");
	...
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugDebug,"[CL-21875] in DutyManagerDlg::init, after AddPage OtherSesSubDutyPropertyPage");
...
{
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugDebug,"[CL-21875] begin DutyManagerDlg::OnTimer");
