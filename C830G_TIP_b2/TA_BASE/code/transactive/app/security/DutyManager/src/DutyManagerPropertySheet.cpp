/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/DutyManager/src/DutyManagerPropertySheet.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
DutyManagerPropertySheet::DutyManagerPropertySheet() :
	CMultiFontPropertySheet("Duty Manager PS", NULL, 0)
{
}
