/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/security/DutyManager/src/GridAssistant.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
std::string GridAssistant::generateProfileString(const TA_Base_Bus::SessionInfoEx& sessionInfoEx, TA_Base_Bus::RegionKey regionKey)
{
    ...
    RegionDutyMatrixElement rdmElement;
	regionDutyMatrix.getElement(sessionInfoEx.SessionId, regionKey, rdmElement);
...
std::string GridAssistant::generateActionGroupString(const TA_Base_Bus::SessionInfoEx& sessionInfoEx, TA_Base_Bus::SubsystemKey subsystemKey, TA_Base_Bus::RegionKey regionKey)
{
	...
	subsystemDutyMatrix.getElement(subsystemKey, regionKey, sdmElement);
