/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_Review_Branch/TA_BASE/transactive/app/security/duty_agent/src/DutyManagerUpdateSender.cpp $
  * @author:  Gregg Kirkpatrick
  * @version: $Revision: #7 $
  *
  * Last modification: $DateTime: 2011/06/20 20:55:54 $
...
#include "DutyAgent.h"
#include "DutyManagerUpdateSender.h"
#include "DutyManagerUpdateConverter.h"
...
// 		if( dmc.getSubsystemsToRemove().length() > 0 )
// 		{
// 			CORBA::Any commsData;
// 			commsData <<= dmc.getSubsystemsToRemove();
// 
// 			m_commsSender->sendBroadcastCommsMessage( TA_Base_Core::DutyAgentBroadcastComms::RemoveSubsystemDuty, commsData, NULL );
// 		}
// 					
// 		if( dmc.getSubsystemsToAdd().length() > 0 )
// 		{
// 			CORBA::Any commsData;
// 			commsData <<= dmc.getSubsystemsToAdd();
// 
// 			m_commsSender->sendBroadcastCommsMessage( TA_Base_Core::DutyAgentBroadcastComms::AddSubsystemDuty, commsData, NULL );
// 		}
