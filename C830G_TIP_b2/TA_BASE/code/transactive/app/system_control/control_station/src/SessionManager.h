...
public:
 ...
 /**
     ...
     *
     * @param unsigned long The action constant
     * @param ResourceList The resource key list of the items that operator wishes to perform action on
     * @param ResourceList The permitted resource key list of the items that operator can perform action on
     *
     */
	void isActionsPermitted(unsigned long action, ResourceList& resourceKeyList,ResourceList& permittedResourceKeyList);
    /** 
