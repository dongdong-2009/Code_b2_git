/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/system_control/system_manager/src/ProcessParamsDlg.cpp $
  * @author:  Dominique Beauregard
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2009/01/15 10:44:51 $
...
namespace TA_Base_App
{
    ...
    void ProcessParamsDlg::OnOK()
    {
            ...
            iter != m_processes.end(); iter++)
        {
            ...
            try
            {
               AdminManager::getInstance().setProcessRunParam(process, runParam);
            }
    ...
    BOOL ProcessParamsDlg::OnInitDialog()
    {
        ...
        std::string debugLevelString = AdminManager::getInstance().
                                    getProcessDebugLevel(entityName);
        ...
        {
            process = *iter;
            debugLevelString = AdminManager::getInstance().getProcessDebugLevel(process);
