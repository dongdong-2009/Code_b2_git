/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/system_control/system_controller/console_manager/src/ProcessManager.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
// Modified on: $DateTime: 2008/11/28 16:26:01 $
// Version:     $Revision: #1 $
//
...
public:
	...
	//
	void setClientRunParam(const int id, const std::string& paramName, const std::string& paramValue);
