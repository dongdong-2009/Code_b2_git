/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/inspector_panel/src/DirectControlDialog.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2009/02/06 11:01:04 $
...
namespace TA_Base_App
{
    ...
    void CDirectControlDialog::OnConfirm() 
    {
		...
		try
		{
			...
			message2 << dataPoint->getDescription() << ": Updated value to \"" << m_newValue << "\".";
