...
*/
	...
	void CEquipmentStatusViewerDlg::checkPermissions()
	{
        ...
        m_isAllowedToConfigure =  TA_Base_Bus::ScadaUtilities::getInstance().isActionAllowedWithLocSub( (unsigned int) TA_Base_Bus::aca_REPORT_CONFIGURATION_ESV,
                                        m_guiEntityKey, locationKey, subsystemKey, 
                                        TA_Base_Core::RunParams::getInstance().get(RPARAM_SESSIONID) );

        m_isAllowedToPrintOrExport =  TA_Base_Bus::ScadaUtilities::getInstance().isActionAllowedWithLocSub ( (unsigned int) TA_Base_Bus::aca_PRINT_EXPORT_ESV,
                                        m_guiEntityKey, locationKey, subsystemKey, 
                                        TA_Base_Core::RunParams::getInstance().get(RPARAM_SESSIONID) );

        m_isAllowedToViewAllReports =  TA_Base_Bus::ScadaUtilities::getInstance().isActionAllowedWithLocSub ( (unsigned int) TA_Base_Bus::aca_VIEW_ALL_REPORTS_ESV,
                                        m_guiEntityKey, locationKey, subsystemKey, 
                                        TA_Base_Core::RunParams::getInstance().get(RPARAM_SESSIONID) );
