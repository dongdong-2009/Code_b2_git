/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/DataPointListItem.h $
  * @author:  Alan Brims
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    private:
		 ...
		 */
        boost::shared_ptr<TA_Base_Core::DataNodeEntityData>              m_dataNode;	
