/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/data_management/archive_manager/src/DeleteArchiveDlg.cpp $
  * @author:  Alan Brims
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    void DeleteArchiveDlg::enableCloseButton()
    {
		...
		//default cancel button in dialog should always be enabled
		m_cancelButton.EnableWindow( TRUE );
