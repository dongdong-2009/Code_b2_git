/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/data_management/archive_manager/src/RetrievingDataDlg.cpp $
...
namespace TA_Base_App
{
        ...
        try
        {
            ...
            do
            {
                ...
                catch( TA_Base_Core::ArchiveException& e )
                {
                    ...
                    userMsg << e.what();
                    UINT selectedButton = userMsg.showMsgBox(IDS_UE_050139);
    ...
    void RetrievingDataDlg::terminate()
    {
        if ( TA_Base_Core::Thread::THREAD_STATE_RUNNING == getCurrentState() )
        {
            ...
            {
                TA_Base_Bus::TransActiveMessage userMsg;
                UINT selectedButton = userMsg.showMsgBox(IDS_UI_050053);
