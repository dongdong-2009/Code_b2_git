...
// 	strParse2 += strBuf2.substr(pos1+1, pos2 - pos1);
	...
	//Siva ++
	//Formay of date as per document is DD/MM/YYYY
	// change to YYYYMM/DD HH24:MI:SS
	...
	//month and day
	strParse1 += strBuf1.substr(3, 2);
	strParse2 += strBuf2.substr(3, 2);

	strParse1 += strBuf1.substr(2, 1);
	strParse2 += strBuf2.substr(2, 1);

	strParse1 += strBuf1.substr(0, 2);
	strParse2 += strBuf2.substr(0, 2);
