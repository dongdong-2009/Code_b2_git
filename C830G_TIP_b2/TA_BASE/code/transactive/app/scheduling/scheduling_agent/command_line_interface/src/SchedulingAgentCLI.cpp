/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/command_line_interface/src/SchedulingAgentCLI.cpp $
...
void SchedulingAgentCLI::processAddCommand(const CommandLine& commandLine)
{
    ...
    for (int i = 0; i < numJobs; i++)
    {
        ...
        TA_Base_Bus::SchedulingAgentCorbaDef::JobID id;
