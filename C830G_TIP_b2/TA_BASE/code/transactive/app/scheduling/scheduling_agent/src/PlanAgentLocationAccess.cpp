/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/PlanAgentLocationAccess.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
TA_Base_App::PlanAgentLocationAccess* TA_Base_App::PlanAgentLocationAccess::m_locationAccess = NULL;
...
void PlanAgentLocationAccess::initialise()
{
    ...
    for (LocationList::const_iterator locIter = locations.begin(); locIter != locations.end(); locIter++)
    {
        ...
        {
            m_locationMap.insert(std::make_pair(location->getKey(), location->getName()));
