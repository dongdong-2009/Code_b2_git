/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/IJobFactory.h $
...
public:
    ...
    virtual void initialise(
        int argc,
        char* argv[],
        TA_Base_Core::ISchedulingAgentEntityData& entityData) = 0;
     ...
     *  the wrong amount of data is retrieved.
     */
    virtual IJob* getJobFromStore(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& id) = 0;
