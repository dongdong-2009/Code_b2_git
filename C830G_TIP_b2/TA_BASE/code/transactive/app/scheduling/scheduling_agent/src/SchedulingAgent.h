/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/SchedulingAgent.h $
...
public:
    ...
    //void agentSetOperationModeInThread();
    void processingControlMode();
    void processingMonitorMode();
    //++limin
...
protected:
     ...
     */
    void initialiseSingletons(int argc, char* argv[]);


    /**
     *  Converts the given string to an unsigned long, and puts it
     *  into the number parameter.
     *  @return true if the conversion is successful, false otherwise
     */
    bool getStringAsUnsignedLong(
