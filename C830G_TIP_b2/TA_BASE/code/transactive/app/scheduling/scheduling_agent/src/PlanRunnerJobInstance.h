/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/PlanRunnerJobInstance.h $
...
class PlanRunnerJobInstance :
    public AbstractJobInstance,
    TA_Base_Core::SpecialisedMessageSubscriber <CommsMessageCorbaDef>
{
...
protected:
    ...
    friend IJobInstance::JobInstanceState PlanRunnerJob::getJobInstanceState(
        unsigned long minuteStarted, std::string& errorMessage);
