/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/Schedule.cpp $
...
typedef TA_Base_Bus::SchedulingAgentCorbaDef::JobID JobID;
typedef TA_Base_Bus::SchedulingAgentCorbaDef::ScheduleType ScheduleType;
typedef TA_Base_Bus::SchedulingAgentCorbaDef::MonthOfYear MonthOfYear;
typedef TA_Base_Bus::SchedulingAgentCorbaDef::DayOfWeek DayOfWeek;
typedef TA_Base_Bus::SchedulingAgentCorbaDef::DayOfWeekSequence DayOfWeekSequence;
...
Schedule::Schedule(TA_Base_Core::IConfigScheduleData& schedule)
    :
...
ScheduleCorbaDef Schedule::toCorbaObject() const
{
    ScheduleCorbaDef corbaSchedule;
    ...
    const TA_Base_Bus::SchedulingAgentCorbaDef::ScheduleCorbaDef& schedule)
{
    ...
    switch( schedule.type )
    {
        ...
        case TA_Base_Bus::SchedulingAgentCorbaDef::Monthly:
        {
            ...
            if ( dayOfMonth == 0 )
            {
                dayOfMonth = gregorian_calendar::end_of_month_day( today.year(), today.month() );
            }
            ptime nextTime(date( today.year(), today.month(), dayOfMonth),
        ...
        break;
        default:
            TA_ASSERT(false, "Unrecognised Schedule Type");
    }
...
std::string Schedule::toString()
{
    ...
    DayOfWeekSequence daysOfWeek = getDaysOfWeek();
...
unsigned short Schedule::getMonthOfYear(const TA_Base_Bus::SchedulingAgentCorbaDef::MonthOfYear month)
{
    switch(month)
    {
        ...
        default:
            TA_ASSERT(false, "Unknown Corba month");
    }
}
...
TA_Base_Bus::SchedulingAgentCorbaDef::MonthOfYear Schedule::getMonthOfYear(const unsigned short month)
{
    switch(month)
    {
        ...
        default:
            TA_ASSERT(false, "Unknown Boost month");
    }
}
    ...
    const unsigned short endYear)
{
    ...
    {
        TA_THROW_CORBA_EXCEPTION(TA_Base_Bus::SchedulingAgentCorbaDef::BadScheduleException(
    ...
    switch(type)
    {
        ...
        case TA_Base_Bus::SchedulingAgentCorbaDef::Yearly:
            ...
            if ( corbaDayOfMonth == 29 && monthOfYear == TA_Base_Bus::SchedulingAgentCorbaDef::February )
            {
                TA_THROW_CORBA_EXCEPTION(TA_Base_Bus::SchedulingAgentCorbaDef::BadScheduleException(
    ...
    const std::string& fieldName)
{
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugError, "%s is out of range: %d.  Must be between %d - %d", 
...
TA_Base_Bus::SchedulingAgentCorbaDef::JobID Schedule::getID()
{
    return CORBA::string_dup(m_scheduleData.getID().c_str());
}
