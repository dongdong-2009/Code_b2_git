/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_agent/src/PlanAgentMap.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
PlanAgentMap::~PlanAgentMap()
{
    ...
    {
        TA_Base_Bus::PlanAgentLibrary* planAgent = iter->second;
        delete planAgent;
    }
...
TA_Base_Bus::PlanAgentLibrary& PlanAgentMap::getPlanAgent(unsigned long location)
{
    ...
    try
    {
        TA_Base_Bus::PlanAgentLibrary* planAgent = new TA_Base_Bus::PlanAgentLibrary(location);
