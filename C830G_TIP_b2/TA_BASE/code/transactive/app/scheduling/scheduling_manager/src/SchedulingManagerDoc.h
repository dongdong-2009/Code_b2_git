/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_manager/src/SchedulingManagerDoc.h $
  * @author:  
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /** 
          ...
          */
        void deleteJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobId);
        ...
        /** 
          ...
          *
          */
        void enableJob(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobId, const bool enable);
		...
		/** 
          ...
          *
          */
        void updateEditLock(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobId, const bool bLock);
		...
		/** 
          ...
          *
          */
		bool isJobLockedForEdit(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobId);
		//++TD16352
