/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/scheduling/scheduling_manager/src/Job.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
         ...
         */
        Job(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& Id, 
            const std::string& type, 
            const std::string& description, 
            const bool isInhibited, 
            const std::vector<NameValuePair>& parameters, 
            const TA_Base_Bus::SchedulingAgentCorbaDef::ProfileID& profileId, 
            const TA_Base_Bus::SchedulingAgentCorbaDef::LocationID& locationId, 
         ...
         */
        TA_Base_Bus::SchedulingAgentCorbaDef::JobID getId() const
        {
            return m_id;
        }
        ...
        bool isNew() const
        {
            return ( strcmp( m_id, SchedulingManager::UNSCHEDULED_JOBID.c_str()) == 0 );
        }
         ...
         * is there isn't one. 
         */
        TA_Base_Bus::SchedulingAgentCorbaDef::LocationID getLocationId() const
        {
            return m_locationId;
        }
         ...
         */
        TA_Base_Bus::SchedulingAgentCorbaDef::ProfileID getProfileId() const
        {
             return m_profileId;
        }
         ...
         */
        void setId(const TA_Base_Bus::SchedulingAgentCorbaDef::JobID& jobId)
        {
            m_id = CORBA::string_dup(jobId);
        }
         ...
         * is there isn't one. 
         */
        void setLocationId(const TA_Base_Bus::SchedulingAgentCorbaDef::LocationID& locationId)
        {
         ...
         */
        void setProfileId(const TA_Base_Bus::SchedulingAgentCorbaDef::ProfileID& profileId)
        {
    ...
    private:
        TA_Base_Bus::SchedulingAgentCorbaDef::JobID m_id;
        std::string m_type;
        std::string m_description;
        bool m_isInhibited;
        std::vector<NameValuePair> m_parameter;
        TA_Base_Bus::SchedulingAgentCorbaDef::ProfileID m_profileId;
        TA_Base_Bus::SchedulingAgentCorbaDef::LocationID m_locationId;
        Schedule m_schedule;
