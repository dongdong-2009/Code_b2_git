/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/configuration/configuration_editor/src/ConfigurationEditorToolbar.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
#ifdef TDS_DEVELOP
        /**
         * showTDSButton, add by hongzhi
         *
         * This will show hidden tds button to the toolbar.
         */
		void showButton(int nID, BOOL bHide=true);
#endif
