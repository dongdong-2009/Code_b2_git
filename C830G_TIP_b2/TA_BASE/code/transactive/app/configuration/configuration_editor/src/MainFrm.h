/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/configuration/configuration_editor/src/MainFrm.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_App
{
	...
	private:
		...
		std::string WriteTDSLog();			// read TDS sql log from database, then write it to MFT
