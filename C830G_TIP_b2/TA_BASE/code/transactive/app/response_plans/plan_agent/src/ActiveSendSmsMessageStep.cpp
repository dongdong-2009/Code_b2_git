/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_agent/src/ActiveSendSmsMessageStep.cpp $
...
TA_Base_Core::EActiveStepState ActiveSendSmsMessageStep::executeImpl( void )
{
	LOG( SOURCE_INFO, GENERIC_LOG_TYPE, DEBUG_LOG_LEVEL, "Data Point Set step %lu", getStepNumber() );
        ...
        try
        {
            ...
            if ( identifier.empty() )
            {
                ...
                msg << "Invalid recipient identifier '" << recipientIdentifier << "' provided for plan step '"
                    << planInfo.str() << "'";
                LOG( SOURCE_INFO, TA_Base_Core::DebugUtil::GenericLog, TA_Base_Core::DebugUtil::DebugError, msg.str().c_str() );
        ...
        {
            // Log the exception.
			LOG( SOURCE_INFO, EXCEPTION_CATCH_LOG_TYPE, "TA_Base_App::ISmsAgentCorbaDef::InvalidGroupException", dumpContext().c_str() );
        ...
        {
            // Log the exception.
			LOG( SOURCE_INFO, EXCEPTION_CATCH_LOG_TYPE, "TA_Base_App::ISmsAgentCorbaDef::InvalidRecipientException", dumpContext().c_str() );
        ...
        {
            // Log the exception.
			LOG( SOURCE_INFO, EXCEPTION_CATCH_LOG_TYPE, "TA_Base_App::ISmsAgentCorbaDef::MessageTooLongException", dumpContext().c_str() );
        ...
        {
            // Log the exception.
			LOG( SOURCE_INFO, EXCEPTION_CATCH_LOG_TYPE, "TA_Base_App::ISmsAgentCorbaDef::CapacityReachedException", dumpContext().c_str() );
        ...
        catch ( CORBA::TRANSIENT& ex )
        {
			...
			LOG( SOURCE_INFO, EXCEPTION_CATCH_LOG_TYPE, "CORBA::TRANSIENT", msg.str().c_str() );
        ...
        {
            // Log the exception.
			LOG( SOURCE_INFO, EXCEPTION_CATCH_LOG_TYPE, "Unknown Exception", dumpContext().c_str() );
