/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_agent/src/ActiveTrainPaStep.cpp $
...
namespace TA_Base_App
{
    ...
    {
		 LOG( SOURCE_INFO, GENERIC_LOG_TYPE, DEBUG_LOG_LEVEL, "Train Public Address step %lu", getStepNumber() );
		 ...
		 /*catch (const TA_Base_Core::EntityTypeException& e)
		 {
			 ...
			 LOG( SOURCE_INFO, EXCEPTION_CATCH_LOG_TYPE, "TA_Base_Core::EntityTypeException", msg.str().c_str() );
