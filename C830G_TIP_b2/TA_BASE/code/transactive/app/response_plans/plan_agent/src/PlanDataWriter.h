...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanDataWriter.h $
...
namespace TA_Base_App
{
	...
	//Plan Edit methods
		...
		void deleteSteps(const std::string& session, TA_Base_Core::NodeId plan, const TA_Base_Core::StepIds& steps);
