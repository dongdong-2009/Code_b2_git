/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/ApprovedPlanTreeView.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2009/10/28 17:02:51 $
...
void CApprovedPlanTreeView::ProcessRparamAssocAlarmIdUpdate ()
{
    ...
    try
    {
        activePlanDetailVar = PlanAgentAccess::getInstance().getAssocAlarmPlanDetail (assocAlarmID);
    }
