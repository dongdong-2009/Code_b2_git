...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/InteractiveStepDlg.h $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
namespace TA_Base_App
{
    ...
    // Construction
    protected:
        CInteractiveStepDlg(const TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail& stepDetail, TA_Base_Core::Seconds timeout); // standard constructor
    ...
    protected:
        ...
        virtual TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail getStepDetail() const;
