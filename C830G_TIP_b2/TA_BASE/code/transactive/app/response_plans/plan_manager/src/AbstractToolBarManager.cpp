...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/AbstractToolBarManager.cpp $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
CToolBar *AbstractToolBarManager::createToolBar(UINT toolBarID)
{
    ...
    toolBar->SetSizes(CSize(100, 44), CSize(24,24));
