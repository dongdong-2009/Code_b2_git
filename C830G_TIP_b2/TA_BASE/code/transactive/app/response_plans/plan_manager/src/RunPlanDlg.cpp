...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/RunPlanDlg.cpp $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
CRunPlanDlg::CRunPlanDlg(const TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail& stepDetail) :
...
BOOL CRunPlanDlg::OnInitDialog()
{
    ...
    TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail stepDetail(getStepDetail());
