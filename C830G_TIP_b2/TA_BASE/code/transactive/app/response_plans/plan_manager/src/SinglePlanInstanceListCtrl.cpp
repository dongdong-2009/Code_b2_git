...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/SinglePlanInstanceListCtrl.cpp $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
void CSinglePlanInstanceListCtrl::PreSubclassWindow()
{
    ...
    InsertColumn(REMARKS_COLUMN_INDEX, _T(LabelMaker::getActivePlanListRemarksColumnLabel()), LVCFMT_LEFT, 200);
...
void CSinglePlanInstanceListCtrl::PopulateInstance(const TA_Base_Core::ActivePlanDetail &activePlanDetail)
{
    ...
    SetItemText(0, ACTIVATION_COLUMN_INDEX, _T(activePlanDetail.timeOfInstantiation));
