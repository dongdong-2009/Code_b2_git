...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/FailureSummaryDlg.h $
...
namespace TA_Base_App
{
    ...
    class CFailureSummaryDlg : public CInteractiveStepDlg
    {
        // Construction
    public:
        CFailureSummaryDlg(const TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail& stepDetail);
