...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanStep.cpp $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
    ...
    m_newStep(true)
{
    ...
    m_stepDetail.name = CORBA::string_dup("New Step");
    m_stepDetail.description = CORBA::string_dup("New Step");
