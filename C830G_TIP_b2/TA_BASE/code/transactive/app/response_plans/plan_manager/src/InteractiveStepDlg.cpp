...
// in any form.
//
// Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/app/response_plans/plan_manager/src/InteractiveStepDlg.cpp $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
CInteractiveStepDlg::CInteractiveStepDlg(const TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail& stepDetail, TA_Base_Core::Seconds timeout) :
    CDialog((UINT)0, NULL),
...
TA_Base_Bus::IPlanManagerCorbaDef::CurrentPlanStepDetail CInteractiveStepDlg::getStepDetail() const
{
