/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_Review_Branch/TA_BASE/transactive/core/alarm/src/AlarmConfig.cpp $
...
{
	const std::string AlarmTypeTableAccessor::DEFAULT_SYSTEM_ALARM_ALARM_VALUE = "ALARM";
	const std::string AlarmTypeTableAccessor::DEFAULT_SYSTEM_ALARM_NORMAL_VALUE = "NORMAL";
	...
	AlarmTypeTableAccessor& AlarmTypeTableAccessor::getInstance()
	{
		...
		if (NULL == m_theAlarmConfig)
		{
            ...
            m_theAlarmConfig->loadAllAlarmTypes();
		}
