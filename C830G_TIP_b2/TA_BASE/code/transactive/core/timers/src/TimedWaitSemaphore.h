/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/timers/src/TimedWaitSemaphore.h $
...
namespace TA_Base_Core
{
	...
	private:
		...
		ReEntrantThreadLockable	m_countLock;
		int volatile m_waitCount;

		ReEntrantThreadLockable	m_semLock;		
		int volatile m_semCount;
		std::list<Condition*> m_condList;
		
		bool volatile m_bDestroyed;
	};
}
