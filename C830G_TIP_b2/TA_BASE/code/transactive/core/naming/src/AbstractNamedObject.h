/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/naming/src/AbstractNamedObject.h $
...
namespace TA_Base_Core
{
	...
	public:
		...
		/**
		  ...
		  */
		virtual void assignObject(CORBA::Object_ptr newObject) = 0;
	...
	protected:
		...
		/**
		  ...
		  */
		CORBA::Object_ptr resolveObject();
