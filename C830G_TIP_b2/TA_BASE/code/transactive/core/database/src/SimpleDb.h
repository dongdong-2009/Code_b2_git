...
* in any form.
*
* Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/database/src/SimpleDb.h $
* @author:  Ripple
* @version: $Revision: #2 $
*
...
namespace TA_Base_Core
{
	...
	public:
		...
		//      solaris
		SimpleDb(const char* connection, const char* user, const char* passwd,
			const char* hostname = "");
		virtual ~SimpleDb();
		...
		void Exec(const char* statement, int numColumns, Buffer& data, int maxrows = FETCH_MAX_ROWS);
