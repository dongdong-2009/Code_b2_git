...
* in any form.
*
* Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/database/src/SimpleDbStatusMonitor.h $
* @author:  Ripple
* @version: $Revision: #1 $
*
...
namespace TA_Base_Core
{
	...
	public:
		...
		//      solaris
		SimpleDbStatusMonitor(const char* connection, const char* user, const char* passwd,
			const char* hostname = "");
