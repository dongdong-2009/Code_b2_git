...
* in any form.
*
* Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/database/src/ConnectionReaper.h $
* @author:  Ripple
* @version: $Revision: #2 $
*
...
namespace TA_Base_Core
{
	...
	* 120 minutes.
		...
		*/
		...
		void reapConnection( OCIConnection* connection );
	...
	* to the vector of monitored connections.
		...
		*/
		...
		std::vector< OCIConnection* > m_monitoredConnections;
		...
		std::vector< OCIConnection* >  m_waitingQueue;
