/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/opctag_alias/src/OpcTagAliasHelper.cpp $
  * @author:  Wu Mintao
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    unsigned long OpcTagAliasHelper::getNextSequenceNumber()
    {
        ...
        const std::auto_ptr<TA_Base_Core::IData> data(databaseConnection->executeQuery(sql, columnNames));
