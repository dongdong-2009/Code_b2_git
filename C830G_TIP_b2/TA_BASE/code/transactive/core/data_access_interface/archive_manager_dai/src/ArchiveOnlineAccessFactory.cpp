/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/archive_manager_dai/src/ArchiveOnlineAccessFactory.cpp $
    ...
    IArchiveOnline* ArchiveOnlineAccessFactory::getArchiveOnlineEntry( bool isReadWrite )
    {
        ...
        else                // Need a standard object.
        {
            if ( 0 == data->getNumRows() ) // No entry found with the specified pkey
            {
                ...
                TA_THROW( DataException( error.str().c_str(), DataException::NO_VALUE, 
                    TA_ArchiveManagerDAI::ARCHIVE_ONLINE_KEY_COLUMN ));
            }
