 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/AlarmAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #2 $
 *
...
namespace TA_Base_Core
{
    ...
    private:
        ...
        /**
          ...
          * @exception DataException raised if the supplied location key is invalid
          */
        void runQueryForAlarms(const std::string& sql, std::vector<IAlarmData*>& alarms);
