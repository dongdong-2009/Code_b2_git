...
class IDatabase
{
    ...
    public:
		 ...
		 */
        virtual IData* executeQuery(const std::string& sql, const std::vector<std::string>& columnNames, 
                                    const unsigned long numRows) =0;
        virtual IData* executeQuery(const std::string& sql, const std::vector<std::string>& columnNames) =0;
         ...
         *      connect() MUST be called prior to this method   
         */
        virtual IData* executeProcedure(const std::string& sql, const std::vector<std::string>& columnNames, 
