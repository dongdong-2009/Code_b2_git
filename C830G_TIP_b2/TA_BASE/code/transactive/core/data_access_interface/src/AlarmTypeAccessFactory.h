 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/AlarmTypeAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
	class AlarmTypeAccessFactory
	{
		...
		public:
			...
			void getAlarmTypeBySql(const std::string& sql, std::vector<IAlarmTypeData*>& alarmTypes, const bool readWrite);
