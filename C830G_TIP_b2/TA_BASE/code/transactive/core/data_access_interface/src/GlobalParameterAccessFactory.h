/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/GlobalParameterAccessFactory.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getGlobalParameterBySql(const std::string& sql, std::vector< IGlobalParameter* >& globalParameters, const bool readWrite);
