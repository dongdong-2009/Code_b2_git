 ...
 * in any form.
 *
 * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/AlarmSeverityHelper.cpp $
...
namespace TA_Base_Core
{
    ...
    void AlarmSeverityHelper::applyChanges()
    {
        ...
        // execute the query
        IData* namedata = databaseConnection->executeQuery(nameSQL.str(),columnNames);
