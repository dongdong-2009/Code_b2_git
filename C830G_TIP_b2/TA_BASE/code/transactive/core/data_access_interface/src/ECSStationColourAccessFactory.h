 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/ECSStationColourAccessFactory.h $
 * @author:  Andy Siow
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
	class ECSStationColourAccessFactory
	{
		...
		public:
			...
			void getECSStationColourBySql(const std::string& sql, std::vector<IECSStationColourData*>& ecsStationColours, const bool readWrite);
