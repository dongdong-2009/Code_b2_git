/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/ConfigLocation.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	ConfigLocation::ConfigLocation( const unsigned long key, const std::string& name, const std::string& description, const unsigned long orderId,
		...
		: m_locationHelper( new LocationHelper(key,name,description,orderId,dateCreated,dateModified) ),
          m_uniqueIdentifier(s_nextAvailableIdentifier++)
	{
	}
