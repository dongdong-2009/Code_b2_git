/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/RegionAccessFactory.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getRegionBySql(const std::string& sql, std::vector< IRegion* >& regions, const bool readWrite=true);
