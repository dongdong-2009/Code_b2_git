/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/ProfileGroupAccessFactory.h $
  * @author:  Anita Lee
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getProfileGroupBySql(const std::string& sql, std::vector<IProfileGroup*>& profileGroups, const bool readWrite);
