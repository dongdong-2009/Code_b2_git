/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/OnlinePrinterAccessFactory.h $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getOnlinePrinterBySql(const std::string& sql, IOnlinePrinters& OnlinePrinters, const bool readWrite);
