...
namespace TA_Base_Core
{
	...
	class OPCEntityDataAccessFactory
	{
		...
		private:
			...
			void getOPCDpData( IDatabase* pDatabase, const std::string& sql, OPCDataPointDataList& dataList );
			void getOPCDnData( IDatabase* pDatabase, const std::string& sql, const std::string& sqlParameter, 
