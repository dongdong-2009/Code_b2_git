/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/OnlinePrinterAccessFactory.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	void OnlinePrinterAccessFactory::getOnlinePrinterBySql(const std::string& sql, IOnlinePrinters& OnlinePrinters, const bool readWrite)
    {
	...
	IOnlinePrinter* OnlinePrinterAccessFactory::getOnlinePrinter(const unsigned long idKey, const bool readWrite)
    {
		...
		getOnlinePrinterBySql(sql.str(), OnlinePrinters, readWrite);
