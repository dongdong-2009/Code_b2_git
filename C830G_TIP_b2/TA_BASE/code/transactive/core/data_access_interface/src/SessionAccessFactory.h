/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/SessionAccessFactory.h $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_Core
{
    ...
    private:
		...
		void getSessions( const std::string& sql, std::vector<ISession*>& sessions );
