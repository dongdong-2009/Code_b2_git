 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/DataPointStateChangeAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
    ...
    public:
		...
		void getDataPointStateChangeBySql(const std::string& sql, std::vector<IDataPointStateChangeData*>& stateChangePointers);
    ...
    private:
        ...
        static DataPointStateChangeAccessFactory* m_instance;
