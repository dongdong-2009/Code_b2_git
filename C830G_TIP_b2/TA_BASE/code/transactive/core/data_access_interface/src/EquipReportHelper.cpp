/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/EquipReportHelper.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	void EquipReportHelper::deleteThisEquipReport()
	{
		...
		databaseConnection->executeModification(sql2.str());
