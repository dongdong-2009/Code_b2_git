/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/ProfileAccessFactory.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	public:
         ...
         *
		 */
		void getProfileBySql(const std::string& sql, std::vector<IProfile*>& profiles, const bool readWrite);
