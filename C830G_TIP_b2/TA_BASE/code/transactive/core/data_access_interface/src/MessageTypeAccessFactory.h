 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/MessageTypeAccessFactory.h $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
	class MessageTypeAccessFactory
	{
		...
		public:
			 ...
			 */
			void getMessageTypeBySql(const std::string& sql, std::vector<IMessageTypeData*>& messageTypes, const bool readWrite);
