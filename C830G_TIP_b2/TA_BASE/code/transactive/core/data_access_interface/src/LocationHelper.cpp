/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/LocationHelper.cpp $
  * @author Karen Graham
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    void LocationHelper::reload()
    {
        ...
        sql << "TO_CHAR(DATE_CREATED,'YYYYMMDDHH24MISS') FROM LOCATION WHERE PKEY = " << m_key;
    ...
    void LocationHelper::addNewLocation()
    {
        ...
        formatSQL.str("");
        formatSQL << "insert into LOCATION (PKEY,NAME,DESCRIPTION,ORDER_ID) ";
