/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/OnlinePrinterHelper.cpp $
  * @author:  Nick Jardine
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    {       
        ...
        {
            TA_THROW(TA_Base_Core::DataConfigurationException("OnlinePrinter data not fully specified. OnlinePrinter cannot be written to database",
                                                         fieldNames));
        }
