/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/EquipReportAccessFactory.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getEquipReportBySql(const std::string& sql, std::vector<IEquipReport*>& reports, const bool readWrite);
