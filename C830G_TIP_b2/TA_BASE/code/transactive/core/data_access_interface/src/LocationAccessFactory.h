/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/LocationAccessFactory.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getLocationBySql(const std::string sql, std::vector< ILocation* >& locations, const bool readWrite);
         ...
         */
        ILocation::ELocationType
            getLocationType(const std::string& locationName) const;
