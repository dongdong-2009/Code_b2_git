 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/AlarmSeverityAccessFactory.h $
 * @author:  Andy Siow
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
	class AlarmSeverityAccessFactory
	{
		...
		public:
			...
			void getAlarmSeverityBySql(const std::string& sql, std::vector<IAlarmSeverityData*>& alarmSeverities, const bool readWrite);
