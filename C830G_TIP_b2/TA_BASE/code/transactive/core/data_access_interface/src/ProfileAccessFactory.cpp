/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/ProfileAccessFactory.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
	...
	void ProfileAccessFactory::getProfileBySql(const std::string& sql, std::vector<IProfile*>& profiles, const bool readWrite)
	{
    ...
    unsigned long ProfileAccessFactory::getDeletedRawProfileType( unsigned long key)
    {
		...
		getProfileBySql(sql.str(), profiles, false);
	...
	std::vector<IProfile*> ProfileAccessFactory::getProfilesByOperator( unsigned long key, const bool readWrite )
	{
		...
		std::vector<IProfile*> profiles;
		getProfileBySql(sql.str(), profiles, readWrite);
    ...
    std::vector<std::string> ProfileAccessFactory::getAllDistinctParameterNames()
    {
        ...
        parameterNames.push_back("Display 1");
        parameterNames.push_back("Display 2");
        parameterNames.push_back("Display 3");
