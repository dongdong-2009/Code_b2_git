 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/ScadaDisplayAccessFactory.h $
 * @author:  Karen Graham
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getScadaDisplayBySql(const std::string& sql, std::vector<IScadaDisplay*>& displayPointers, const bool readWrite);
    ...
    private:
        static ScadaDisplayAccessFactory* m_instance;
	};
