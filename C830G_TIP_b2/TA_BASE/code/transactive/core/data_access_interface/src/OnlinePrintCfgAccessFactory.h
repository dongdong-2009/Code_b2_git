/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/OnlinePrintCfgAccessFactory.h $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getOnlinePrintCfgBySql(const std::string& sql, IOnlinePrintCfgs& OnlinePrintCfgs, const bool readWrite);
