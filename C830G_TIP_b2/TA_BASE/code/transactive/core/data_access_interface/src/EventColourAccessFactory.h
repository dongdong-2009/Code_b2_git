 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/EventColourAccessFactory.h $
 * @author:  Derrick Liew
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
	...
	public:
		...
		void getEventColourBySql(const std::string& sql, std::vector< IEventColourData* >& eventColours, const bool readWrite);
