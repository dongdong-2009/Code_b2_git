/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/src/SubsystemHelper.cpp $
...
namespace TA_Base_Core
{
    ...
    void SubsystemHelper::checkForReferencesFromEntityTable()
    {
        ...
        IData* data =
            databaseConnection->executeQuery(cascadeSql.str(), columnNames);
    ...
    void SubsystemHelper::reload()
    {
        ...
        sql << " select PKEY, NAME, IS_PHYSICAL, EXCLUSIVE_CONTROL,"
			...
			<< " TO_CHAR(DATE_CREATED,'YYYYMMDDHH24MISS') from SUBSYSTEM where PKEY = " << m_key;
