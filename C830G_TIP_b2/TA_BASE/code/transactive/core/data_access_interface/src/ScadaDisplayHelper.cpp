...
namespace TA_Base_Core
{
    ...
    {       
        ...
        {
            TA_THROW(TA_Base_Core::DataConfigurationException("Display data not fully specified. Scada display cannot be written to database",
                                                         fieldNames));
        }
...
#ifdef TDS_DEVELOP
        sql << "values (" << databaseConnection->getNextPkey("SCADA_SEQ") << ",'";
#else
