/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/plans/src/AlarmPlanAssocHelper.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    void AlarmPlanAssocHelper::addNew()
    {
        ...
        // This is documented in the comment of this method.
        // We are responsible for deleting the returned IData object when we're done with it
        data = databaseConnection->executeQuery(formatSQL.str(),columnNames);
    ...
    std::string AlarmPlanAssocHelper::retrieveEntityTypeName(unsigned long entityTypeKey)
    {
        ...
        try
        {
            ...
            data = DatabaseFactory::getInstance().getDatabase(OnlineUpdatable_Cd, Read)->executeQuery(sql.str(), columnNames);
