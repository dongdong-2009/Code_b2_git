 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/data_recording_dai/src/PersistedState.cpp $
 * @author:  Jade Welton
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Core
{
    ...
    : m_columnMap( columnMap ), m_entityKey( entityKey ), m_valid( false ), m_typeName( typeName )
    {
    ...
    void PersistedState::reload()
    {
        ...
        std::auto_ptr<TA_Base_Core::IData> data( databaseConnection->executeQuery( sql.str().c_str(), columnNames ) );
        if ( data.get() != NULL )
        {
