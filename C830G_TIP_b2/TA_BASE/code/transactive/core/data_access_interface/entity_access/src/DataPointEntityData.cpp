/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/entity_access/src/DataPointEntityData.cpp $
  * @author HoaVu
  * @version $Revision: #2 $
  * Last modification: $DateTime: 2011/03/29 11:47:07 $
...
namespace TA_Base_Core
{
	...
	const std::string DataPointEntityData::DATAPOINT_CONTROL_TIMEOUT_PERIOD_SECONDS ="ControlTimeOutInSec";
	...
	bool DataPointEntityData::setUpdatePriorityLevel ( long newPriority )
	{
		// set up the new parameter value to be written
		std::map < std::string, std::string > parameters;
		parameters [ DATAPOINT_SERVICE_STATE ] = "LOW";

		if ( 1 == newPriority )
		{
			parameters [ DATAPOINT_SERVICE_STATE ] = "HIGH";
		}
		// else do nothing
	...
	int DataPointEntityData::getControlTimeoutPeriodSeconds()
	{
		return getIntegerData ( DATAPOINT_CONTROL_TIMEOUT_PERIOD_SECONDS );
	}
