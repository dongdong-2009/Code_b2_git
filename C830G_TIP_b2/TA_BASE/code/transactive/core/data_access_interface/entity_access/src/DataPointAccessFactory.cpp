/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/entity_access/src/DataPointAccessFactory.cpp $
  * @author:  HoaVu
  * @version: $Revision: #1 $
  *
                                                                            ...
                                                                            std::vector< DataPointEntityData *> & dataPointEntitiesList )
    {
		...
		try
		{
				  ...
				  itr++ )
			{
				...
				{
					// log error message
					std::string msg ( "\nFailed to obtain DataPoint " );
					msg += ( *itr )->getName();
					LOG( SourceInfo, DebugUtil::GenericLog, DebugUtil::DebugError, msg.c_str() );
				}
			}
		}
		catch ( ... )
