/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/entity_access/src/DataPointEntityData.h $
  * @author HoaVu
  * @version $Revision: #2 $
...
namespace TA_Base_Core
{
	...
	public:
		...
		*/
		...
		/**
         * getControlTimeoutPeriodSeconds
         *
         * Returns the control timeout period associated with the DataPoint entity
         *
         * @return the control timeout period of this DataPoint entity
         */
		int getControlTimeoutPeriodSeconds();
	...
	public:
		...
		static const std::string DATAPOINT_CONTROL_TIMEOUT_PERIOD_SECONDS;//Jinmin++ 
    };
