/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_Review_Branch/TA_BASE/transactive/core/data_access_interface/entity_access/src/EntityAccessFactory.h $
  * @author Nick Jardine
  * @version $Revision: #4 $
...
namespace TA_Base_Core
{
    ...
    public:
		...
		IEntityDataList getEntitiesOfType(const std::string& type, const bool readWrite, const bool loadParam, const std::vector<std::string>& parameterNames);
		...
		IEntityDataList getEntitiesOfTypeAtLocation( const std::string& type, unsigned long locationKey, const bool loadParam, const std::vector<std::string>& parameterNames);
		...
		IEntityDataList getEntitiesOfTypeAtLocation( const std::string& type, const std::vector<unsigned long>& locationKeys, const bool loadParam, const std::vector<std::string>& parameterNames);
        /**
         * getEntitiesOfTypeAtLocation
         *
         * Retrieves all entities of the specified type at the specified location
    ...
    private:
         ...
         */
        IData* getSingularData(std::string sql,std::vector<std::string> columnNames,
		...
		/** 
		  ...
		  */
		void getCorbaNames( const std::string& sql, CorbaNameList& corbaNames );
		 ...
		 * @param readWrite		whether or not write access to the data is required
		 */ 
		void getEntityData( const std::string& sql, IEntityDataList& entityData, bool readWrite = false );
        ...
        /** 
          ...
          */
        template<typename T>
        void getEntityDataWithParameterValues( const std::string& sql, const std::string& parameterSQL,
