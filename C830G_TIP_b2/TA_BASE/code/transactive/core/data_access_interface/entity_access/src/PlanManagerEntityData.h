/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/entity_access/src/PlanManagerEntityData.h $
  * @author Bart Golab
  * @version $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    private:
        ...
        static const std::string FLOWCHART_DIR;
        //TD 13265
        static const std::string REPORT_TEMPLATE;
		//TD 17888 marc_bugfix
