/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/system_controller/src/ManagedProcessAccessFactory.h $
...
namespace TA_Base_Core
{
    ...
    public:
		...
		std::vector<std::string> getPeersOfManagedProcessBySql(IDatabase* databaseConnection, const std::string& sql);
