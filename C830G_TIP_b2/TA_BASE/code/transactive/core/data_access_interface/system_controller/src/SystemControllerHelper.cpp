/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/system_controller/src/SystemControllerHelper.cpp $
...
namespace TA_Base_Core
{
    ...
    void SystemControllerHelper::addNew()
    {
        ...
        formatSQL << m_agentPollPeriod << "," << m_heartbeatSendPeriod << ",";
