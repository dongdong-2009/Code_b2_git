  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/radio/src/RASpeedDialSetAccessFactory.cpp $
  * @author Glen Kidd
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    IRASpeedDialSet* RASpeedDialSetAccessFactory::getRASpeedDialSetByProfile(unsigned long profileID)
    {
        ...
        IData* data = databaseConnection->executeQuery(buildSql.str(),columnNames);
