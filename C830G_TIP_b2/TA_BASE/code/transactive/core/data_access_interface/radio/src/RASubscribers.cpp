  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/radio/src/RASubscribers.cpp $
  * @author Glen Kidd
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    void RASubscribers::applyChanges()
    {
		...
		if(m_subscriberType == PATCH_GROUP)
		{
			...
			IData* data1 = databaseConnection1->executeQuery(sql1,columnNames1);
