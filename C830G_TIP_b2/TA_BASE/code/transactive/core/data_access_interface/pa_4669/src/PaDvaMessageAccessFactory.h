/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/pa_4669/src/PaDvaMessageAccessFactory.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
#include "core/data_access_interface/pa_4669/src/IPaTisMessageMap.h"
...
namespace TA_Base_Core
{
	...
	public:
        ...
        /**
         * getAllPaDvaMessagesForConfigEditor
         *
		 * note : this function is only used by ConfigEditor when use the distribute database
		 *
         * Retrieves all PaDvaMessages and returns the associated data as a vector of  
         * objects conforming to the IPaTisMessageMap interface.
         *
         * @param   readWrite  (optional) set to true to return writeable
         ...
         *
         */
		IPaTisMessageMaps getAllPaDvaMessagesForConfigEditor( const bool readWrite = false);
       ...
       IConfigPaDvaMessage* copyPaDvaMessage(const IConfigPaDvaMessage* paDvaMessageToCopy);
        ...
        /**
         * enumerateTisMessages
         *
         * Enumerates all available TIS Messages
         *
         * @return an array of all available TIS Messages
         *
         * @exception DatabaseException 
         *            - if there is a database problem.
         */         
