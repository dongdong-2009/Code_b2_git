/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/pa_4669/src/IConfigPaDvaMessageVersion.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        virtual void setVersionData(const std::string& newVersion,
                                        IPaDvaMessageVersion::EVersionColumn column) = 0;
