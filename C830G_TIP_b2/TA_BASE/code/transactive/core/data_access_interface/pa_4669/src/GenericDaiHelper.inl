/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/pa_4669/src/GenericDaiHelper.inl $
  * @author Jade Lee
  * @version $Revision: #1 $
...
{   
                ...
                const DatabaseQueryHelper::QueryData& queryData)
    {
        ...
        TA_Base_Core::IData* data = databaseConnection->executeQuery(sql.str(), 
                                                       queryData.columnNames);
