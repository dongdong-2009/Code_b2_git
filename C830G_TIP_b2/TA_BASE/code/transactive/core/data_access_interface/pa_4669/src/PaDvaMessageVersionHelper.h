/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/pa_4669/src/PaDvaMessageVersionHelper.h $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         *         - NOT_UNIQUE if the key returns multiple records 
         */
        virtual std::string getVersionData(IPaDvaMessageVersion::EVersionColumn column);
         ...
         *
         */
        std::string getMessageVersion(IPaDvaMessageVersion::ELocation location,
    ...
    private:
        ...
        std::string m_versionData[IPaDvaMessageVersion::VERSION_COLUMN_MAX];
