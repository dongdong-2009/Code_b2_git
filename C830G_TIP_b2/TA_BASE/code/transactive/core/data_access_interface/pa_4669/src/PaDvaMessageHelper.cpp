/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/pa_4669/src/PaDvaMessageHelper.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
//        FUNCTION_EXIT;
    ...
    void PaDvaMessageHelper::modifyExistingPaDvaMessage() //throw(TA_Base_Core::TransactiveException)
    {
		...
		sql << "BEGIN "
            ...
            << (databaseConnection->escapeAQSQLString(m_type)).c_str() << "'' " 
