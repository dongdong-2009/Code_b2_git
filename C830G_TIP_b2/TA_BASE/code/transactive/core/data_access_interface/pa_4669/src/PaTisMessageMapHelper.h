/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/pa_4669/src/PaTisMessageMapHelper.h $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
         ...
         * getLocationKey
         *
         * Returns the Location Key of this PaTisMessageMap.  If this PaTisMessageMap record does not 
         ...
         * getLabel
         *
         * Returns the Label of this PaTisMessageMap.  If this PaTisMessageMap record does not 
         * exist in the database (constructed without a key), then data will be retrieved
         * from within the class.  Otherwise, if this is the first time data for this 
         * existing PaTisMessageMap has been requested, all the data is loaded from the database.
         *
         ...
         * getType
         *
         * Returns the Type of this PaTisMessageMap.  If this PaTisMessageMap record does not 
         * exist in the database (constructed without a key), then data will be retrieved
         * from within the class.  Otherwise, if this is the first time data for this 
         * existing PaTisMessageMap has been requested, all the data is loaded from the database.
         *
         ...
         * setLocationKey
         *
         * Sets the Location Key of this PaTisMessageMap. The set values are not written to the database
         ...
         *
         * @param  locationKey the new Location Key for this PaTisMessageMap
         *
         * @throws DatabaseException 
         *         - if there is a problem establishing a connection with the database.
         *         - if an error is encountered while retrieving data.
         ...
         * setLabel
         *
         * Sets the Label of this PaTisMessageMap. The set values are not written to the database
         * until writePaTisMessageMapData() is called.  This method should only be used by the 
         * ConfigPaTisMessageMap class.
         *
         * @param  operation the Operation description for this PaTisMessageMap
         *
         * @throws DatabaseException 
         *         - if there is a problem establishing a connection with the database.
         *         - if an error is encountered while retrieving data.
         ...
         * setType
         *
         * Sets the Area of this PaTisMessageMap. The set values are not written to the database
         * until writePaTisMessageMapData() is called.  This method should only be used by the 
         * ConfigPaTisMessageMap class.  
         *
         * @param  type the new Type for this PaTisMessageMap
         *
         * @throws DatabaseException 
         *         - if there is a problem establishing a connection with the database.
         *         - if an error is encountered while retrieving data.
