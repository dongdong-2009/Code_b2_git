/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/pa_4669/src/IConfigPaDvaMessagePublicVersion.h $
  * @author Jade Lee
  * @version $Revision: #1 $
  * Last modification: $DateTime: 2008/11/28 16:26:01 $
  * Last modified by: $Author: builder $
  * 
  * IConfigPaDvaMessagePublicVersion - This is the interface supported by objects that allow configuration of
  * PaDvaMessagePublicVersions. It provides methods for retrieving, settings, and writing data for an PaDvaMessagePublicVersion object.
...
#if !defined IConfigPaDvaMessagePublicVersion_H
#define IConfigPaDvaMessagePublicVersion_H
...
namespace TA_Base_Core
{
    ...
    class IConfigPaDvaMessagePublicVersion : public virtual TA_Base_Core::IConfigItem, public virtual IPaDvaMessagePublicVersion
    {

    public:

        virtual ~IConfigPaDvaMessagePublicVersion() {};

        virtual void setLocationKey(unsigned long key) =0;
        virtual void setVersionData(const std::string& newVersion,
                                        IPaDvaMessagePublicVersion::EVersionColumn column) = 0;
...
#endif // !defined IConfigPaDvaMessagePublicVersion_H
