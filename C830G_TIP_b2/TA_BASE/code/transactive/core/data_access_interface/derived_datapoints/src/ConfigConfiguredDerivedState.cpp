/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/derived_datapoints/src/ConfigConfiguredDerivedState.cpp $
  * @author Karen Graham
  * @version $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    ConfigConfiguredDerivedState::~ConfigConfiguredDerivedState()
	{
        try
        {
            ...
            m_parent.updateChanges(parameter.str(), oldValue.str(), 0);
