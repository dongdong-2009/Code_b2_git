/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/tis_agent_4669/src/PredefinedMessageLibraryAccessFactory.cpp $
...
namespace TA_Base_Core
{
	...
	std::vector<IPredefinedMessageLibrary*> PredefinedMessageLibraryAccessFactory::getPredefinedMessageLibraries()
    {
        return getPredefinedMessageLibrariesWhere();
    }


    std::vector<IPredefinedMessageLibrary*> PredefinedMessageLibraryAccessFactory::getPredefinedMessageLibrariesWhere(std::string whereSQL /* = "" */)
    {
        ...
        try
        {
            ...
            while (moreData)
            {
		        ...
		        {
			        predefinedMessageLibraries.push_back( new PredefinedMessageLibraryData(
				        data->getUnsignedLongData( i, TA_TISAgentDAI::PREDEFINED_MESSAGE_LIBRARY_PKEY_COLUMN ) ) );
		        }
	...
	IConfigPredefinedMessageLibrary* PredefinedMessageLibraryAccessFactory::createNewPredefinedMessageLibrary( unsigned short version, const std::string& libraryType,
		std::vector<unsigned char>& libraryFileContent )
	{

		return new TA_Base_Core::ConfigPredefinedMessageLibraryData( version, libraryType, libraryFileContent );
	}

	IPredefinedMessageLibrary* PredefinedMessageLibraryAccessFactory::getPredefinedMessageLibrary( unsigned short version, const std::string& libraryType )
	{
		...
		try
		{
			messageLibraries = getPredefinedMessageLibrariesWhere(whereSQL.str());
		}
	...
	//hongran++ TD17500
	IPredefinedMessageLibrary* PredefinedMessageLibraryAccessFactory::getOCCLocalPredefinedMessageLibrary( unsigned short version, const std::string& libraryType )
	{
    ...
    void PredefinedMessageLibraryAccessFactory::deleteOCCLocalAllMessageLibrariesOfTypeNotMatching( const std::string& libraryType, unsigned short currentVersion, unsigned short nextVersion )
    {
    ...
    void PredefinedMessageLibraryAccessFactory::deleteAllMessageLibrariesOfTypeNotMatching( const std::string& libraryType, unsigned short currentVersion, unsigned short nextVersion )
    {
	...
	PredefinedMessage PredefinedMessageLibraryAccessFactory::getPredefinedMessage( unsigned short version, std::string& libraryType, 
																				   int librarySection, unsigned short messageTag)
	{
		...
		std::auto_ptr<TA_Base_Core::IData> messagedata (databaseConnection->executeQuery(messageSql.str(), columnNames));
