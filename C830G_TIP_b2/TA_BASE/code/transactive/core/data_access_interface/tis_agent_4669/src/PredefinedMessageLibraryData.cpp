/**
  ...
  * in any form.
  *
  * Source: $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/tis_agent_4669/src/PredefinedMessageLibraryData.cpp $
...
namespace TA_Base_Core
{
	...
	unsigned short PredefinedMessageLibraryData::getVersion()
	{
		TA_ASSERT(m_messageLibraryHelper != NULL,"The MessageLibraryHelper pointer is null.");
    ...
    STISLedAttributes PredefinedMessageLibraryData::getDefaultSTISLedAttributes()
    {
        TA_ASSERT(m_messageLibraryHelper != NULL,"The MessageLibraryHelper pointer is null.");
    ...
    STISPlasmaAttributes PredefinedMessageLibraryData::getDefaultSTISPlasmaAttributes()
    {
        TA_ASSERT(m_messageLibraryHelper != NULL,"The MessageLibraryHelper pointer is null.");
    ...
    TTISLedAttributes PredefinedMessageLibraryData::getDefaultTTISLedAttributes()
    {
        TA_ASSERT(m_messageLibraryHelper != NULL,"The MessageLibraryHelper pointer is null.");
