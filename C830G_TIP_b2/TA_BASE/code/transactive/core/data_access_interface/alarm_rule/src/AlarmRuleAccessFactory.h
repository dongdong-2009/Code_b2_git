/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/alarm_rule/src/AlarmRuleAccessFactory.h $
...
namespace TA_Base_Core
{
    ...
    protected:
        ...
        /** 
          ...
          */
        std::vector<unsigned long> getKeys(const std::string& sql);
