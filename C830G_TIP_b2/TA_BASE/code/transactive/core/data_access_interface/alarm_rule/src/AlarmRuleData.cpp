/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/alarm_rule/src/AlarmRuleData.cpp $
...
namespace TA_Base_Core
{
    ...
    void AlarmRuleData::setEntityTypeKey(unsigned long entityTypeKey)
    {
        ...
        std::string oldEntityType = getEntityTypeName(oldEntityTypeKey);
    ...
    void AlarmRuleData::setEntityKey(unsigned long entityKey)
    {
        ...
        std::string oldEntity = getEntityName(oldEntityKey);
