/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/alarm_rule/src/AlarmRuleActionParameterHelper.cpp $
...
namespace TA_Base_Core
{
    ...
    void AlarmRuleActionParameterHelper::deleteThisObject()
    {
        ...
        databaseConnection->executeModification(deleteActionParametersSql.str());
    ...
    void AlarmRuleActionParameterHelper::createNewAlarmRuleActionParameter()
    {
        ...
        IData* data = databaseConnection->executeQuery(getPkeySql, columnNames);
