/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/core/data_access_interface/alarm_rule/src/SuppressionRuleHelper.cpp $
  * @author:  Dirk McCormick
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2010/03/01 16:34:14 $
...
namespace TA_Base_Core
{
	...
	void SuppressionRuleHelper::createNewAlarmRule()
	{
        ...
        if(getAlarmType() == 0)
        {
            getPkeyUsingAllParameters << "alarmtype IS NULL";
        }
        else
        {
		...
		if (ruleType==TA_Base_Core::SuppressionByDescriptionRuleData::RULE_TYPE)
		{
			...
			{
				getPkeyUsingAllParameters << " AND alarmdescription IS NULL";
			}
			else
			{
