...
END_MESSAGE_MAP()
    ...
    void TransActiveDialog::OnGetMinMaxInfo(MINMAXINFO FAR* lpMMI) 
    {
        ...
        LOG_GENERIC(SourceInfo, DebugUtil::DebugDebug, "--------OnGetMinMaxInfo");
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugDebug, "----------OnWindowPosChanging_Entry");
        ...
        {
			LOG_GENERIC(SourceInfo, DebugUtil::DebugDebug, "Moved the window SWP_NOSIZE or SWP_NOZORDER|SWP_NOOWNERZORDER");
			CRect windowRect;
			getWorkArea();			
