 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/history/data_recording/src/DbDataWriter.cpp $
 * @author:  Jade Welton
 * @version: $Revision: #1 $
 *
...
namespace TA_Base_Bus
{
    ...
    std::string DbDataWriter::getSourceTime( struct tm& timeStruct ) const
    {
