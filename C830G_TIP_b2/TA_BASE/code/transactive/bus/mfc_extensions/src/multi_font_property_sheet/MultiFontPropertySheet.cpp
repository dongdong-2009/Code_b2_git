...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mfc_extensions/src/multi_font_property_sheet/MultiFontPropertySheet.cpp $
  * @author:  Rob Young
  * @version: $Revision: #1 $
  *
...
CMultiFontPropertySheet::CMultiFontPropertySheet(UINT nIDCaption, CWnd* pParentWnd, UINT iSelectPage)
	:CPropertySheet(nIDCaption, pParentWnd, iSelectPage), m_isModal(false)
{
}

CMultiFontPropertySheet::CMultiFontPropertySheet(LPCTSTR pszCaption, CWnd* pParentWnd, UINT iSelectPage)
	:CPropertySheet(pszCaption, pParentWnd, iSelectPage), m_isModal(false)
{
}
