/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mfc_extensions/src/editable_list_control/ListCellComboBox.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
// Construction
public:
    CListCellComboBox(CEditableListCtrl* parent, ICellManager* cellManager, CRect cellRect, int item, int subItem, CString text, ICellManager::CellData data);
