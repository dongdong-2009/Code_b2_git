/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/DataPointAgentCorbaDef_Impl/src/DataPointAgentCorbaDef_Impl.cpp $
  * @author  HoaVu
  * @version $Revision: #1 $
...
namespace TA_Base_Bus
{
	...
	void DataPointAgentCorbaDef_Impl::threadedTimerExpired(long timerId, void* userData)
	{
        ...
        if ( ( TA_Base_Core::Control != TA_Base_Core::Monitor ) && 
