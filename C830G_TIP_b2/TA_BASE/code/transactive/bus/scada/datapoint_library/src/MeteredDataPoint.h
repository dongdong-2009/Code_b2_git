/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/datapoint_library/src/MeteredDataPoint.h $
  * @author  HoaVu
  * @version $Revision: #1 $
...
namespace TA_Base_Bus
{
	...
	private:
		 ...
		 *
		 */
		void correct ( double newValue, std::string sessionId );
