/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/datapoint_library/src/DerivedDataPoint.cpp $
  * @author  HoaVu
  * @version $Revision: #1 $
        ...
        {        
            ...
            try
            {
                      ...
                      itr != m_listOfDerivedInputAssociations.end(); ++itr )
                {
                    ...
                    if ( dpStateTS.time > currentStateTS.time ||
						((dpStateTS.time == currentStateTS.time) && // TD15104
                         (dpStateTS.millitm > currentStateTS.millitm) ))
                    {
                        m_currentState->setTimestamp(dpStateTS);
                    }
