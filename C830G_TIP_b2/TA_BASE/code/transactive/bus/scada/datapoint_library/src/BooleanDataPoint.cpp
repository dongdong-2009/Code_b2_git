...
/**
  ...
  * in any form.
  *
  * Source : $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/datapoint_library/src/BooleanDataPoint.cpp $
  * @author  J. Welton
  * @version $Revision: #1 $
...
namespace TA_Base_Bus
{
	...
	{
        bool alarmEnabled;
        m_persistence->readPersistedValue( DP_TRUE_ALARM_ENABLED, m_entityKey, alarmEnabled );
	...
	{
        bool alarmEnabled;
        m_persistence->readPersistedValue( DP_FALSE_ALARM_ENABLED, m_entityKey, alarmEnabled );
