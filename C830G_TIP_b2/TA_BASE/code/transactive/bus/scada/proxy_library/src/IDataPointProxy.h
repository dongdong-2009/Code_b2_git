		...
		public:
			...
			*/
			...
			/**
			  ...
			  */
			virtual void			setValue(std::string value, std::string sessionId = "", unsigned long triggeringEntityKey = 0, char * triggeringEntityValue = NULL, bool auditEventLoggingEnabled = true, timeb deadTime=SCADA_DEFAULT_TIMEB) = 0; //TD15649
			...
			/**
			  ...
			  */
			virtual void			setBoolValue(bool value, std::string sessionId,timeb deadTime=SCADA_DEFAULT_TIMEB) = 0;
			...
			/**
			  ...
			  */
			virtual void			setAnalogueValue(double value, std::string sessionId,timeb deadTime=SCADA_DEFAULT_TIMEB) = 0;
