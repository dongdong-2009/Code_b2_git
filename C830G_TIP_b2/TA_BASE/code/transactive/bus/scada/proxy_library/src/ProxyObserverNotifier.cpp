/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/proxy_library/src/ProxyObserverNotifier.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    ProxyObserverNotifier::ProxyObserverNotifier(ObserverUpdateQueueProcessor& observerUpdateQueueProcessor)
    ...
    void ProxyObserverNotifier::queueNotification(ScadaEntityUpdateType updateType)
    {
        m_observerUpdateQueueProcessor.queueNotification(this, getEntityKey(), updateType);
        LOG_GENERIC( SourceInfo, DebugUtil::DebugDebug, "Queued update item of entity [%u] with update [%d]", getEntityKey(), updateType);
    }
