/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/scada/datanode_library/src/DataNodeTypes.h $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_Bus
{
	...
	public:
		...
		bool checkConfigValidForChildDataPoints(std::string & configName);

		bool checkConfigValidForChildDataNodes(std::string & configName);
