/**
  ...
  *
  * Source:    $File: //depot/4669_T01271350/TA_BASE/transactive/bus/security/authentication_library/src/KeepSessionAliveThread.cpp $
  * @author:   Anita Lee
  * @version:  $Revision: #2 $
  *
  * Last modification: $DateTime: 2008/12/01 10:49:15 $
...
{
    KeepSessionAliveThread::KeepSessionAliveThread() : m_terminated(false)
    {
    }
