/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_Review_Branch/TA_BASE/transactive/bus/security/duty_monitor_framework/src/DataCache.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2011/06/09 16:45:11 $
...
DataCache::DataCache() :
    ...
    m_operatorLookup(m_operatorMap, TA_Base_Core::OperatorAccessFactory::getInstance(),
...
std::vector< RegionSubsystemKey > DataCache::getAllSubsystemsByAllRegion( const bool readWrite /*= false*/ )
{
	...
	sql << "select SEREGI_ID, PHYSICAL_SUBSYSTEM_KEY from SE_REG_SUB_V";
