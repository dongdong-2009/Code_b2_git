/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mathematical_evaluation/src/RealNumberLessThanOrEqualComparison.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #1 $
  *
...
{
    RealNumberLessThanOrEqualComparison::RealNumberLessThanOrEqualComparison(std::auto_ptr< IRealNumberExpression > leftHandSide,
    ...
    RealNumberLessThanOrEqualComparison::~RealNumberLessThanOrEqualComparison()
    {
    ...
    bool RealNumberLessThanOrEqualComparison::evaluate() const
    {
