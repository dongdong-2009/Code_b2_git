/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/mathematical_evaluation/src/RealNumberGreaterThanComparison.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #1 $
  *
...
{
    RealNumberGreaterThanComparison::RealNumberGreaterThanComparison(std::auto_ptr< IRealNumberExpression > leftHandSide,
    ...
    RealNumberGreaterThanComparison::~RealNumberGreaterThanComparison()
    {
    ...
    bool RealNumberGreaterThanComparison::evaluate() const
    {
