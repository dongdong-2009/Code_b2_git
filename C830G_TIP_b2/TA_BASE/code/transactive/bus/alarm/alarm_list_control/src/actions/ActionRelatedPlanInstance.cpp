 ...
 * in any form.
 *
 * Source:   $File: //depot/4669_Review_Branch/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedPlanInstance.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #4 $
 *
...
//                    alarm = NULL;
    ...
    unsigned long ActionRelatedPlanInstance::getPlanManagerKey(IAlarmRetriever& alarmRetriever)
    {
