/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_T01271350/TA_BASE/transactive/bus/alarm/alarm_list_control/src/Filter.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    public:
     ...
     void addFilter(FilterType type, FilterComparison comparison, EAlarmOMType OMType);
        ...
        union FilterValue
        {
            std::string* stringValue;    // FILTER_PROFILE, FILTER_ASSOCIATED_ENTITY_NAME,
