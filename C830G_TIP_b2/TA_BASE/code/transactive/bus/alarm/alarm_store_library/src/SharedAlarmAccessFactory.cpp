...
namespace TA_Base_Bus
{
	...
	long SharedAlarmAccessFactory::removeLocSubSystemDutyAlarms(unsigned long ulLocationKey, std::list<unsigned long>& subSystemKeyList)
	{
		TA_Base_Core::ThreadGuard guard(m_lock);
		return m_sa->removeLocSubSystemDutyAlarms(ulLocationKey, subSystemKeyList);
