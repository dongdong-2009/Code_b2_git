...
public:
	...
	BOOL LoadFromResource(UINT uiResourceID);
	void LoadFromResource(LPCTSTR lpszModule, UINT uiResourceID);
	...
	MSHTML::IHTMLDocument* GetDocument();
	MSHTML::IHTMLDocument2* GetDocument2();	// get document interface; returns NULL 
	...
	MSHTML::IHTMLDocument3* GetDocument3();
