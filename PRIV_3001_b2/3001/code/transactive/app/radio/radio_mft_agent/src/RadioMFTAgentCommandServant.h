 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_ALL_TIP/4677/transactive/app/radio/radio_mft_agent/src/RadioMFTAgentCommandServant.h $
 * @author:  Glen Kidd
 * @version: $Revision: #1 $
 *
...
// ++AZ: TD 14314
		...
		/**
		 * Get resource with the given Name and type
		 *
		 * @return RadioResource
		 */
        virtual void getResourceByAlias(const char* rid, TA_IRS_Bus::Radio::ERadioResourceType type, TA_IRS_Bus::Radio::RadioResource_out resource);
...
//TD18785
		...
		virtual void getRadioResourceCount(const ::TA_IRS_Bus::Radio::RadioResource& resource, ::CORBA::Short& count);


		virtual void updateResource(const ::TA_IRS_Bus::Radio::RadioResource& oldResource, const ::TA_IRS_Bus::Radio::RadioResource& newResource);
		virtual void addNewResource(const ::TA_IRS_Bus::Radio::RadioResource& newResource);
		virtual void deleteResource(const ::TA_IRS_Bus::Radio::RadioResource& oldResource);

		virtual void setPrivateCallState(const ::TA_IRS_Bus::Radio::RadioResource& resource, ::TA_IRS_Bus::Radio::EPrivateCallState callState);
	private:
		//Disabled Methods
