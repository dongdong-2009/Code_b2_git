#include "app/radio/radio_mft_agent/src/RemoteApiRadioCommand.h"
...
{
	LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugError, "ERROR : Exception while calling the method!");
}
}