 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_ALL_TIP/4677/transactive/app/radio/radio_mft_agent/src/RadioMFTAgentHelper.h $
...
public:
	...
	static ApiState convertApiStateFromIDL(TA_IRS_Bus::Radio::EApiState state);
	static TA_IRS_Bus::Radio::EApiState convertApiStateToIDL(ApiState aState);
...
*/
	...
	static int getMCCReconnectionWaitingTime();
	static int getMaxRadioRetries();
	static int getMaxTalkgroupQueryTimeout();
	static int getMaxRadioUserQueryTimeout();
	static int getDatabaseMCCQueryTimeout();
	static int getGPIOMAvailability();
	static std::string convertGPIOMToString(int gpiom);
...
public:
	...
	static int DEFAULT_MCCRECONNECTION_WAITING_TIME;
	static int DEFAULT_MAX_RADIO_RETRIES;
	static int DEFAULT_MAX_TALKGROUP_QUERY_TIMEOUT;
	static int DEFAULT_MAX_RADIOUSER_QUERY_TIMEOUT;
	static int DEFAULT_MAX_DATABASE_MCC_QUERY_TIMEOUT;
	static int DEFAULT_GPIOM_AVAILABILITY;
