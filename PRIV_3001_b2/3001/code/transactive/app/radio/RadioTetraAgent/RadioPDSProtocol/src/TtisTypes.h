/**
  ...
  *
  */
#if !defined(PDS_TTISTYPES_H)
#define PDS_TTISTYPES_H
...
namespace TA_IRS_App
{
    ...
    namespace TtisTypes
    {
		...
		// Added for PDS Download, common data access for RadioPDSManger and RadioAgentServerServant
		// Dennis Abriol
		
		struct SPDSDownloadDataResults
		{
			long lTrainID;
			bool bStatus;
