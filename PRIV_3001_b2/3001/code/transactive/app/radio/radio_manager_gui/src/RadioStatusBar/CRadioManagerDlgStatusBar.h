 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui/src/RadioStatusBar/CRadioManagerDlgStatusBar.h $
...
class CRadioManagerDlgStatusBar : public CStatusBar
{
	...
	protected:
		...
		afx_msg LRESULT onNotifiedPrivateCallRejected(WPARAM wParama, LPARAM lParam);
