 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui/src/RadioSelectedEntity/SelectedEntityDetails/EntityDetailsAreaStrategyFactory.h $
 * @author:  F. Stuart
 * @version: $Revision: #2 $
 *
