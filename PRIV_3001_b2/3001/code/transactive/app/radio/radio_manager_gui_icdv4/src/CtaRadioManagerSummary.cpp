 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui_icdv4/src/CtaRadioManagerSummary.cpp $
 * @author:  Glen Kidd
 * @version: $Revision: #2 $
 *
	  ...
	  CtaAuditing(agentConfiguration->getKey(), TA_Base_Core::RadioAudit::Context)
{
	...
	m_ServerRadioAgentMessageSubscriber = new ServerRadioAgentMessageSubscriber(this);
}

CtaRadioManagerSummary::~CtaRadioManagerSummary()
{
	delete m_ServerRadioAgentMessageSubscriber;
	m_ServerRadioAgentMessageSubscriber = NULL;
...
void CtaRadioManagerSummary::Subscribe()
{
	...
	m_ServerRadioAgentMessageSubscriber->Subscribe();
