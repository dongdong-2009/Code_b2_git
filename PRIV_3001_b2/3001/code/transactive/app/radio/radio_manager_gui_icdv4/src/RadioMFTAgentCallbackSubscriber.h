/**
  ...
  * any form.
  *
  * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui_icdv4/src/RadioMFTAgentCallbackSubscriber.h $
  * @author:  Frik Stuart
  * @version: $Revision: #2 $
  *
...
class RadioMFTAgentCallbackSubscriber : public virtual POA_TA_IRS_Bus::RadioMFTAgentCallbackIDL 
{
	...
	public:
		...
		void operationCancelMessage(TA_IRS_Bus::Radio::EApiState,const TA_IRS_Bus::Radio::RadioResource &) {};
		void resourcePTTMessage(const TA_IRS_Bus::Radio::RadioResource &,const char *,TA_IRS_Bus::Radio::EPTTState){};
		void resourceChangeMessage(const TA_IRS_Bus::Radio::RadioResource &,const TA_IRS_Bus::Radio::RadioResource &) {};
...
//		RadioResourceType convertResourceType(TA_IRS_Bus::ERadioResourceType etype);
		...
		/*
		 * Value to determine if the Private Call is initiated by this console
		 * 
		 */
		bool m_bIsPrivateCallIncoming;
};
