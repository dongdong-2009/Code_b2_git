 ...
 * in any form.
 *
 * Source:   $Source: /cvs/1TS-9999-T/code/transactive/app/radio/radio_manager_gui_icdv4/src/RadioStatusPage/Attic/CRadioStatusPage.h,v $
 * @author:  Glen Kidd
 * @version: $Revision: #2 $
 *
...
afx_msg void OnRButtonUp(UINT nFlags, CPoint point);
		...
		afx_msg LRESULT onNotifiedOperationFail(WPARAM wParam = 0, LPARAM lParam = 0);
		afx_msg HBRUSH OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor);
		afx_msg void onEmergencyPressed();
	//}}AFX_MSG
		DECLARE_MESSAGE_MAP()
