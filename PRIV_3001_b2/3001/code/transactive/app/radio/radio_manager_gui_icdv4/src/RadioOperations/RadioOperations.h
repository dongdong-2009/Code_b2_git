 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui_icdv4/src/RadioOperations/RadioOperations.h $
 * @author:  Glen Kidd
 * @version: $Revision: #2 $
 *
...
#include "app/radio/radio_manager_gui_icdv4/src/RadioOperations/IRadioOperationsObserver.h"
...
#include "bus\trains\traincorbaproxy\src\traininformationcorbaproxy.h"
...
//TD18869
		...
		void setCallForwardingState(bool state);

		bool getCallForwardingState();

		void setTrainProxy(TA_IRS_Bus::TrainInformationCorbaProxyPtr trainAgent);

		void onIncomingDriverCall(unsigned long trainId);
		
		void onResetDriverCall(unsigned long trainId);
		
		void notifyFailOp(RadioResource& resource, int ref=0/*optional*/);
