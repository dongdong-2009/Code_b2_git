...
namespace TA_IRS_App
{
    ...
    public:
         ...
         */
        virtual void updateTrainLibraryVersions(TA_IRS_Bus::CommonTypes::TrainIdType trainId, unsigned long libraryVersion, unsigned short scheduleVersion) =0;
         ...
         * @param version
         */
        virtual void trainDownloadStarted(TA_IRS_Bus::CommonTypes::TrainIdType trainId, TA_IRS_App::ITrainEventCallback::ETrainLibraryType downloadType, unsigned long version) =0;
         ...
         */
        virtual void trainDownloadComplete(TA_IRS_Bus::CommonTypes::TrainIdType trainId, TA_IRS_App::ITrainEventCallback::ETrainLibraryType downloadType, bool success, std::string statusString, unsigned long version) =0;
         ...
         */
        virtual void trainUpgradeComplete(TA_IRS_Bus::CommonTypes::TrainIdType trainId, TA_IRS_App::ITrainEventCallback::ETrainLibraryType downloadType, bool success, std::string statusString, unsigned long version) =0;
