/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/tr_train/src/TrTrainComponent.h $
  * @author:  Lucky Cuizon
  * @version: $Revision: #1 $
  *
...
#if !defined(TRTRAINCOMPONENT_A4EEC36D_18C5_4D02_927B_EC8EFFC7172B__INCLUDED_)
#define TRTRAINCOMPONENT_A4EEC36D_18C5_4D02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class TrTrainComponent : public TA_Base_App::AbstractComponent
    {
    ...
    public:
         ...
         */
        TrTrainComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~TrTrainComponent();
    ...
    private:
         ...
         */
        TrTrainComponent( const TrTrainComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        TrTrainComponent& operator=(const TrTrainComponent&);
...
#endif // !defined(TRTRAINCOMPONENT_A4EEC36D_18C5_4D02_927B_EC8EFFC7172B__INCLUDED_)
