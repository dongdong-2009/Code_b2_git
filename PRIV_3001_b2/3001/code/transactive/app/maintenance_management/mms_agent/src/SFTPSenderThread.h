...
namespace TA_IRS_App
{
	...
	private: //data
		...
		void setBuffer(char* buffer, std::string& data, int maxlength);
		...
		bool createMessageHeader(char* msgContext,int startPosition, unsigned long  msgIndex, TA_Base_Bus::MMSMessageType::MessageType msgType, timeb* valueDate = NULL);
