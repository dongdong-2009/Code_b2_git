/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_TIP/4669/transactive/app/signs/ttis_manager/src/TTISMessageManager.h $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
		...
		static const char* ASK_DISPLAY_FREETEXT;
		static const char* ASK_DOWNLOAD_MESSAGE_LIBRARY;
		static const char* ASK_UPGRADE_MESSAGE_LIBRARY;
		static const char* ASK_UPGRADE_ISCS_MESSAGE_LIBRARY;

		// Error handle
		static const char* ERROR_CONTACTED_AGENT;
		static const char* ERROR_ACCESS_DATABASE;
		...
		static const char* ERROR_SENDING_CANCEL_DOWNLOAD_TRAIN;          
		...
		static const char* NO_TIS_AGENT_DISPLAY_ERRORPREDEFINE;
		static const char* NO_TIS_AGENT_DISPLAY_ERRORFREETEXT;
        static const char* NO_TRAIN_AGENT_DISPLAY_ERROR_PREDEFINE;
        static const char* NO_TRAIN_AGENT_DISPLAY_ERROR_FREETEXT;        
        static const char* NO_TRAIN_AGENT_CLEAR_ERROR;
        ...
        static const char* ASK_SUBMIT_RESET;
