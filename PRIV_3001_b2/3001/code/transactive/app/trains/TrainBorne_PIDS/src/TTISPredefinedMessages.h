/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4669_TIP/4669/transactive/app/signs/ttis_manager/src/TTISPredefinedMessages.h $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        const TA_Base_Core::PredefinedMessage* getMessageById( int messageId );
    ...
    private:
        ...
        /** 
          ...
          *
          */
        void postMessageToWindows(const std::vector<CWnd*>& windows, int message, unsigned long value);

		bool postMessageToWindow(CWnd* window, UINT message, unsigned long value);
        ...
        unsigned long m_currentTTISLibraryVersion;
        unsigned long m_nextTTISLibraryVersion;
