...
namespace TA_IRS_App
{
	...
	CancelLibraryDownloadTask::CancelLibraryDownloadTask( ITimsTisManagerTaskCallback& callback,
		TA_IRS_Bus::CommonTypes::TrainIdType trainId,
		const std::string& sessionId )
		: m_callback( callback ),
		m_trainId( trainId ),
		m_sessionId( sessionId )
	{
		FUNCTION_ENTRY( "CancelLibraryDownloadTask" );
		FUNCTION_EXIT;
	}


	CancelLibraryDownloadTask::~CancelLibraryDownloadTask()
	{
		FUNCTION_ENTRY( "~CancelLibraryDownloadTask" );
		FUNCTION_EXIT;
	}
	...
	void CancelLibraryDownloadTask::executeWorkItem()
	{
		FUNCTION_ENTRY( "executeWorkItemcancelLibraryDownload" );

		m_callback.cancelLibraryDownload( m_trainId,
									      m_sessionId );
