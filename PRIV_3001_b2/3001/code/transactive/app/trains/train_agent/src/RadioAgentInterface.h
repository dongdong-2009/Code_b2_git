...
namespace TA_IRS_App
{
    ...
    public:
		...
		//Lucky
		/**
         * This sets up a data call to transfer the given data to the given trainID.
         *
         * @exception TrainRadioException if making the call fails, or there is already a transfer in progress.
         *
		 * @param trainItsi   The TSI to send the data to
         * @param trainID    The trainID to send the data to
         * @param data    The raw bytes to send
		 * @param sessionId    The operator sending the data
         */
        virtual void makeDataCall( const std::string& trainItsi, unsigned long trainID,
								   const TA_IRS_Bus::TrainMessageData& data,
								   const std::string& sessionId );
		...
		//Lucky
		/**
         * This ends a data call in progress to the given trainID.
         *
         * No exceptions will be thrown. Errors will be logged in the event of failure.
         *
         * @param trainItsi    The TSI to send the data to
         * @param sessionId    The operator sending the data
         */
        virtual void cancelDataCall( unsigned long trainID,
                                     const std::string& sessionId );
		//Lucky
		/**
         * Sends a notification status of EndofTtisDownload
         *
         * No exceptions will be thrown. Errors will be logged in the event of failure.
         *
         * @param lTrainID    The trainID to send the data to
         * @param sStatus     The sStatus sending the data
         */
        virtual void notifyEndOfTtisDownload ( const unsigned long& lTrainID, const unsigned short& sStatus );
    ...
    private:
		...
		/**
		 * This is the radio corba client for RadioServerAgentIDL
		 */
		typedef TA_Base_Core::NamedObject <
			TA_IRS_Bus::RadioServerAgentIDL,
			TA_IRS_Bus::RadioServerAgentIDL_ptr,
			TA_IRS_Bus::RadioServerAgentIDL_var > RadioServerAgentIDLObject;
        /**
		...
		/**
		 * The server session for RadioServerAgentIDL
		 */
		RadioServerAgentIDLObject m_radioServerAgentSession;
