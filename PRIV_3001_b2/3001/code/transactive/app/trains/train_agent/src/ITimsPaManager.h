...
namespace TA_IRS_App
{
    ...
    public:
        ...
        virtual unsigned long getTrainPaLibraryVersion( TA_IRS_Bus::CommonTypes::TrainIdType trainId ) = 0;
        ...
        virtual void preRecordedAnnouncement( const TA_IRS_Bus::CommonTypes::TrainIdList& trainIdList,
											  ...
											  TA_Base_Bus::ITrainPaCorba::EDvaMsgPriority messagePriority) = 0;
