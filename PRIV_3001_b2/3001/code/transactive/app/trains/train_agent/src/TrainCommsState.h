...
namespace TA_IRS_App
{
    ...
    public:
        ...
        TrainCommsState( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
                         ...
                         unsigned long paLibraryVersion = 0,
                         unsigned long ttisLibraryVersion = 0,
                         unsigned long ttisScheduleVersion = 0 );
        ...
        unsigned long getPaLibraryVersion() const;
         ...
         */
        unsigned long getTtisLibraryVersion() const;
         ...
         */
        unsigned long getTtisScheduleVersion() const;
        ...
        /**
         * Initilize the TSI associated with the given MPU. Optionally sets this as the active MPU.
         *
         ...
         */
        void initTrainTsi( TA_IRS_Bus::ProtocolCommonTypes::ETimsOrigin mpu,
                          const std::string& tsi,
                          time_t timestamp,
                          bool setAsPrimary = true );

		/**
         * Update the active TSI associated with the given MPU
         *         
         * @param tsi    the active TSI for this MPU
         * @param timestamp    The timestamp on the incoming TIMS message
         * @param setAsPrimary    If true, this MPU will be the primary
         */
        void setActiveTrainTsi(  const std::string& tsi,
                          time_t timestamp,
                          bool setAsPrimary = true );
        ...
        void setPaLibraryVersion( unsigned long version,
                                  time_t timestamp );
         ...
         * @param timestamp    The timestamp on the incoming TIMS message
         */
        void setTtisLibraryVersion( unsigned long version,
                                    time_t timestamp );
         ...
         * @param timestamp    The timestamp on the incoming TIMS message
         */
        void setTtisScheduleVersion( unsigned long version,
                                     time_t timestamp );
        ...
        void setLibraryVersions( unsigned long paLibraryVersion,
		...
		unsigned long getTalkgroupId(void);
