...
namespace TA_IRS_App
{
    ...
    public:
		...
		void resetTerminatedPec( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
								 TA_Base_Bus::ITrainPecCorba::EPecCarNumber car,
								 TA_Base_Bus::ITrainPecCorba::EPecNumber pec,
								 const char* sessionId,
								 TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource);
		...
		void resetAllPecAtPecTermination( TA_Base_Bus::ITrainCommonCorba::TrainId trainId, const char* sessionId,
										  TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource );
		 ...
		 * @param pecTrainSource The PEC Train Source
         */
        void holdPec( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
                       TA_Base_Bus::ITrainPecCorba::EPecCarNumber car,
                       TA_Base_Bus::ITrainPecCorba::EPecNumber pec,
                       const char* sessionId,
					   TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource );
