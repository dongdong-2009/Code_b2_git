/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP/3001/transactive/app/signs/ttis_manager/src/AbstractTrainDownloads.cpp $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
	...
	*/
    ...
    void AbstractTrainDownloads::notifyDownloadFinished(const DownloadInformation& download, bool success)
    {
		...
		update.displayMessage = download.lastError;     
    ...
    void AbstractTrainDownloads::notifyDownloadCancelled(const DownloadInformation& download)
    {
        ...
        update.displayMessage = message.str();
		//update.displayMessage = "Cancelled";
	...
	*/
    ...
    void AbstractTrainDownloads::sendUpdate(const DownloadStatusDisplay& update)
    {
		...
		LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "Send download status change to GUI-TrainID:[%d], downloadstatus:[%d]", update.trainId, update.currentState);
