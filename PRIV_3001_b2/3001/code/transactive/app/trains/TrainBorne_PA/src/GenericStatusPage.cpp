/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP/3001/transactive/app/trains/TrainBorne_PA/src/GenericStatusPage.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
...
//#include "app/trains/TrainBorne_PA/src/RightsChangedWindowNotificationHandler.h"
...
void GenericStatusPage::updateReportLists(const TA_Base_Bus::IPAAgentCorbaDef::BroadcastProgressUpdateData& pr)
{
    ...
    // song toan++
    // TD 10316
    CListCtrl& failuresList = getFailuresListControl();
    CListCtrl& progressList = getProgressListControl();
    // ++song toan
    // TD 10316
...
void GenericStatusPage::addStringToStatusArea(const std::string& newLine)
{
	...
	getStatusTextListBox().AddString(strippedLine.c_str());

	// Scroll to bottom of control automatically
	BOOL hr = getStatusTextListBox().SetTopIndex(getStatusTextListBox().GetCount() - 1);
