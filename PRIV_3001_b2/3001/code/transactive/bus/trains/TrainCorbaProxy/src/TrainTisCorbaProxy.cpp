...
namespace TA_IRS_Bus
{
	...
	void TrainTisCorbaProxy::cancelLibraryDownload(const CommonTypes::TrainIdList& trains, 
												   const std::string& sessionId)
	{
		...
		CORBA_CATCH( CORBA_CALL( m_tisCorbaObject->namedObject, cancelLibraryDownload, ( CommonTypesConversion::convertToCorba( trains ), 
																						sessionId.c_str() ) ) );
