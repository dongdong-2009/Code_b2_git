...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         * @param cppType    The C++ type to be converted
         */
        static TA_Base_Bus::ITrainDriverCallCorba::TrainChangeover convertToCorba( const CallTypes::TrainChangeover& cppType );
         ...
         * @param CorbaType    The CORBA type to be converted
         */
		static CallTypes::TrainChangeover convertToCpp( const TA_Base_Bus::ITrainDriverCallCorba::TrainChangeover& CorbaType );
