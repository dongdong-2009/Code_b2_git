...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         */
		std::map<unsigned long, TrainStateUpdateCorbaProxyPtr> createDepotTrainStateUpdateCorbaProxy();
    ...
    private:
         ...
         */
		std::map<unsigned long, std::string> m_depotTrainAgentEntityName;
         ...
         * Cached proxy object.
         */
		std::map<unsigned long, TrainStateUpdateCorbaProxyPtr> m_depotTrainStateUpdateCorbaProxy;
