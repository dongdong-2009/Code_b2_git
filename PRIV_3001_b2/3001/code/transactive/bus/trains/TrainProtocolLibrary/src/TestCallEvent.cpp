...
namespace TA_IRS_Bus
{
    ...
    const unsigned short TestCallEvent::EXPECTED_MESSAGE_LENGTH = 19;
    const unsigned short TestCallEvent::TTIS_VERSION_POSITION = 5;
    const unsigned short TestCallEvent::PA_VERSION_POSITION = 13;
            ...
            : TimsEvent( data, sendingTsi, destinationTsi )
    {
        ...
        m_ttisVersion = getLong( TTIS_VERSION_POSITION );
        m_paVersion = getLong( PA_VERSION_POSITION );
        m_scheduleVersion = getLong( SCHEDULE_VERSION_POSITION );
    ...
    unsigned long TestCallEvent::getTtisVersion() const
    {
    ...
    unsigned long TestCallEvent::getPaVersion() const
    {
    ...
    unsigned long TestCallEvent::getScheduleVersion() const
    {
