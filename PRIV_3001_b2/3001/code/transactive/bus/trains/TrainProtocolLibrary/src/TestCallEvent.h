...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         */
        unsigned long getTtisVersion() const; //Lucky : Based on ICD, Ttis version is 4 bytes


        /**
         * Gets the PA library version on the train
         */
        unsigned long getPaVersion() const; //Lucky: Based on ICD, Pa Version is 4 bytes.


        /**
         * Gets the Schedule library version on the train
         */
        unsigned long getScheduleVersion() const; //Lucky: Based on ICD, Schedule version is 4 bytes
    ...
    private:
         ...
         */
        unsigned long m_paVersion;


        /**
         * The TTIS version number
         */
        unsigned long m_ttisVersion;


        /**
         * The schedule version number
         */
        unsigned long m_scheduleVersion;
