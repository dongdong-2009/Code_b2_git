...
namespace TA_IRS_Bus
{
          ...
          m_announcementId( announcementId )
    {
        ...
        // No cyclic DVA in C955, not to implement yet
    ...
    TrainCommand::TrainResponseResult PaCyclicPreRecordedAnnouncementCommand::setResponse( TrainEventPtr response )
    {
        ...
        {
            LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugWarn, "PaCyclicBroadcast doesn't be supported in C955, no original command for it" );
