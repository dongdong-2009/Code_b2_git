/**
  ...
  *
  */
#if !defined(PECREQUESTFORRESETEVENT_H)
#define PECREQUESTFORRESETEVENT_H
...
namespace TA_IRS_Bus
{
    ...
    /**
     * Represents a PEC request for reset event.
     * @author Adam Radics
     * @version 1.0
     * @created 05-Feb-2008 3:20:24 PM
     */

    class PecRequestForResetEvent : public AbstractPecEvent
    {
    ...
    public:
         ...
         */
        PecRequestForResetEvent( const TrainMessageData& data,
         ...
         * Destructor
         */
        virtual ~PecRequestForResetEvent();
     ...
     * @created 05-Feb-2008 3:20:24 PM
     */
    typedef boost::shared_ptr< PecRequestForResetEvent > PecRequestForResetEventPtr;

}

#endif // !defined(PecRequestForResetEvent_H)
