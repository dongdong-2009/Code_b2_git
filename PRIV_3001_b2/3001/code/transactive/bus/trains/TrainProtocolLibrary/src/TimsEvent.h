...
namespace TA_IRS_Bus
{
    ...
    public:
		...
		/**
         * Gets the PEC Train Source
         */
		PecTypes::EPecTrainSource getPecTrainSource() const;
    ...
    protected:
        ...
        /**
         * Gets the long at the given address.
         *
         * @exception ProtocolException if the address is not valid.
         *
         * @param position
         */
        unsigned long getLong( unsigned short position ) const;
    ...
    private:
		...
		/**
		 * Position of the PEC Train Source
		 */
