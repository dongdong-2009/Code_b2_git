...
namespace TA_IRS_Bus
{
    ...
    const unsigned short PaResetEvent::EXPECTED_MESSAGE_LENGTH = 9;
    const unsigned short PaResetEvent::ANNOUNCEMENT_ID_POSITION = 6;
    const unsigned short PaResetEvent::STATUS_POSITION = 5;
            ...
            : TimsEvent( data, sendingTsi, destinationTsi )
    {
		...
		m_status = static_cast<ProtocolPaTypes::EPaCommandResult>(getByte(STATUS_POSITION));
	...
	ProtocolPaTypes::EPaCommandResult PaResetEvent::getStatus() const
	{
		return m_status;
	}
