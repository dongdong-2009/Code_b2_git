...
namespace TA_IRS_Bus
{
    ...
    const unsigned short TtisCommandReceivedEvent::EXPECTED_MESSAGE_LENGTH = 13;
  ...
  //  const unsigned short TtisCommandReceivedEvent::SCHEDULE_LIBRARY_VERSION = 8;
            ...
            : TimsEvent( data, sendingTsi, destinationTsi )
    {
		...
		m_libraryVersion = getLong( LIBRARY_VERSION_POSITION );  //Lucky : Based on the ICD, Library version is 4bytes.
    ...
    unsigned int TtisCommandReceivedEvent::getLibraryVersion() const
    {
