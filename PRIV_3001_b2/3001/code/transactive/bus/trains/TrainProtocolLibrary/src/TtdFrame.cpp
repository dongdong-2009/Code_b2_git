...
namespace TA_IRS_Bus
{
    ...
    const unsigned short TtdFrame::MAX_FRAME_SIZE = 238;
                                                  ...
                                                  unsigned char origin )
    {
        ...
        while ( currentByte != rawData.end() )
        {
            ...
            currentFrame = new TtdFrame( frameList.size() + 1, trainId, dataType, origin );
          ...
          m_lengthPosition( 0 )
    {
        ...
        addByte( m_headerData, dataType );
        addByte( m_headerData, trainId );
        ...
        addByte( m_headerData, MESSAGE_DESTINATION_VMC );
    ...
    void TtdFrame::addByte( TtisTypes::LibraryDataType& frameData, unsigned char dataByte )
    {
        ...
        if ( dataByte == 0x06 )
        {
            frameData.push_back( 0x06 );
            frameData.push_back( 0x00 );
        }
        else if ( dataByte == 0x07 )
        {
            frameData.push_back( 0x06 );
