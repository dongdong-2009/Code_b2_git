 ...
 */
#include "src\TableInfo.h"

/** User stub definition for function: int CTableInfo::analyzeData(VrtLinesConT &) */
int (::CTableInfo::CppTest_Stub_analyzeData) (::VrtLinesConT & VtrOneTable) 
{
	if (CppTest_IsCurrentTestCase("test_err2_analyzeData_1"))
	{
		return -1;	
	}
	return analyzeData(VtrOneTable);
}
