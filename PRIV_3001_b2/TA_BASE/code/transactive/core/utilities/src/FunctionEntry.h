/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/core/utilities/src/FunctionEntry.h $
...
namespace TA_Base_Core
{
    ...
    private:
        ...
        const char* m_file;         // The filename
        const char* m_functName;    // The function name
    };
