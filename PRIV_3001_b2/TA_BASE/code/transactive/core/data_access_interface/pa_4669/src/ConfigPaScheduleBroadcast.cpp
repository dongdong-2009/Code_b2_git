...
std::list<unsigned long> ConfigPaScheduleBroadcast::getZoneKeys()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
...
void ConfigPaScheduleBroadcast::setZoneKeys( const std::list<unsigned long>& vecZoneKeys )
{
...
void ConfigPaScheduleBroadcast::setDvaMsgKeys( const std::list<unsigned long>& lstMsgKeys )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setDvaMsgKeys( lstMsgKeys );
}

void ConfigPaScheduleBroadcast::setIntervalTime( time_t tmIntervalTime )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIntervalTime( tmIntervalTime );
}

void ConfigPaScheduleBroadcast::setIsSun( bool bSun )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsSun( bSun );
}

void ConfigPaScheduleBroadcast::setIsMon( bool bMon )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsMon( bMon );
}

void ConfigPaScheduleBroadcast::setIsTue( bool bTue )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsTue( bTue );
}

void ConfigPaScheduleBroadcast::setIsWed( bool bWed )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsWed( bWed );
}

void ConfigPaScheduleBroadcast::setIsThu( bool bThu )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsThu( bThu );
}

void ConfigPaScheduleBroadcast::setIsFri( bool bFri )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsFri( bFri );
}

void ConfigPaScheduleBroadcast::setIsSat( bool bSat )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsSat( bSat );
}

void ConfigPaScheduleBroadcast::setIsChime( bool bChime )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    m_pPaScheduleBroadcastHelper->setIsChime( bChime );
}

std::list<unsigned long> ConfigPaScheduleBroadcast::getDvaMsgKeys()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getDvaMsgKeys();
}

time_t ConfigPaScheduleBroadcast::getIntervalTime()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIntervalTime();
}

bool ConfigPaScheduleBroadcast::getIsSun()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsSun();
}

bool ConfigPaScheduleBroadcast::getIsMon()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsMon();
}

bool ConfigPaScheduleBroadcast::getIsTue()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsTue();
}

bool ConfigPaScheduleBroadcast::getIsWed()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsWed();
}

bool ConfigPaScheduleBroadcast::getIsThu()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsThu();
}

bool ConfigPaScheduleBroadcast::getIsFri()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsFri();
}

bool ConfigPaScheduleBroadcast::getIsSat()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsSat();
}

bool ConfigPaScheduleBroadcast::getIsChime()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getIsChime();
}

void ConfigPaScheduleBroadcast::setScheduleId( unsigned long scheduleId )
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->setScheduleId(scheduleId);
}

unsigned long ConfigPaScheduleBroadcast::getScheduleId()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
    return m_pPaScheduleBroadcastHelper->getScheduleId();
}
