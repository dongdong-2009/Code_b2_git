...
public:
    ...
    virtual void setZoneKeys( const std::list<unsigned long>& vecZoneKeys ) = 0;
    virtual void setIsEnable( bool bEnable ) = 0;
    virtual void setAutoDel( bool bAutoDel ) = 0;

    virtual void setDvaMsgKeys( const std::list<unsigned long>& lstMsgKeys ) = 0;
	virtual void setScheduleId( unsigned long scheduleId) = 0;
    virtual void setIntervalTime( time_t tmIntervalTime ) = 0;
    virtual void setIsSun( bool bSun ) = 0;
    virtual void setIsMon( bool bMon ) = 0;
    virtual void setIsTue( bool bTue ) = 0;
    virtual void setIsWed( bool bWed ) = 0;
    virtual void setIsThu( bool bThu ) = 0;
    virtual void setIsFri( bool bFri ) = 0;
    virtual void setIsSat( bool bSat ) = 0;
    virtual void setIsChime( bool bChime ) = 0;
