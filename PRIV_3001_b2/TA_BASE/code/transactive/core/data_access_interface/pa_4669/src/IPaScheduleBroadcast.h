...
public:
    ...
    virtual std::list<unsigned long> getZoneKeys() = 0;
    virtual bool getIsEnable() = 0;
    virtual bool getAutoDel() = 0;

    virtual std::list<unsigned long> getDvaMsgKeys() = 0;
	virtual unsigned long getScheduleId() = 0;
    virtual time_t getIntervalTime() = 0;
    virtual bool getIsSun() = 0;
    virtual bool getIsMon() = 0;
    virtual bool getIsTue() = 0;
    virtual bool getIsWed() = 0;
    virtual bool getIsThu() = 0;
    virtual bool getIsFri() = 0;
    virtual bool getIsSat() = 0;
    virtual bool getIsChime() = 0;
