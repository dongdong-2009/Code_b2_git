...
namespace TA_Base_App{
	...
	void IEventWorker::setDegradeMode(bool isInDegradedMode)
	{
		m_DegradedMode = isInDegradedMode;
		LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"Worker Thread in Degraded Mode: %d",(int)m_DegradedMode);
	}
};