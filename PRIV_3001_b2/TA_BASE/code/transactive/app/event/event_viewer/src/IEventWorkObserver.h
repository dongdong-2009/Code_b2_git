...
namespace TA_Base_App{
	...
	public:
		...
		virtual void statusBarUpdate(TA_Base_Core::EventCategory eventCategory,std::string status ) = 0;
		...
		virtual void mergeEventFromATS( std::vector<TA_Base_Core::ICombinedEventData*> & eventlist) = 0;
