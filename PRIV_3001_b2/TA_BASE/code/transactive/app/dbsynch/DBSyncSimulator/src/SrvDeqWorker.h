...
private:																				
	...
	size_t m_nDeqTotal;	
 	...
 	/*
 	* m_pTimer used to update AQ_DEQ_TOKEN_CHECK.UPD_TIME every 30 seconds  and print log info, 
