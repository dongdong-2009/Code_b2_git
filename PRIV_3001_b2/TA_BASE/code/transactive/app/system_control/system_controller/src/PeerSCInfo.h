/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/app/system_control/system_controller/src/PeerSCInfo.h $
...
namespace TA_Base_App
{
    ...
    private:
        ...
        boost::tribool m_isPeerResolvedLastTime;
    ...
    typedef boost::shared_ptr<PeerSCInfo> PeerSCInfoPtr;
} // namespace TA_Base_App
