/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/app/system_control/system_controller/src/SystemControllerAdmin.cpp $
...
namespace TA_Base_App
{
    ...
    {
        TA_Base_Core::ProcessDataSeq processes;
        ProcessManager::getInstance().getAllProcesses(processes);
        return new TA_Base_Core::ProcessDataSeq(processes);
    }
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo, "Instructed by System Manager to shutdown");
        ...
        {
            LOG_GENERIC(SourceInfo, DebugUtil::DebugWarn, "Instructed by System Manager to shutdown a different System Controller (%s)!", hostname);
        }
    }
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo, "Instructed by System Manager to start %s", entityName);
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo, "Instructed by System Manager to change operation mode of %s to %d", entityName, operationMode);
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo, "Instructed by System Manager to stop %s", entityName);
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo, "Instructed by System Manager to set run param on %s", entityName);
    ...
    {
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo, "[notifyStandbyAgent] entityName = %s , hostName = %s!", entityName, hostName);
