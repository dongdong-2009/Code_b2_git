/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/app/system_control/system_controller/src/ManagedProcessInfo.h $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        virtual void getProcessData(TA_Base_Core::ProcessData&);
    ...
    protected:
        ...
        void waitForProcessTerminate(unsigned long pid);

        static std::string makeDbConnectionFile(const std::string& locationName);
