/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/app/system_control/system_controller/src/PeerProcessManager.h $
...
namespace TA_Base_App
{
    class PeerProcessManager
        : public virtual POA_TA_Base_Core::IProcessSubjectCorbaDef,
    ...
    public:
        ...
        /**
          ...
          *
          */
        virtual TA_Base_Core::IProcessObserverCorbaDef_ptr registerProcessObserver(const char* host,
        ...
        /**
          ...
          *
          */
        virtual void registerPeer(const std::string& host, TA_Base_Core::IProcessObserverCorbaDef_var observer);
        virtual void addProcessObserver(const std::string& host, TA_Base_Core::IProcessObserverCorbaDef_var observer);
        ...
        /**
          ...
          *
          */
        virtual void notify(const TA_Base_Core::ProcessData& process);
        virtual void notify(const std::vector<TA_Base_Core::ProcessData>& processes);
        ...
        TA_Base_Core::IProcessObserverCorbaDef_var getProcessObserver(const std::string& host);

        static std::string getString(const TA_Base_Core::ProcessData& process);
    ...
    private:
        ...
        /**
          ...
          */
        std::map<std::string, TA_Base_Core::IProcessObserverCorbaDef_var> m_observers;
