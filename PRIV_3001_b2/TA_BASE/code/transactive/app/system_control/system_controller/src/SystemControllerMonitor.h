/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/app/system_control/system_controller/src/SystemControllerMonitor.h $
...
namespace TA_Base_App
{
    ...
    private:
        ...
        /**
          ...
          */
        std::vector<PeerSCInfoPtr> m_peerSCsToPulsate;
        ...
        /**
          ...
          */
        std::vector<PeerSCInfoPtr> m_groupSCsToPulsate;

        /**
          * A map of hostnames to entity data. Contains the entity data for
          * each peer of this System Controller.
          */
        std::map<std::string, TA_Base_Core::ServerEntityDataPtr> m_peerEntityData;
