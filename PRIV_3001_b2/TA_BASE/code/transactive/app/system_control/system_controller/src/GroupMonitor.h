/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/app/system_control/system_controller/src/GroupMonitor.h $
...
namespace TA_Base_App
{
    ...
    private:
        ...
        boost::tribool m_isGroupOffline;
    };

    typedef boost::shared_ptr<GroupMonitor> GroupMonitorPtr;
} // namespace TA_Base_App
