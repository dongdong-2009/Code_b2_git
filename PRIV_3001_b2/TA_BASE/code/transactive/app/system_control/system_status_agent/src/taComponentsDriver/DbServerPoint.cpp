/**
  ...
  * 
  * Source:    $File: //depot/PRIV_3001/TA_BASE/transactive/app/system_control/system_status_agent/src/taComponentsDriver/DbServerPoint.cpp $
  * @author:   Chris DeWolfe
  * @version:  $Revision: #2 $
  *
  * Last modification: $DateTime: 2018/03/23 17:08:29 $
...
#define  defMysqlDBType            2
	...
	*/
	...
	{
        if (boost::iequals(strDBName, defOracleDBName)) //no case insensitive
		{
