/**
  ...
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_mft_processor/src/LaunchGuiAppActiveStep.cpp $
  * @author:  Huang Jian
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2014/01/27 19:44:32 $
