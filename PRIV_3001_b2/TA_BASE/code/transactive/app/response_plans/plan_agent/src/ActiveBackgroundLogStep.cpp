/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_agent/src/ActiveBackgroundLogStep.cpp $
...
namespace TA_Base_App
{
	...
	ActiveBackgroundLogStep::ActiveBackgroundLogStep( const TA_Base_Core::StepDetail& stepDetail,
        const TA_Base_Core::BackgroundLogParameters& params, IActivePlanFlow& flowControl ) : ActiveStep(stepDetail, flowControl),
        m_sendPopupMessageTryTimes(0),
	    m_params(params)
	{
	}

	TA_Base_Core::EActiveStepState ActiveBackgroundLogStep::executeImpl( void )
	{
		LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugDebug, "Background Log step %lu", getStepNumber() );
