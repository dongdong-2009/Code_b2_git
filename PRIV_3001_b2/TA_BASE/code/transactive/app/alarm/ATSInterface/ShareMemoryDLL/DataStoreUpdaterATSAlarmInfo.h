...
{
	class DataStoreUpdaterATSAlarmInfo  :public DataStoreUpdater<std::string , ATSAlarmQueueItem,ATSAlarmInfoManager>
	{
	public:
		
		virtual ~DataStoreUpdaterATSAlarmInfo();
		void Initialize(std::vector< boost::shared_ptr<ATSAlarmQueueItem> >& batch);
