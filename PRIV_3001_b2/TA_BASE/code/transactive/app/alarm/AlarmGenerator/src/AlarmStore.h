/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4677_ALL_TIP/TA_BASE/transactive/bus/alarm/alarm_list_control/src/AlarmStore.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
  * Last modification: $DateTime: 2010/10/04 16:13:46 $
...
//#include "bus/alarm/shared_alarm_library/src/AlarmFilterSet.h"
...
//        void setSort(const Sort& sort);
         ...
         * getAlarmCount
         *
         * This will retrieve the number of alarms currently stored in the alarm cache. This is not the count
         * returned by the Alarm Store, but simply a count of how many alarms the cache holds at the time the 
         * method is called.
         *
         * @return unsigned long - The number of alarms currently in the alarm cache.
         */
        unsigned long getAlarmCount() const;
    ...
    private:
        ...
        typedef std::map<std::string, TA_Base_Core::AlarmDetailCorbaDef*> AlarmCache;
        ...
        // This is the object that the Alarm Store calls back to send alarm updates
        //AlarmStoreCallback* m_alarmStoreCallback;
        ...
        // This is all currently cached alarms
        AlarmCache m_alarmCache;
        
        // The thread lock for the alarm cache
        mutable TA_Base_Core::ReEntrantThreadLockable m_alarmCacheLock;
