 ...
 * in any form
 *
 * Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/bus/mfc_extensions/src/tab_dialog_control/tabdialogctrl.h $
 * @author:  Andy Parker
 * @version: $Revision: #1 $
 *
 * Last mofification: $DateTime: 2018/03/14 13:51:20 $
