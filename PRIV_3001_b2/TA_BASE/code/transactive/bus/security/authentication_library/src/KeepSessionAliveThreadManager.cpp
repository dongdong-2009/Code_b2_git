/**
  ...
  *
  * Source:    $File: //depot/PRIV_3001/TA_BASE/transactive/bus/security/authentication_library/src/KeepSessionAliveThreadManager.cpp $
  * @author:   Anita Lee
  * @version:  $Revision: #2 $
  *
  * Last modification: $DateTime: 2018/03/23 17:51:00 $
