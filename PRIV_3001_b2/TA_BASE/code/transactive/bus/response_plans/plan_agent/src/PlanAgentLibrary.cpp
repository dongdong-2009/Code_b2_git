...
* in any form.
*
* Source:   $File: //depot/PRIV_3001/TA_BASE/transactive/bus/response_plans/plan_agent/src/PlanAgentLibrary.cpp $
* @author:  Ripple
* @version: $Revision: #1 $
*
...
void PlanAgentLibrary::processPopupMftMessageStepResponse( const TA_Base_Core::CurrentPlanStepDetail& currentStepDetail, TA_Base_Core::EPlanStepCompletionStatus status )
{
    CORBA_CALL( m_planAgent,
        processPopupMftMessageStepResponse,
        ( currentStepDetail, status ) );
}
