...
{
	class AlarmACKCommandManager : public CacheDataManager<unsigned long, I_ATS_ISCS_ALARM::AlarmACKCommand>
	{
	public:
		...
		virtual unsigned long getCacheDataKey(I_ATS_ISCS_ALARM::AlarmACKCommand* cacheData);
		virtual bool writeCacheDataToMem(I_ATS_ISCS_ALARM::AlarmACKCommand* cacheData,ShareMemoryHelper* mem, char* pos);
		virtual bool readCacheDataFromMem(I_ATS_ISCS_ALARM::AlarmACKCommand* cacheData,ShareMemoryHelper* mem, char* pos);
...
// 		};
		...
		{				 
			...
			AlarmAcknowledgeBySize=I_ATS_ISCS_ALARM::PROFILE_ID_SIZE+LongSharedMemoryData,
