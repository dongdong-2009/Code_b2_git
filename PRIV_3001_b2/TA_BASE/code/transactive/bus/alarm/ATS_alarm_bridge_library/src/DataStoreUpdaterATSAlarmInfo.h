...
{
	class DataStoreUpdaterATSAlarmInfo  :public DataStoreUpdater<std::string , I_ATS_ISCS_ALARM::ATSAlarmQueueItem,ATSAlarmInfoManager>
	{
	public:
		
		virtual ~DataStoreUpdaterATSAlarmInfo();
		void Initialize(std::vector< boost::shared_ptr<I_ATS_ISCS_ALARM::ATSAlarmQueueItem> >& batch);
