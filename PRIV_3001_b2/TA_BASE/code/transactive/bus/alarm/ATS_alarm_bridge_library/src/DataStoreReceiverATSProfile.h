...
namespace TA_Base_Bus
{
	...
	class DataStoreReceiverATSProfile   : public DataStoreReceiver<unsigned long, I_ATS_ISCS_ALARM::ATSProfileInfo, ATSProfileManager>
	{
	public:
		...
		boost::shared_ptr<I_ATS_ISCS_ALARM::ATSProfileInfo> getProfile();
