...
struct locationIndex: boost::multi_index::composite_key<
	...
	BOOST_MULTI_INDEX_MEMBER(TA_Base_Core::AlarmItem, bool, isATSAlarm),
...
struct alarmIndices:boost::multi_index::indexed_by<
	...
	>,
	// SORT_BY_ATSFLAG
	boost::multi_index::ordered_non_unique<BOOST_MULTI_INDEX_MEMBER(TA_Base_Core::AlarmItem, bool, isATSAlarm)
	>,
...
typedef boost::multi_index::nth_index<AlarmIndex, SORT_BY_ATSFLAG>::type		alarmindex_by_atsFlag;
