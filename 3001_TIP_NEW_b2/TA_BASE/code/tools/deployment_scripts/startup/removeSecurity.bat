:: S.Liew 8th August 2002
:: -----------------------------
::
:: Usage: 
::
::   removeSecurity <Username>
::
:: Examples:
::
::   removeSecurity newmacro
::   removeSecurity "Tom Jones"
::
:: Description:
::
::   NT batch file to remove tight security settings from a user profile
::
:: Event sequence:
::
...
if not " %~1" == " " goto ok1
echo Incorrect usage: removeSecurity ^<Username^>
echo. 
echo e.g.             removeSecurity newmacro
echo e.g.             removeSecurity "Tom Jones"
goto end
:ok1
...
:: 3. removeSecurity.reg exists

if exist removeSecurity.reg goto ok3
echo Associated file removeSecurity.reg not found
goto end
:ok3
