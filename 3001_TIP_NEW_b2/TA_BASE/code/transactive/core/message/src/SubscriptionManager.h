...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/message/src/SubscriptionManager.h $
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    const unsigned long OCC_LOCATION = 1; //xinsong ++: used for subscribe configupdate message, may need to get data from db
