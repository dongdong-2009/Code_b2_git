/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/message/src/SubscriptionManager.cpp $
...
/////////////////////////////////////////////////////////////////////////////////////////
                                                   ...
                                                   IEventHandler* handler )
    {
        ...
        bool isHandleOutOfOrderMessage = ( TA_Base_Core::RunParams::getInstance().isSet( "HandleOutOfOrderMessage" ) || "Alarm" == channelName );

        StructuredEventConsumer* consumer = new StructuredEventConsumer( new DefaultAdminProvider, isHandleOutOfOrderMessage );
