...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/message/src/BackwardsCompatibility.h $
  * @author:  Cameron Rochester
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2015/11/20 16:45:38 $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        static void subscribeToConfigUpdateMessage( const MessageContext& context, AbstractMessageSubscriber* subscriber, unsigned long locationKey = OCC_LOCATION );

        static void subscribeToConfigUpdateMessage( const MessageType& messageType, AbstractMessageSubscriber* subscriber, unsigned long locationKey = OCC_LOCATION );
