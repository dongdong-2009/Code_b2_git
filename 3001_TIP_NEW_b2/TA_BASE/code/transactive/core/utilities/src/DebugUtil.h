...
namespace TA_Base_Core
{
    ...
    public:
        ...
        /**
		  ...
		  */
		void log(const char* file, int line, EDebugType type, ...);
        ...
        /**
          ...
          *      line is greater than 0 or is -1 if unknown
		  */
   		void logGeneric(const char* file, int line, ...);
        ...
        void logLargeString(const char* file, int line, EDebugLevel level, const std::string& str);
        ...
        /**
		  ...
		  */
		void logMore(const char* file, int line, ...);
		...
		/**
		  ...
		  */
		const EDebugLevel& getLevel() const
        {
    ...
    private:
        ...
        /**
          ...
          *      line is greater than 0
          */
		void logMessage(const char* file, int line, EDebugType type, va_list args, bool simpleLog, bool printCache);
