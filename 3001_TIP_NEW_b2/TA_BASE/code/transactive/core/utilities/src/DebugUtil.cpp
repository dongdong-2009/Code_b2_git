/**
  ...
  * @version: $Revision: #10 $
  *
  * Last modification: $DateTime: 2016/07/19 16:41:49 $
...
namespace TA_Base_Core
{
    ...
    void DebugUtil::log(const char* file, int line, EDebugType type, ...)
    {
        TA_DEBUG_ASSERT ( file != NULL && *file != 0, "File name not provided" );
    ...
    void DebugUtil::logGeneric(const char* file, int line, ...)
    {
        TA_DEBUG_ASSERT ( file != NULL && *file != 0, "File name not provided" );
    ...
    void DebugUtil::logMore(const char* file, int line, ...)
    {
		// If logging is turned off for the level then do nothing
...
// 		return (level - 1);
    ...
    void DebugUtil::logLargeString(const char* file, int line, TA_Base_Core::DebugUtil::EDebugLevel level, const std::string& str)
    {
