/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/naming/src/BindingHandler.cpp $
  * @author:  Cameron Rochester
  * @version: $Revision: #13 $
  *
  * Last modification: $DateTime: 2015/07/09 15:14:35 $
...
namespace TA_Base_Core
{
    ...
    void ObjectRepositoryInfo::setObjectRepository( NamedObjectRepositoryCorbaDef_ptr repository, unsigned long timeToLive )
    {
        ...
        omniORB::setClientCallTimeout(m_resolvedRepository, nsResolveTimeoutMs);
