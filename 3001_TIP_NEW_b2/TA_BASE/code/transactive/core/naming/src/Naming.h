...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/naming/src/Naming.h $
	...
	*/
	...
	public:
		...
		*/
		...
		// yanrong++: CL-21230
		std::string getServantKey(const std::string& agentName);
		// ++yanrong
	...
	private:
		...
		*/
		CORBA::Object_ptr resolveName( const std::string& agentName, const std::string& objectName );
		...
		*/
		void setObjectRepository( NamedObjectRepositoryCorbaDef_ptr repository,
