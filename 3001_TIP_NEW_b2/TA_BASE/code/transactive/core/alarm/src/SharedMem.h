	...
	private:
		...
		static bool create(const char* strSharedName, CREATE_FLAG create_flag)
		{
			...
			{	
				...
				{
				case _create:
					m_pSegment = new fixed_managed_winShmem(create_only, strSharedName, 128*1024*1024, (void*)(1024*1024*1024));
					break;
				case _open:
					m_pSegment = new fixed_managed_winShmem(open_only, strSharedName, (void*)(1024*1024*1024)); 
					break;
				case _open_create:
					m_pSegment = new fixed_managed_winShmem(open_or_create, strSharedName, 128*1024*1024, (void*)(1024*1024*1024));
					break;
				}
				if (m_pSegment == NULL)
				{
