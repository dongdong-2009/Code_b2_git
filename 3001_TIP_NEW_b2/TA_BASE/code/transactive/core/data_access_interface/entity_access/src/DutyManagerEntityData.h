/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/entity_access/src/DutyManagerEntityData.h $
  * @author Bart Golab
  * @version $Revision: #5 $
  *
...
namespace TA_Base_Core
{
    ...
    private:
		//DutyManagerEntityData(const DutyManagerEntityData& dutyManagerEntityData);
