/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/entity_access/src/DutyManagerEntityData.cpp $
  * @author Bart Golab
  * @version $Revision: #3 $
  *
...
namespace TA_Base_Core
{
    ...
    DutyManagerEntityData::DutyManagerEntityData() :
        EntityData()
    {
		m_corbaTimeoutSeconds = USE_DEFAULT_TIMEOUT;
    }
