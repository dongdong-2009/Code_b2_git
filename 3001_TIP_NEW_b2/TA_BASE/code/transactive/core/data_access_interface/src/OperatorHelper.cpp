/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/OperatorHelper.cpp $
  * @author:  Nick Jardine
  * @version: $Revision: #13 $
  *
...
//		TA_ASSERT(formatSQL.size() > 0, "addNewOperator: Get SQL Statement error");
        ...
        /*std::ostringstream sql;
        sql << "insert into OPERATOR (PKEY, NAME, DESCRIPTION, PASSWD) ";
