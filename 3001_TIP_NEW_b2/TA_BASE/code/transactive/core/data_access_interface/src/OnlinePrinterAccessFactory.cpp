/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/OnlinePrinterAccessFactory.cpp $
  * @author:  Ripple
  * @version: $Revision: #4 $
  *
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(ONLINE_PRINTER_SELECT_18503, PKEY_COL, PRINTER_COL,
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, ONLINE_PRINTER_SELECT_18503, PKEY_COL, PRINTER_COL,
			LOCATION_COL, SUBSYSTEM_COL, ISALARM_COL, PKEY_COL, idKey);
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(ONLINE_PRINTER_SELECT_18504, PKEY_COL, PRINTER_COL, 
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, ONLINE_PRINTER_SELECT_18504, PKEY_COL, PRINTER_COL,
			LOCATION_COL, SUBSYSTEM_COL, ISALARM_COL, LOCATION_COL, pLocation, ISALARM_COL, SUBSYSTEM_COL);
