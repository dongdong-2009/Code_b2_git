 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/AlarmData.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #11 $
 *
...
//		TA_ASSERT(sql.size() > 0, "AlarmData::reload(): Prepare SQL Statement error");
    ...
    void AlarmData::createNewAlarm()
    {
		...
		char severityKeyString[50];
		char typeKeyString[50];
        char stateString[2];
        char mmsStateString[2];
		char avlStatusString[2];
