/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/ActionGroupHelper.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #6 $
  *
...
//		strSql  = databaseConnection->prepareSQLStatement(SE_ACTION_GROUP_INSERT_11851, 
		...
		databaseConnection->prepareSQLStatement(strSql, SE_ACTION_GROUP_INSERT_11851,
			...
			databaseConnection->escapeInsertString(m_name), m_isControlType);
