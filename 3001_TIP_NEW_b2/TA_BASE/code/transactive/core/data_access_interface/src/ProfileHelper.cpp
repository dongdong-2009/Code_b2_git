/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/ProfileHelper.cpp $
...
//		TA_ASSERT(strSql.size() > 0, "ProfileHelper::addNewProfile(): Prepare SQL Statement error");
        ...
        /*std::ostringstream sql;
        sql << "insert into SE_PROFILE (SEPROF_ID, NAME, SEPTYP_ID) ";
...
//		TA_ASSERT(strSql.size() > 0, "ProfileHelper::updateLocationDisplays(): Prepare SQL Statement error");
		...
		do 
        {
            ...
            for (unsigned long i = 0; i < data->getNumRows(); ++i)
            {
                ...
                {
                    locationKeysAlreadyInDatabase.insert(std::make_pair<unsigned long, int>(locationKey, 1));
                }
            }
