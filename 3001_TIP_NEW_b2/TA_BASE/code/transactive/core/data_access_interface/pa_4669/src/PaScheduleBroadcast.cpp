...
std::list<unsigned long> PaScheduleBroadcast::getZoneKeys()
{
    TA_ASSERT( m_pPaScheduleBroadcastHelper != NULL, "The PaScheduleBroadcastHelper pointer is null." );
