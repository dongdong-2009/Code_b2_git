/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/plans/src/ConfigPlanDssDpRule.h $
  * @author Jade Lee
  * @version $Revision: #3 $
  * Last modification: $DateTime: 2013/01/08 14:02:12 $
