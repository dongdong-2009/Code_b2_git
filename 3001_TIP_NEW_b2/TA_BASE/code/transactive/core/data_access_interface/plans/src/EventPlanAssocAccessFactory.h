/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/plans/src/EventPlanAssocAccessFactory.h $
  * @author:  Brad Cleaver
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2012/04/25 13:39:48 $
