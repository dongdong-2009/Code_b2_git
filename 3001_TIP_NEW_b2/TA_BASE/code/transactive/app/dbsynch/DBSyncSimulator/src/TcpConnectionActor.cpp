...
{ 
	...
	{
		LOG_GENERIC(SourceInfo, DebugUtil::DebugError, "_InitMysqlNewServer() new CMysqlSrvWorkSingle()"); 
...
{ 
	...
	{
		LOG_GENERIC(SourceInfo, DebugUtil::DebugError, "_InitOracleNewServer() new CSrvWorkMutil()"); 
		bFunRes = false;	
	}
...
bool TcpConnectionActor::isHealth()
{
	...
	{
		LOG_GENERIC(SourceInfo, DebugUtil::DebugError, "EnqNotWork %d > %d, need to be released [ClientID=%s]",
	...
	{
		LOG_GENERIC(SourceInfo, DebugUtil::DebugError, "DeqNotWork %d > %d, need to be released [ClientID=%s]",
	...
	{
		LOG_GENERIC(SourceInfo, DebugUtil::DebugError, "DeqACKNotGet %d > %d, need to be released [ClientID=%s]",
	...
	{
		LOG_GENERIC(SourceInfo, DebugUtil::DebugError, "HandSharkNotGet %d > %d, need to be released [ClientID=%s]",
...
void TcpConnectionActor::serverstopWrok(int nMode)
{
	if (NULL != m_pServerTcpComType)
	{
