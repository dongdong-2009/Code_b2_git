...
private:
	...
	bool	b_TimerSendRunning,b_svrTimerSendRunning;
	CDlgWholeText m_DlgWholeText;
	afx_msg void OnTimer(UINT_PTR nIDEvent);
	CListCtrl m_LT_ServerInfo;
	CListCtrl m_LT_ClientInfo;
	map<int,string> m_clientCommandList;
	map<int,string> m_serverCommandList;
	int m_currentCommandIndex,m_currentSvrCommandIndex;
