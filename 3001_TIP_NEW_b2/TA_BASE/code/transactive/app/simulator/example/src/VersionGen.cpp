/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/simulator/example/src/VersionGen.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
{
	char componentName[] = "Generic Server Simulator Examples";
	char buildVersion[] = "#buildVersion";
	char componentVersion[] = "#buildVersion";
	char buildDate[] = "1";
	char identString[] = "@(#)Uncontrolled";
