/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/scada/inspector_panel/src/ConfirmOverrideDialog.cpp $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2014/06/09 10:51:46 $
...
namespace TA_Base_App
{
	...
	CConfirmOverrideDialog::CConfirmOverrideDialog(CWnd* pParent, int iPoint, CEquipment *equipment)
