/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/scada/inspector_panel/src/InspectorPanelDlg.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #5 $
  *
...
namespace TA_Base_App
{
      ...
      m_isInDirectControl(false)
	{
		...
		//TA_Base_Core::RunParams::getInstance().set("ProxyBulkPollCorbaTimeOut", "8");
		TA_Base_Core::RunParams::getInstance().set("DisableNotifyResolutionExImmediate", "");
	...
	void CInspectorPanelDlg::updatePermissions()
	{
		if (m_equipment == NULL)
			return;
		AccessControlHelper::getInstance()->updateAccessControlMap(m_rightsMgr);
		m_MainTab.updatePermissions();
        m_directControlDlg.updatePermissions();
	}
	...
	{
		LOG(SourceInfo, TA_Base_Core::DebugUtil::GenericLog, TA_Base_Core::DebugUtil::DebugInfo,"RightsLib notify change");
