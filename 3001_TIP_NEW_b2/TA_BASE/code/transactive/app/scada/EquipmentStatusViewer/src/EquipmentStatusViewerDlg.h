 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/EquipmentStatusViewerDlg.h $
 * @author:  Rod Rolirad
 * @version: $Revision: #6 $
 *
 * Last modification: $DateTime: 2013/03/06 16:31:08 $
