 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/EquipmentStatusListCtrl.cpp $
 * @author:  Rod Rolirad
 * @version: $Revision: #6 $
 *
 * Last modification: $DateTime: 2014/06/19 18:33:04 $
...
namespace TA_Base_App
{
	...
	void CEquipmentStatusListCtrl::PreSubclassWindow() 
	{
		...
		InsertColumn(DUMMY_COLUMN,			"");
   		InsertColumn(ASSET_COLUMN,			"Equipment Code");
