/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/data_management/archive_manager/src/BasicHelper.cpp $
...
// 		}
        ...
        std::string dateStr = theDate.Format("%m/%d/%Y");
		// ++ CL-16726
        if( includeTime )
        {
    ...
    {   
		...
		// TD16705
		return fileName.substr( fileName.rfind( '\\' ) + strlen("?DDMMYY") + 1 , fileName.length() - strlen(".dmp") - strlen("?DDMMYY") -fileName.rfind( '\\' ) -1 );
    }
