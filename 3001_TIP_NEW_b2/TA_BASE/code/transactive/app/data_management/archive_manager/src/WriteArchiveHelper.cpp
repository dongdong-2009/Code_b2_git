/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/data_management/archive_manager/src/WriteArchiveHelper.cpp $
...
namespace TA_Base_App
{
    ...
    void WriteArchiveHelper::createManualArchive( std::string& messageForUser, TA_ArchiveManager::EMsgLevel& messageLevel )
    {
		...
		*/
		...
		rangeDlg.setDvdVolume(atoi(amData->getVolumeofDVD().c_str()));
		// ++yangguang TD16713
