...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/data_management/archive_manager/src/BurnDvdDlg.h $
  * @author:  Alan Brims
  * @version: $Revision: #2 $
  *
...
{
    class BurnDvdDlg : public CDialog, public TA_Base_Core::Thread
    {
    public:
        /**
          * BurnDvdDlg
