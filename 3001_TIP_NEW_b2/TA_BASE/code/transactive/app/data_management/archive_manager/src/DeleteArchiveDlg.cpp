/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/data_management/archive_manager/src/DeleteArchiveDlg.cpp $
  * @author:  Alan Brims
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_App
{
	...
	LRESULT DeleteArchiveDlg::OnForceCancel(WPARAM wp, LPARAM lp)
	{
		...
		UINT selectedButton = userMsg.showMsgBox(IDS_UI_050023);
    ...
    void DeleteArchiveDlg::run()
    {
        ...
        try
        {
            ...
            catch( TA_Base_Core::ArchiveException& e )
            {
                ...
                TA_Base_Bus::TransActiveMessage userMsg;
                userMsg << e.what();
                UINT selectedButton = userMsg.showMsgBox(IDS_UE_050131);
                ...
                if( 1 == state )
                {
                    ...
                    try
                    {
                        ...
                        if ( it == m_archives.end() )
                        {
                            ...
                            TA_Base_Bus::TransActiveMessage userMsg;
                            userMsg << date << reason;
                            UINT selectedButton = userMsg.showMsgBox(IDS_UE_050054);
                    ...
                    catch( TA_Base_Core::ArchiveException& e )
                    {
                        ...
                        TA_Base_Bus::TransActiveMessage userMsg;
                        userMsg << e.what();
                        UINT selectedButton = userMsg.showMsgBox(IDS_UE_050132);
			...
			//td19009 bgn
			if( m_stateManager.getState() == StateManager::PROCESSING ) //already delete all 
            {
				enableCloseButton(); 
            }
            //td19009 end
	...
	/*	if(m_forceCancel && m_delthrd != NULL)
        ...
        if ( TA_Base_Core::Thread::THREAD_STATE_RUNNING == getCurrentState() )
        {
            ...
            {
                TA_Base_Bus::TransActiveMessage userMsg;
                UINT selectedButton = userMsg.showMsgBox(IDS_UI_050050);
    ...
    BOOL DeleteArchiveDlg::OnInitDialog() 
    {
        ...
        m_archiveList.InsertColumn( DATA_DATE_COL,        _T("Data Date"),        LVCFMT_LEFT, dateWidth, -1);
        m_archiveList.InsertColumn( RESTORED_BY_COL,      _T("Restored By"),      LVCFMT_LEFT, whoWidth,  -1);
        m_archiveList.InsertColumn( RESTORATION_DATE_COL, _T("Restoration Date"), LVCFMT_LEFT, dateTimeWidth, -1);
        m_archiveList.InsertColumn( DELETION_DUE_DATE_COL,_T("Deletion Date"),    LVCFMT_LEFT, deletionWidth, -1);
        m_archiveList.InsertColumn( STATUS_COL,           _T("Status"),           LVCFMT_LEFT, statusWidth, -1);
    ...
    void DeleteArchiveDlg::populateList()
    {
        ...
        catch( TA_Base_Core::ArchiveException& e )
        {
            ...
            TA_Base_Bus::TransActiveMessage userMsg;
            userMsg << e.what();
            UINT selectedButton = userMsg.showMsgBox(IDS_UE_050053);//IDS_UE_050133); td19370
            enableCloseButton();
            return;
        }
        ...
        if( m_archives.empty() )
        {
            ...
            UINT selectedButton = userMsg.showMsgBox(IDS_UW_050012);
        ...
        {   
            ...
            restorationDate = TA_ArchiveManager::convertTimeTToStringDate( it->second.restoredDate, true );
    ...
    void DeleteArchiveDlg::OnModifyButton() 
    {
        ...
        catch( TA_Base_Core::ArchiveException& e )
        {
            ...
            TA_Base_Bus::TransActiveMessage userMsg;
            userMsg << e.what();
            UINT selectedButton = userMsg.showMsgBox(IDS_UE_050134);
        ...
        if ( IDCANCEL == status )
        {
            ...
            try
            {
                ...
                UINT selectedButton = userMsg.showMsgBox(IDS_UI_050057);
        ...
        else if ( IDOK == status )
        {
            ...
            catch( TA_Base_Core::ArchiveException& e )
            {
                ...
                TA_Base_Bus::TransActiveMessage userMsg;
                userMsg << e.what();
                UINT selectedButton = userMsg.showMsgBox(IDS_UE_050117);
            ...
            if( 0 == inventory.get() )
            {
                ...
                TA_Base_Bus::TransActiveMessage userMsg;
                userMsg << error;
                UINT selectedButton = userMsg.showMsgBox(IDS_UE_050118);
