/*
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/reporting/crystal_reports_viewer/src/CrystalReportsHelper.hpp $
  * @author:  B. Carbonaro
  * @version: $Revision: #8 $
  *
  * Last modification: $DateTime: 2013/05/09 13:41:49 $
    ...
    namespace TA_Reporting
    {
		...
		public:
		    ...
		    /**
		      ...
		      *         returns false.
		      */
            bool viewReport(std::vector<std::string>& parameterValuePairs, bool isATS = false);

			/**
		      * closeReport
		      * 
		      * This method close the report .
		      *
		      * @return True if the report was successfully deleted otherwise it 
		      *         returns false.
		      *
		      */
			bool closeReport();
			...
			void setDisplayBackgroundEdge( BOOL displayBackgroundEdge );
			void setDisplayBorder( BOOL displayBorder);

			/**
		      * setShowToolBar
		      * 
		      * This method set show/hide toolbar .
		      *
		      * @return True if the report was successfully show/hide toolbar otherwise it 
		      *         returns false.
		      *
		      */
			...
			/**
		      * setShowStatusBar
		      * 
		      * This method set show/hide status bar .
		      *
		      * @return True if the report was successfully show/hide status bar otherwise it 
		      *         returns false.
		      *
		      */
			bool setShowStatusBar( bool showStatusBar );
		...
		private:
			...
			/**
		      ...
		      *
		      */
			bool openReport( bool isATS = false);
			...
			//CCrystalReportViewer9* m_pReportViewerBackup;
