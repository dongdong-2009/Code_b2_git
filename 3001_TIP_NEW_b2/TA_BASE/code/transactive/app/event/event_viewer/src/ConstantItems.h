...
namespace EventViewerConstants {
	...
	const std::string STATUS_ATS_QUERYING( "ATS Querying" );
	const std::string STATUS_ISCS_QUERYING( "ISCS Querying" );
	const std::string STATUS_ATS_READY( "ATS Ready" );
	const std::string STATUS_ISCS_READY( "ISCS Ready" );
	const std::string STATUS_ATS_UNHEALTHY( "ATS Unhealthy" );
	const std::string STATUS_ISCS_UNHEALTHY( "ISCS Unhealthy" );
	const std::string STATUS_ATS_DISABLED( "ATS Disabled" );
	const std::string STATUS_ICSC_DISABLED( "ISCS Disabled" );
