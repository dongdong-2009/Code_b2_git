/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_controller/src/ProcessInfo.cpp $
...
namespace TA_Base_App
{
    ...
    // getProcessData
    //
    void ProcessInfo::getProcessData( TA_Base_Core::ProcessData& data, bool isLockFirst /* = true */ )
    {
        ...
        data.requestedState = getProcessStatus( isLockFirst );
