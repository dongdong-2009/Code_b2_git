/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_controller/src/ProcessManager.h $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /** 
          ...
          *
          */
        void getAllProcesses( std::vector<TA_Base_Core::ProcessData>& processDataList, bool isLockFirst = true );
        ...
        EntityToProcessMap& getProcesses() { return m_processes; };
    ...
    private:
        ...
        /** 
          ...
          */
		void handleTwoAgentsInControl(ManagedProcessInfo* agent);
