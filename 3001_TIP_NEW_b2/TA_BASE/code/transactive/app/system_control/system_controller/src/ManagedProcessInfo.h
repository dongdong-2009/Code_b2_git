/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_controller/src/ManagedProcessInfo.h $
  * @author:  Justin Ebedes
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2014/08/06 14:57:11 $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /** 
          ...
          *
          */
        TA_Base_Core::EOperationMode getOperationMode( bool isQqueryRemote = true, bool isLockFirst = true );
        ...
        /** 
          ...
          *
          */
        virtual void getProcessData( TA_Base_Core::ProcessData& data, bool isLockFirst = true );
		...
		/** 
          * isStandbyProcess
          *
          * Returns true if the managed process is Standby Process
          *
          */
...
//         virtual void closeFailoverAlarm();
    ...
    private:
         ...
         */
        TA_Base_Core::EProcessStatus getStatusToChangeTo( bool isLockFirst = true )
        {
            if ( false == isLockFirst )
            {
                return m_statusToChangeTo;
            }

            TA_THREADGUARD( m_changeStateLock );
            return m_statusToChangeTo;
        };
...
//         std::string m_failoverAlarmId;
        ...
        /*static*/ mutable TA_Base_Core::NonReEntrantThreadLockable m_lock;
