/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_controller/src/SystemController.cpp $
	   ...
	   /* if (m_signalHandler == NULL)
		{
			LOG_GENERIC(SourceInfo, DebugUtil::DebugFatal,
				"New failed to allocate SignalEventHandler");
			exit(1);
		}*/
        ...
        try
        {
            ...
            {
                LOG_GENERIC(SourceInfo, DebugUtil::DebugFatal,
                    "New failed to allocate SystemControllerAdmin");
                exit(1);
            }*/

            m_shutdownExecutor = new ShutdownExecutor;
            /*if (m_shutdownExecutor == NULL)
            {
                LOG_GENERIC(SourceInfo, DebugUtil::DebugFatal, "New failed to allocate ShutdownExecutor");
                exit(1);
            }*/
        }
