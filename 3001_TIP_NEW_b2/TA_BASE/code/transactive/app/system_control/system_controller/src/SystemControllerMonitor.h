/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_controller/src/SystemControllerMonitor.h $
  * @author:  Justin Ebedes
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2016/12/21 17:43:53 $
...
namespace TA_Base_App
{
    ...
    private:
        ...
        void closeExistingAlarms();
        std::string makeAlarmEntityName( const std::string& groupOrPeerName );
        friend class CloseExistingAlarmsThread;
