/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_controller/src/ProcessUtilities.cpp $
...
namespace TA_Base_App
{
                                      ...
                                      const std::string& processAddress)
    {
        ...
        while ((pos = processAddress.find_first_not_of(" \t",nextPos)) > 0)
        {  
