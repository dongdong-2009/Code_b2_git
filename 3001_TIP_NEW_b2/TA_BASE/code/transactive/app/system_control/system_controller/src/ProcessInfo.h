/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_controller/src/ProcessInfo.h $
...
namespace TA_Base_App
{
    ...
    public:
		...
		/**
          ...
          * @return The PID.
          */
        TA_Base_Core::ProcessId getProcessId( bool isLockFirst = true )
        {
        ...
        /**
          ...
          */
        TA_Base_Core::EProcessStatus getProcessStatus( bool isLockFirst = true )
        {
            if ( false == isLockFirst )
            {
        ...
        /** 
          ...
          *
          */
        virtual void getProcessData( TA_Base_Core::ProcessData& data, bool isLockFirst = false );
        ...
        /**
          ...
          */
        virtual unsigned int getNumRestarts( bool isLockFirst = true )
        {
            if ( false == isLockFirst )
            {
    ...
    protected:
        ...
        /**
          ...
          */
        virtual TA_Base_Core::DateTime_ul getTimeStarted( bool isLockFirst = true )
        {
            if ( false == isLockFirst )
            {
