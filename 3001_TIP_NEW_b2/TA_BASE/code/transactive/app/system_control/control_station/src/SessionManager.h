/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/SessionManager.h $
  * @author:  Karen Graham
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2013/11/14 15:00:36 $
...
using TA_Base_Bus::AuthenticationAgentNamedObj;
...
public:
	...
	* getLoginStatus
	*
	* Returns true if the session is in login status
	*
	*
	* @return true if the session is in login status
	*/
	bool getLoginStatus(){
		return m_isLoggedIn;
	}
