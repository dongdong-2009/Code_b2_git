/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/SessionDetails.h $
  * @author:  Karen Graham
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2013/03/18 11:18:59 $
...
public:
    ...
    struct SessionInfo
    {
        ...
        //the Change//
        SessionInfo()
            : operatorId(0), profileId(0), locationId(0), consoleId(0), password(""), isOverriden(false), overrideOperatorId(0), overrideProfileId(0), overridePassword(""),isDisplayOnly(0){}
    };
	...
	ProfileVector getListOfProfiles(TA_Base_Core::IOperator* theOperator,bool isCentral, const bool onlyOverridable = false);
