/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/ControlStation2.h $
  * @author:  Karen Graham
  * @version: $Revision: #5 $
  *
...
public:
	...
	STDMETHOD(changeDisplayMode)();
	STDMETHOD(getDisplayMode)(BSTR*);
	...
	STDMETHOD(setRunParam)(BSTR paramName,BSTR paramValue);
private:
