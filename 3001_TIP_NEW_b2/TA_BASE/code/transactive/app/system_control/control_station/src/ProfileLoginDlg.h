/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/ProfileLoginDlg.h $
  * @author:  Karen Graham
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2012/12/24 15:03:25 $
...
private:
	...
	* @Returns the ordered vector of all the order ids of stations.
	*/
	std::vector<unsigned long> getLocalOrderIdList();
