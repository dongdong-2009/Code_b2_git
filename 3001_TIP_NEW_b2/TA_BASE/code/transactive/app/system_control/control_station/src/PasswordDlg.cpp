/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/PasswordDlg.cpp $
  * @author:  San Teo
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2012/12/04 17:41:51 $
...
BOOL CPasswordDlg::OnInitDialog() 
{
  ...
  LOG(SourceInfo, DebugUtil::GenericLog, DebugUtil::DebugInfo, "Rectinfo- left:%d, top:%d,width:%d,height:%d",newRect.left,newRect.top,width,height);
	...
	m_oldPasswordEdit.SetPasswordChar(8234);
	m_newPasswordEdit.SetPasswordChar(8234);
	m_confirmPasswordEdit.SetPasswordChar(8234);
	...
	if (pSysMenu != NULL)
	{
		if (m_mode == TA_Base_App::TA_ControlStation::FORCEDTOCHANGEPASSWORD)
		{
