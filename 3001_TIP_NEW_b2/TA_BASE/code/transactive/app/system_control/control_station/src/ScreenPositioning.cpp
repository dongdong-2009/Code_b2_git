/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/ScreenPositioning.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2014/03/10 14:22:18 $
...
void ScreenPositioning::loadLaunchBarScreenLayout(TA_Base_Core::ControlStation& controlStationDatabaseEntry)
{
    ...
    ControlStation::LaunchBarPosition launchBarPosition = ControlStation::HIDDEN;
    try
    {
    ...
    for (unsigned int screen = 1; screen <= m_numberOfMonitors; screen++)
    {
        ...
        else // No launch bar
        {
            ...
            case(ControlStation::TOP):
                ...
                appRect.bottom = m_screenBottom * screenPercentage;
                break;
