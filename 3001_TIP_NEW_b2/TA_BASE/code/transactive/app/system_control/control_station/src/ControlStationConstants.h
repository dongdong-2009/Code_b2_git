/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/ControlStationConstants.h $
  * @author:  Karen Graham
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2014/11/10 17:38:12 $
...
#define WM_FORCE_LOGOUT_LOSTNETWORD			(WM_USER + 214)
...
namespace TA_Base_App
{
	namespace TA_ControlStation
	{
		...
		static const std::string SCREENPERCENTAGE = "ScreenPercentage";
