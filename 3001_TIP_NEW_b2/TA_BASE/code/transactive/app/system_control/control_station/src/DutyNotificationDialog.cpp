/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/control_station/src/DutyNotificationDialog.cpp $
  * @author:  San Teo
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2012/06/07 17:47:09 $
...
const CString DutyNotificationDialog::GAIN_FORMAT = "You have gained rights from\n\t%s/%s\n";
const CString DutyNotificationDialog::GAIN_DUTYLESS_FORMAT = "You have gained rights\n";
const CString DutyNotificationDialog::DENIED_FORMAT = "You have been denied rights by\n\t%s/%s\n";
const CString DutyNotificationDialog::LOST_FORMAT = "You have lost rights to\n\t%s/%s\n";
const CString DutyNotificationDialog::CHANGED_FORMAT = "You have rights changed to\n\t%s/%s\n"; // TD19075
const CString DutyNotificationDialog::CHANGE_DUTYLESS_FORMAT = "You have changed rights\n"; // TD19075
const CString DutyNotificationDialog::LOST_DUTYLESS_FORMAT = "You have lost rights\n";
