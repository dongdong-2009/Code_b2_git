/**
  ...
  * 
  * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_status_agent/src/pingDriver/PingableDataPointDriver.h $
  * @author:   Chris DeWolfe
  * @version:  $Revision: #3 $
  *
  * Last modification: $DateTime: 2013/09/18 11:38:34 $
...
namespace TA_Base_App
{
    ...
    private:
        ...
        static const std::string& getLogString( PingablePoint* pPoint );
