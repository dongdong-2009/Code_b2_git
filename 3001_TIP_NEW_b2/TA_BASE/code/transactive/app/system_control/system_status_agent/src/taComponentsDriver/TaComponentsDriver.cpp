/**
  ...
  * 
  * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/system_control/system_status_agent/src/taComponentsDriver/TaComponentsDriver.cpp $
  * @author:   Chris DeWolfe
  * @version:  $Revision: #3 $
  *
  * Last modification: $DateTime: 2017/10/04 13:47:35 $
...
namespace TA_Base_App
{
	...
	ISelfResolvingPointContainer* TaComponentsDriver::convertToIPointContainer(TA_Base_Bus::DataPoint* const dataPoint)
	{
		...
		//Support for DbSynchPoint
		pPoint = DbSynchPoint::convertToIPointContainer(dataPoint);
		if(pPoint != 0)
		{
			FUNCTION_EXIT;
			return pPoint;
