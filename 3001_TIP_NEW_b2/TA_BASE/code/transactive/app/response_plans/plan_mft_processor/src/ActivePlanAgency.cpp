/**
  ...
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_mft_processor/src/ActivePlanAgency.cpp $
  * @author:  Huang Jian
  * @version: $Revision: #13 $
  *
...
namespace TA_Base_App
{
    ...
    void ActivePlanAgencyImpl::processActiveStepDetailUpdate( const TA_Base_Core::CurrentPlanStepDetail &currentPlanStepDetail )
    {
        ...
        case TA_Base_Core::POPUP_MFT_MESSAGE_STEP:
            pNewStep = new TA_Base_App::MftMessageActiveStep(currentPlanStepDetail);
            break;
