/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanAccessFactory.cpp $
...
//                     lstSteps.push_back( new  ActiveFailureSummaryStep(stepDetails[stepIndex-1], stepParameters->failureSummary(), flowControl) );
                ...
                case TA_Base_Core::PLAN_CHECK_TIMER_STEP:
                {
                        ...
                        stepDefined = true;
                    #else
					reason = "Error: TA_Base_Core::PLAN_CHECK_TIMER_STEP has not been defined.";
                ...
                case TA_Base_Core::PLAN_SET_TIMER_STEP:
                {
                        ...
                        stepDefined = true;
                    #else
					reason = "Error: TA_Base_Core::PLAN_SET_TIMER_STEP has not been defined.";
                ...
                case TA_Base_Core::EXECUTE_SCRIPT_STEP:
                {
                    ...
                    stepDefined = true;
                    #else
					reason = "Error: TA_Base_Core::EXECUTE_SCRIPT_STEP has not been defined.";
                ...
                case TA_Base_Core::DATA_POINT_TIME_CHECK_STEP:
                {
                    ...
                    stepDefined = true;
                    #else
					reason = "Error: TA_Base_Core::DATA_POINT_TIME_CHECK_STEP has not been defined.";
                ...
                case TA_Base_Core::SHUTDOWN_SYSTEM_STEP:
                {
                    ...
                    stepDefined = true;
                    #else
					reason = "Error: TA_Base_Core::SHUTDOWN_SYSTEM_STEP has not been defined.";
