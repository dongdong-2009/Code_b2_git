/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_agent/src/ActivePlanDecisionStepMessage.cpp $
...
#if defined ( STEPTYPE_DECISION ) || defined ( STEPTYPE_BACKGROUND_DECISION )
