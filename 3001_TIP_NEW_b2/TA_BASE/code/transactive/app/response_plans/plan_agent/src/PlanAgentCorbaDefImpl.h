...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanAgentCorbaDefImpl.h $
...
namespace TA_Base_App
{
	...
	public:
        ...
        virtual void processPopupMftMessageStepResponse(const TA_Base_Core::CurrentPlanStepDetail& currentStepDetail, TA_Base_Core::EPlanStepCompletionStatus status);
