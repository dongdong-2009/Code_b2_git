...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanExecutor.h $
...
namespace TA_Base_App
{
	...
	public:
		...
		void processPopupMftMessageStepResponse(const TA_Base_Core::CurrentPlanStepDetail& step, const int status);
