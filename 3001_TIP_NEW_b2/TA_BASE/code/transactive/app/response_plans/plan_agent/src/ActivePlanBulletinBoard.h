...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_agent/src/ActivePlanBulletinBoard.h $
  *  @author:  Gregg Kirkpatrick
  *  @version: $Revision: #14 $
  *
  *  Last modification: $DateTime: 2014/07/22 14:29:08 $
