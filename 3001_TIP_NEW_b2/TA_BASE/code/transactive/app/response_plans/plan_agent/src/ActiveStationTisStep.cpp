/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_agent/src/ActiveStationTisStep.cpp $
  *  @author:  Bart Golab
  *  @version: $Revision: #5 $
  *
  *  Last modification: $DateTime: 2013/10/21 09:00:51 $
	...
	TA_Base_Core::EActiveStepState ActiveStationTisStep::executeImpl( void )
	{
		...
		try
		{
			...
			if(currentVersion == m_params.message.libraryVersion)
			{
				...
				for(unsigned int i = 0 ; i < m_params.stationPids.length() ; ++i)
				{
