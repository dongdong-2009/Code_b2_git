/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_manager/src/NewPlanStepDlg.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #9 $
  *
...
namespace
{
    static const TA_Base_Core::EStep STEP_TYPES[] =
    {
        ...
        TA_Base_Core::PLAN_CHECK_TIMER_STEP,
#endif
#if defined (STEPTYPE_PLAN_SET_TIMER)
        TA_Base_Core::PLAN_SET_TIMER_STEP,
#endif
#if defined (STEPTYPE_EXECUTE_SCRIPT)
        TA_Base_Core::EXECUTE_SCRIPT_STEP,
#endif
#if defined (STEPTYPE_DATA_POINT_TIME_CHECK)
        TA_Base_Core::DATA_POINT_TIME_CHECK_STEP,
#endif
#if defined (STEPTYPE_POPUP_MFT_MESSAGE)
        TA_Base_Core::POPUP_MFT_MESSAGE_STEP,
#endif
#if defined (STEPTYPE_SHUTDOWN_SYSTEM)
        TA_Base_Core::SHUTDOWN_SYSTEM_STEP,
#endif
