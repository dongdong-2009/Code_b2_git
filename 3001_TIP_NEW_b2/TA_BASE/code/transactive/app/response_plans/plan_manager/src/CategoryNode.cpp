...
// in any form.
//
// Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_manager/src/CategoryNode.cpp $
// @author:  Bart Golab
// @version: $Revision: #5 $
//
...
CategoryNode::CategoryNode(const CategoryNode& other) :
TreeNode(const_cast<CategoryNode &>(other).getNodeSummary()), m_childNodeMap(NULL)
{
	FUNCTION_ENTRY( "CategoryNode" );
	FUNCTION_EXIT;
}
