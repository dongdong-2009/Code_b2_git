/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_manager/src/Utilities.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #12 $
  *
    ...
    switch (stepType)
    {
        ...
        case TA_Base_Core::VMS_SET_SCENE_STEP:
          ...
          case TA_Base_Core::PLAN_CHECK_TIMER_STEP:
              FUNCTION_EXIT;
              return getString(IDS_STEP_TYPE_PLAN_CHECK_TIMER, "Plan Check Timer");

          case TA_Base_Core::PLAN_SET_TIMER_STEP:
              FUNCTION_EXIT;
              return getString(IDS_STEP_TYPE_PLAN_SET_TIMER, "Plan Set Timer");

          case TA_Base_Core::EXECUTE_SCRIPT_STEP:
              FUNCTION_EXIT;
              return getString(IDS_STEP_TYPE_EXECUTE_SCRIPT, "Execute Script");

          case TA_Base_Core::DATA_POINT_TIME_CHECK_STEP:
              FUNCTION_EXIT;
              return getString(IDS_STEP_TYPE_DATA_POINT_TIME_CHECK, "Data Point Time Check");

          case TA_Base_Core::POPUP_MFT_MESSAGE_STEP:
              FUNCTION_EXIT;
              return getString(IDS_STEP_TYPE_POPUP_MFT_MESSAGE, "Popup MFT Message");

          case TA_Base_Core::SHUTDOWN_SYSTEM_STEP:
              FUNCTION_EXIT;
              return getString(IDS_STEP_TYPE_SHUTDOWN_SYSTEM, "Shutdown System");
          ...
          case TA_Base_Core::BACKGROUND_DECISION_STEP:
              FUNCTION_EXIT;
              return getString(IDS_STEP_BACKGROUND_DECISION_STEP, "User Define Message");
