/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/response_plans/plan_manager/src/ApprovedPlanTreeView.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2012/04/02 14:58:27 $
