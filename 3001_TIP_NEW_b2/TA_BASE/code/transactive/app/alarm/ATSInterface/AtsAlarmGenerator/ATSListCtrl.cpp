...
std::string CATSListCtrl::_formatState(I_ATS_ISCS_ALARM::AlarmState state)
{
	CString strState;
	switch (state)
	{
	...
	case I_ATS_ISCS_ALARM::AlarmReturned:
		...
		break;
	case I_ATS_ISCS_ALARM::AlarmClosed:
...
std::string CATSListCtrl::_formatMMSState(I_ATS_ISCS_ALARM::MmsStateType mmsStateType)
{
...
void CATSListCtrl::OnLvnDeleteitem(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	I_ATS_ISCS_ALARM::AlarmDetail* pAlarmDetail = (I_ATS_ISCS_ALARM::AlarmDetail*) GetItemData(nIndex);
...
I_ATS_ISCS_ALARM::AlarmDetail* CATSListCtrl::getAlarmDetails(std::string& strAlarmID)
{
	TA_Base_Bus::ThreadGuard guard(m_threadLock);
...
void CATSListCtrl::removeAlarmFromAutoClose(I_ATS_ISCS_ALARM::AlarmDetail* pAlarmDetails)
{
...
{
	TA_Base_Bus::ThreadGuard guard(m_threadLock);
	I_ATS_ISCS_ALARM::AlarmDetail* pAlarmDetails = reinterpret_cast<I_ATS_ISCS_ALARM::AlarmDetail*>(lParam);
...
{
	TA_Base_Bus::ThreadGuard guard(m_threadLock);
	I_ATS_ISCS_ALARM::AlarmDetail* pAlarmDetail = reinterpret_cast<I_ATS_ISCS_ALARM::AlarmDetail*>(lParam);
