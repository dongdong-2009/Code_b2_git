...
public:
	...
	void getProfileConfig(I_ATS_ISCS_ALARM::ProfileInfo& profileInfo);
	
	I_ATS_ISCS_ALARM::AlarmDetail* createAlarm(CString& strAlarmID, CString& strAlarmValue, CString& strSystemName, 
	...
	I_ATS_ISCS_ALARM::AlarmDetail* createRandomAlarm();
