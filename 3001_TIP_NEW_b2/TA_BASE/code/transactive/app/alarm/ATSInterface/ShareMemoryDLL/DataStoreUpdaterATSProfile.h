...
{
	class DataStoreUpdaterATSProfile  :public DataStoreUpdater<std::string , ATSProfileInfo,ATSProfileManager>
	{
	public:

		virtual ~DataStoreUpdaterATSProfile();
		void Initialize(std::vector< boost::shared_ptr<ATSProfileInfo> >& batch);
