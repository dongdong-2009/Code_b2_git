...
namespace TA_Base_Core
{
	...
	typedef ACE_Allocator_Adapter< ACE_Malloc_T<ACE_LITE_MMAP_MEMORY_POOL,ACE_Null_Mutex, ACE_Control_Block> > ALLOCATOR;
...
//HP++
		...
		// return the reference counter
		static int mapSharedMem(const char* mapfile = "C:/ATSShared.map", bool attempDeleteOldFile = true);
		// return the reference counter
		static int unmapSharedMem();
		//++zyr
		 
	private:
		static ALLOCATOR* create(const char* mapfile = "C:/ATSShared.map", bool attempDeleteOldFile = true);
