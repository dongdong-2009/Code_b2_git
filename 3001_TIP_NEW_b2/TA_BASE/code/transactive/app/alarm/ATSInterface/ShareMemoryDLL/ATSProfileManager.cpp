...
namespace TA_Base_Bus
{
	...
	ATSProfileManager::ATSProfileManager(long maxBlockCount,long blockByteSize)
		:CacheDataManager<unsigned long, ATSProfileInfo>(maxBlockCount,blockByteSize,"ATSProfileInfo")
	{
...
// 		return  cacheData->ID;
// 	}
	bool ATSProfileManager::writeCacheDataToMem(ATSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos)
	{
	...
	bool ATSProfileManager::readCacheDataFromMem(ATSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos)
	{		
		//Attention: if the sequence of the following fields is updated, all related component should be re-compile.
