// ATSMmsQueueItem.h: interface for the ATSMmsQueueItem class.
//
//////////////////////////////////////////////////////////////////////
...
class ATSMmsQueueItem  
{
public:
	ATSMmsQueueItem(const char* _assetName, const char* _alarmId, const char* _operatorId, unsigned long targetDate, const char* _problemReport);
	ATSMmsQueueItem();
	~ATSMmsQueueItem();

	ATSMmsQueueItem(const ATSMmsQueueItem& atsMmsQueueItem);
	ATSMmsQueueItem& operator=(const ATSMmsQueueItem& atsMmsQueueItem);
