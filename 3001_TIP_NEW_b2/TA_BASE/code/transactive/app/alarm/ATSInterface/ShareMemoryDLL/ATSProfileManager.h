...
{
	class ATSProfileManager : public CacheDataManager<unsigned long, ATSProfileInfo>
	{
	public:
		...
		virtual bool writeCacheDataToMem(ATSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos);
		virtual bool readCacheDataFromMem(ATSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos);
