...
namespace I_ATS_ISCS_ALARM
{
	...
	*/
	...
	public:
		...
		*/
		virtual void submitATSAlarm( const AlarmDetail& details, const ProfileInfo& profileInfo ) = 0;
		...
		*            1) the Input Queue length is exceeded 
		*/
		virtual void submitATSAlarmList( std::list<AlarmDetail*> details, const ProfileInfo& profileInfo ) = 0;
		...
		*             
		*/
		virtual unsigned long retrieveATSAlarmAckUpdate( std::list<AlarmAckUpdate*>& updates ) = 0;
		...
		*             
		*/
		virtual unsigned long retrieveATSMmsJobRequest( std::list<MmsJobRequest*>& updates ) = 0;
	...
	*/
	...
	public:
		...
		*
		* @param	std::list<ATSAlarmQueueItem*>&	 a return list of ATS alarms.
		*             
		*/
		virtual unsigned long retrieveATSAlarm( std::list<ATSAlarmQueueItem*>& details ) = 0;
		...
		*             
		*/
		virtual void submitATSAlarmAckUpdate( const AlarmAckUpdate& update ) = 0; //May catch 
		...
		*             
		*/
		virtual void submitATSMmsJobRequest( const MmsJobRequest& update ) = 0;
	};
	...
	*             
	*/
	ALARM_API I_ATS_ISCS_ALARM::IATSAlarm* getATSInterface();
	...
	*             
	*/
	ALARM_API I_ATS_ISCS_ALARM::IISCSAlarm* getISCSInterface();
