/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/alarm/alarm_agent/src/AvalancheSuppressionRule.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2012/07/24 13:20:34 $
