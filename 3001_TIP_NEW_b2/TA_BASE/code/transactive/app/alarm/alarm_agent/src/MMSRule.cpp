/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/alarm/alarm_agent/src/MMSRule.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2012/07/24 10:52:53 $
...
//                 }
				...
				//	message.alarmID.in());
			//	TA_Base_Bus::MMSSubmitManager::getInstance()->getSubmitter()->submitAutoAlarmMessage(message);
