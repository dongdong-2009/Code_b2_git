/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/alarm/alarm_agent/src/AlarmCache.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #20 $
  *
  * Last modification: $DateTime: 2015/01/29 17:19:27 $
	...
	*/
                             ...
                             bool p_multipleOccurancesAllowed )
    {
        ...
        LOG( SourceInfo, DebugUtil::GenericLog, DebugUtil::DebugInfo,
             "Inserting an alarm with uuid %s and type %u",
             p_alarm.alarmID.in(),
...
//         m_queue->push(queueItem);
    ...
    void AlarmCache::openAlarm( const std::string& p_alarmId )
    {
        ...
        if( alarm->state == TA_Base_Core::AlarmSuppressed )
        {
			...
			alarm->isChildOfAvalanche=false;
        }
