 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/authentication_agent/src/SessionRegister.h $
 * @author:   Nick Jardine
 * @version:  $Revision: #9 $
 *
...
namespace TA_Base_App
{
    ...
    public:
         ...
         * @exception AuthenticationAgentException Thrown if the specified session is not currently valid.
         */
        TA_Base_Bus::SessionInfo getSession(const std::string& sessionId);
	...
	private:
		...
		//unsigned long m_operatorOverrideKey;
		//unsigned long m_seprofOverrideKey;
		// ++ly
    };
}
