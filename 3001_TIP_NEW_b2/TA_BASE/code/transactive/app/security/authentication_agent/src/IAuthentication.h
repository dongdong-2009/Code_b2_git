 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/authentication_agent/src/IAuthentication.h $
 * @author:   Nick Jardine
 * @version:  $Revision: #3 $
 *
 * Last modification: $DateTime: 2012/06/07 16:58:46 $
...
namespace TA_Base_App
{
    ...
    public:
         ...
         * log in attempt.
	     */
        virtual std::string requestSession(unsigned long userId, unsigned long profileId, unsigned long locationId, unsigned long workstationId, const std::string & password, bool displayOnly) =0;
         ...
         */
        virtual std::string changeProfile(const std::string & sessionId, unsigned long profileId, unsigned long locationId, const std::string & password, bool displayOnly) =0;
