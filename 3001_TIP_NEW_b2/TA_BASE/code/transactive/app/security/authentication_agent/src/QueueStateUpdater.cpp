 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/authentication_agent/src/QueueStateUpdater.cpp $
 * @author:   Nick Jardine
 * @version:  $Revision: #3 $
 *
 * Last modification: $DateTime: 2013/07/30 11:34:07 $
