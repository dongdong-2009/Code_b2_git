 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/authentication_agent/src/UserCache.cpp $
 * @author:   Nick Jardine
 * @version:  $Revision: #3 $
 *
 * Last modification: $DateTime: 2014/01/15 10:23:09 $
...
namespace TA_Base_App
{
    ...
    void UserCache::changeUserPassword(const unsigned long userId, const std::string& password)
    {
        ...
        if (0 == password.length())
        {
            ...
            TA_THROW(AuthenticationSecurityException("The new password was empty. Passwords cannot be empty", AuthenticationSecurityException::INVALID_PASSWORD) );
        }
