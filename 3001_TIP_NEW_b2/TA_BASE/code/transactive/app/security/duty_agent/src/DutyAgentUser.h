 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/duty_agent/src/DutyAgentUser.h $
...
namespace TA_Base_App
{
    ...
    private:
		...
		std::map<std::string,TA_Base_Bus::DASType::DbKey> m_locationNameMap; 
