 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/duty_agent/src/DutyAgentImpl.h $
...
#define RPARAM_DUTY_CENTER		 "DutyCenter"
...
namespace TA_Base_App
{
    ...
    public:
		...
		//virtual void authReallocateDuty(const TA_Base_Bus::IAuthenticationAgentCorbaDef::SessionInfoCorbaDef& session);
		...
		*/
		...
		virtual void testNotifyStationOnLine(DutyAgentTypeCorbaDef::Key locationKey);

		virtual void testNotifyStationOffLine(DutyAgentTypeCorbaDef::Key locationKey);
    ...
    private:
		...
		TA_Base_Bus::DASType::LocationSet	getPeerQueryLocationSet();
		...
		boost::shared_ptr<DutyCenter>				  m_pDutyCenter;	
    };
}
