/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/DutyManager/src/DutyManagerPropertySheet.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2012/04/18 18:40:16 $
...
DutyManagerPropertySheet::DutyManagerPropertySheet() :
	CMultiFontPropertySheet("Rights Manager PS", NULL, 0)
{
}
