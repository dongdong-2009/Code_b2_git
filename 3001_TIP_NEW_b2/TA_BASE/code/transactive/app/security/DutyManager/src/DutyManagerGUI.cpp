/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/security/DutyManager/src/DutyManagerGUI.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #6 $
  *
  * Last modification: $DateTime: 2013/10/18 09:32:45 $
  * Last modified by:  $Author: jinmin.huang $
  *
  * This class provides an interface between GenericGUI and Rights Manager. 
...
void DutyManagerGUI::createApplicationObject()
{
    ...
    TA_THROW(TA_Base_Core::GenericGUIException("Rights Manager initialisation failed.",  TA_Base_Core::GenericGUIException::INITIALISATION_ERRORS));
}
