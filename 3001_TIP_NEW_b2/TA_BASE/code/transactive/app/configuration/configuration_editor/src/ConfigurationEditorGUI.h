/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/configuration/configuration_editor/src/ConfigurationEditorGUI.h $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
...
#if !defined(AFX_ConfigurationEditorGUI_H__2A63FC16_95CE_48E6_9464_A662B7478D49__INCLUDED_)
#define AFX_ConfigurationEditorGUI_H__2A63FC16_95CE_48E6_9464_A662B7478D49__INCLUDED_
...
{
    class ConfigurationEditorGUI : public TA_Base_Bus::AbstractDocumentGUI
    {
    public:
	    ...
	    *
	    */
	    virtual ~ConfigurationEditorGUI();
		//TD18095, jianghp
        ...
        * @exception  ProcessAlreadyRunningException is thrown if a configuration editor is already
        *             running and connected to the schema this one is trying to connect to.
        *
        */
    ...
    private:
         ...
         */
        ConfigurationEditorGUI( const ConfigurationEditorGUI&);
         ...
         * Hidden as a private method so it is not used.
         */
        ConfigurationEditorGUI& operator=(const ConfigurationEditorGUI&);


        static const std::string ICON_SIZE_USER_SETTING;

    };
}

#endif // !defined(AFX_ConfigurationEditorGUI_H__2A63FC16_95CE_48E6_9464_A662B7478D49__INCLUDED_)
