/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/configuration/config_plugins/config_plugin_helper/src/AbstractDetailView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2013/11/13 18:08:50 $
...
END_MESSAGE_MAP()
    ...
    void AbstractDetailView::applyButtonPressed(TA_Base_Core::IConfigItem* currentItem) 
    {
        ...
        catch ( const TA_Base_Core::DatabaseException& e)
        {
			...
			::MessageBox(AfxGetApp()->m_pMainWnd->m_hWnd, e.what(), "ConfigurationEditor", MB_SETFOREGROUND | MB_TOPMOST);
        }
