/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/configuration/config_plugins/sound_file/src/SoundFileComponent.cpp $
  * @author:  Brad Cleaver
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2012/05/03 18:06:46 $
