/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/configuration/config_plugins/plan_dss_rule/src/PlanDssRuleListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2015/04/28 14:59:19 $
...
namespace TA_Base_App
{
    ...
    const char* const COL_NAME_APPLIED = "Status";
    const char* const COL_NAME_LOCATION = "Location";
    const char* const COL_NAME_TRIGGER_ENTITY = "Trigger Entity";
    const char* const COL_NAME_ACTIVE_PLAN = "Active Plan";
    const char* const COL_NAME_MINIMUM_INTERVAL = "Minimum Interval";
	const char* const COL_NAME_ACTIVED_TOLERANT_TIME = "Tolerant Time for Active";
	const char* const COL_NAME_DENY_STRATEGY = "Deny Multiple Strategy";
	const char* const COL_NAME_ACTIVATE_VALUE = "Activate Value";
	const char* const COL_NAME_NEED_DEACTIVATE = "Need Deactivate";
	const char* const COL_NAME_ALLOW_MULTIPLE = "Allow Multiple";
    const char* const COL_NAME_ENABLE = "Enable";
	const char* const COL_NAME_VALID_TIME_IN_DAY = "Valid Time in Day";
	const char* const COL_NAME_VALID_DAYS_IN_WEEK = "Valid Days in Week";
    ...
    const char* const STATUS_NEW = "New";
    const char* const STATUS_MODIFIED = "Modified";
