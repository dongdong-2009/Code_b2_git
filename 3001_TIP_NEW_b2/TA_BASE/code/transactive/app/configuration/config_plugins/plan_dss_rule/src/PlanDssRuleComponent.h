/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/configuration/config_plugins/plan_dss_rule/src/PlanDssRuleComponent.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  * Last modification: $DateTime: 2012/12/20 12:41:12 $
...
#if !defined(PlanDssRuleComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
#define PlanDssRuleComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_
...
{
    class PlanDssRuleComponent : public AbstractComponent
    {
    ...
    public:
         ...
         */
        PlanDssRuleComponent(const std::string& componentName);


        /**
         * Destructor
         */
	    virtual ~PlanDssRuleComponent();
    ...
    public:
        ...
        {
            return TA_Base_Bus::aca_CE_CONFIGURE_ALARM_PLAN_ASSOCIATIONS;
        }
    ...
    private:
         ...
         */
        PlanDssRuleComponent( const PlanDssRuleComponent&);
         ...
         * Hidden as a private method so it is not used.
         */
        PlanDssRuleComponent& operator=(const PlanDssRuleComponent&);
...
#endif // !defined(PlanDssRuleComponent_A4EEC36D_18C5_4d02_927B_EC8EFFC7172B__INCLUDED_)
