/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/app/configuration/config_plugins/plan_dss_rule/src/PlanDssRuleDetailView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #8 $
  *
  * Last modification: $DateTime: 2013/12/23 10:38:28 $
...
END_MESSAGE_MAP()
    ...
    void PlanDssRuleDetailView::onButtonLocation()
    {
        ...
        ChangeDialog dlg( mapLocs, "Location", strCurItem.c_str(), this );
        int response = dlg.DoModal();
    ...
    void PlanDssRuleDetailView::onButtonDenyStrategy()
    {
        ...
        ChangeDialog dlg( mapStrategies, "Deny Multiple Strategy", strCurItem.c_str(), this );
        int response = dlg.DoModal();
