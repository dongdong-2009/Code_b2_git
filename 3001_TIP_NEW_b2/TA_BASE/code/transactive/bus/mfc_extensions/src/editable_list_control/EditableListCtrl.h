/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/mfc_extensions/src/editable_list_control/EditableListCtrl.h $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
...
public:
		 CEditableListCtrl();
		 CEditableListCtrl(ICellManager *cellManager, bool singleClick = false, int numImages = 8);
		 CEditableListCtrl(bool singleClick, int numImages = 8);
