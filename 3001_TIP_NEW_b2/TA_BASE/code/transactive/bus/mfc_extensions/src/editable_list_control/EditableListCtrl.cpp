/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/mfc_extensions/src/editable_list_control/EditableListCtrl.cpp $
  * @author:  Ripple
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2014/05/26 10:48:49 $
...
CEditableListCtrl::CEditableListCtrl() 
	: m_cellManager(NULL),m_cellEditCtrl(NULL),m_singleClick(false), m_noCheckIconIndex(-1), m_checkIconIndex(-1), m_numImages(8), m_imageList(NULL), m_buttonProcessor(NULL), m_comboxCellDataSortable(TRUE)
{
}
