/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/mfc_extensions/src/auto_sort_list_ctrl/AutoSortListCtrl.cpp $
  * @author Jade Lee
  * @version $Revision: #3 $
  *
  * Last modification: $DateTime: 2012/09/25 16:30:45 $
