 ...
 * in any form
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/mfc_extensions/src/tab_dialog_control/tabdialogctrl.h $
 * @author:  Andy Parker
 * @version: $Revision: #2 $
 *
 * Last mofification: $DateTime: 2012/02/06 16:15:14 $
