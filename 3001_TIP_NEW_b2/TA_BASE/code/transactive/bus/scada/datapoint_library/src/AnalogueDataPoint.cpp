/**
  ...
  * in any form.
  *
  * Source : $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/datapoint_library/src/AnalogueDataPoint.cpp $
  * @author  J. Welton
  * @version $Revision: #4 $
...
namespace TA_Base_Bus
{
	...
	void AnalogueDataPoint::setAlarmsOtherLimit()
	{
		...
		minDeltaValue = std::pow( (double)10, (double)-precision);
