/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/proxy_library/src/DataNodeProxy.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #6 $
  *
...
namespace TA_Base_Bus
{
    ...
    void DataNodeProxy::loadConfiguration()
    {
        ...
        try
        {
            LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "Loading configuration for DataNode [%u]", getEntityKey());
