/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/proxy_library/src/DataPointProxyManager.cpp $
  * @author:  Ripple
  * @version: $Revision: #4 $
  *
            ...
            case TA_Base_Bus::CompleteDynamicSyncStateUpdate:
                {
                    ...
                    if (isAlreadyConfigValid)
                    {
						proxy->queueNotification(AgentConnected); //zhiqiang++TD_20597
                        proxy->queueNotification(ValueStateUpdate);
