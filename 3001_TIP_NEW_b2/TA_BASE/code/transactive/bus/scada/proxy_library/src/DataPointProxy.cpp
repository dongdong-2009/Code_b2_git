/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/proxy_library/src/DataPointProxy.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #5 $
  *
...
namespace TA_Base_Bus
{
	...
	void DataPointProxy::loadConfiguration()
	{
        ...
        LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "Loading configuration for DataPoint [%u]", getEntityKey());
