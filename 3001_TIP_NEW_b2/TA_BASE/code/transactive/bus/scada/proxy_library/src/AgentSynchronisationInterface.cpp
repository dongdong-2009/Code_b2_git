/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/proxy_library/src/AgentSynchronisationInterface.cpp $
  * @author:  Ripple
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2015/07/06 18:21:21 $
...
namespace TA_Base_Bus
{
	...
	void AgentSynchronisationInterface::add(unsigned long entityKey)
	{
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "bug detect add entity %u", entityKey );
        queueRequest(item);
	}
