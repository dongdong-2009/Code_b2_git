/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/datanode_library/src/DataNode.cpp $
  * @author:  Ripple
  * @version: $Revision: #9 $
  *
...
namespace TA_Base_Bus
{
    ...
    void DataNode::processUpdateActivation()
    {
		...
		if ( !m_childProxiesCreated )
		{
			...
			SummaryRequest summaryRequest(m_staticConfig.entityKey, SummaryRequest::ReCalculateRequestFromChildren);
			m_summaryQ->queueItemUnique( summaryRequest, false);
			LOG_GENERIC( SourceInfo, DebugUtil::DebugDebug, "processUpdateActivation, key:%lu, queue item for recalculate", 
    ...
    void DataNode::updateSynState(const TA_Base_Bus::DnSyncUpdate& toupdate)
    {
		...
		case DnCombinedInhibitMMSUpdate:
			m_dynamicState.combinedInhibitMMSState = toupdate.combinedInhibitMMSState;
			break;
        case DnNotesUpdate:
