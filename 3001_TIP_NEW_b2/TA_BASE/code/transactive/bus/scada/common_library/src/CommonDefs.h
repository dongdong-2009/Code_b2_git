/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/common_library/src/CommonDefs.h $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
...
namespace TA_Base_Bus
{
    ...
    const char * const DPTALM_TRUE_SHORT	= "";
    const char * const DPTALM_FALSE			= "False Alarm";
    const char * const DPTALM_FALSE_SHORT	= "";
    const char * const DPTALM_GENERAL		= "DataPointAlarm";
    const char * const DPTALM_GENERAL_SHORT	= "";
    const char * const DPTALM_UNKNWN		= "DataPointUnknownAlarm";
    const char * const DPTALM_UNKNWN_SHORT	= "";
