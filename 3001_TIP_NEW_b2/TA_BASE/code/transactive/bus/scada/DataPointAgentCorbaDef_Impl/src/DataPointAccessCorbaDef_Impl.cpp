/**
  ...
  * in any form.
  *
  * Source : $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/DataPointAgentCorbaDef_Impl/src/DataPointAccessCorbaDef_Impl.cpp $
  * @author  HoaVu
  * @version $Revision: #4 $
...
namespace TA_Base_Bus
{
    ...
    {
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "registerMonitorAgentForStateUpdate uniqueId[%s]", uniqueId );
        ...
        LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to registerMonitorAgentForStateUpdate uniqueId[%s]", uniqueId );
    }
	...
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "setAlarmProperty dpkey[%d], session[%s]", dpKey, sessionId);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to setAlarmProperty dpkey[%d]", dpKey);
	}
	...
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "writeDataPointValue dpkey[%d], session[%s]", dpKey, sessionId);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to writeDataPointValue dpkey[%d]", dpKey);
	}

	void DataPointAccessCorbaDef_Impl::writeDataPointValueWithoutLoggingEvent(CORBA::ULong dpKey, const char* sessionId,
		const ScadaCorbaTypes::UTag& value, CORBA::ULong triggeringEntity, const char* triggeringEntityValue)
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "writeDataPointValueWithoutLoggingEvent dpkey[%d], session[%s]", dpKey, sessionId);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to writeDataPointValueWithoutLoggingEvent dpkey[%d]", dpKey);
	}

	void DataPointAccessCorbaDef_Impl::setOverride(CORBA::ULong dpKey, 
		const char* sessionId, const ScadaCorbaTypes::UTag& value)
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "setOverride dpkey[%d], session[%s]", dpKey, sessionId);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to setOverride dpkey[%d]", dpKey);
	}

	void DataPointAccessCorbaDef_Impl::removeOverride(CORBA::ULong dpKey, const char* sessionId)
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "removeOverride dpkey[%d], session[%s]", dpKey, sessionId);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to removeOverride dpkey[%d]", dpKey);
	}
	...
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "setMeterCorrectionValue dpkey[%d], session[%s], value[%f]", dpKey, sessionId, correctionValue);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to setMeterCorrectionValue dpkey[%d]", dpKey);
	}
	...
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "setInputInhibitState dpkey[%d], session[%s], state[%d]", dpKey, sessionId, inhibit);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to setInputInhibitState dpkey[%d]", dpKey);	
	}
	...
	{
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "setOutputInhibitState dpkey[%d], session[%s], state[%d]", dpKey, sessionId, inhibit);
		...
		LOG_GENERIC( SourceInfo, DebugUtil::DebugInfo, "finished to setOutputInhibitState dpkey[%d]", dpKey);
	}
