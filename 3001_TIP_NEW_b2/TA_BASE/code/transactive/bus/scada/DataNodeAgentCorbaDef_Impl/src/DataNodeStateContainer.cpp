/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/scada/DataNodeAgentCorbaDef_Impl/src/DataNodeStateContainer.cpp $
  * @author:  Ripple
  * @version: $Revision: #7 $
  *
  * Last modification: $DateTime: 2016/12/05 17:36:17 $
...
namespace TA_Base_Bus
{
		...
		const TA_Base_Bus::DataNodeCorbaTypes::DataNodeDisplayState & updateDetails )
    {
		...
		*dpUpdate = updateDetails;
        ...
        std::map < unsigned long, DataNodeDisplayClient * >::iterator itr = m_listOfDataNodeClients.end();
