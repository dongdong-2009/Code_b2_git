/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/duty_monitor_framework/src/DutyDataStoreSingleton.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #3 $
  *
...
void DutyDataStoreSingleton::populate(bool ignoreSystemOperators, bool ignoreAppSubsystems,bool ignoreOtherSesSubDuties /*= true*/)
{
	...
	else
	{
   	...
   	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, end DutyAgentAccess().getDutyState");
 
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, begin m_regionDutyMatrix.populate");
    m_regionDutyMatrix.populate(regionDuties);
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, end m_regionDutyMatrix.populate");

	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, begin m_subsystemDutyMatrix.populate");
	m_subsystemDutyMatrix.populate(subsystemStates,subsystemDuties);
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, end m_subsystemDutyMatrix.populate");

	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, begin m_defRegionAssignmentMatrix.populate");
    m_defRegionAssignmentMatrix.populate();
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, end m_defRegionAssignmentMatrix.populate");
	
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, end DutyDataStoreSingleton::populate");
    FUNCTION_EXIT;
}
...
void DutyDataStoreSingleton::populateStaticData()
{
	...
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"DutyDataStoreSingleton::populateStaticData begin");

    m_regionDutyMatrix.populateStaticData();

	m_subsystemDutyMatrix.populateStaticData();
	
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"DutyDataStoreSingleton::populateStaticData end");
	FUNCTION_EXIT;
}
...
void DutyDataStoreSingleton::populateDynamicData()
{
	...
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"DutyDataStoreSingleton::populateDynamicData begin");
	...
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, DutyAgentAccess().getDutyState end");
	
	m_regionDutyMatrix.populateDynamicData(regionDuties);
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, m_regionDutyMatrix.populateDynamicData end");
	
	m_subsystemDutyMatrix.populateDynamicData(subsystemStates,subsystemDuties);
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, m_subsystemDutyMatrix.populateDynamicData end");
	
	m_defRegionAssignmentMatrix.populate();
	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"[CL-21875] in DutyDataStoreSingleton::populate, m_defRegionAssignmentMatrix.populate end");

	LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,"DutyDataStoreSingleton::populateDynamicData end");
	FUNCTION_EXIT;
}
