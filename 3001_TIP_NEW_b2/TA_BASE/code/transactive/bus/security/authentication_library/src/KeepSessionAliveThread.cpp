/**
  ...
  *
  * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/authentication_library/src/KeepSessionAliveThread.cpp $
  * @author:   Anita Lee
  * @version:  $Revision: #7 $
  *
  * Last modification: $DateTime: 2012/09/06 14:28:23 $
