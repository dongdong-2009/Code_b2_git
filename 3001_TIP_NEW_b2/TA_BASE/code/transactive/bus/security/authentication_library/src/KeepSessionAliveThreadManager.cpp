/**
  ...
  *
  * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/authentication_library/src/KeepSessionAliveThreadManager.cpp $
  * @author:   Anita Lee
  * @version:  $Revision: #5 $
  *
  * Last modification: $DateTime: 2012/06/20 14:53:49 $
