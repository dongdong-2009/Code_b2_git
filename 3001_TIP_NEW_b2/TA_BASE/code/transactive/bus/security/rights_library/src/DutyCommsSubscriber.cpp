 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/rights_library/src/DutyCommsSubscriber.cpp $
 * @author:   Nick Jardine
 * @version:  $Revision: #5 $
 *
 * Last modification: $DateTime: 2016/01/14 10:19:14 $
