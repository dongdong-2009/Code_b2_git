...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/security_utilities/src/ISessionUpdateObserver.h $
  * @author:  Gregg Kirkpatrick
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2012/06/11 16:45:58 $
...
namespace TA_Base_Bus
{
	...
	//private:
	//	ISessionUpdateObserver(const ISessionUpdateObserver& sessionUpdateObserver);
	};
}
