 ...
 * 
 * Source:    $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/rights_agent/xacml_factory/src/XacmlFactoryInternal.h $
 * @author:   Gregg Kirkpatrick
 * @version:  $Revision: #5 $
 *
 * Last modification: $DateTime: 2012/03/26 17:13:42 $
