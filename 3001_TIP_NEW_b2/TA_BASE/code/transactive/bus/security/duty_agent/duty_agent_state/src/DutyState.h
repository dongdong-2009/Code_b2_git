/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/duty_agent/duty_agent_state/src/DutyState.h $
...
namespace TA_Base_Bus
{
	...
	public:
		...
		//print duty map with Subsystem name and profile name
