/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/security/duty_agent/duty_agent_state/src/DutyPolicyFactory.cpp $
  *  @author:  Gregg Kirkpatrick
  *  @version: $Revision: #4 $
  *
  *  Last modification: $DateTime: 2013/07/22 13:43:07 $
...
namespace TA_Base_Bus
{
	...
	const IDutyPolicy::POLICY_RESULT DutyPolicyFactoryImpl::RailDutyPolicy::m_allocRegionPolicy[2][3][3] = {
		...
		----------------------------------------------*/
		/*PT_CENTRAL*/ {/*EQ_EQ */ {/*EQ_EQ */ IDutyPolicy::PR_ADD,
