/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/response_plans/plan_agent/src/PlanAgentLibrary.h $
  * @author:  Ripple
  * @version: $Revision: #9 $
  *
...
namespace TA_Base_Bus
{
    ...
    public:
        ...
        void processPopupMftMessageStepResponse(const TA_Base_Core::CurrentPlanStepDetail& currentStepDetail, TA_Base_Core::EPlanStepCompletionStatus status);
