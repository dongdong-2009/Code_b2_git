/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/response_plans/active_plans_display/src/AutonomousPlanActiveInstanceListCtrl.cpp $
  * @author:  Rob Young
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2013/06/24 10:58:28 $
