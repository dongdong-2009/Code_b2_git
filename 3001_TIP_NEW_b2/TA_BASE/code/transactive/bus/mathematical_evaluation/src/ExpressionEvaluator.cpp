/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/mathematical_evaluation/src/ExpressionEvaluator.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #7 $
  *
  * Last modification: $DateTime: 2014/04/28 10:02:15 $
