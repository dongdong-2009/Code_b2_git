 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/database_status_monitor/src/SimpleDbStatusChecker.h $
 * @author:  J.Chevalley
 * @version: $Revision: #4 $
 *
 * Last modification: $DateTime: 2013/10/03 16:17:23 $
