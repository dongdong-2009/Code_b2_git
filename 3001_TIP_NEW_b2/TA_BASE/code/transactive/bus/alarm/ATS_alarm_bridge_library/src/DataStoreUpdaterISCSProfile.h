...
{
	class DataStoreUpdaterISCSProfile  :public DataStoreUpdater<std::string , I_ATS_ISCS_ALARM::ISCSProfileInfo,ISCSProfileManager>
	{
	public:

		virtual ~DataStoreUpdaterISCSProfile();
		void Initialize(std::vector< boost::shared_ptr<I_ATS_ISCS_ALARM::ISCSProfileInfo> >& batch);
