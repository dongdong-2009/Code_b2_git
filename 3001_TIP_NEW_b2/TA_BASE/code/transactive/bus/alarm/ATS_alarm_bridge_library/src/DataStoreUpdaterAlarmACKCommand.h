...
{
	class DataStoreUpdaterAlarmACKCommand  :public DataStoreUpdater<unsigned long, I_ATS_ISCS_ALARM::AlarmACKCommand,AlarmACKCommandManager>
	{
	public:
		
		virtual ~DataStoreUpdaterAlarmACKCommand();
		void Initialize(std::vector< boost::shared_ptr<I_ATS_ISCS_ALARM::AlarmACKCommand> >& batch);
