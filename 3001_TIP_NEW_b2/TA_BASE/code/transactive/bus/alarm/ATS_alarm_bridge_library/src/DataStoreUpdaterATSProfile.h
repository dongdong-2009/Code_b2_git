...
#if !defined(AFX_DataStoreUpdatereATSProfile1_H__6199400B_C677_42D0_B3EF_1CD13328F051__INCLUDED_)
#define AFX_DataStoreUpdatereATSProfile1_H__6199400B_C677_42D0_B3EF_1CD13328F051__INCLUDED_
...
{
	class DataStoreUpdaterATSProfile  :public DataStoreUpdater<std::string , I_ATS_ISCS_ALARM::ATSProfileInfo,ATSProfileManager>
	{
	public:

		virtual ~DataStoreUpdaterATSProfile();
		void Initialize(std::vector< boost::shared_ptr<I_ATS_ISCS_ALARM::ATSProfileInfo> >& batch);
