...
{
	class ISCSProfileManager : public CacheDataManager<unsigned long, I_ATS_ISCS_ALARM::ISCSProfileInfo>
	{
	public:
...
// 		virtual unsigned long getCacheDataKey(ISCSProfileInfo* cacheData);
		virtual bool writeCacheDataToMem(I_ATS_ISCS_ALARM::ISCSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos);
		virtual bool readCacheDataFromMem(I_ATS_ISCS_ALARM::ISCSProfileInfo* cacheData,ShareMemoryHelper* mem, char* pos);
