...
namespace TA_Base_Bus
{
	...
	class DataStoreReceiverISCSProfile   : public DataStoreReceiver<unsigned long, I_ATS_ISCS_ALARM::ISCSProfileInfo, ISCSProfileManager>
	{
	public:
		...
		boost::shared_ptr<I_ATS_ISCS_ALARM::ISCSProfileInfo> getProfileWithoutLock();
		boost::shared_ptr<I_ATS_ISCS_ALARM::ISCSProfileInfo> getProfile();
