...
{
	class DataStoreUpdaterMMSJobCommand  :public DataStoreUpdater<std::string , I_ATS_ISCS_ALARM::AlarmMmsJobCommand,AlarmMMSJobCommandManager>
	{
	public:

		virtual ~DataStoreUpdaterMMSJobCommand();
		void Initialize(std::vector< boost::shared_ptr<I_ATS_ISCS_ALARM::AlarmMmsJobCommand> >& batch);
