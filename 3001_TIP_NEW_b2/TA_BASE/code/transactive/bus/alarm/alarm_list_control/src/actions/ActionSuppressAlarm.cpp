 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionSuppressAlarm.cpp $
 * @author:  Anita Lee
 * @version: $Revision: #2 $
 *
...
namespace TA_Base_Bus
{
    ...
    bool ActionSuppressAlarm::isAvailable(IAlarmRetriever& alarmRetriever)
    {
		...
		//ATS Alarm check
		if (alarmRetriever.getNumberAttr(selectedAlarms[0], IS_ATS_ALARM))
		{
			FUNCTION_EXIT;
			return false;
		}
