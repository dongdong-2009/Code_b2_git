 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedInspector.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
 * Last modification: $DateTime: 2012/03/27 13:48:44 $
...
namespace TA_Base_Bus
{
    ...
    void ActionRelatedInspector::performAction(IAlarmRetriever& alarmRetriever)
    {
		...
		if(true == alarmDetail->isATSAlarm)
		{
