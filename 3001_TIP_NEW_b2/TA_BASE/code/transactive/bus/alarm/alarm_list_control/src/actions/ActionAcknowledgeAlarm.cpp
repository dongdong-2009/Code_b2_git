 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionAcknowledgeAlarm.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #4 $
 *
 * Last modification: $DateTime: 2013/12/12 13:49:33 $
...
// 		try
// 		{
// 			//DataStoreUpdaterAlarmACKCommand::getInstance()->Initialize(selectedATSACKAlarm);
// 			if (selectedATSACKAlarm.size()>0) 
// 			{
// 				
// 				
// 				DataStoreUpdaterAlarmACKCommand::getInstance()->onDispatchObjects(selectedATSACKAlarm);
// 			}
// 		}
// 		catch( const TA_Base_Core::NoAlarmAgentException& )
// 		{
// 			LOG_EXCEPTION_CATCH(SourceInfo, "NoAlarmAgentException", "ATS Could not acknowledge some or all of the alarms");
// 			wasSuccessful = false;
// 		}
