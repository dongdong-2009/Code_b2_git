 ...
 * in any form.
 *
 * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionJobRequest.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #4 $
 *
 * Last modification: $DateTime: 2012/09/17 16:34:37 $
...
namespace TA_Base_Bus
{
    ...
    void ActionJobRequest::performAction(IAlarmRetriever& alarmRetriever)
    {
		...
		commandLine << alarm->isATSAlarm?1:0;
