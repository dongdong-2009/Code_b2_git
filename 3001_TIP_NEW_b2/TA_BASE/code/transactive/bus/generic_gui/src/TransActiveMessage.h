...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/generic_gui/src/TransActiveMessage.h $
  * @author:  Brett Zimmerman
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2013/10/24 13:47:39 $
...
private:
	...
	*/
	...
	bool LoadString( CString &sMessage, UINT uiMessageID ) 
	{
...
private:
    ...
    */
    ...
    static std::vector<HWND> s_popupHWnd;
};
