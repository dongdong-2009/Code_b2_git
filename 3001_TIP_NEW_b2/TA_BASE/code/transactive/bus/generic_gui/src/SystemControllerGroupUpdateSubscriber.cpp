/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/generic_gui/src/SystemControllerGroupUpdateSubscriber.cpp $
  * @author:  Anita Lee
  * @version: $Revision: #3 $
  *
  * Last modification: $DateTime: 2013/10/24 17:16:18 $
