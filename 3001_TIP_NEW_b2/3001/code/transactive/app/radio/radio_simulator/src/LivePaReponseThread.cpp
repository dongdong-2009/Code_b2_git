...
namespace TA_IRS_App
{
    ...
    LivePaReponseThread::LivePaReponseThread(LivePaReponseThread::LiveRespThreadId annId, RadioCommsObserver* radioCommsObserver, const std::vector<unsigned char> resp)
    {
        TA_ASSERT(NULL != radioCommsObserver, "radioCommsObserver is NULL");
        m_threadId = annId;
