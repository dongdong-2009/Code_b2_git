 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui/src/RadioStatusPage/ResourceButton/EmptyButtonStrategy.h $
...
class EmptyButtonStrategy : public IResourceButtonStrategy
{
	...
	private:
		...
		void validateTextForButton (CString & strAliasFilter);
};
#endif