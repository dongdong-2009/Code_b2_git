 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui/src/RadioStatusPage/ResourceButton/IResourceButtonStrategy.h $
...
class IResourceButtonStrategy : public TA_Base_Bus::IDecoratorButtonBehaviourStrategy
{
	...
	public:
		...
		virtual void cancelCurrentOperation(ApiState state) = 0;
