 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui/src/RadioManagerFramework.cpp $
 * @author:  Glen Kidd
 * @version: $Revision: #2 $
 *
...
UINT RadioManagerFramework::WM_RELAUNCH_RADIO_MANAGER = RegisterWindowMessage("RadioManagerRelaunch");
...
/*TD18626, jianghp
	...
	CWnd *pWndPrev;
	if ( (pWndPrev = CWnd::FindWindow(NULL,_T("Radio Manager"))))  
	{
		CWnd * pWndChild = pWndPrev->GetLastActivePopup();
		pWndPrev->SendMessage(WM_RELAUNCH_RADIO_MANAGER,0,0);
