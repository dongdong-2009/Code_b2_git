 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui/src/RadioCallstackPage/CCallStackPage.h $
 * @author:  Glen Kidd
 * @version: $Revision: #2 $
 *
...
class CCallStackPage : public CPropertyPage
{
	...
	protected:
		...
		afx_msg LRESULT onNotifiedResourceRemove(WPARAM pResource = 0, LPARAM lParam = 0);
		afx_msg LRESULT onNotifiedPrivateCallRejected(WPARAM pResource = 0, LPARAM lParam = 0);
