 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui/src/RadioSelectedEntity/SelectedEntityOperations/EntityOperationsAreaStrategyFactory.cpp $
 * @author:  F. Stuart
 * @version: $Revision: #2 $
 *
...
#include "app/radio/radio_manager_gui/src/RadioSelectedEntity/SelectedEntityOperations/DynamicRegroupEntityOperationsAreaStrategy.h"

#include "app/radio/radio_manager_gui/src/RadioSelectedEntity/SelectedEntityOperations/EmptyEntityOperationsAreaStrategy.h"
...
#include "app/radio/radio_manager_gui/src/RadioSelectedEntity/SelectedEntityOperations/PatchGroupEntityOperationsAreaStrategy.h"

#include "app/radio/radio_manager_gui/src/RadioSelectedEntity/SelectedEntityOperations/RadioEntityOperationsAreaStrategy.h"
...
IEntityOperationsAreaStrategy* EntityOperationsAreaStrategyFactory::getEntityOperationsAreaStrategy(RadioResourceType type)
{
	...
	switch(type)
	{
		...
		case RR_TRAIN:
		{
			TrainEntityOperationsAreaStrategy* pTrainStrategy = new TrainEntityOperationsAreaStrategy();
			pEntityOperationsAreaStrategy = pTrainStrategy;
			break;
		}
		default:
		{
