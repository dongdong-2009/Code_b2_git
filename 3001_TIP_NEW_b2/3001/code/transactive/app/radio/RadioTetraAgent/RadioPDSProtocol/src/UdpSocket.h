...
* 
* This module create UDP socket, perform all low level api
* call of higher level class.
*/
...
#include "app/radio/RadioTetraAgent/RadioPDSProtocol/src/ISocket.h"
...
namespace TA_Base_Core
{
	...
	private:
			...
			// Socket.
			//
			struct sockaddr_in m_socketHandle;
            ...
            mutable bool m_bIsDisconnected;
    	...
    	{
        	return( service == m_strServiceName );
    	}
