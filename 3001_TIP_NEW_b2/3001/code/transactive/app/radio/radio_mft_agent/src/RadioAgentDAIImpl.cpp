 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_mft_agent/src/RadioAgentDAIImpl.cpp $
 * @author:  Glen Kidd
 * @version: $Revision: #2 $
 *
...
RadioAgentDAIImpl::RadioAgentDAIImpl()
{
	...
	try {
		entityData = RadioMFTAgentHelper::getRadioMFTAgentEntity();
		...
		m_entityLocation = 0;
		m_entitySubsystem = 0;
		LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugError, "Database error: %s", e.what());
	}
