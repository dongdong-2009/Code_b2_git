/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui_icdv4/src/RadioErrorMsg.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
            ...
            case 10091:
                {
                    ...
                    ::SendMessage(eWnd, EM_REPLACESEL, 0, (LPARAM) sErrorMsg[lParam]);
                }
