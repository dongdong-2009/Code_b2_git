 ...
 * in any form.
 *
 * Source:   $File: //depot/4677_TIP/4677/transactive/app/radio/radio_manager_gui_icdv4/src/CtaRadioManagerSummary.h $
 * @author:  Glen Kidd
 * @version: $Revision: #2 $
 *
...
#include "app/radio/radio_manager_gui_icdv4/src/ItaRadioManagerSummary.h"
							   ...
							   public virtual ItaRadioManagerSummary						 
{
	...
	private:
		...
		ServerRadioAgentMessageSubscriber* m_ServerRadioAgentMessageSubscriber;
