/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/PAAtsTriggeredBroadcastDatabaseAccessor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2013/10/30 13:46:48 $
...
namespace TA_IRS_App
{
    ...
    void PaAtsTriggeredBroadcastDatabaseAccessor::refreshCachedMaps()
    {
        ...
        {
            delete m_stationDvaMessageCachedMap;
            m_stationDvaMessageCachedMap = NULL;
        }
        ...
        if ( NULL != m_dvaVersionCachedMap )
        {
            delete m_dvaVersionCachedMap;
            m_dvaVersionCachedMap = NULL;
        }
        ...
        m_eventTypes[TA_IRS_Bus::IAtsPasCorbaDef::PreDeparture] = "Creep";
        ...
        m_eventTypes[TA_IRS_Bus::IAtsPasCorbaDef::TrainNotBoard] = "Train Not Board";
    ...
    PaAtsTriggeredBroadcastDatabaseAccessor::getDvaMessageDataForSelection(unsigned long locationKeyFilter) const
    {
        ...
        PaStationDvaMessageCachedMap::FilterStationDvaMessageIdRange filter(locationKeyFilter, 1, 999);
                ...
                itr ++)
        {
            ...
            vec.push_back(getLocationName(itr->ulLocationKey));
            vec.push_back(getDvaMsgTypeString(itr->usMsgType));
    ...
    std::string PaAtsTriggeredBroadcastDatabaseAccessor::getDvaMsgTypeString(const unsigned short type) const
    {
    ...
    std::string PaAtsTriggeredBroadcastDatabaseAccessor::getLatestVersionForMessage(unsigned long stationDvaMessagePrimaryKey)
    {
        ...
        try
        {
            StationDvaMessageRecord message = m_stationDvaMessageCachedMap->getCachedDbRecordFromKey(stationDvaMessagePrimaryKey);
             DvaVersionRecord versionRecord = m_dvaVersionCachedMap->getRecordFromLocation(message.ulLocationKey);
