/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/pa_ats_triggered_broadcast/src/PAAtsTriggeredBroadcastListColumns.cpp $
  * @author Jade Lee
  * @version $Revision: #3 $
  *
  * Last modification: $DateTime: 2013/09/05 10:26:45 $
