/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/pa_zone/src/PAZoneListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
  ...
  * 
  * This view contains a list of all PA Zones available to be configured. This view must
  * communicate with the PaZoneDetailView as this will show the details of the item selected in this view.
  */

#if !defined(AFX_PaZoneListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
#define AFX_PaZoneListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_

#include <afxcview.h>
#include <string>

#include "app/configuration/config_plugins/pa_zone/src/PaZoneListColumns.h"
...
{
    class PaZoneListView : public TA_Base_App::AbstractListView
    {
    protected:
        /**
         * Constructor
	    ...
	    virtual ~PaZoneListView();

	    DECLARE_DYNCREATE(PaZoneListView)
    ...
    public:
        ...
        void itemStatusUpdate(unsigned long id, const CString& status);
        
        // Overrides
	    // ClassWizard generated virtual function overrides
	    //{{AFX_VIRTUAL(PaZoneListView)
	    public:
    ...
    private:
	   ...
	   */
        ...
        *                 m_actions vector
        * @param LPARAM - This is a pointer to this object. ie the PaZoneListView object.
        */
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
        ...
        // sort the columns.
        std::map<unsigned long,PaZoneDatabaseAccessor::PaZoneRecord> m_currentDisplayedItems;

        PaZoneListColumns m_columnHelper;
    };
...
#endif // !defined(AFX_PaZoneListView_H__D8199CFB_594F_4ED1_9A1E_632168E5BF11__INCLUDED_)
