/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/tr_train/src/TrTrainFrameworkView.h $
  * @author:  Lucky Cuizon
  * @version: $Revision: #1 $
  *
  ...
  * 
  * This view contains a splitter. It then loads the top of the splitter as a list of Trains
  * and the bottom as a view for the user to configure a single Trains details.
  */


#if !defined(AFX_TrTrainFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
#define AFX_TrTrainFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_
...
namespace TA_IRS_App
{
    ...
    class TrTrainFrameworkView : public TA_Base_App::AbstractFrameworkView
    {
    protected:
        /**
         * Constructor
         ...
         */
	    TrTrainFrameworkView();

	    DECLARE_DYNCREATE(TrTrainFrameworkView)
    ...
    // Overrides
	    ...
	    //{{AFX_VIRTUAL(TrTrainFrameworkView)
	    //}}AFX_VIRTUAL
...
#endif // !defined(AFX_TrTrainFrameworkView_H__1332EF35_428C_4AA3_8B05_008BBA40FA97__INCLUDED_)
