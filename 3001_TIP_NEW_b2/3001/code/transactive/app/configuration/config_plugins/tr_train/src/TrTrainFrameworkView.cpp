/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/tr_train/src/TrTrainFrameworkView.cpp $
  * @author:  Lucky Cuizon
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    const int TrTrainFrameworkView::TOP_PANE      = 0;
    const int TrTrainFrameworkView::BOTTOM_PANE   = 1;
    const int TrTrainFrameworkView::ZERO_COLUMN   = 0;

    const int TrTrainFrameworkView::TOP_PANE_SIZE = 200;

    IMPLEMENT_DYNCREATE(TrTrainFrameworkView, CView)


    TrTrainFrameworkView::TrTrainFrameworkView()
    {
    }
...
BEGIN_MESSAGE_MAP(TrTrainFrameworkView, AbstractFrameworkView)
	//{{AFX_MSG_MAP(TrTrainFrameworkView)
	ON_WM_SIZE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

    
    BOOL TrTrainFrameworkView::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
    {
    ...
    void TrTrainFrameworkView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    CRuntimeClass* TrTrainFrameworkView::getRuntimeClassForDetailView()
    {
        return RUNTIME_CLASS(TrTrainDetailView);
    }


    CRuntimeClass* TrTrainFrameworkView::getRuntimeClassForListView()
    {
        return RUNTIME_CLASS(TrTrainListView);
    }

    
    /////////////////////////////////////////////////////////////////////////////
    // TrTrainFrameworkView diagnostics

    #ifdef _DEBUG
    void TrTrainFrameworkView::AssertValid() const
    {
	    AbstractFrameworkView::AssertValid();
    }

    void TrTrainFrameworkView::Dump(CDumpContext& dc) const
    {
