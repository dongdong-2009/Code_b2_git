/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/ecs_station_mode/src/ECSStationModeListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
  ...
  * 
  * This view contains a list of all ECS Station Modes available to be configured. This view must communicate
  * with the ECSStationModeDetailView as this will show the details of the item selected in this view.
  */
...
typedef TA_IRS_App::ECSStationModeDatabaseAccessor::ECSStationModeRecord ECSStationModeRecord;

using  namespace TA_Base_App::TA_Configuration;

namespace TA_IRS_App
{
    const int ECSStationModeListView::APPLIED_COLUMN                = 0;
    const int ECSStationModeListView::KEY_COLUMN                    = 1;
    const int ECSStationModeListView::STATION_MODE_COLUMN           = 2;
    const int ECSStationModeListView::LOCATION_COLUMN               = 3;
    const int ECSStationModeListView::OPERATION_COLUMN              = 4;
    const int ECSStationModeListView::TRACK_COLUMN                  = 5;
    const int ECSStationModeListView::CONDITION_COLUMN              = 6;
    const int ECSStationModeListView::CONGESTION_COLUMN             = 7;

    const CString ECSStationModeListView::APPLIED_COLUMN_NAME       = "Status";
    const CString ECSStationModeListView::KEY_COLUMN_NAME           = "Key";
    const CString ECSStationModeListView::STATION_MODE_COLUMN_NAME  = "Station Mode";
    const CString ECSStationModeListView::LOCATION_COLUMN_NAME      = "Location";
    const CString ECSStationModeListView::OPERATION_COLUMN_NAME     = "Operation";
    const CString ECSStationModeListView::TRACK_COLUMN_NAME         = "Track";
    const CString ECSStationModeListView::CONDITION_COLUMN_NAME     = "Operating Condition";
    const CString ECSStationModeListView::CONGESTION_COLUMN_NAME     = "Congestion Logic";

    const int ECSStationModeListView::APPLIED_COLUMN_WIDTH          = 60;
    const int ECSStationModeListView::KEY_COLUMN_WIDTH              = 70;
    const int ECSStationModeListView::STATION_MODE_COLUMN_WIDTH     = 80;
    const int ECSStationModeListView::LOCATION_COLUMN_WIDTH         = 80;
    const int ECSStationModeListView::OPERATION_COLUMN_WIDTH        = 150;
    const int ECSStationModeListView::TRACK_COLUMN_WIDTH            = 150;
    const int ECSStationModeListView::CONDITION_COLUMN_WIDTH        = 150;
    const int ECSStationModeListView::CONGESTION_COLUMN_WIDTH       = 300;


    // These are the possible values for the status of each ECS Station Mode
    const CString ECSStationModeListView::NEW = "New";
    const CString ECSStationModeListView::MODIFIED = "Modified";
    const CString ECSStationModeListView::UPTODATE = "";

    const bool ECSStationModeListView::ASCENDING = true;
    const bool ECSStationModeListView::DESCENDING = false;

    IMPLEMENT_DYNCREATE(ECSStationModeListView, CListView)


    ECSStationModeListView::ECSStationModeListView()
    ...
    {
        m_componentIcon = LoadIcon(GetModuleHandle(ECSStationModeComponent::DLL_NAME), MAKEINTRESOURCE(IDI_CONFIG_ECS_STATION_MODES) );
    }
...
BEGIN_MESSAGE_MAP(ECSStationModeListView, AbstractListView)
	//{{AFX_MSG_MAP(ECSStationModeListView)
	ON_WM_CREATE()
    ON_WM_SIZE()
...
END_MESSAGE_MAP()
    ...
    int ECSStationModeListView::OnCreate(LPCREATESTRUCT lpCreateStruct) 
    {
    ...
    void ECSStationModeListView::OnInitialUpdate() 
    {
        ...
        GetListCtrl().InsertColumn( STATION_MODE_COLUMN,         STATION_MODE_COLUMN_NAME,         LVCFMT_LEFT, STATION_MODE_COLUMN_WIDTH  );
        GetListCtrl().InsertColumn( LOCATION_COLUMN,             LOCATION_COLUMN_NAME,             LVCFMT_LEFT, LOCATION_COLUMN_WIDTH      );
        GetListCtrl().InsertColumn( OPERATION_COLUMN,            OPERATION_COLUMN_NAME,            LVCFMT_LEFT, OPERATION_COLUMN_WIDTH     );
        ...
        GetListCtrl().InsertColumn( CONGESTION_COLUMN,           CONGESTION_COLUMN_NAME,           LVCFMT_LEFT, CONGESTION_COLUMN_WIDTH    );
    }


    void ECSStationModeListView::OnSize(UINT nType, int cx, int cy) 
    {
    ...
    void ECSStationModeListView::loadAllItems()
    {
        ...
        ECSStationModeDatabaseAccessor* dbAccessor = dynamic_cast<ECSStationModeDatabaseAccessor*>(getDatabaseAccessor());
        TA_ASSERT( dbAccessor != NULL, "DB accessor could not be cast to an ECS Station Mode one");
        ...
        for (std::map<unsigned long,ECSStationModeRecord>::iterator iter = m_currentDisplayedItems.begin(); 
             iter != m_currentDisplayedItems.end(); ++iter)
        {
            ...
            GetListCtrl().SetItemText(position, STATION_MODE_COLUMN,  iter->second.stationMode);
            GetListCtrl().SetItemText(position, LOCATION_COLUMN,      iter->second.location);
            GetListCtrl().SetItemText(position, OPERATION_COLUMN,     iter->second.operation);
            ...
            GetListCtrl().SetItemText(position, CONGESTION_COLUMN,    iter->second.congestionLogic);
    ...
    void ECSStationModeListView::itemDetailsChanged(unsigned long id, const CString& name)
    {
        ...
        ECSStationModeRecord details = dbAccessor->getItemDetails( id );
        ...
        if (foundItemIndex != -1)
        {
            ...
            GetListCtrl().SetItemText(foundItemIndex, STATION_MODE_COLUMN,  details.stationMode);
            GetListCtrl().SetItemText(foundItemIndex, LOCATION_COLUMN,      details.location);
            GetListCtrl().SetItemText(foundItemIndex, OPERATION_COLUMN,     details.operation);
            ...
            GetListCtrl().SetItemText(foundItemIndex, CONGESTION_COLUMN,     details.congestionLogic);
        ...
        else
        {
            ...
            GetListCtrl().SetItemText(position, STATION_MODE_COLUMN,  details.stationMode);
            GetListCtrl().SetItemText(position, LOCATION_COLUMN,      details.location);
            GetListCtrl().SetItemText(position, OPERATION_COLUMN,     details.operation);
            ...
            GetListCtrl().SetItemText(position, CONGESTION_COLUMN,    details.congestionLogic);
        ...
        std::map<unsigned long,ECSStationModeRecord>::iterator matching;
        ...
        {
            m_currentDisplayedItems.insert( std::map<unsigned long,ECSStationModeRecord>::value_type(id,details) );
        }
    ...
    void ECSStationModeListView::copyItem()
    {
    ...
    void ECSStationModeListView::newItem()
    {
 ...
 /*   void ECSStationModeListView::deleteItem()
    {
    ...
    void ECSStationModeListView::onColumnclick(NMHDR* pNMHDR, LRESULT* pResult) 
    {
	...
	void ECSStationModeListView::updateHeaderSort(const unsigned int column)
	{
        ...
        headerItem.hbm = (HBITMAP)LoadImage(GetModuleHandle(ECSStationModeComponent::DLL_NAME), MAKEINTRESOURCE(resourceToLoad), IMAGE_BITMAP, 0, 0, LR_LOADMAP3DCOLORS);
    ...
    int CALLBACK ECSStationModeListView::compareItems(LPARAM index1, LPARAM index2, LPARAM listCtrl)
    {
        ECSStationModeListView* list = reinterpret_cast<ECSStationModeListView*>(listCtrl);
        // Double check it has converted ok
        list = dynamic_cast<ECSStationModeListView*>(list);
        ...
        std::map<unsigned long,ECSStationModeRecord>::iterator item1 = list->m_currentDisplayedItems.find( index1 );
        std::map<unsigned long,ECSStationModeRecord>::iterator item2 = list->m_currentDisplayedItems.find( index2 );
        ...
        switch(list->m_sortColumn)
        {
            ...
            case(STATION_MODE_COLUMN):
                    value1 = atoi((LPCTSTR)item1->second.stationMode);
                    value2 = atoi((LPCTSTR)item2->second.stationMode);
                    returnVal = value1 - value2 ;
                    break;

            case(LOCATION_COLUMN):
                    string1 = item1->second.location;
                    string2 = item2->second.location;
                    returnVal = string1.CompareNoCase(string2);
                    break;

            case(OPERATION_COLUMN):
                    string1 = item1->second.operation;
                    string2 = item2->second.operation;
                    returnVal = string1.CompareNoCase(string2);
                    break;
            ...
            case(CONGESTION_COLUMN):
                    string1 = item1->second.congestionLogic;
                    string2 = item2->second.congestionLogic;
                    returnVal = string1.CompareNoCase(string2);
                    break;
    ...
    void ECSStationModeListView::OnDraw(CDC* pDC)
    {
    ...
    /////////////////////////////////////////////////////////////////////////////
    // ECSStationModeListView diagnostics

    #ifdef _DEBUG
    void ECSStationModeListView::AssertValid() const
    {
	    AbstractListView::AssertValid();
    }

    void ECSStationModeListView::Dump(CDumpContext& dc) const
    {
