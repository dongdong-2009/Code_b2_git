/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_4669_TRAIN_ECP/CODE_4669/transactive/app/configuration/config_plugins/train_radio_groups/src/TA_TrainRadioGroupsConfigPlugin.cpp $
...
{
    static AFX_EXTENSION_MODULE TA_TrainRadioGroupsConfigPluginDll  = { NULL, NULL };
        ...
        DllMain( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
    {
        ...
        {
            TRACE0( "TA_TRAINRADIOGROUPSCONFIGPLUGIN.DLL Initializing!\n" );

            // Extension DLL one-time initialization

            if ( !AfxInitExtensionModule( TA_TrainRadioGroupsConfigPluginDll, hInstance ) )
                return 0;
            ...
            new CDynLinkLibrary( TA_TrainRadioGroupsConfigPluginDll );
        }
        else if ( dwReason == DLL_PROCESS_DETACH )
        {
            TRACE0( "TA_TRAINRADIOGROUPSCONFIGPLUGIN.DLL Terminating!\n" );
            // Terminate the library before destructors are called
            AfxTermExtensionModule( TA_TrainRadioGroupsConfigPluginDll );
        }
    ...
    /**
      ...
      *
      * @return IConfigurableComponent*  A new trainRadioComponent object which implements
    ...
    {
        return new TrainRadioGroupComponent( componentName );
    }
