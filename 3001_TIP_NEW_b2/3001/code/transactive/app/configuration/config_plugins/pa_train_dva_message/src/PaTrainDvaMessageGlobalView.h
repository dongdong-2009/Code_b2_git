/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/pa_train_dva_message/src/PaTrainDvaMessageGlobalView.h $
  * @author:  Jade Lee
  * @version: $Revision: #2 $
  *
...
namespace TA_IRS_App
{
    ...
    protected:
        ...
        afx_msg void onVersionChanged(NMHDR* pNMHDR, LRESULT* pResult);
    	//}}AFX_MSG
	    DECLARE_MESSAGE_MAP()
