/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/ecs_master_mode/src/ECSMasterModeListView.h $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
    ...
    private:
	   ...
	   */
       ...
       static int CALLBACK compareItems(LPARAM index1, LPARAM index2, LPARAM actionListCtrl);
		...
		static const int SITUATION_COLUMN;
		...
		static const CString SITUATION_COLUMN_NAME;
		...
		static const int SITUATION_COLUMN_WIDTH;
