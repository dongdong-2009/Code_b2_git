/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/ecs_master_mode/src/ECSMasterModeListView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #4 $
  *
...
namespace TA_IRS_App
{
	...
	const int ECSMasterModeListView::SITUATION_COLUMN               = 9;
	...
	const CString ECSMasterModeListView::SITUATION_COLUMN_NAME      = "Situation";
	...
	const int ECSMasterModeListView::SITUATION_COLUMN_WIDTH         = 150;
...
END_MESSAGE_MAP()
    ...
    void ECSMasterModeListView::OnInitialUpdate() 
    {
		...
		GetListCtrl().InsertColumn( SITUATION_COLUMN,   SITUATION_COLUMN_NAME,   LVCFMT_LEFT, SITUATION_COLUMN_WIDTH   );
    }
    ...
    void ECSMasterModeListView::loadAllItems()
    {
             ...
             iter != m_currentDisplayedItems.end(); ++iter)
        {
			...
			GetListCtrl().SetItemText(position, SITUATION_COLUMN,     iter->second.situation);
    ...
    void ECSMasterModeListView::itemDetailsChanged(unsigned long id, const CString& name)
    {
        ...
        if (foundItemIndex != -1)
        {
			...
			GetListCtrl().SetItemText(foundItemIndex, SITUATION_COLUMN,     details.situation);
        ...
        else
        {
			...
			GetListCtrl().SetItemText(position, SITUATION_COLUMN,     details.situation);
    ...
    int CALLBACK ECSMasterModeListView::compareItems(LPARAM index1, LPARAM index2, LPARAM listCtrl)
    {
        ...
        switch(list->m_sortColumn)
        {
            ...
            case(MESSAGE_COLUMN):
                    ...
                    returnVal = string1.CompareNoCase(string2);
					break;            
			case(SITUATION_COLUMN_WIDTH):
					string1 = item1->second.situation;
					string2 = item2->second.situation;
					returnVal = string1.CompareNoCase(string2);
					break;
