/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/configuration/config_plugins/ecs_master_mode/src/ECSMasterModeDatabaseAccessor.h $
  * @author:  Karen Graham
  * @version: $Revision: #3 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        struct ECSMasterModeRecord
        {
			...
			CString situation;          // The Situation field.
        };
