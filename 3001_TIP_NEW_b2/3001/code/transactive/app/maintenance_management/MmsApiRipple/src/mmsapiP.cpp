/**
  ...
  * 
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/app/maintenance_management/MmsApiRipple/src/mmsapiP.cpp $
...
MMSEXPORT int MMSAPI put_Q(char *q_name, char *target_q_name, 
...
MMSEXPORT int MMSAPI get_Q(char *q_name, char * msg, short len, int32 itimeout)
{
...
MMSEXPORT int MMSAPI getPendingMsgs(char *q_name)
{
...
MMSEXPORT char* MMSAPI getErrorMsg()
{
	LOG_GENERIC(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,
...
MMSEXPORT int32 MMSAPI getErrorCode()
