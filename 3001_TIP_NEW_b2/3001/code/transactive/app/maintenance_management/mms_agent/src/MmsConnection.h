/**
  ...
  * 
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/app/maintenance_management/mms_agent/src/MmsConnection.h $
...
namespace TA_IRS_App
{
  ...
  //IMmsConnectionCorbaDef methods:
	...
	//helper methods:
		...
		void submitPreventiveMessage(TA_Base_Bus::MMSMessageType::MessageType type, const char* assetId, const char* dataPointName, 
