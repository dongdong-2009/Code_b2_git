/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP/3001/transactive/app/cctv/video_display_manager/src/DisplayItemManager.h $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
#define WM_TVSS_COMMAND		(WM_USER + 120)
...
namespace TA_IRS_App
{
    ...
    public:
        ...
        TrainBorneMonitor* getMonitor(std::string name);
        TrainBorneMonitor* getMonitor(unsigned long pkey);
		//TD19471  lichao++
        ...
        std::map<std::string, TrainBorneMonitor*>     getAllMonitors();
		std::map<unsigned long, Sequence*>	getAllSequencesByKeys();
    ...
    private:
        ...
        TrainBorneMonitor* createMonitor( unsigned long key, 
                                const std::string& name,
                                const std::string& description,
 ...
 //       void processStageStateMessage( unsigned long stageKey, const TA_Base_Bus::BVSStageCorbaDef::BVSStageState& stageConfig );
        ...
        void notifyMonitorListeners(TrainBorneMonitor* modifiedItem);
        ...
        std::map<std::string, TrainBorneMonitor*> m_monitors;
        std::map<unsigned long, TrainBorneMonitor*> m_monitorsByPkey;
        //TD19471   Lichao++
