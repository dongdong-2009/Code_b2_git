/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP/3001/transactive/app/signs/ttis_manager/src/TrainDownloadManager.h $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
		...
		void cancelDownload(const TA_IRS_Bus::CommonTypes::TrainIdList& trainList);
