/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP/3001/transactive/app/signs/ttis_manager/src/DownloadTrainListCtrl.h $
  * @author Adam Radics
  * @version $Revision: #1 $
...
namespace TA_IRS_App
{
    class DownloadTrainListCtrl : public TA_IRS_Bus::TrainListCtrl,
                                  public TA_IRS_Bus::ILocationCacheObserver
    {
    public:
    ...
    private:
        ...
        virtual void onLocationCacheChange() { Invalidate(); }
