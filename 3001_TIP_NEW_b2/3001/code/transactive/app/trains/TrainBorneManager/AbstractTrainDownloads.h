/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP/3001/transactive/app/signs/ttis_manager/src/AbstractTrainDownloads.h $
  * @author:  Adam Radics
  * @version: $Revision: #1 $
  *
...
namespace TA_IRS_App
{
    ...
    protected:
         ...
         */
        virtual void notifyDownloadPending(const DownloadInformation& download);
         ...
         * @param download    The download information structure
         */
        virtual void notifyDownloadInProgress(const DownloadInformation& download);
         ...
         */
        virtual void notifyDownloadFinished(const DownloadInformation& download, bool success);
