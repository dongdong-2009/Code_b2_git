/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP/3001/transactive/app/signs/ttis_manager/src/TrainVersionManager.cpp $
  * @author:  Adam Radics
  * @version: $Revision: #2 $
  *
...
#include "app/trains/TrainBorne_PIDS/src/TisUserMessageMacroDef.h"
...
namespace TA_IRS_App
{
          ...
          m_trainVersions()
    {
		...
		runThreadedFunc(boost::bind(&TrainVersionManager::init, this));
        FUNCTION_EXIT;
    }
    ...
    void TrainVersionManager::processVersionChange(const TA_Base_Core::TrainDataVersion& versionChange)
    {
        ...
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo,
                    "Processing version update for train %d: Versions: %u %u %d %d",
                    version->trainNumber,
	...
	std::string TrainVersionManager::convertTrainVersionToStr(unsigned long version)
	{
		FUNCTION_ENTRY( "convertTrainVersionToStr" );

		unsigned long versionNumber = version;
