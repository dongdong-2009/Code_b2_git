/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP/3001/transactive/app/trains/TrainBorne_PA/src/StdAfx.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
#include "app/trains/TrainBorne_PA/src/resource.h"		// main symbols
...
typedef TA_Base_Core::NamedObject<TA_Base_Bus::ITrainPaMethod,
	   					     TA_Base_Bus::ITrainPaMethod_ptr, 
	           			     TA_Base_Bus::ITrainPaMethod_var> PAAgentNamedObject;
