/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP/3001/transactive/app/trains/TrainBorne_PA/src/GenericStatusPage.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
#include "app/trains/TrainBorne_PA/src/IWindow.h"
...
// song toan++
// TD 10316
    virtual CListCtrl& getFailuresListControl() = 0;
// ++song toan
// TD 10316
...
// song toan++
// TD 10316
    virtual CListCtrl& getProgressListControl() = 0;
// ++song toan
// TD 10316

	// TD16865
	virtual std::map<unsigned int, std::string>& getTrainIdAndServiceNumber() = 0;
	// TD16865
