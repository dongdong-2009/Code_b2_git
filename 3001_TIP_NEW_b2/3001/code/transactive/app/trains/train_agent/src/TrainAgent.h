/**
  ...
  * @version: $Revision: #3 $
  *
  * Last modification: $Date: 2015/07/24 $
...
#include "RadioAccess.h"
#include"TrainAgentServant.h"
...
namespace TA_IRS_App
{
    ...
    private:
		...
		*/
		...
		/**
	  * The servant that receives all incoming requests. Such as RadioSDS
      */
	    TrainAgentServant* m_servant;
