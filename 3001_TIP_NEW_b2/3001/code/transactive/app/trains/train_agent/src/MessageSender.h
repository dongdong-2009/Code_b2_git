...
namespace TA_IRS_App
{
    ...
    public:
		...
		*/
		...
		virtual void sendStateUpdate( unsigned long trainId,unsigned char cameraId, unsigned long monitorId  );
         ...
         * @param update    The update to send
         */
		virtual void sendClientUpdate( const TA_IRS_Bus::CallTypes::TrainChangeover& update );
