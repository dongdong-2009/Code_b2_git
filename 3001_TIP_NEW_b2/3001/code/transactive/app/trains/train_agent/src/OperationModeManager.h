 ...
 * @version: $Revision: #5 $
 *
 * Last modification: $Date: 2013/07/19 $
...
namespace TA_IRS_App
{
    ...
    public:
		...
		*/
        ...
        virtual void timerExpired(long timerId, void* userData);//limin++ CL-21120

		virtual void registerDutyReleaseUpdate (ISpecializedMsgProc * objObserver);		
    ...
    private:
		...
		*/
		...
		std::set <ISpecializedMsgProc *> m_setSpecializeMsgSubs;

		void notifySubsForReleaseControl ();
    };
