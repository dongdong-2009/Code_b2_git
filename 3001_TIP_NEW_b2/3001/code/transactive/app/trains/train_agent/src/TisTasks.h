...
namespace TA_IRS_App
{
 ...
 class CancelLibraryDownloadTask : public TA_Base_Core::IWorkItem
    {
    ...
    public:
         ...
         */
        CancelLibraryDownloadTask( ITimsTisManagerTaskCallback& callback,
                            TA_IRS_Bus::CommonTypes::TrainIdType trainId,
                            const std::string& sessionId );
         ...
         * Destructor
         */
        virtual ~CancelLibraryDownloadTask();
