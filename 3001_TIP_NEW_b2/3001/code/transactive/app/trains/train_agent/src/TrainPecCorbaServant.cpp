...
namespace TA_IRS_App
{
    ...
    void TrainPecCorbaServant::answerPec( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
                                          TA_Base_Bus::ITrainPecCorba::EPecCarNumber car,
                                          TA_Base_Bus::ITrainPecCorba::EPecNumber pec,
										  const char* sessionId, TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource )
    {
		...
		LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,
			"answerPec: TrainId=%d, car=%d, pec=%d, pecTrainSource=%d",
			static_cast<int> (trainId),
			static_cast<TA_Base_Bus::ITrainPecCorba::EPecCarNumber> ( car ),
			static_cast<TA_Base_Bus::ITrainPecCorba::EPecNumber> ( pec ),
			static_cast<TA_Base_Bus::ITrainPecCorba::EPecTrainSource> ( pecTrainSource ));


        CPP_CATCH( m_timsPecManager.answerPec( TA_IRS_Bus::CommonTypesConversion::convertToCpp( trainId ),
                                               TA_IRS_Bus::PecTypesConversion::convertToCpp( car ),
                                               TA_IRS_Bus::PecTypesConversion::convertToCpp( pec ),
											   sessionId, TA_IRS_Bus::PecTypesConversion::convertToCpp( pecTrainSource )));
										 ...
										 TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource)
    {
        ...
        CPP_CATCH( m_timsPecManager.resetPec( TA_IRS_Bus::CommonTypesConversion::convertToCpp( trainId ),
                                              ...
                                              TA_IRS_Bus::PecTypesConversion::convertToCpp( pec ),
                                              sessionId,
											  TA_IRS_Bus::PecTypesConversion::convertToCpp( pecTrainSource )));

        FUNCTION_EXIT;
    }


    void TrainPecCorbaServant::holdPec( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
                                        TA_Base_Bus::ITrainPecCorba::EPecCarNumber car,
                                        TA_Base_Bus::ITrainPecCorba::EPecNumber pec,
                                        const char* sessionId,
										TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource )
    {
        ...
        CPP_CATCH( m_timsPecManager.holdPec( TA_IRS_Bus::CommonTypesConversion::convertToCpp( trainId ),
                                             TA_IRS_Bus::PecTypesConversion::convertToCpp( car ),
                                             TA_IRS_Bus::PecTypesConversion::convertToCpp( pec ),
                                             sessionId,
											 TA_IRS_Bus::PecTypesConversion::convertToCpp( pecTrainSource )) );
	...
	void TrainPecCorbaServant::resetTerminatedPec( TA_Base_Bus::ITrainCommonCorba::TrainId trainId,
												   TA_Base_Bus::ITrainPecCorba::EPecCarNumber car,
												   TA_Base_Bus::ITrainPecCorba::EPecNumber pec,
												   const char* sessionId,
												   TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource)
	{
		FUNCTION_ENTRY("resetTerminatedPec");
		OperationModeManager::ensureControlState();
		...
		LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,
					"calling resetTerminatedPec");

		CPP_CATCH( m_timsPecManager.resetPec( TA_IRS_Bus::CommonTypesConversion::convertToCpp( trainId ),
											  TA_IRS_Bus::PecTypesConversion::convertToCpp( car ),
											  TA_IRS_Bus::PecTypesConversion::convertToCpp( pec ),
											  sessionId,
											  TA_IRS_Bus::PecTypesConversion::convertToCpp( pecTrainSource ),true));
	...
	void TrainPecCorbaServant::resetAllPecAtPecTermination( TA_Base_Bus::ITrainCommonCorba::TrainId trainId, const char* sessionId,
															TA_Base_Bus::ITrainPecCorba::EPecTrainSource pecTrainSource )
	{
		FUNCTION_ENTRY( "resetAllPec" );
		...
		LOG_GENERIC(SourceInfo,TA_Base_Core::DebugUtil::DebugInfo,
					"calling resetAllPECTermination");

		CPP_CATCH( m_timsPecManager.resetAllPec(TA_IRS_Bus::CommonTypesConversion::convertToCpp( trainId ),
												sessionId, TA_IRS_Bus::PecTypesConversion::convertToCpp( pecTrainSource ),true));
