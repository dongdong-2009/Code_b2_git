...
namespace TA_IRS_App
{
    ...
    public:
		 ...
		 * @param pecTrainSource Ther PEC Train Source
         */
        virtual void answerPec( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
								...
								const std::string& sessionId, TA_IRS_Bus::PecTypes::EPecTrainSource pecTrainSource ) = 0;
        ...
        virtual void holdPec( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
                               ...
                               TA_IRS_Bus::ProtocolPecTypes::EPecNumber pec,
                               const std::string& sessionId,
							   TA_IRS_Bus::PecTypes::EPecTrainSource pecTrainSource ) = 0;
