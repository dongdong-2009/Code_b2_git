...
namespace TA_IRS_App
{
    ...
    public:
        ...
        virtual void answerPec( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
								...
								const std::string& sessionId, TA_IRS_Bus::PecTypes::EPecTrainSource pecSource );
        ...
        virtual void resetAllPec( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
                                  const std::string& sessionId,
								  TA_IRS_Bus::PecTypes::EPecTrainSource pecTrainSource,bool bIsTerminated = false );
		 ...
		 * @param pecTrainSource The PEC Train Source
         */
        virtual void holdPec( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
                               TA_IRS_Bus::ProtocolPecTypes::EPecCarNumber car,
                               TA_IRS_Bus::ProtocolPecTypes::EPecNumber pec,
                               const std::string& sessionId,
							   TA_IRS_Bus::PecTypes::EPecTrainSource pecTrainSource );
		...
		virtual void processReleaseOfCtrl( );
    ...
    private:
		...
		/*
		* check whether the pec is answer by operator
		*/
		bool isAnswerByOperator ( TA_IRS_Bus::CommonTypes::TrainIdType trainId,
			TA_IRS_Bus::ProtocolPecTypes::EPecCarNumber car,
			TA_IRS_Bus::ProtocolPecTypes::EPecNumber pec,
			const std::string& sessionId ) ;
        ...
        */
        ...
        typedef std::map< std::pair< TA_IRS_Bus::ProtocolPecTypes::EPecCarNumber, TA_IRS_Bus::ProtocolPecTypes::EPecNumber >, TA_IRS_Bus::ProtocolCctvTypes::ECctvCamera > CarPec2CameraMapType;
        CarPec2CameraMapType m_CarPpec2CameraMap;
        void initCarPec2CameraMap();

        TA_Base_Core::NamedObject < TA_Base_Bus::TVSSManagerCorbaDef,
            TA_Base_Bus::TVSSManagerCorbaDef_ptr,
            TA_Base_Bus::TVSSManagerCorbaDef_var > m_tvssManagerNamedObject;
			
       void initTvssManagerNamedObject();

        typedef std::map<unsigned long, long> Console2MonitorMapType;
        Console2MonitorMapType m_Console2MonitorMap;
        void initConsole2MonitorMap();
        long getMonitorIdFromSession( const std::string& sessionId );
		
	private:
		
		void resetInvalidPec (TA_IRS_Bus::CommonTypes::TrainIdType trainId,
