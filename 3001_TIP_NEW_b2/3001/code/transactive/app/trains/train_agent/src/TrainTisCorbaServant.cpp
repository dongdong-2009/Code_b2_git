...
namespace TA_IRS_App
{
	...
	void TrainTisCorbaServant::cancelLibraryDownload( const TA_Base_Bus::ITrainCommonCorba::TrainList& trains, 
													  const char* sessionId)
	{
		...
		CPP_CATCH( m_timsTisManager.cancelLibraryDownload( TA_IRS_Bus::CommonTypesConversion::convertToCpp(trains),
														    sessionId ) );
