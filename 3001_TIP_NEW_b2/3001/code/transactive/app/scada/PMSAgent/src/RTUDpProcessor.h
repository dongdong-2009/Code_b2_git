/**
  ...
  * any form.
  *
  * Source:		$File: //depot/3001_TIP_NEW/3001/transactive/app/scada/PMSAgent/src/RTUDpProcessor.h $
  * @author:	HoaVu
  * @version:	$Revision: #4 $
  *
  * Last modification:	$DateTime: 2014/08/07 15:18:30 $
...
namespace TA_IRS_App
{
	...
	public:
		...
		*
		*/
		virtual int getStatusWordNumber() const
		{
			return m_statusWordNumber;
		}
    ...
    protected:
		...
		volatile bool m_updateAllDataPoint;
        volatile bool m_threadTerminated;
		volatile bool m_isStandardTcpModbusDevice;
		TA_Base_Core::EOperationMode m_opertionMode;
		...
		TA_Base_Core::ReEntrantThreadLockable	m_updateAllDataPointLock;
