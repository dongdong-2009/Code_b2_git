/**
  ...
  * any form.
  *
  * Source:		$File: //depot/3001_TIP_NEW/3001/transactive/app/scada/PMSAgent/src/RTUManager.h $
  * @author:	HoaVu
  * @version:	$Revision: #3 $
  *
...
namespace TA_IRS_App
{
    ...
    public:
		...
		// when agent terminate to stop rtu workers.
		void terminate();
    ...
    private:
		...
		TA_Base_Core::ReEntrantThreadLockable   m_rtuAddLock;
    };
}
