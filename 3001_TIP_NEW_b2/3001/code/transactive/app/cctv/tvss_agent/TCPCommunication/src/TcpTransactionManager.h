...
namespace TA_IRS_App
{
	...
	public:
		...
		*/
		boost::shared_ptr<ITcpEvent> waitForEvent(unsigned long TransactionID);
		...
		*/
		bool receivedEvent(const TVSSEvent& event, unsigned long transactionID);
	...
	private:
		...
		*/
		bool waitListSignalTransaction(unsigned long transactionID,boost::shared_ptr<ITcpEvent> event_copy);
		...
		*/
		boost::shared_ptr<ITcpEvent>  waitListGetEvent(unsigned long transactionID);
