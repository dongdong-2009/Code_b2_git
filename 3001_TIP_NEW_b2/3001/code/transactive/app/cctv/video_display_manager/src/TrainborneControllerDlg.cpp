/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/cctv/video_display_manager/src/TrainborneControllerDlg.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
namespace TA_IRS_App
{
        ...
        BEGIN_MESSAGE_MAP(TrainborneControllerDlg, CDialog)
            ...
            ON_BN_CLICKED(IDC_SINGLERADIO, OnSingleradioX)
            ON_BN_CLICKED(IDC_SEQUENCERADIO, OnSequenceradio)
            ON_BN_CLICKED(IDC_QUADRADIO, OnQuadradioX)
            ON_WM_LBUTTONDOWN()
            ON_WM_RBUTTONDOWN()
            ON_WM_MOUSEMOVE()
            ON_WM_DESTROY()
		...
		void TrainborneControllerDlg::OnSingleradioX()
		{
			OnSingleradio();
		}
		void TrainborneControllerDlg::OnSingleradio(bool doResetCam)
        {
		...
		void TrainborneControllerDlg::OnQuadradioX()
		{
			OnQuadradio();
		}
        void TrainborneControllerDlg::OnQuadradio(bool doResetCam)
        {
