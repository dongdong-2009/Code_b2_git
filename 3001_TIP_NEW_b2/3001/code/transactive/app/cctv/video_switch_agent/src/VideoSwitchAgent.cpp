/**
  ...
  *
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/app/cctv/video_switch_agent/src/VideoSwitchAgent.cpp $
  * @author:   Katherine Thomson
  * @version:  $Revision: #9 $
  *
  * Last modification: $DateTime: 2017/03/31 10:16:47 $
...
namespace TA_IRS_App
{
        ...
        TA_Base_Bus::IEntityList& createdEntities)
    {
		...
		SwitchManager::getInstance().addCameraForSequence();				//lazy initialization
    ...
    void VideoSwitchAgent::agentSetControl()
    {
		...
		m_communicationsHandler->setToControl();
