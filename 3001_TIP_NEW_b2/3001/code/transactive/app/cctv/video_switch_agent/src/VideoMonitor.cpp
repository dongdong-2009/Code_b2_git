/**
  ...
  *
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/app/cctv/video_switch_agent/src/VideoMonitor.cpp $
  * @author:   Katherine Thomson
  * @version:  $Revision: #4 $
  *
  * Last modification: $DateTime: 2013/11/07 14:13:29 $
...
namespace TA_IRS_App
{
    ...
    // getSize
    //
	TA_Base_Bus::VideoMonitorCorbaDef::EVideoMonitorSize VideoMonitor::getSize()
    {
        ...
        TA_Base_Bus::VideoMonitorCorbaDef::EVideoMonitorSize size = TA_Base_Bus::VideoMonitorCorbaDef::Small;
        if ( MEDIUM == sizeStr )
        {
            size = TA_Base_Bus::VideoMonitorCorbaDef::Medium;
        }
        else if ( LARGE == sizeStr )
        {
            size = TA_Base_Bus::VideoMonitorCorbaDef::Large;
        }
        return size;
    }
	...
	unsigned long VideoMonitor::getDisplayOrder()
	{
		TA_Base_Bus::GenericAgent::ensureControlMode();//limin

		TA_ASSERT( 0 != m_videoMonitorData.get(), "The monitor database object has not been set." );

		return (unsigned long)m_videoMonitorData->getDisplayOrder();
	}
	...
	bool VideoMonitor::isOverallMonitor()
	{
		...
		return m_videoMonitorData->isOverallMonitor();
	}
    ///////////////////////////////////////////////////////////////////////
    //
    // IEntity Methods
    ...
    // setToControlMode
    //
    void VideoMonitor::activateTheServant()
    {
    ...
    // setToMonitorMode
    //
    void VideoMonitor::deactivateTheServant()
    {
	...
	void VideoMonitor::setToControlMode()
	{
		activateTheServant();
	}

	void VideoMonitor::setToMonitorMode()
	{
		deactivateTheServant();
	}
