...
/**
  ...
  *
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/app/cctv/video_switch_agent/src/SwitchManager.h $
...
namespace TA_IRS_App
{
    ...
    public:
       ...
       // virtual TA_Base_Bus::BVSStageCorbaDef_ptr getBVSStage( unsigned long entityKey );
		...
		// This interface only support local test
		virtual void processAlarmStack(const TA_Base_Bus::SwitchManagerCorbaDef::TriggerAlarmSequence& alarms,bool bOpen);
		/**
          * acknowledgeAlarm
          *
        ...
        virtual void closeAlarm(const TA_Base_Core::AlarmDetailCorbaDef& pAlarmDetail/*,unsigned long consoleId*/);
        ...
        virtual void closeAlarmWithEvent( unsigned long stationId, unsigned long eventId/*,unsigned long consoleId*/);
       ...
       // void removeQuad( unsigned long entityKey );
        ...
        void setStageSwitchMode(unsigned long originatingStage, unsigned long destinationStage, bool allowSwitch);

		void addCameraForSequence();
