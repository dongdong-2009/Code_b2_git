/**
  ...
  *
  */
#if !defined(DisplayRequestStatusDialog_H)
#define DisplayRequestStatusDialog_H
...
namespace TA_IRS_App
{
    ...
    public:
         ...
         */
        void setDisplayRequest( const TA_Base_Core::TrainList& trainList,
                                time_t timestamp,
         ...
         */
        void handleDisplayResult( const TA_Base_Core::TTISDisplayResult& displayResult );
    ...
    private:
         ...
         */
        void updateTrainStatus( TA_IRS_Bus::CommonTypes::TrainIdType trainId, const std::string& statusString );
        ...
        // Dialog Data
	    //{{AFX_DATA(DisplayRequestStatusDialog)
	    enum { IDD = IDD_DISPLAY_REQUEST };
        CButton m_okButton; // The OK button to close the dialog
...
#endif // !defined(DisplayRequestStatusDialog_H)
