/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/signs/stis_manager/src/PidGroupCombo.cpp $
  * @author:  Adam Radics
  * @version: $Revision: #2 $
  *
...
namespace TA_IRS_App
{
    ...
    const std::string PidGroupCombo::HMIGroupName = "Current Schematic Selected PID";
