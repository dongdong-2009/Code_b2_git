#ifndef PA_SIM_TABLE_ISCSWASH_H
#define PA_SIM_TABLE_ISCSWASH_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTableIscsWash.h $
  ...
  * 
  * Declaration file for PASimTableIscsWash class
  */
#ifdef WIN32
...
{
    /**
      * @class PASimTableIscsWash
      *
      * PASimTableIscsWash is a derived table class.
      *
      * TABLE IscsWash 
      *
      */
    class PASimTableIscsWash : public PASimTable
    {
    ...
    public:
        /**
          ...
          */
        PASimTableIscsWash(PASimTableQueryProcessor * parent, LocationType loc);
    ...
    private:
        /**
          ...
          */
        typedef struct PASimTableIscsWashRecord
        {
            // 0
        ...
        /**
          * 
          */
        PASimTableIscsWashRecord m_tableData;
...
#endif // #ifndef PA_SIM_TABLE_ISCSWASH_H
