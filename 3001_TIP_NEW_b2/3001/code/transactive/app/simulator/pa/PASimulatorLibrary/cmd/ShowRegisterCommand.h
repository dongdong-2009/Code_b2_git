#ifndef ShowRegisterCommand_H
#define ShowRegisterCommand_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/cmd/ShowRegisterCommand.h $
...
namespace PA_Sim
{
    /** 
      ...
      * 
      */
    class ShowRegisterCommand : public LeafCommand
    {
	public:
        ShowRegisterCommand(CommandOwner * owner);
