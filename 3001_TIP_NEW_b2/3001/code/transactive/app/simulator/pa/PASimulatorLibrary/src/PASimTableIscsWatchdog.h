#ifndef PA_SIM_TABLE_ISCSWATCHDOG_H
#define PA_SIM_TABLE_ISCSWATCHDOG_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTableIscsWatchdog.h $
  ...
  * 
  * Declaration file for PASimTableIscsWatchdog class
  */
...
{
    /**
      * @class PASimTableIscsWatchdog
      *
      * PASimTableIscsWatchdog is a derived table class.
      *
      * TABLE IscsWatchdog 
      *
      */
    class PASimTableIscsWatchdog : public PASimTable
    {
    ...
    public:
        /**
          ...
          */
        PASimTableIscsWatchdog(PASimTableQueryProcessor * parent, LocationType loc);

        /**
          * Destructor
          */
        ~PASimTableIscsWatchdog();
...
#endif // #ifndef PA_SIM_TABLE_ISCSWATCHDOG_H
