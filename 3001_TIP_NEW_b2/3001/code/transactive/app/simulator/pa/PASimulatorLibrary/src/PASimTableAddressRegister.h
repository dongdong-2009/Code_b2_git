#if !defined(PA_SIM_TABLE_ADDRESS_REGISTER_H)
#define PA_SIM_TABLE_ADDRESS_REGISTER_H
/*
...
/**
  ...
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTableAddressRegister.h $
...
namespace PA_Sim
{
    ...
    private:
        ...
        /** The value of 'X' in the PMF document, from which the addresses
          * of the PA tables are based
          */
        unsigned short m_baseAddressPA;
...
#endif // !defined(PA_SIM_TABLE_ADDRESS_REGISTER_H)
