#ifndef PA_SIM_USER_PROTOCOL_H
#define PA_SIM_USER_PROTOCOL_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimUserProtocol.h $
...
namespace PA_Sim
{
    ...
    /**
      ...
      * querys given by PASimulatorCommandProcessor, sent to
      * PATableQueryProcessor.
      */
    class UserQuery : public UserProtocol
    {
    public:
        /// Constructor with values that ought to be known at construction time
        UserQuery(MessageType type, TableOutputFormat format = f_default);
        ...
        ///
        /// @param recordstr as per PASimUtility::expandRange 'r' parameter
        /// @param max as per PASimUtility::expandRange 'max' parameter
        ...
        /// PASimTablePAXXXX::processUserWrite implementations to deal with
    ...
    const unsigned char PASim_User_Show                 = 'R'; // Read
    /// Code for 'set' queries or replies
    const unsigned char PASim_User_Set                  = 'W'; // Write
    /// Code for 'dump' queries or replies
    const unsigned char PASim_User_Dump                 = 'D'; // Dump
    /// Code for 'log' queries or replies
    const unsigned char PASim_User_Log                  = 'L'; // Log
    /// Code for 'show mode' queries or replies
    const unsigned char PASim_User_Mode                 = 'M'; // Mode

} // namespace PA_Sim
} // namespace TA_IRS_App
#endif // #ifndef PA_SIM_USER_PROTOCOL_H
