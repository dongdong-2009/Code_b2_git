...
/**
  ...
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTable.h $
...
namespace PA_Sim
{
    ...
    /**
      * @class PASimTable
      *
      * PASimTable is an abstract base class for PASim Tables.  Whether a
    ...
    public:
        /**
          ...
          */
        PASimTable(TableIdentifier tableId, PASimTableQueryProcessor * parent, LocationType loc);
    ...
    protected:
        /**
          ...
          * but that use PASimTable::processWriteQuery to sent the Write
    ...
    inline unsigned int PASimTable::getNumberOfRecords() const
    {
    ...
    /**
      ...
      * @param table the PASimTable to be streamed
      */
    std::ostream &operator<< (std::ostream &os, const PASimTable &table);

#define PA_TABLE_PUT(x,y) PASimUtility::put##x(m_tableData[i].y,n)
#define PA_TABLE_PUT_SPARE(x) PASimUtility::put##x(0,n)
// #define PA_TABLE_PUT2D(x,y) PASimUtility::put##x(m_tableData[i][j].y,n)
#define PA_TABLE_GET(y,z) m_tableData[i].z = PASimUtility::get##y(s,x)
#define PA_TABLE_GET_SPARE(y) PASimUtility::get##y(s,x)
// #define PA_TABLE_GET2D(y,z) m_tableData[i][j].z = PASimUtility::get##y(s,x)
} // namespace PA_Sim
} // namespace TA_IRS_App
