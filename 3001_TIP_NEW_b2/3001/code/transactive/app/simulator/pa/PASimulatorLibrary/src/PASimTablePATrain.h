#ifndef PA_SIM_TABLE_PATRAIN_H
#define PA_SIM_TABLE_PATRAIN_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTablePATrain.h $
...
namespace PA_Sim
{
    /**
      ...
      *
      */
    class PASimTablePATrain : public PASimTable
    {
    ...
    public:
        /**
          ...
          */
        PASimTablePATrain(PASimTableQueryProcessor * parent, LocationType loc);
    ...
    protected:
        ...
        /**
          * struct representing the data in an PATrain table
          */
        typedef struct PASimTablePATrainRecord
        {
        ...
        ///
        /// Type definition of an array of the PATrainRecords
        /// typedef PASimTablePATrainRecord * PATrainDataArray;
        ///
        PASimTablePATrainRecord * m_tableData;
...
#endif // #ifndef PA_SIM_TABLE_PATRAIN_H
