/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/cmd/SetWildCommand.cpp $
...
bool SetWildCommand::makeQuery(TokenList & args, const std::string & argstr, UserQuery * query, LocationType location, std::ostream & err)
{
    ...
    TableIdentifier tableId = PAWILD;
    //
	...
	{
        err << "ERROR: could not determine table address for table \"PAWILD\" (ouch)" << std::endl;
        return false;
	}
