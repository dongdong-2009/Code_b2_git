#ifndef LogStartCommand_H
#define LogStartCommand_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/cmd/LogStartCommand.h $
...
namespace PA_Sim
{
    /** 
      ...
      * 
      */
    class LogStartCommand : public LeafCommand
    {
	public:
        LogStartCommand(CommandOwner * owner);
    ...
    }; // class LogStartSubCommand

} // namespace PA_Sim
} // namespace TA_IRS_App

#endif // #ifndef LogStartCommand_H
