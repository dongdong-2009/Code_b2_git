#ifndef SetRegisterCommand_H
#define SetRegisterCommand_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/cmd/SetRegisterCommand.h $
...
namespace PA_Sim
{
    /** 
      ...
      * 
      */
    class SetRegisterCommand : public LeafCommand
    {
	public:
        SetRegisterCommand(CommandOwner * owner);
...
#endif // #ifndef SetTableCommand_H
