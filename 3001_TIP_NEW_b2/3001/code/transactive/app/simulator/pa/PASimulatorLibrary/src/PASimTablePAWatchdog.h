#ifndef PA_SIM_TABLE_PAWATCHDOG_H
#define PA_SIM_TABLE_PAWATCHDOG_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTablePAWatchdog.h $
  ...
  * 
  * Declaration file for PASimTablePAWatchdog class
  */
...
{
    /**
      * @class PASimTablePAWatchdog
      *
      * PASimTablePAWatchdog is a derived table class.
      *
      * TABLE PAWatchdog 
      *
      */
    class PASimTablePAWatchdog : public PASimTable
    {
    ...
    public:
        /**
          ...
          */
        PASimTablePAWatchdog(PASimTableQueryProcessor * parent, LocationType loc);

        /**
          * Destructor
          */
        ~PASimTablePAWatchdog();
...
#endif // #ifndef PA_SIM_TABLE_PAWATCHDOG_H
