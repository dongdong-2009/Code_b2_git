#ifndef SetTableCommand_H
#define SetTableCommand_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/cmd/SetTableCommand.h $
...
namespace PA_Sim
{
    /** 
      ...
      * 
      */
    class SetTableCommand : public LeafCommand
    {
	public:
        SetTableCommand(CommandOwner * owner);
