#ifndef PA_SIM_TABLE_PAWILD_H
#define PA_SIM_TABLE_PAWILD_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTablePAWILD.h $
  ...
  * 
  * Declaration file for PASimTablePAWILD class
  */
...
{
    /**
      * @class PASimTablePAWILD
      *
      * PASimTablePAWILD is a derived table class.
      *
      * TABLE PAWILD 
      *
      */
    class PASimTablePAWILD : public PASimTable
    {
    ...
    public:
        /**
          ...
          */
        PASimTablePAWILD(PASimTableQueryProcessor * parent, LocationType loc);
    ...
    private:
        ...
        /**
          * struct representing the data in an PAWILD table
          */
        typedef struct PASimTablePAWILDRecord
        {
        ...
        PASimTablePAWILDRecord * m_tableData;
...
#endif // #ifndef PA_SIM_TABLE_PAWILD_H
