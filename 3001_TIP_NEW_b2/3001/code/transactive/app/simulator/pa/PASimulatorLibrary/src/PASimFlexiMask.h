/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimFlexiMask.h $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
{
    char formPAtr[16];
    sprintf(formPAtr,"0x%%0.%dx", sizeof(T)*2);

    char s[64];
    sprintf(s, formPAtr, val);
    std::string ss = s;
