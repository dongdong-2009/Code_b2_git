/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/cmd/SetTrainLocationCommand.cpp $
...
bool SetTrainLocationCommand::makeQuery(TokenList & args, const std::string & argstr, UserQuery * query, LocationType location, std::ostream & err)
{
    ...
    Word branch_id = PASimUtility::convertBranchId2IntegerString(branch_id_str, branch_id_cnvrtd_str);
    if (branch_id == 0)
    {
