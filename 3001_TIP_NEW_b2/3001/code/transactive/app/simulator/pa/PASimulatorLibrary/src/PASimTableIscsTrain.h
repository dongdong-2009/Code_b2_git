#ifndef PA_SIM_TABLE_ISCSTRAIN_H
#define PA_SIM_TABLE_ISCSTRAIN_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/src/PASimTableIscsTrain.h $
  ...
  * 
  * Declaration file for PASimTableIscsTrain class
  */
#ifdef WIN32
...
namespace PA_Sim
{
    ...
    /**
      * @class PASimTableIscsTrain
      *
      * PASimTableIscsTrain is a derived table class.
      *
      * TABLE IscsTrain 
      *
      */
    class PASimTableIscsTrain : public PASimTable
    {
    ...
    public:
        /**
          ...
          */
        PASimTableIscsTrain(PASimTableQueryProcessor * parent, LocationType loc);
    ...
    private:
        /**
          ...
          */
        typedef struct PASimTableIscsTrainRecord
        {
        ...
        /**
          * 
          */
        PASimTableIscsTrainRecord * m_tableData;
...
#endif // #ifndef PA_SIM_TABLE_ISCSTRAIN_H
