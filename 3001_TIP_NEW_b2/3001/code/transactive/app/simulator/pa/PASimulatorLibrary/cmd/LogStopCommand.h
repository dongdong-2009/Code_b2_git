#ifndef LogStopCommand_H
#define LogStopCommand_H
/**
  * The source code in this file is the property of 
  * Ripple Systems and is not for redistribution
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/simulator/pa/PASimulatorLibrary/cmd/LogStopCommand.h $
...
namespace PA_Sim
{
    /** 
      ...
      * 
      */
    class LogStopCommand : public LeafCommand
    {
	public:
        LogStopCommand(CommandOwner * owner);
    ...
    }; // class LogStopSubCommand

} // namespace PA_Sim
} // namespace TA_IRS_App

#endif // #ifndef LogStopCommand_H
