...
namespace TA_IRS_App
{
	...
	public:
		...
		*/
		...
		/**
		* This method will cause the thread to block until the specified transaction id event is received
		*/
		boost::shared_ptr<AtsITcpEvent> waitForEvent(unsigned long TransactionID);
		...
		*/
		bool receivedEvent(const AtsEvent& event, unsigned long transactionID);
	...
	private:
		...
		*/
		bool waitListSignalTransaction(unsigned long transactionID,boost::shared_ptr<AtsITcpEvent> event_copy);
		...
		*/
		boost::shared_ptr<AtsITcpEvent>  waitListGetEvent(unsigned long transactionID);
	...
	private:
		...
		typedef struct
		{
			...
			boost::shared_ptr<AtsITcpEvent>			incomingEvent;
