/**
  ...
  * 
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/app/ats/AtsAgent/src/OperationModeManager.cpp $
  * @author:   Darren Sampson
  * @version:  $Revision: #4 $
  * @see:      9999-Q01-02-0016-GenericAgent_Usage_Guidelines.doc
  *
  * Last modification: $DateTime: 2016/12/21 16:10:47 $
						...
						if (inControlMode())
						{
...

							{
								...
								while (setOccDoubleFailureState == false)
								{
									try
									{
										m_trainAgent->inDoubleAtsFailure(CORBA::Boolean(true));
					...
					case Normal:
						{
							...
							{
								//When Ats Failure Mode ended send no double Ats failure message to train agent
								TA_Base_Core::IWorkItemPtr newWorkItem( new DoubleAtsFailureWorkItem(m_trainAgent, false));
								m_threadPool->queueWorkItem( newWorkItem );
