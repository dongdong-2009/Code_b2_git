/**
  ...
  * 
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/app/ats/AtsAgent/src/DataManager.h $
  * @author:   Ross Tucker
  * @version:  $Revision: #2 $
...
namespace TA_IRS_App
{
    ...
    private:
		...
		//Used to set AtsTcpServer
		std::string m_primaryServer;
		std::string m_secondaryServer;
