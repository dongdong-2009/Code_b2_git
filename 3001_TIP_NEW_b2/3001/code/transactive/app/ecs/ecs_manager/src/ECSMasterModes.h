...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/ecs/ecs_manager/src/ECSMasterModes.h $
  * @author:  Robert Young
  * @version: $Revision: #4 $
  *
  * Last modification: $DateTime: 2012/08/16 10:22:13 $
...
namespace TA_IRS_App
{
    ...
    private:
        ...
        struct MasterModeExecutionLastUpdated
        {
            TA_IRS_Bus::EEcsExecutionState executionState;
            long fromMasterMode;
            long toMasterMode;
        };
        ...
        /** 
          ...
          * zone the dialog should load for. Uses the command line parameter ZONE_DIRECTION_RPARAM
    ...
    private:
        ...
        LocationNames          m_locationNames;

        MasterModeDetails      m_currentMasterModeDetails;
        ...
        MasterModeExecutionLastUpdated m_masterModeExecutionLastUpdated;
    };
} // namespace TA_IRS_App
