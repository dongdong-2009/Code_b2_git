/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/ecs/ecs_manager/src/ECSStationModesOverviewDlg.cpp $
  * @author:  Robert Young
  * @version: $Revision: #6 $
  *
...
namespace TA_IRS_App
{
	...
	DWORD WINAPI ECSStationModesOverviewDlg::ThreadFunction(LPVOID lpThreadParameter)
	{
		...
		ECSSMD->onInitialise();
        ECSSMD->PostMessage(WM_ENABLE_CLOSE, static_cast<WPARAM>(TRUE), 0 );
		return TRUE;
	}
	// Reduce launching manager time
