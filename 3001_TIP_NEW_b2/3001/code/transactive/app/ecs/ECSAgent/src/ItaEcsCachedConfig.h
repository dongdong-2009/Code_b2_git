/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/ecs/ECSAgent/src/ItaEcsCachedConfig.h $
  * @author:  Ripple
  * @version: $Revision: #3 $
  *
...
public:
    ...
    virtual unsigned long getModeControlDpEntityKey()=0;  
    virtual unsigned long getModeInProgressDpEntityKey()=0;  
    virtual unsigned long getAutoModeDpEntityKey()=0;  
