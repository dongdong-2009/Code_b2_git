/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/ecs/ECSAgent/src/MasterModeLocksManager.cpp $
  * @author:  Ripple
  * @version: $Revision: #5 $
  *
...
void MasterModeLocksManager::processEmergencyUpdate(unsigned long zoneId, bool value)
{
    ...
    unsigned long currMasterMode = m_theDatapoints.getCurrentMasterMode();

    if( currMasterMode != TA_IRS_Bus::ECS_NONE_OR_INVALID && 
		currMasterMode != TA_IRS_Bus::ECS_NONE_AND_EXPECTING)
    {
        unsigned long currentAppliedEcsZoneId = m_theMaps.getZoneIdFromMasterMode( currMasterMode );
