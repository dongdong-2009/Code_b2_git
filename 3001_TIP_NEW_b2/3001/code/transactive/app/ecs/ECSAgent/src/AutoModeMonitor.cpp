/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/ecs/ECSAgent/src/AutoModeMonitor.cpp $
  * @author:  Ripple
  * @version: $Revision: #5 $
  *
    ...
    case ItaEcsCachedConfig::CONFIG_AUTO_MODE_CORBA_NAME:
        {
            ...
            const unsigned long ulKey = m_theConfig.getAutoModeDpEntityKey();
            if ( 0u != ulKey )
            {
                TA_Base_Bus::ScadaProxyFactory::getInstance().createDataPointProxy(ulKey, *this, m_autoModeProxy);
            }
        }
        break;
    default:
