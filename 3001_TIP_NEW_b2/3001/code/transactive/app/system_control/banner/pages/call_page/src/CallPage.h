/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/app/system_control/banner/pages/call_page/src/CallPage.h $
  * @author:  C. DeWolfe - Heavily modified by Dirk McCormick
  * @version: $Revision: #5 $
  *
  * Last modification: $DateTime: 2014/03/12 14:55:16 $
...
namespace TA_IRS_App
{
    ...
    protected:
		...
		afx_msg LRESULT OnDisableCallPage(WPARAM wParam, LPARAM lParam);
		afx_msg LRESULT CallPage::onActivateCall(WPARAM wParam, LPARAM lParam);
    ...
    private:
         ...
         * isEmergencyCall
         *
         * @return true if the specified input call is classified as an
         *      emergency call
         *
         * @param call details of the call
         */
        bool isEmergencyCall(const TA_IRS_Bus::ICallEntry& call);
	    ...
	    */
         ...
         *  refreshButtonText
         *
         *  Sets the text on the button that corresponds to the given call
         *  type, including the number of calls of that type that exist.
         */
        void refreshButtonText(const std::string& callType);
