/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/3001/transactive/app/pa/PAManager/src/GenericStatusModel.cpp $
  * @author Jade Lee
  * @version $Revision: #5 $
...
bool GenericStatusModel::getHasOverrideOption()
{
    ...
    if (!isTrainModel())
    {
		...
		LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugError, "Invalid context" );
    ...
    else
    {
		...
		LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugError, "No implementation for getHasOverrideOption" );
