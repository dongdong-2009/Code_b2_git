/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/3001/transactive/app/pa/PAManager/src/PaRightsManager.h $
  * @author Sean Liew
  * @version $Revision: #2 $
...
private:
    ...
    enum EPrivateRight
    {
        ...
        PA_RETRY_LOCAL_BROADCASTS = PUBLIC_RIGHT_MAX,      // see hasRightToRetryBroadcast        
