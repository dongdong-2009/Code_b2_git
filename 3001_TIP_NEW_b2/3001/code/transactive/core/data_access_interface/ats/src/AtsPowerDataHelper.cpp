/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/core/data_access_interface/ats/src/AtsPowerDataHelper.cpp $
  * @author:  Nick Jardine
  * @version: $Revision: #4 $
  *
...
namespace TA_IRS_Core
{
    ...
    void AtsPowerDataHelper::reload()
    {
		...
		sql << KEY_COL << " = " << m_idKey;*/
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_STD_SELECT_48505, m_idKey);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_SELECT_48505, m_idKey);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_SELECT_48505, m_idKey);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_STD_DELETE_48901, m_idKey);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_DELETE_48901, m_idKey);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_DELETE_48901, m_idKey);
    ...
    void AtsPowerDataHelper::modifyExistingAtsPowerData() throw(TA_Base_Core::TransactiveException)
    {
      ...
      /*  std::ostringstream sql;
        ...
        // get a connection to the database
        TA_Base_Core::IDatabase* databaseConnection = TA_Base_Core::DatabaseFactory::getInstance().getDatabase(TA_Base_Core::Ats_Cd, TA_Base_Core::Write);
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_STD_UPDATE_48651, m_subsectionNumber,
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_UPDATE_48651, m_subsectionNumber,
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_UPDATE_48651, m_subsectionNumber,
			m_locationId, m_bitPosition, m_powerDataPointEntityKey, m_idKey);
        databaseConnection->executeModification(strSql);
	...
	/*	std::ostringstream sql;
        sql << "insert into AT_POWER_ENTITY_MAP (" 
            ...
            << m_subsectionNumber << ", " 
            << m_powerDataPointEntityKey << ")";*/
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_STD_INSERT_48801, newKey,
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_INSERT_48801, newKey,
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_INSERT_48801, newKey,
			m_locationId, m_bitPosition, m_subsectionNumber, m_powerDataPointEntityKey);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), AT_POWER_ENTITY_MAP_Oracle_SELECT_48551);
//		std::string strSql  = databaseConnection->prepareSQLStatement(AT_POWER_ENTITY_MAP_SELECT_48551);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, AT_POWER_ENTITY_MAP_SELECT_48551);
