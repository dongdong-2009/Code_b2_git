/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/3001/transactive/core/data_access_interface/mms_dai/src/MmSchedulingAccessFactory.cpp $
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), MM_SCHEDULING_Oracle_SELECT_55051);
//		std::string strSql  = databaseConnection->prepareSQLStatement(MM_SCHEDULING_SELECT_55051);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, MM_SCHEDULING_SELECT_55051);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), SUBSYSTEM_STD_SELECT_18006, entityKey);
//		std::string strSql  = databaseConnection->prepareSQLStatement(SUBSYSTEM_SELECT_18006, entityKey);
		TA_Base_Core::SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, SUBSYSTEM_SELECT_18006, entityKey);
