...
{
    struct ILocationCacheObserver
    {
        virtual ~ILocationCacheObserver() {}
        virtual void onLocationCacheChange() = 0;
    };
    ...
    public:
        ...
        /**
         * Retrieves and returns the Depot location keys.
         * 
         ...
         *               Or the data doesnt exist.
         */
        DepotLocationMap getDepotLocationKeys();
		...
		bool isInControlOfLocation( unsigned long locationKey, unsigned long communicationLocationKey ); //limin++, ECP-338 CL-20150
        ...
        void registerObserver(ILocationCacheObserver* observer) { m_observers.insert(observer); }
        void deregisterObserver(ILocationCacheObserver* observer) { m_observers.erase(observer); }
    ...
    private:
		...
		/**
		 * map of depot location keys
		 */
		DepotLocationMap m_depotLocationKeys;

        std::set<ILocationCacheObserver*> m_observers;
    };
