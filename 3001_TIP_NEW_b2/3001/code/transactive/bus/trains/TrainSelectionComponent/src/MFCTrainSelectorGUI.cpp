/**
  ...
  *
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/bus/trains/TrainSelectionComponent/src/MFCTrainSelectorGUI.cpp $
  * @author:   Adam Radics
  * @version:  $Revision: #2 $
  *
...
bool MFCTrainSelectorGUI::isLocationInControl( unsigned long trainLocation )
{
	FUNCTION_ENTRY( "isLocationInControl" );
	FUNCTION_EXIT;
	return LocationCache::getInstance().isInControlOfLocation( trainLocation );
}
