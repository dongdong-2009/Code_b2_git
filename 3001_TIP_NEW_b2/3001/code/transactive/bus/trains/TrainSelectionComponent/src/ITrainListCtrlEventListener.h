/**
  ...
  *
  * Source:    $File: //depot/3001_TIP_NEW/3001/transactive/bus/trains/TrainSelectionComponent/src/ITrainListCtrlEventListener.h $
  * @author:   Adam Radics
  * @version: $Revision: #3 $
  *
  * Last modification: $Date: 2015/10/13 $
...
namespace TA_IRS_Bus
{
    ...
    public:
        ...
        virtual bool onIsSelectable(TrainListCtrl* list, TA_IRS_Bus::CommonTypes::TrainIdType trainId, unsigned long trainLocation, int rowNumber,unsigned long trainCommunicationLocation) =0;
