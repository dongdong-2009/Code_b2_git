/**
  ...
  * @version: $Revision: #6 $
  *
  * Last modification: $Date: 2016/12/16 $
...
namespace TA_IRS_Bus
{
    ...
    public:
		...
		/**
         * This will recovery train list
         *
         */
		void recoveryTrainList();

		/**
         * This method is to check is there any train need to add or update
         * from current train map. If there has, add or update the cache
		 * and update UI
		 *
         * @param trains    each train details
         */
		void updateTrainList(TrainInformationTypes::TrainDetailsList& trains);

		/**
         * This method is to check is there any train need to remove from current
         * current train map.If there it is, remove from cache and update UI
		 *
         * @param trains   each train details
         */
		void deleteTrainList(TrainInformationTypes::TrainDetailsList& trains);	
    ...
    private:
		...
		/**
         * Retrieves the data from database GroupID,GroupTSI and Subscriber Name
         */
		 void getRadioGroups();
         ...
         */
		std::map<unsigned long, std::string> m_depotLocationKey;
		...
		/**
		 * This will register the TrainInformation subscriber
		 */
		void addObserverTrainInfo();

		/**
		 * This will check if the location key is exist in the depot location cache
		 */
		bool isDepotLocation(unsigned long locationKey);
		
		/**
		 * Lock for train details map
		 */
		TA_Base_Core::ReEntrantThreadLockable m_trainMapLock;
