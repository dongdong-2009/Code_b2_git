/**
  ...
  *
  */
#if !defined(PADVARESETCOMMAND_H)
#define PADVARESETCOMMAND_H
...
namespace TA_IRS_Bus
{
     ...
     */
    class PaDvaResetCommand : public TimsCommand
    {
    ...
    public:
         ...
         */
        PaDvaResetCommand( CommonTypes::TrainIdType trainId,
    ...
    typedef boost::shared_ptr< PaDvaResetCommand > PaDvaResetCommandPtr;

}

#endif // !defined(PaDvaResetCommand_H)
