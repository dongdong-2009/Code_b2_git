...
{
    const TrainMessageType PaDvaResetCommand::MESSAGE_TYPE = 15;
    const unsigned short PaDvaResetCommand::MESSAGE_LENGTH = 8;
    const unsigned short PaDvaResetCommand::ANNOUNCEMENT_ID_POSITION = 5;


    PaDvaResetCommand::PaDvaResetCommand( CommonTypes::TrainIdType trainId,
              ...
              m_announcementId( announcementId )
    {
        ...
        FUNCTION_ENTRY( "PaDvaResetCommand" );
    ...
    PaDvaResetCommand::~PaDvaResetCommand()
    {
        FUNCTION_ENTRY( "~PaDvaResetCommand" );
        FUNCTION_EXIT;
    }
    ...
    TrainCommand::TrainResponseResult PaDvaResetCommand::setResponse( TrainEventPtr response )
    {
        ...
        if ( paCommandReceivedEvent )
        {
            ...
            if ( ( paCommandReceivedEvent->getOriginalCommand() == PaCommandReceivedEvent::PaDvaReset ) &&
    ...
    PaCommandReceivedEventPtr PaDvaResetCommand::getCommandReceivedResponse()
    {
    ...
    PaTrainMessageCompletedEventPtr PaDvaResetCommand::getTrainMessageCompletedResponse()
    {
    ...
    std::string PaDvaResetCommand::getLogString()
    {
