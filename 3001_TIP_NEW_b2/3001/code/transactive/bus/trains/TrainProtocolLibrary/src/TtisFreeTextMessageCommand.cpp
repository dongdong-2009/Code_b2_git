...
namespace TA_IRS_Bus
{
    ...
    const unsigned short TtisFreeTextMessageCommand::MESSAGE_LENGTH = 10;
    ...
    const unsigned short TtisFreeTextMessageCommand::PERRUN_POSITION = 7;
    ...
    const unsigned short TtisFreeTextMessageCommand::MESSAGE_POSITION = 8;
    const unsigned short TtisFreeTextMessageCommand::MAX_MESSAGE_LENGTH = 130;
          ...
          m_displayAttributesByte( 0 )
    {
        ...
        setByte( PERRUN_POSITION, static_cast<unsigned char>( m_perRun ) );
    ...
    std::string TtisFreeTextMessageCommand::getLogString()
    {
        ...
        logStream << "[Pid=" << std::hex << static_cast<int>( m_pidSelection )<< "]"
                  ...
                  << "[per run=" << static_cast<int>( m_perRun ) << "]"
