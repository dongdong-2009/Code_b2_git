/**
  ...
  *
  */
#if !defined(TTISCOMMANDRECIEVEDEVENT_H)
#define TTISCOMMANDRECIEVEDEVENT_H
...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         */
        unsigned int getLibraryVersion() const;
    ...
    private:
         ...
         * The library version
         */
		unsigned long m_libraryVersion; //Lucky : Based on the ICD, library version is 4bytes.
