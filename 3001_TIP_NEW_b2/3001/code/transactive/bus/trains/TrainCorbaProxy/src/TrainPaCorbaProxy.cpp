...
namespace TA_IRS_Bus
{
    ...
    unsigned long TrainPaCorbaProxy::getTrainPaLibraryVersion( CommonTypes::TrainIdType trainId )
    {
        FUNCTION_ENTRY( "getTrainPaLibraryVersion" );

        //unsigned short paLibversion = 0;
        unsigned long paLibversion = 0;
													 ...
													 bool isEmergency)
    {
        ...
        TA_Base_Bus::ITrainPaCorba::EDvaMsgPriority ePriority = 
            isEmergency ? TA_Base_Bus::ITrainPaCorba::EEMERGENCY : TA_Base_Bus::ITrainPaCorba::ENORMAL;
