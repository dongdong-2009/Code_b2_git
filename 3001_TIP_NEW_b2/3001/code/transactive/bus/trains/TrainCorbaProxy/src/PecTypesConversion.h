...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         * @param cppType    The C++ type to be converted
         */
		static TA_Base_Bus::ITrainPecCorba::EPecTrainSource convertToCorba( const PecTypes::EPecTrainSource& cppType);
         ...
         * @param CorbaType    The CORBA type to be converted
         */
		static PecTypes::EPecTrainSource convertToCpp( const TA_Base_Bus::ITrainPecCorba::EPecTrainSource& CorbaType);
