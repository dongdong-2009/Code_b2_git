 ...
 * in any form.
 *
 * Source: $File: //depot/3001_TIP_NEW/3001/transactive/bus/pa/cachedmaps/src/CachedMaps.h $
 * @author Sean Liew
 * @version $Revision: #7 $
...
namespace TA_IRS_Bus
{
    ...
    public:
        ...
        *
        */
        void refreshKeyToPaAtsTriggeredBroadcastRecordMap( unsigned long locationKey = 0 )
        ...
        */
        ...
        /**
        * processDvaVersionUpdates (passthrough function)
        *
        * @see PaDvaVersionCachedMap::processDvaVersionUpdates
        *
        */
        ...
        *
        */
        void refreshKeyToDvaVersionRecordMap( unsigned long locationKey = 0 );
        //throw(TA_Base_Core::DataException, TA_Base_Core::DatabaseException, TA_Base_Core::InvalidPasConfigurationException);
        ...
        *
        */
        unsigned long refreshKeyToPaZoneRecordMap( unsigned long locationKey = 0 )
            //throw(TA_Base_Core::DataException, TA_Base_Core::DatabaseException, TA_Base_Core::InvalidPasConfigurationException)
        {
        ...
        *
        */
        void refreshKeyToPaStationRecordMap( unsigned long locationKey = 0 );
