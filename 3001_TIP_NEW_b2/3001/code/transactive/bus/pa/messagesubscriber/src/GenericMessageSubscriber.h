/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/3001/transactive/bus/pa/messagesubscriber/src/GenericMessageSubscriber.h $
  * @author Jade Lee
  * @version $Revision: #3 $
...
namespace TA_IRS_Bus
{
    ...
    public:
         ...
         *
         */
        void    addListenerWindow(HWND wnd, bool broadcastFlag = false, bool filterByLocation = false);
    ...
    private:
         ...
         *                      Defaults to false for backward compatibility.
         */
        void resetSubscription(bool broadcastFlag = false, bool filterByLocation = false);
