...
namespace TA_IRS_Bus
{
    ...
    // ExceptionChecked
    template <class PACKET_TYPE, class BUFFERED_TYPE>
    void GenericMessageSubscriber<PACKET_TYPE, BUFFERED_TYPE>::resetSubscription(bool broadcastFlag, bool filterByLocation)
    {
        ...
        if (broadcastFlag)
        {
            ...
            FilterData ftData;
            NameValuePair regionFilter(REGION_FILTER_NAME, TA_Base_Core::DataConversion::toString(m_locationKey));
    ...
    template <class PACKET_TYPE, class BUFFERED_TYPE>
    void GenericMessageSubscriber<PACKET_TYPE, BUFFERED_TYPE>::addListenerWindow(HWND wnd, bool bcFlag, bool filterByLocation)
    {
        ...
        if (addWindowToSet(wnd))
        {
            ...
            resetSubscription(bcFlag, filterByLocation);
        }
