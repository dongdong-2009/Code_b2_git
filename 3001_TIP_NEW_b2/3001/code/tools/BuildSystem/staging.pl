#
# $Source: /cvs/1TS-9999-T/code/tools/BuildSystem/staging.pl,v $
# $Revision: 1.1.2.1 $
# $Date: 2003/05/21 04:01:44 $
# $Author: adamr $
#
# This script moves all of the built files from the build
# machine to its appropriate place in the staging area
#
# $Last modified by: andrewdc 2003/05/06 09:00:00 $
# $reason: make script more modularised enabling more robust search arguments
